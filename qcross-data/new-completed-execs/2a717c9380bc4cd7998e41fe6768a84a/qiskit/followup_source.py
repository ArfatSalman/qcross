...
qc.append(UGate(3.1560639900200687, 5.736507853795902, 5.182419857278261), qargs=[qr[3]], cargs=[])
...
backend_0b81766f33524d50bbf320413693c6dd = Aer.get_backend('aer_simulator_matrix_product_state')
counts = execute(qc, backend=backend_0b81766f33524d50bbf320413693c6dd, shots=5542).result().get_counts(qc)
RESULT = counts
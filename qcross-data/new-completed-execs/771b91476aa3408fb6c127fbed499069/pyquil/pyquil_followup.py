...
defns = get_custom_get_definitions("CSGate", "RXXGate", "CU3Gate", "CXGate", "U2Gate", "XGate", "CCZGate", "CUGate", "RZZGate", "U1Gate", "RGate", "CCXGate", "SwapGate")
...
subcircuit = Program()
subcircuit.inst(Gates.CUGate(1.573398276884453, 2.4750711131608187, 2.608178435015891, 0.020264981462429707, 3, 2 ))
subcircuit.inst(Gates.CCXGate( 3, 6, 2 ))
subcircuit.inst(Gates.CXGate( 6, 4 ))

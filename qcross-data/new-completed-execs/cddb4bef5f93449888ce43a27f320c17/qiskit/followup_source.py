...
subcircuit.append(CRXGate(0.7524962069161311), qargs=[qr[1], qr[6]], cargs=[])
subcircuit.append(CCZGate(), qargs=[qr[7], qr[1], qr[6]], cargs=[])
subcircuit.append(RZZGate(0.46490371756219195), qargs=[qr[7], qr[5]], cargs=[])
subcircuit.append(DCXGate(), qargs=[qr[4], qr[9]], cargs=[])
subcircuit.append(RVGate(5.04524665062051,1.7636237549722318,4.690324347774963), qargs=[qr[9]], cargs=[])
subcircuit.append(U1Gate(2.4842501674681814), qargs=[qr[6]], cargs=[])

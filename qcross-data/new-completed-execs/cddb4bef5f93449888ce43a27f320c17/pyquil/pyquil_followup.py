...
defns = get_custom_get_definitions("IGate", "RZZGate", "RC3XGate", "XGate", "CU1Gate", "SdgGate", "RXGate", "CCZGate", "CRYGate", "U1Gate", "RYGate", "PhaseGate", "DCXGate", "CRXGate", "RVGate", "CHGate")
...
subcircuit = Program()
subcircuit.inst(Gates.CRXGate(0.7524962069161311, 1, 6 ))
subcircuit.inst(Gates.CCZGate( 7, 1, 6 ))
subcircuit.inst(Gates.RZZGate(0.46490371756219195)( 7, 5 ))
subcircuit.inst(Gates.DCXGate( 4, 9 ))
subcircuit.inst(Gates.RVGate(5.04524665062051, 1.7636237549722318, 4.690324347774963)( 9 ))
subcircuit.inst(Gates.U1Gate(2.4842501674681814, 6 ))

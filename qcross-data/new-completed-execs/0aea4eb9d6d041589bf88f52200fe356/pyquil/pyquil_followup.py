...
defns = get_custom_get_definitions("SXdgGate", "CHGate", "RXXGate", "RXGate", "U1Gate", "ZGate", "CRYGate", "RYYGate", "XGate", "iSwapGate", "CZGate", "RZXGate", "SXGate", "CYGate", "ECRGate", "CRZGate", "RGate", "SGate")
...
subcircuit = Program()
subcircuit.inst(Gates.CRYGate(3.142547021000323, 0, 1 ))
subcircuit.inst(Gates.SGate( 0 ))
subcircuit.inst(Gates.U1Gate(1.1029693994010046, 1 ))

...
defns = get_custom_get_definitions("SXdgGate", "CSGate", "RXGate", "RYGate", "SdgGate", "HGate", "RZGate", "CPhaseGate", "RYYGate", "UGate", "SwapGate", "RCCXGate", "CSXGate", "U3Gate", "SXGate", "U1Gate", "RGate", "TGate")
...
subcircuit = Program()
subcircuit.inst(Gates.RGate(3.863590788996665, 1.7755874178641218)( 0 ))

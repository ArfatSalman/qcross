...
defns = get_custom_get_definitions("CSGate", "CU3Gate", "CSdgGate", "CRXGate", "PhaseGate", "CRYGate", "RYYGate", "RCCXGate", "SwapGate", "UGate", "CCZGate", "CUGate", "CSXGate", "CZGate", "U1Gate", "CRZGate", "RZZGate", "TGate")
...
subcircuit = Program()
subcircuit.inst(Gates.CRYGate(0.18861614070395222, 8, 4 ))
subcircuit.inst(Gates.SwapGate( 9, 2 ))
subcircuit.inst(Gates.CSXGate( 3, 9 ))
subcircuit.inst(Gates.UGate(2.29898529136329, 2.602581019015746, 3.608523225163746)( 8 ))

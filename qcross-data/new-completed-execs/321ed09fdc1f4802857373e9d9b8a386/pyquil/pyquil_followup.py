...
defns = get_custom_get_definitions("CU1Gate", "ZGate", "HGate", "CRXGate", "PhaseGate", "U2Gate", "CPhaseGate", "XGate", "TdgGate", "CUGate", "DCXGate", "CZGate", "RGate", "CYGate", "RZZGate")
...
subcircuit.inst(Gates.PhaseGate(1.0991937230132693, 0 ))
subcircuit.inst(Gates.RZZGate(0.29263822564237946)( 0, 1 ))
subcircuit.inst(Gates.CU1Gate(1.319709844326333, 1, 0 ))
subcircuit.inst(Gates.CPhaseGate(0.07651702010631041, 0, 1 ))
subcircuit.inst(Gates.CUGate(3.544831331267256, 5.290981419397922, 4.5769317827703135, 3.078979867833689, 0, 1 ))
subcircuit.inst(Gates.RGate(3.7945044816842795, 4.841616274028528)( 0 ))

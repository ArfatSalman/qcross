...
circuit.append(Gates.RZGate(1.011876271526295)( qr[1] ))
circuit.append(Gates.CHGate( qr[0], qr[1] ))
circuit.append(Gates.CUGate(4.470339697850853, 2.3870542496998692, 0.050955830933431714, 0.06883225750858235)( qr[0], qr[4] ))
circuit.append(Gates.C3XGate( qr[6], qr[4], qr[5], qr[1] ))
circuit.append(Gates.RC3XGate( qr[4], qr[6], qr[5], qr[2] ))
circuit.append(Gates.SdgGate( qr[5] ))
circuit.append(Gates.CCXGate( qr[0], qr[5], qr[6] ))

...
defns = get_custom_get_definitions("RVGate", "ZGate", "HGate", "CRXGate", "CPhaseGate", "U2Gate", "CYGate", "DCXGate", "SXGate", "U1Gate", "ECRGate", "SGate", "TGate")
...
subcircuit.inst(Gates.CYGate( 0, 3 ))

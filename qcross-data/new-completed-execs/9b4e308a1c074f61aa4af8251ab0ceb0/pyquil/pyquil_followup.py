...
defns = get_custom_get_definitions("CHGate", "CXGate", "HGate", "CRXGate", "PhaseGate", "RCCXGate", "iSwapGate", "XGate", "U3Gate", "DCXGate", "U1Gate", "RZZGate", "CCXGate", "SwapGate")
...
subcircuit = Program()
subcircuit.inst(Gates.RCCXGate( 0, 9, 8 ))

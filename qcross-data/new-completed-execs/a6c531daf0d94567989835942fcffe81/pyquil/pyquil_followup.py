...
defns = get_custom_get_definitions("CU1Gate", "CXGate", "CRXGate", "CPhaseGate", "U2Gate", "PhaseGate", "CSXGate", "U3Gate", "DCXGate", "CZGate", "SXGate", "ECRGate", "CRZGate", "RZZGate", "SwapGate")
...
subcircuit = Program()
subcircuit.inst(Gates.ECRGate( 6, 2 ))
subcircuit.inst(Gates.RZZGate(3.4677289488904535)( 5, 2 ))
subcircuit.inst(Gates.CZGate( 3, 4 ))
subcircuit.inst(Gates.CPhaseGate(5.900280104099499, 2, 1 ))

...
subcircuit.append(ECRGate(), qargs=[qr[6], qr[2]], cargs=[])
subcircuit.append(RZZGate(3.4677289488904535), qargs=[qr[5], qr[2]], cargs=[])
subcircuit.append(CZGate(), qargs=[qr[3], qr[4]], cargs=[])
subcircuit.append(CPhaseGate(5.900280104099499), qargs=[qr[2], qr[1]], cargs=[])

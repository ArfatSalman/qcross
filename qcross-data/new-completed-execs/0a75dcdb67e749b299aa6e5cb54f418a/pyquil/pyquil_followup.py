...
defns = get_custom_get_definitions("CSdgGate", "IGate", "SGate", "RC3XGate", "SdgGate", "RZXGate", "C3XGate", "DCXGate", "ECRGate", "RYGate", "C3SXGate", "RYYGate", "CUGate", "CU3Gate", "CYGate", "UGate")
...
subcircuit = Program()
subcircuit.inst(Gates.RYGate(3.2534282040977613, 2 ))
subcircuit.inst(Gates.DCXGate( 3, 2 ))
subcircuit.inst(Gates.ECRGate( 1, 2 ))

...
backend_9727fb1c0f7d4032a41b122403a81264 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_9727fb1c0f7d4032a41b122403a81264, shots=3919).result().get_counts(qc)
RESULT = counts

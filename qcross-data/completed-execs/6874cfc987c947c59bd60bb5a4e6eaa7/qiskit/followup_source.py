...
backend_0b5797496ef24005a16601f2fb10abc3 = Aer.get_backend('qasm_simulator')
counts_1 = execute(qc_1, backend=backend_0b5797496ef24005a16601f2fb10abc3, shots=979).result().get_counts(qc_1)
counts_2 = execute(qc_2, backend=backend_0b5797496ef24005a16601f2fb10abc3, shots=979).result().get_counts(qc_2)

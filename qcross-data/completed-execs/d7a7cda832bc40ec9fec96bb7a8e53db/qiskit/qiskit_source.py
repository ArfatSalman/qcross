...
backend_d19ad8e724d24281b9287b1929b4316f = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_d19ad8e724d24281b9287b1929b4316f, shots=692).result().get_counts(qc)
RESULT = counts
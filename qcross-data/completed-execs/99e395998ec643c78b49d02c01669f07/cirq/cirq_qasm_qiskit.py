...
circuit.append(Gates.CUGate(p_5c6e3d, 4.167661441102218, 4.623446645668956, 3.865496458458116)( qr[1], qr[4] ))
...
circuit.append(Gates.CU1Gate(4.028174522740928)( qr[0], qr[3] ))

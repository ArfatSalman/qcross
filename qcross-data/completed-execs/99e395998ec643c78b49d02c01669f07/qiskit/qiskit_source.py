...
backend_b58d2e9bd5bd4ba18c2a773578cdffd3 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_b58d2e9bd5bd4ba18c2a773578cdffd3, shots=979).result().get_counts(qc)
RESULT = counts
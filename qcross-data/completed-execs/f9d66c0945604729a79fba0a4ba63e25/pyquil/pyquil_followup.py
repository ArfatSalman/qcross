...
p_3d9a09 = circuit.declare('p_3d9a09', 'REAL')

defns = get_custom_get_definitions("SdgGate", "CHGate", "CU1Gate", "CCXGate", "RCCXGate", "U2Gate", "CSXGate", "RZGate", "CRZGate", "ZGate", "XGate")
...
circuit.inst(Gates.RZGate(p_3d9a09, 0 ))

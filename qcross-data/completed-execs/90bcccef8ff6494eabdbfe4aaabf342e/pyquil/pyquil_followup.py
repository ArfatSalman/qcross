...
defns = get_custom_get_definitions("ZGate", "RZGate", "XGate", "SXGate", "SGate", "SdgGate", "C3SXGate", "CU1Gate", "CUGate", "CSXGate")
...
circuit.inst(Gates.C3SXGate( 0, 7, 1, 2 ))
...
circuit.inst(Gates.CU1Gate(3.2142159669963557, 7, 3 ))

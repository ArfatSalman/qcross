...
backend_8be1359980b54fd4a1f4d845f0a722ed = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_8be1359980b54fd4a1f4d845f0a722ed, shots=3919).result().get_counts(qc)
RESULT = counts

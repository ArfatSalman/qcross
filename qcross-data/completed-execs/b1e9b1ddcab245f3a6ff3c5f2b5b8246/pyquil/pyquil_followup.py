...
defns = get_custom_get_definitions("RYYGate", "SXGate", "CUGate", "CCXGate", "ZGate", "XGate", "RCCXGate", "CRZGate", "RZGate")
...
subcircuit = Program()
subcircuit.inst(Gates.RYYGate(0.9356897707598831)( 4, 5 ))
subcircuit.inst(Gates.XGate( 10 ))

...
p_2c5a30 = Symbol('p_2c5a30')
p_d8aa57 = Symbol('p_d8aa57')
p_90c25c = Symbol('p_90c25c')
p_b36eca = Symbol('p_b36eca')

circuit = cirq.Circuit()

circuit.append(Gates.RZGate(6.163759533339787)( qr[1] ))
circuit.append(Gates.RZZGate(p_2c5a30)( qr[2], qr[3] ))
circuit.append(Gates.iSwapGate( qr[2], qr[3] ))
circuit.append(Gates.CSXGate( qr[1], qr[0] ))
circuit.append(Gates.XGate( qr[2] ))
circuit.append(Gates.CUGate(0.5112149185250571, 5.897054719225356, p_d8aa57, p_90c25c)( qr[0], qr[2] ))
circuit.append(Gates.CU1Gate(p_b36eca)( qr[3], qr[0] ))

...
backend_c35c1321ac3d48598988b16553d519b6 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_c35c1321ac3d48598988b16553d519b6, shots=7838).result().get_counts(qc)
RESULT = counts
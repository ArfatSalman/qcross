...
p_efcc68 = Symbol('p_efcc68')
p_2061b2 = Symbol('p_2061b2')
p_536d06 = Symbol('p_536d06')
p_732b5a = Symbol('p_732b5a')
p_dbfaed = Symbol('p_dbfaed')
p_28ab37 = Symbol('p_28ab37')
p_c8704d = Symbol('p_c8704d')
p_77100f = Symbol('p_77100f')

circuit = cirq.Circuit()

circuit.append(Gates.RZGate(p_536d06)( qr[3] ))
circuit.append(Gates.CRZGate(p_dbfaed)( qr[6], qr[3] ))
circuit.append(Gates.CRXGate(p_2061b2)( qr[1], qr[7] ))
circuit.append(Gates.CCXGate( qr[5], qr[9], qr[7] ))
circuit.append(Gates.ZGate( qr[2] ))
circuit.append(Gates.TGate( qr[9] ))
circuit.append(Gates.XGate( qr[8] ))
circuit.append(Gates.CRZGate(p_28ab37)( qr[1], qr[6] ))
circuit.append(Gates.RZGate(p_efcc68)( qr[1] ))
...
circuit.append(Gates.CRZGate(p_77100f)( qr[1], qr[2] ))
circuit.append(Gates.U2Gate(p_c8704d, p_732b5a)( qr[2] ))

...
subcircuit.append(Gates.CZGate( qr[1], qr[3] ))
subcircuit.append(Gates.CRXGate(4.736752714049485)( qr[0], qr[4] ))
subcircuit.append(Gates.CU1Gate(4.501598818751339)( qr[2], qr[4] ))
subcircuit.append(Gates.CU3Gate(3.865496458458116, 2.6636908506222836, 6.221353754875494)( qr[4], qr[1] ))

...
defns = get_custom_get_definitions("RCCXGate", "UGate", "ZGate", "CU1Gate", "RZZGate", "CRZGate", "C3SXGate", "RZGate", "TGate", "SGate", "CCXGate", "SXGate", "CUGate", "CRXGate")

circuit += defns

circuit.inst(Gates.RZGate(6.163759533339787, 4 ))
circuit.inst(Gates.ZGate( 3 ))
circuit.inst(Gates.CRZGate(4.2641612072511235, 1, 4 ))
...
circuit.inst(Gates.CU1Gate(4.028174522740928, 2, 4 ))

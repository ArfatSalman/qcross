...
backend_169a40fa637248e6b31f0c05391f9ee3 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_169a40fa637248e6b31f0c05391f9ee3, shots=1385).result().get_counts(qc)
RESULT = counts

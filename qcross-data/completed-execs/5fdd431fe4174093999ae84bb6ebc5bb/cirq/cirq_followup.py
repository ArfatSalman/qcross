...
circuit.append(Gates.CSXGate( qr[8], qr[4] ))
circuit.append(Gates.CUGate(0.5112149185250571, 5.897054719225356, 2.3864521352475245, 5.987304452123941)( qr[2], qr[7] ))
circuit.append(Gates.SdgGate( qr[0] ))
circuit.append(Gates.C3SXGate( qr[2], qr[5], qr[1], qr[6] ))
...
subcircuit.append(Gates.CRYGate(3.1402006997068588)( qr[8], qr[2] ))
subcircuit.append(Gates.SXdgGate( qr[7] ))
circuit.append(subcircuit)
circuit.append(cirq.inverse(cirq.expand_composite(subcircuit)))

circuit.append(Gates.C3SXGate( qr[0], qr[3], qr[8], qr[2] ))
circuit.append(Gates.SXGate( qr[2] ))
circuit.append(Gates.CU1Gate(3.2142159669963557)( qr[5], qr[3] ))
circuit.append(Gates.CRZGate(1.4112277317699358)( qr[6], qr[5] ))
circuit.append(Gates.ZGate( qr[8] ))
circuit.append(Gates.CSXGate( qr[2], qr[8] ))
circuit.append(Gates.ZGate( qr[1] ))
circuit.append(Gates.CHGate( qr[7], qr[0] ))

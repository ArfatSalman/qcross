...
qr_c9ee67 = QuantumRegister(5, name='qr_c9ee67')
qc.add_register(qr_c9ee67)
# SECTION
# NAME: MEASUREMENT
...
backend_350c095d0e2c4182913a367ee577fb19 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_350c095d0e2c4182913a367ee577fb19, shots=7838).result().get_counts(qc)
RESULT = counts

...
p_6d84ca = Symbol('p_6d84ca')
p_e64f44 = Symbol('p_e64f44')
p_ac3f49 = Symbol('p_ac3f49')

circuit = cirq.Circuit()

circuit.append(Gates.RZGate(p_6d84ca)( qr[8] ))
circuit.append(Gates.CSXGate( qr[2], qr[4] ))
circuit.append(Gates.CUGate(p_ac3f49, 5.897054719225356, p_e64f44, 5.987304452123941)( qr[0], qr[6] ))
...
circuit = cirq.resolve_parameters(circuit, {
    "p_6d84ca": 6.163759533339787,
    "p_e64f44": 2.3864521352475245,
    "p_ac3f49": 0.5112149185250571
}, recursive=True)

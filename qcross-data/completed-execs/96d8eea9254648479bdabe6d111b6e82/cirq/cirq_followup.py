...
circuit.append(Gates.SwapGate( qr[4], qr[2] ))
circuit.append(Gates.U2Gate(5.355095913145835, 0.5025385094232117)( qr[1] ))
circuit.append(Gates.SdgGate( qr[5] ))
circuit.append(Gates.CRZGate(2.5299146290041223)( qr[2], qr[10] ))
circuit.append(Gates.SXGate( qr[9] ))
circuit.append(Gates.CHGate( qr[0], qr[10] ))
circuit.append(Gates.CXGate( qr[3], qr[4] ))
circuit.append(Gates.IGate( qr[7] ))
circuit.append(Gates.DCXGate( qr[5], qr[7] ))
circuit.append(Gates.RC3XGate( qr[7], qr[9], qr[6], qr[8] ))
circuit.append(Gates.CU1Gate(3.4774129386607884)( qr[8], qr[5] ))
circuit.append(cirq.measure(qr[3], key='cr0'))
circuit.append(cirq.measure(qr[8], key='cr1'))
circuit.append(cirq.measure(qr[10], key='cr2'))

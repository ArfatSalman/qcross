...
qc_1.append(Gates.TGate( qr_1[0] ))
qc_1.append(Gates.SXdgGate( qr_1[4] ))
qc_1.append(Gates.RZGate(4.722103101046168)( qr_1[1] ))
qc_1.append(Gates.CRZGate(0.6393443962862078)( qr_1[4], qr_1[2] ))
qc_1.append(Gates.CU1Gate(2.5476776328466872)( qr_1[2], qr_1[7] ))
qc_1.append(Gates.RZGate(3.6614081973587154)( qr_1[5] ))
qc_1.append(Gates.XGate( qr_1[7] ))
qc_1.append(Gates.CSXGate( qr_1[6], qr_1[0] ))

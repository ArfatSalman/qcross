...
qc_1.inst(Gates.CU1Gate(2.5476776328466872, 2, 7 ))
qc_1.inst(Gates.RZGate(3.6614081973587154, 5 ))
qc_1.inst(Gates.XGate( 7 ))
qc_1.inst(Gates.CSXGate( 6, 0 ))
...
defns = get_custom_get_definitions("ZGate", "TGate", "SXdgGate")

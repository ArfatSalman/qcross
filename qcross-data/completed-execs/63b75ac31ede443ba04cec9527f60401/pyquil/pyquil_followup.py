...
p_a6862f = circuit.declare('p_a6862f', 'REAL')

defns = get_custom_get_definitions("CHGate", "CRZGate", "RZGate", "ECRGate", "SGate", "CRXGate", "RYYGate", "CSXGate", "SXdgGate")
...
circuit.inst(Gates.CRZGate(p_a6862f, 3, 4 ))

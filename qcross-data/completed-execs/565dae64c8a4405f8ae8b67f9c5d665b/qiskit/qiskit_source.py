...
backend_1852014c52b64d27abcd40bb34df2352 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_1852014c52b64d27abcd40bb34df2352, shots=3919).result().get_counts(qc)
RESULT = counts
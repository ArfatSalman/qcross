...
defns = get_custom_get_definitions("ZGate", "RZGate")
...
defns = get_custom_get_definitions("ZGate", "C3SXGate", "CRXGate", "XGate", "CRZGate")

qc_2 += defns

qc_2.inst(Gates.ZGate( 3 ))
qc_2.inst(Gates.XGate( 3 ))
qc_2.inst(Gates.CRXGate(5.987304452123941, 0, 3 ))
qc_2.inst(Gates.CRZGate(1.0296448789776642, 1, 3 ))
qc_2.inst(Gates.C3SXGate( 0, 4, 3, 2 ))

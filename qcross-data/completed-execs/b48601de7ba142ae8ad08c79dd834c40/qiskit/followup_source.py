...
backend_2558b92eab1d4eaf92281198e2dcccdf = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_2558b92eab1d4eaf92281198e2dcccdf, shots=1959).result().get_counts(qc)
RESULT = counts

...
backend_3d16f9cdebc84524b4f20639ebcf4bd6 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_3d16f9cdebc84524b4f20639ebcf4bd6, shots=7838).result().get_counts(qc)
RESULT = counts

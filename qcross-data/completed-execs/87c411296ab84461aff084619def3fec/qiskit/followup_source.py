...
backend_84a6f77b5ba44acf92306e7f6ed374d1 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_84a6f77b5ba44acf92306e7f6ed374d1, shots=692).result().get_counts(qc)
RESULT = counts

...
backend_8df984c4f15f4f0cb7f0a2507ced8a63 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_8df984c4f15f4f0cb7f0a2507ced8a63, shots=5542).result().get_counts(qc)
RESULT = counts

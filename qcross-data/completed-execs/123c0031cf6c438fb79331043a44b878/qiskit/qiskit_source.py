...
backend_1d4edc4ba3f74e70bee1216a0e51d328 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_1d4edc4ba3f74e70bee1216a0e51d328, shots=1959).result().get_counts(qc)
RESULT = counts
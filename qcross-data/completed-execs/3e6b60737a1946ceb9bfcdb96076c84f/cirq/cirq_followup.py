...
p_280a56 = Symbol('p_280a56')
p_376f59 = Symbol('p_376f59')
p_046fa5 = Symbol('p_046fa5')
p_0bfb4f = Symbol('p_0bfb4f')
p_2fed8d = Symbol('p_2fed8d')
p_bf5488 = Symbol('p_bf5488')

circuit = cirq.Circuit()

circuit.append(Gates.RZGate(p_376f59)( qr[4] ))
circuit.append(Gates.ZGate( qr[6] ))
circuit.append(Gates.XGate( qr[6] ))
circuit.append(Gates.CRXGate(p_046fa5)( qr[0], qr[6] ))
...
circuit.append(Gates.CRZGate(p_bf5488)( qr[1], qr[7] ))
...
circuit.append(Gates.RZZGate(p_280a56)( qr[7], qr[0] ))
...
circuit.append(Gates.CUGate(5.03147076606842, 5.0063780207098425, 3.1562533916051736, p_0bfb4f)( qr[6], qr[2] ))
circuit.append(Gates.U2Gate(p_2fed8d, 2.1276323672732023)( qr[2] ))

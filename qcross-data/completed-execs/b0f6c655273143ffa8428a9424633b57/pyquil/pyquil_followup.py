...
defns = get_custom_get_definitions("ECRGate", "C3SXGate", "RCCXGate", "CRXGate", "CU1Gate", "SGate", "RZGate", "XGate", "ZGate", "SdgGate", "CHGate")
...
qr_3c8618 = circuit.declare("qr_3c8618", "BIT", 1)

...
qr_3c8618 = QuantumRegister(1, name='qr_3c8618')
qc.add_register(qr_3c8618)
# SECTION
# NAME: MEASUREMENT
...
backend_4344f47b009d4fdc9bffb788afcedb02 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_4344f47b009d4fdc9bffb788afcedb02, shots=1959).result().get_counts(qc)
RESULT = counts

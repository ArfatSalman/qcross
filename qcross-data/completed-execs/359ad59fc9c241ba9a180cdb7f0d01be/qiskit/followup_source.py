...
backend_61d0281bac904a26955a32ea75ccbf56 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_61d0281bac904a26955a32ea75ccbf56, shots=692).result().get_counts(qc)
RESULT = counts

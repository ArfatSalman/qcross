...
defns = get_custom_get_definitions("SXdgGate", "iSwapGate", "C3SXGate", "RZZGate", "CU1Gate", "CUGate", "RZGate", "TGate", "XGate", "CSXGate", "CHGate")
...
circuit.inst(Gates.CU1Gate(5.154187354656876, 0, 3 ))

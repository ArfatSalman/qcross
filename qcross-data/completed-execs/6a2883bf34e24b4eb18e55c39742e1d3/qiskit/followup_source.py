...
qc = transpile(qc, basis_gates=None, optimization_level=2, coupling_map=[[0,
    1], [0, 4], [0, 5], [1, 0], [1, 10], [2, 3], [2, 5], [2, 6], [2, 8], [3,
    2], [4, 0], [4, 7], [5, 0], [5, 2], [6, 2], [6, 9], [7, 4], [8, 2], [9,
    6], [10, 1]])
# SECTION
# NAME: EXECUTION

from qiskit import Aer, transpile, execute
backend_3156d0d1d0fb42669bc3998e57f0c4c6 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_3156d0d1d0fb42669bc3998e57f0c4c6, shots=7838).result().get_counts(qc)
RESULT = counts

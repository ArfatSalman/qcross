...
backend_d8523b48f4e343acbd679de4f1df321b = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_d8523b48f4e343acbd679de4f1df321b, shots=7838).result().get_counts(qc)
RESULT = counts

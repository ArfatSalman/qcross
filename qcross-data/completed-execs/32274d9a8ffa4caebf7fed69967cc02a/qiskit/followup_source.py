...
backend_ff3ddf73f3924896a904405e9ed84ed8 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_ff3ddf73f3924896a904405e9ed84ed8, shots=1959).result().get_counts(qc)
RESULT = counts

...
backend_f42d8bea968a48c5901410e3465c9fbf = Aer.get_backend('statevector_simulator')
counts = execute(qc, backend=backend_f42d8bea968a48c5901410e3465c9fbf, shots=489).result().get_counts(qc)
RESULT = counts

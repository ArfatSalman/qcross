...
qc.append(CRZGate(4.2641612072511235), qargs=[qr[7], qr[8]], cargs=[])
qc.append(CRXGate(5.987304452123941), qargs=[qr[1], qr[9]], cargs=[])
qc.append(CCXGate(), qargs=[qr[4], qr[6], qr[9]], cargs=[])
...
qc.append(CCXGate(), qargs=[qr[5], qr[6], qr[4]], cargs=[])
qc.append(C3SXGate(), qargs=[qr[2], qr[5], qr[3], qr[6]], cargs=[])
qc.append(CSXGate(), qargs=[qr[3], qr[2]], cargs=[])
qc.append(ZGate(), qargs=[qr[3]], cargs=[])
qc.append(CHGate(), qargs=[qr[9], qr[1]], cargs=[])
...
qc.append(CRXGate(5.970852306777193), qargs=[qr[9], qr[1]], cargs=[])
...
backend_9d20709de4904c889f477b23e54ae103 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_9d20709de4904c889f477b23e54ae103, shots=5542).result().get_counts(qc)
RESULT = counts

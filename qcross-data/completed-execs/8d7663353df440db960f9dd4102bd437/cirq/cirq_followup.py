...
circuit.append(Gates.CRZGate(4.2641612072511235)( qr[7], qr[8] ))
circuit.append(Gates.CRXGate(5.987304452123941)( qr[1], qr[9] ))
circuit.append(Gates.CCXGate( qr[4], qr[6], qr[9] ))
...
circuit.append(Gates.CCXGate( qr[5], qr[6], qr[4] ))
circuit.append(Gates.C3SXGate( qr[2], qr[5], qr[3], qr[6] ))
circuit.append(Gates.CSXGate( qr[3], qr[2] ))
circuit.append(Gates.ZGate( qr[3] ))
circuit.append(Gates.CHGate( qr[9], qr[1] ))
...
circuit.append(Gates.CRXGate(5.970852306777193)( qr[9], qr[1] ))

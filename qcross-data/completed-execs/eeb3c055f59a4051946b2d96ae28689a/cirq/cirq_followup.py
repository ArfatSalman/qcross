...
p_6cbc43 = Symbol('p_6cbc43')
p_8b0f45 = Symbol('p_8b0f45')
p_6f2ade = Symbol('p_6f2ade')
p_da88cf = Symbol('p_da88cf')

circuit = cirq.Circuit()

circuit.append(Gates.RZGate(6.163759533339787)( qr[1] ))
circuit.append(Gates.RZZGate(p_6cbc43)( qr[2], qr[3] ))
circuit.append(Gates.iSwapGate( qr[2], qr[3] ))
circuit.append(Gates.CSXGate( qr[1], qr[0] ))
circuit.append(Gates.XGate( qr[2] ))
circuit.append(Gates.CUGate(p_da88cf, p_6f2ade, 2.3864521352475245, 5.987304452123941)( qr[0], qr[2] ))
...
circuit.append(Gates.RYYGate(p_8b0f45)( qr[2], qr[0] ))

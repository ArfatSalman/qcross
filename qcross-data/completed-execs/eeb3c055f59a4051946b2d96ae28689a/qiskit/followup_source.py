...
# SECTION
# NAME: PARAMETERS
p_6cbc43 = Parameter('p_6cbc43')
p_8b0f45 = Parameter('p_8b0f45')
p_6f2ade = Parameter('p_6f2ade')
p_da88cf = Parameter('p_da88cf')
...
qc.append(RZZGate(p_6cbc43), qargs=[qr[2], qr[3]], cargs=[])
qc.append(iSwapGate(), qargs=[qr[2], qr[3]], cargs=[])
qc.append(CSXGate(), qargs=[qr[1], qr[0]], cargs=[])
qc.append(XGate(), qargs=[qr[2]], cargs=[])
qc.append(CUGate(p_da88cf, p_6f2ade, 2.3864521352475245, 5.987304452123941),
...
qc.append(RYYGate(p_8b0f45), qargs=[qr[2], qr[0]], cargs=[])
...
backend_48b861aa32ce458dbd45356c1d470c97 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_48b861aa32ce458dbd45356c1d470c97, shots=692).result().get_counts(qc)
RESULT = counts

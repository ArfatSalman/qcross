...
subcircuit.append(Gates.RYGate(3.393897726708824)( qr[0] ))
subcircuit.append(Gates.iSwapGate( qr[2], qr[0] ))
subcircuit.append(Gates.PhaseGate(1.7897858384938228)( qr[0] ))
subcircuit.append(Gates.ECRGate( qr[0], qr[4] ))
subcircuit.append(Gates.CU1Gate(2.0685963035149753)( qr[4], qr[0] ))
subcircuit.append(Gates.PhaseGate(5.336667571035288)( qr[0] ))
subcircuit.append(Gates.CUGate(5.014941143947427, 4.437078557875917, 6.016631690603051, 3.1243053509071124)( qr[1], qr[2] ))
subcircuit.append(Gates.SXGate( qr[1] ))
subcircuit.append(Gates.iSwapGate( qr[3], qr[6] ))

...
defns = get_custom_get_definitions("CRZGate", "ECRGate", "iSwapGate", "C3SXGate", "RCCXGate", "CRXGate", "CU1Gate", "CUGate", "SGate", "RZGate", "RYGate", "XGate", "CSXGate", "PhaseGate", "ZGate", "SdgGate", "SXGate", "CHGate")
...
subcircuit = Program()
subcircuit.inst(Gates.RYGate(3.393897726708824, 0 ))
subcircuit.inst(Gates.iSwapGate( 2, 0 ))
subcircuit.inst(Gates.PhaseGate(1.7897858384938228, 0 ))
subcircuit.inst(Gates.ECRGate( 0, 4 ))

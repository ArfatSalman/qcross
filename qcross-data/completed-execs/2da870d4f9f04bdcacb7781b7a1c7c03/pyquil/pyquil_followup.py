...
defns = get_custom_get_definitions("XGate")

qc_1 += defns

qc_1.inst(Gates.XGate( 0 ))
...
qc_1.wrap_in_numshots_loop(1959)
...
defns = get_custom_get_definitions("RZGate", "ZGate", "C3SXGate", "CRXGate", "CHGate")

qc_2 += defns

qc_2.inst(Gates.RZGate(6.163759533339787, 3 ))
qc_2.inst(Gates.ZGate( 5 ))
qc_2.inst(Gates.CRXGate(2.0099472182748075, 2, 4 ))
qc_2.inst(Gates.C3SXGate( 5, 0, 1, 2 ))
qc_2.inst(Gates.CHGate( 3, 5 ))
qc_2.inst(Gates.C3SXGate( 0, 2, 1, 4 ))
...
qc_2.wrap_in_numshots_loop(1959)

...
defns = get_custom_get_definitions("CUGate", "ZGate", "RZGate", "RZZGate", "TGate", "SXdgGate", "SXGate", "ECRGate", "SdgGate", "C3SXGate", "CRXGate", "RYYGate", "CU1Gate", "UGate", "U2Gate", "XGate", "CSXGate", "CRZGate")
...
qr_4ed64d = circuit.declare("qr_4ed64d", "BIT", 8)

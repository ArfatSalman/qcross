...
qr_4ed64d = QuantumRegister(8, name='qr_4ed64d')
qc.add_register(qr_4ed64d)
# SECTION
# NAME: MEASUREMENT
...
backend_7594b158822b4635b474436467c15368 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_7594b158822b4635b474436467c15368, shots=2771).result().get_counts(qc)
RESULT = counts

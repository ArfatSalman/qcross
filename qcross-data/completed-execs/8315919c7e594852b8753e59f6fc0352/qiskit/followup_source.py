...
backend_992fccc2ffcb437999b82cbb8608f123 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_992fccc2ffcb437999b82cbb8608f123, shots=1385).result().get_counts(qc)
RESULT = counts

...
defns = get_custom_get_definitions("SXGate", "CCXGate", "CU3Gate", "RZGate", "UGate", "CRXGate", "CRZGate", "ZGate", "U1Gate", "TGate")
...
subcircuit.inst(Gates.U1Gate(6.171674001528992, 7 ))
subcircuit.inst(Gates.UGate(3.5173414605326783, 2.3568871696687452, 6.011900464835247)( 8 ))
subcircuit.inst(Gates.CU3Gate(5.1829934776392745, 2.7315239782495464, 3.9984051265341463, 2, 4 ))

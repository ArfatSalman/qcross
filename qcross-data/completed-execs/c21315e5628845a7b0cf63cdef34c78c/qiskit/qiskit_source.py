...
backend_1addfa2778dc4d58b930eec9989027ad = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_1addfa2778dc4d58b930eec9989027ad, shots=5542).result().get_counts(qc)
RESULT = counts
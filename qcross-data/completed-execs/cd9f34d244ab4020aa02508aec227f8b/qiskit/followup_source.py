...
qr_86f8e5 = QuantumRegister(7, name='qr_86f8e5')
qc.add_register(qr_86f8e5)
# SECTION
# NAME: MEASUREMENT
...
backend_2d456214136f40b3a8a53b6ae05737a8 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_2d456214136f40b3a8a53b6ae05737a8, shots=2771).result().get_counts(qc)
RESULT = counts

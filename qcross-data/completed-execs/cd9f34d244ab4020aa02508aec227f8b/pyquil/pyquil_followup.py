...
defns = get_custom_get_definitions("C3SXGate", "SXGate", "RZGate", "ZGate", "CUGate", "U2Gate", "RZZGate", "TGate", "CU1Gate", "SdgGate", "XGate", "CRZGate", "RYYGate", "CRXGate", "CSXGate")
...
qr_86f8e5 = circuit.declare("qr_86f8e5", "BIT", 7)

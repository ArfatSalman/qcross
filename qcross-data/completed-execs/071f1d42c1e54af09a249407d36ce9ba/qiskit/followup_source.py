...
qr_1d6ecb = QuantumRegister(2, name='qr_1d6ecb')
qc.add_register(qr_1d6ecb)
# SECTION
# NAME: MEASUREMENT
...
backend_592858e648c0453e886d42de452a20d7 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_592858e648c0453e886d42de452a20d7, shots=979).result().get_counts(qc)
RESULT = counts

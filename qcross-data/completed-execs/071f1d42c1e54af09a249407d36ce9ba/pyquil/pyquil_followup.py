...
defns = get_custom_get_definitions("CRZGate", "SXdgGate", "CRXGate", "RYYGate", "ZGate", "CUGate", "SGate", "RZGate", "TGate", "XGate", "CSXGate", "ECRGate", "CHGate")
...
qr_1d6ecb = circuit.declare("qr_1d6ecb", "BIT", 2)

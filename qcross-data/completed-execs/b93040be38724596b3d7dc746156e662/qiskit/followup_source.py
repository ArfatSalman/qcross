...
qc = transpile(qc, basis_gates=None, optimization_level=2, coupling_map=[[0,
    1], [0, 3], [0, 5], [1, 0], [1, 2], [2, 1], [2, 4], [3, 0], [4, 2], [5, 0]]
    )
# SECTION
# NAME: EXECUTION

from qiskit import Aer, transpile, execute
backend_50e3350fcacc4c458ac949be25edf18a = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_50e3350fcacc4c458ac949be25edf18a, shots=692).result().get_counts(qc)
RESULT = counts

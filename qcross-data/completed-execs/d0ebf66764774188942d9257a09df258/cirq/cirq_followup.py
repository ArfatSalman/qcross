...
circuit.append(Gates.CCXGate( qr[9], qr[10], qr[2] ))
circuit.append(Gates.ZGate( qr[5] ))
circuit.append(Gates.XGate( qr[2] ))
circuit.append(Gates.RCCXGate( qr[8], qr[1], qr[7] ))
circuit.append(Gates.RZGate(4.229610589867865)( qr[0] ))
circuit.append(Gates.CCXGate( qr[2], qr[8], qr[5] ))
circuit.append(Gates.SdgGate( qr[2] ))
circuit.append(Gates.U2Gate(4.214504315296764, 4.6235667602042065)( qr[8] ))

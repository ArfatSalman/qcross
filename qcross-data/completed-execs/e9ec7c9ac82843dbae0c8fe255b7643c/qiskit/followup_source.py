...
qr_e36135 = QuantumRegister(10, name='qr_e36135')
qc.add_register(qr_e36135)
# SECTION
# NAME: MEASUREMENT
...
backend_21b2e2a6a04b47e1a758fb2d9908091b = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_21b2e2a6a04b47e1a758fb2d9908091b, shots=2771).result().get_counts(qc)
RESULT = counts

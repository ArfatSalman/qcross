...
backend_f6ba873f41014660bcf2f66e0671e86f = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_f6ba873f41014660bcf2f66e0671e86f, shots=5542).result().get_counts(qc)
RESULT = counts

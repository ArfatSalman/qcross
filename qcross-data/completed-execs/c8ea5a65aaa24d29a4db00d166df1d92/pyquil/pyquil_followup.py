...
defns = get_custom_get_definitions("IGate", "CUGate", "RCCXGate", "CU1Gate", "CCXGate", "CYGate", "SXGate", "UGate", "CRXGate", "PhaseGate", "C3SXGate", "SGate", "CRZGate", "RZXGate", "RZZGate", "TGate", "RZGate", "ZGate")
...
subcircuit.inst(Gates.PhaseGate(0.4827903095199283, 5 ))
subcircuit.inst(Gates.RZXGate(1.1412693567569159)( 0, 3 ))

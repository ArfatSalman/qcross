...
subcircuit.append(PhaseGate(0.4827903095199283), qargs=[qr[5]], cargs=[])
subcircuit.append(RZXGate(1.1412693567569159), qargs=[qr[0], qr[3]], cargs=[])
...
qc = transpile(qc, basis_gates=None, optimization_level=2, coupling_map=[[0, 1], [1, 0], [1, 2], [1, 3], [1, 4], [1, 5], [2, 1], [3, 1], [3, 6], [4, 1], [5, 1], [6, 3], [6, 7], [7, 6]])
# SECTION
# NAME: EXECUTION

from qiskit import Aer, transpile, execute
backend_7bf0bee9c393475283ada084d94adbef = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_7bf0bee9c393475283ada084d94adbef, shots=1385).result().get_counts(qc)
RESULT = counts

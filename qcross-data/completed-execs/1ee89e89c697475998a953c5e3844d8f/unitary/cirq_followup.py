...
circuit.append(Gates.CRXGate(5.987304452123941)( qr[1], qr[2] ))
circuit.append(Gates.SGate( qr[2] ))
circuit.append(Gates.CCXGate( qr[0], qr[1], qr[2] ))
circuit.append(Gates.CHGate( qr[2], qr[1] ))
circuit.append(Gates.CHGate( qr[0], qr[2] ))
circuit.append(Gates.RYYGate(1.6723037552953224)( qr[0], qr[1] ))
circuit.append(Gates.ZGate( qr[2] ))
circuit.append(Gates.TGate( qr[1] ))
circuit.append(Gates.ZGate( qr[0] ))
circuit.append(Gates.SGate( qr[2] ))
circuit.append(Gates.ECRGate( qr[2], qr[1] ))
...
circuit.append(Gates.CRZGate(4.167661441102218)( qr[2], qr[0] ))
circuit.append(Gates.SGate( qr[2] ))

...
p_d090d2 = circuit.declare('p_d090d2', 'REAL')

defns = get_custom_get_definitions("CRZGate", "SXGate", "SXdgGate", "ZGate", "SdgGate", "CUGate", "RZGate", "XGate", "SGate", "PhaseGate", "CU1Gate", "CSXGate", "C3SXGate")
...
subcircuit = Program()
subcircuit.inst(Gates.PhaseGate(3.8139021644696793, 6 ))
...
circuit.inst(Gates.CU1Gate(p_d090d2, 8, 3 ))

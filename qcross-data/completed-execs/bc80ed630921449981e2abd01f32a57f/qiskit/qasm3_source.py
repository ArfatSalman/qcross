...
subcircuit.append(PhaseGate(3.8139021644696793), qargs=[qr[6]], cargs=[])
...
qc.append(CU1Gate(p_d090d2), qargs=[qr[8], qr[3]], cargs=[])
...
backend_ee2c1f22539d443cb9e376c7794e7372 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_ee2c1f22539d443cb9e376c7794e7372, shots=3919).result().get_counts(qc)
RESULT = counts

...
defns = get_custom_get_definitions("C3SXGate", "CHGate", "CU1Gate", "RZZGate", "CUGate", "iSwapGate", "XGate", "RZGate", "CSXGate")
...
circuit.inst(Gates.CUGate(0.5112149185250571, 5.897054719225356, 2.3864521352475245, 5.987304452123941, 3, 0 ))

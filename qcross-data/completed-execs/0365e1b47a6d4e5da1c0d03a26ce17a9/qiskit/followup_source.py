...
backend_ebd609e6abf44b47912d4c6116ad8edc = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_ebd609e6abf44b47912d4c6116ad8edc, shots=692).result().get_counts(qc)
RESULT = counts

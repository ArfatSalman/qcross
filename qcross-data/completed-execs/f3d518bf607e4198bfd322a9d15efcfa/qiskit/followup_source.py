...
qr_b1d578 = QuantumRegister(7, name='qr_b1d578')
qc.add_register(qr_b1d578)
# SECTION
# NAME: MEASUREMENT
...
backend_4148b46fcd3946a88fa4d89ae091963d = Aer.get_backend('aer_simulator_matrix_product_state')
counts = execute(qc, backend=backend_4148b46fcd3946a88fa4d89ae091963d, shots=489).result().get_counts(qc)
RESULT = counts

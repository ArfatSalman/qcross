...
defns = get_custom_get_definitions("SGate", "TGate", "RCCXGate", "CRXGate", "ZGate", "RYYGate", "ECRGate", "iSwapGate", "CHGate", "RZGate", "SdgGate", "CCXGate", "CSXGate", "SXdgGate", "CRZGate", "XGate")
...
qr_b1d578 = circuit.declare("qr_b1d578", "BIT", 7)

...
circuit.append(Gates.CRZGate(1.0296448789776642)( qr[2], qr[5] ))
circuit.append(Gates.C3SXGate( qr[0], qr[7], qr[5], qr[3] ))

subcircuit = cirq.Circuit()
subcircuit.append(Gates.CU3Gate(1.2827690425732097, 1.3283826543858017, 3.672121211148789)( qr[1], qr[6] ))
subcircuit.append(Gates.CZGate( qr[0], qr[2] ))

...
backend_58286f7cdea64f6a9e52f96fc3f8c579 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_58286f7cdea64f6a9e52f96fc3f8c579, shots=5542).result().get_counts(qc)
RESULT = counts

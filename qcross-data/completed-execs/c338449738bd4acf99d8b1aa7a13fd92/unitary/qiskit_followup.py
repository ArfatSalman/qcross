...
from qiskit import Aer, transpile, execute
backend_f9042e013d6546c5befb4575ab350121 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_f9042e013d6546c5befb4575ab350121, shots=1385).result().get_counts(qc)
RESULT = counts

...
p_1505f2 = circuit.declare('p_1505f2', 'REAL')
p_079085 = circuit.declare('p_079085', 'REAL')

defns = get_custom_get_definitions("CSXGate", "CHGate", "ZGate", "RZGate", "TGate", "ECRGate", "RZZGate", "SGate", "SdgGate", "C3SXGate", "CRXGate", "CU1Gate", "U2Gate", "XGate", "RCCXGate", "CRZGate")
...
circuit.inst(Gates.CRXGate(p_1505f2, 2, 5 ))
...
circuit.inst(Gates.U2Gate(p_079085, 2.1276323672732023)( 2 ))
...
params = {
    "p_1505f2": 2.0099472182748075,
    "p_079085": 2.5163050709890156
}

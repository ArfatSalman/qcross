...
p_1505f2 = Symbol('p_1505f2')
p_079085 = Symbol('p_079085')
...
circuit.append(Gates.CRXGate(p_1505f2)( qr[2], qr[5] ))
...
circuit.append(Gates.U2Gate(p_079085, 2.1276323672732023)( qr[2] ))

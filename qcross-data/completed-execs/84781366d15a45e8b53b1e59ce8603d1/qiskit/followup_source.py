...
backend_fabad15ef27046beaa67082cb96cfed0 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_fabad15ef27046beaa67082cb96cfed0, shots=5542).result().get_counts(qc)
RESULT = counts

...
p_66ceca = Symbol('p_66ceca')
p_39e93a = Symbol('p_39e93a')
p_3166e0 = Symbol('p_3166e0')
...
circuit.append(Gates.SXGate( qr[1] ))
circuit.append(Gates.RZGate(p_66ceca)( qr[1] ))
...
circuit.append(Gates.RZGate(p_39e93a)( qr[1] ))
circuit.append(Gates.CU1Gate(p_3166e0)( qr[0], qr[1] ))
circuit.append(Gates.XGate( qr[1] ))

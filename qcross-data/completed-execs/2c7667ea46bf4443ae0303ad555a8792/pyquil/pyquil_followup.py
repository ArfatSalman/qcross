...
defns = get_custom_get_definitions("XGate", "RZGate", "ZGate", "RCCXGate", "SGate", "CSXGate", "CHGate", "CRXGate", "C3SXGate", "ECRGate", "SdgGate", "CU1Gate", "CRZGate")
...
circuit.inst(Gates.CRXGate(2.0099472182748075, 4, 6 ))
circuit.inst(Gates.C3SXGate( 3, 1, 2, 4 ))
circuit.inst(Gates.CHGate( 0, 3 ))
circuit.inst(Gates.C3SXGate( 1, 4, 2, 6 ))
circuit.inst(Gates.ZGate( 4 ))
circuit.inst(Gates.ECRGate( 3, 5 ))
circuit.inst(Gates.SdgGate( 3 ))
circuit.inst(Gates.RCCXGate( 4, 6, 1 ))
circuit.inst(Gates.SGate( 2 ))
circuit.inst(Gates.RZGate(4.229610589867865, 2 ))
circuit.inst(Gates.C3SXGate( 1, 4, 2, 5 ))
...
circuit.inst(Gates.C3SXGate( 4, 1, 5, 0 ))
circuit.inst(Gates.CSXGate( 1, 4 ))
circuit.inst(Gates.ZGate( 6 ))
circuit.inst(Gates.CRZGate(4.833923139882297, 1, 3 ))
circuit.inst(Gates.CU1Gate(4.028174522740928, 2, 0 ))
circuit.inst(Gates.C3SXGate( 4, 1, 6, 0 ))

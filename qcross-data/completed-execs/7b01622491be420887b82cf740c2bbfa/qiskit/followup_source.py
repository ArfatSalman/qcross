...
qr_d634f6 = QuantumRegister(1, name='qr_d634f6')
qc.add_register(qr_d634f6)
# SECTION
# NAME: MEASUREMENT
...
backend_8146532ee7894dfe8b1053d768f87edc = Aer.get_backend('aer_simulator_density_matrix')
counts = execute(qc, backend=backend_8146532ee7894dfe8b1053d768f87edc, shots=1959).result().get_counts(qc)
RESULT = counts

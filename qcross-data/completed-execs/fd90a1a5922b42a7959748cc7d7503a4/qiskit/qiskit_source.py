...
backend_949d641fff5e4601a7db09f94becf873 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_949d641fff5e4601a7db09f94becf873, shots=1959).result().get_counts(qc)
RESULT = counts
...
qc = transpile(qc, basis_gates=None, optimization_level=2, coupling_map=[[0,
    1], [0, 5], [1, 0], [1, 4], [1, 11], [2, 7], [2, 9], [3, 9], [4, 1], [4,
    7], [4, 9], [5, 0], [5, 10], [5, 12], [6, 9], [7, 2], [7, 4], [8, 10],
    [9, 2], [9, 3], [9, 4], [9, 6], [10, 5], [10, 8], [11, 1], [12, 5]])
# SECTION
# NAME: EXECUTION

from qiskit import Aer, transpile, execute
backend_22a0748f99de4786b40a5b8520cbe687 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_22a0748f99de4786b40a5b8520cbe687, shots=3919).result().get_counts(qc)
RESULT = counts

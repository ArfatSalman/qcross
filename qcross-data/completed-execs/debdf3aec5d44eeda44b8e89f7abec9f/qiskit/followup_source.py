...
qr_9ec5c5 = QuantumRegister(3, name='qr_9ec5c5')
qc.add_register(qr_9ec5c5)
# SECTION
# NAME: MEASUREMENT
...
backend_8386ce2228f2407cace9a019f7f422f1 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_8386ce2228f2407cace9a019f7f422f1, shots=7838).result().get_counts(qc)
RESULT = counts

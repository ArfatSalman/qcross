...
defns = get_custom_get_definitions("XGate", "CRZGate", "CU1Gate", "ZGate", "U2Gate", "CSXGate", "CHGate", "RCCXGate", "CCXGate", "RZGate", "SdgGate")
...
qr_9ec5c5 = circuit.declare("qr_9ec5c5", "BIT", 3)

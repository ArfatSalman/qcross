...
defns = get_custom_get_definitions("CCXGate", "DCXGate", "RCCXGate", "XGate", "RZGate", "SdgGate", "TGate", "CPhaseGate", "U2Gate", "SXdgGate", "CHGate", "CSXGate", "ZGate", "CRZGate", "CU1Gate", "RZZGate")
...
subcircuit.inst(Gates.RZZGate(5.2545763615896)( 5, 0 ))
subcircuit.inst(Gates.DCXGate( 7, 8 ))
subcircuit.inst(Gates.CPhaseGate(1.672427069032094, 10, 3 ))

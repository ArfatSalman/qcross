...
p_6c4436 = circuit.declare('p_6c4436', 'REAL')
p_1bf06f = circuit.declare('p_1bf06f', 'REAL')

defns = get_custom_get_definitions("CCXGate", "XGate", "RZGate", "SdgGate", "CRXGate", "RYYGate", "TGate", "SXdgGate", "CHGate", "CSXGate", "SGate", "ZGate", "ECRGate", "iSwapGate")

circuit += defns

circuit.inst(Gates.RZGate(p_6c4436, 1 ))
...
circuit.inst(Gates.RYYGate(p_1bf06f)( 1, 0 ))

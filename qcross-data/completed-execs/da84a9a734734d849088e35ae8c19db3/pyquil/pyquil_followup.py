...
defns = get_custom_get_definitions("RCCXGate", "ZGate", "iSwapGate", "SXdgGate", "RZGate", "CSXGate", "XGate", "CHGate", "SGate", "SdgGate", "CCXGate", "RYYGate", "TGate", "ECRGate", "CRXGate")
...
qr_ce3c79 = circuit.declare("qr_ce3c79", "BIT", 7)

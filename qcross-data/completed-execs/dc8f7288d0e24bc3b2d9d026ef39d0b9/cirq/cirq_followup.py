...
p_07b76a = Symbol('p_07b76a')
p_33dcc3 = Symbol('p_33dcc3')
p_a535bd = Symbol('p_a535bd')
p_ec8253 = Symbol('p_ec8253')
p_fd45fe = Symbol('p_fd45fe')

circuit = cirq.Circuit()

circuit.append(Gates.RZGate(6.163759533339787)( qr[4] ))
circuit.append(Gates.ZGate( qr[3] ))
circuit.append(Gates.CRZGate(p_ec8253)( qr[2], qr[4] ))
circuit.append(Gates.CUGate(p_a535bd, 5.897054719225356, p_07b76a, p_33dcc3)( qr[2], qr[3] ))
...
circuit.append(Gates.RZGate(p_fd45fe)( qr[1] ))

...
defns = get_custom_get_definitions("CSXGate", "ZGate", "XGate", "IGate", "CPhaseGate", "CCXGate", "iSwapGate", "TGate", "U3Gate", "RCCXGate", "CXGate", "RYYGate", "SdgGate", "ECRGate", "UGate", "SGate", "SXdgGate", "RZGate", "CRXGate", "CHGate", "U1Gate")
...
subcircuit = Program()
subcircuit.inst(Gates.CXGate( 0, 2 ))
subcircuit.inst(Gates.CPhaseGate(4.167661441102218, 2, 1 ))
subcircuit.inst(Gates.IGate( 0 ))
subcircuit.inst(Gates.UGate(2.9790366726895714, 5.974354952564585, 3.2287759437031154)( 1 ))
subcircuit.inst(Gates.SdgGate( 1 ))
subcircuit.inst(Gates.RYYGate(0.2906326206587185)( 2, 0 ))
subcircuit.inst(Gates.U1Gate(1.4447770477048325, 0 ))
subcircuit.inst(Gates.SdgGate( 0 ))
subcircuit.inst(Gates.U3Gate(3.5173414605326783, 2.3568871696687452, 6.011900464835247)( 1 ))
...
qr_26c774 = circuit.declare("qr_26c774", "BIT", 7)

...
backend_edd3a8ecfd044599a7e47fa4f64d8ffc = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_edd3a8ecfd044599a7e47fa4f64d8ffc, shots=3919).result().get_counts(qc)
RESULT = counts

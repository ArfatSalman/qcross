...
backend_51d57460b3544842bc2aa94be0d037fb = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_51d57460b3544842bc2aa94be0d037fb, shots=1959).result().get_counts(qc)
RESULT = counts

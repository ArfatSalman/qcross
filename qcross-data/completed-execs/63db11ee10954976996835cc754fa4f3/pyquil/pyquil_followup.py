...
defns = get_custom_get_definitions("SXdgGate", "XGate", "RZGate", "CSXGate", "SGate", "CHGate", "CRXGate", "RYYGate", "SdgGate", "CCXGate", "iSwapGate")
...
qr_3d4676 = circuit.declare("qr_3d4676", "BIT", 7)

...
qr_3d4676 = QuantumRegister(7, name='qr_3d4676')
qc.add_register(qr_3d4676)
# SECTION
# NAME: MEASUREMENT
...
backend_8ab3d5aea8fd4615a7e425fa371f0124 = Aer.get_backend('aer_simulator_matrix_product_state')
counts = execute(qc, backend=backend_8ab3d5aea8fd4615a7e425fa371f0124, shots=489).result().get_counts(qc)
RESULT = counts

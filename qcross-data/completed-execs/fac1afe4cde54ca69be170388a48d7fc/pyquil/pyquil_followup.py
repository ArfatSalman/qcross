...
defns = get_custom_get_definitions("TGate", "CRZGate", "CPhaseGate", "CSXGate", "SXGate", "XGate", "CRXGate", "CU1Gate", "HGate", "SXdgGate", "ECRGate", "RZGate", "ZGate", "CHGate", "RXGate", "RYYGate", "RZZGate", "iSwapGate")
...
qr_768dbe = circuit.declare("qr_768dbe", "BIT", 1)

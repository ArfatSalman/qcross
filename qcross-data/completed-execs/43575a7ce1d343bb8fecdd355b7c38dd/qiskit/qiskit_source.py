...
backend_5ab4113a27b9494a9e36c7df0981bdbc = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_5ab4113a27b9494a9e36c7df0981bdbc, shots=7838).result().get_counts(qc)
RESULT = counts
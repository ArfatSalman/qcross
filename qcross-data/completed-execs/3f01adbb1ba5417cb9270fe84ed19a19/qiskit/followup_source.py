...
qr_5586be = QuantumRegister(1, name='qr_5586be')
qc.add_register(qr_5586be)
# SECTION
# NAME: MEASUREMENT
...
backend_c85b61d6ca474842a3e036e801a63abf = Aer.get_backend(
    'statevector_simulator')
counts = execute(qc, backend=backend_c85b61d6ca474842a3e036e801a63abf,

...
defns = get_custom_get_definitions("CU1Gate", "iSwapGate", "CRZGate", "RYYGate", "CSXGate", "RZZGate", "CHGate", "XGate", "RZGate", "SGate", "SXdgGate", "RCCXGate", "TGate", "CUGate", "C3SXGate")
...
qr_5586be = circuit.declare("qr_5586be", "BIT", 1)

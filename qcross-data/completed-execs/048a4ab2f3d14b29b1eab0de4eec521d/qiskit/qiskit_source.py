...
backend_f33a9a00737440a79619dfa4cbe18a0b = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_f33a9a00737440a79619dfa4cbe18a0b, shots=1385).result().get_counts(qc)
RESULT = counts
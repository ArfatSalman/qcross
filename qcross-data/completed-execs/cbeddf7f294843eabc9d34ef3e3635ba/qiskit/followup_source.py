...
qc = transpile(qc, basis_gates=None, optimization_level=1, coupling_map=[[0,
    1], [1, 0], [1, 2], [1, 3], [2, 1], [2, 4], [2, 6], [3, 1], [4, 2], [5,
    8], [6, 2], [6, 7], [7, 6], [7, 8], [8, 5], [8, 7]])
# SECTION
# NAME: EXECUTION

from qiskit import Aer, transpile, execute
backend_8783d2f0b6d0468dad40dcc1a73be458 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_8783d2f0b6d0468dad40dcc1a73be458, shots=1385).result().get_counts(qc)
RESULT = counts

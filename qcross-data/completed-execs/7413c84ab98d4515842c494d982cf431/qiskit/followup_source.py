...
backend_9d4e1b318e9b4f8b936654632ed15f0a = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_9d4e1b318e9b4f8b936654632ed15f0a, shots=1385).result().get_counts(qc)
RESULT = counts

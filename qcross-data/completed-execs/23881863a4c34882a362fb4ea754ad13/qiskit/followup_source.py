...
qr_01ad6e = QuantumRegister(2, name='qr_01ad6e')
qc.add_register(qr_01ad6e)
# SECTION
# NAME: MEASUREMENT
...
backend_586b5d5946c7472d838767d3af02dea7 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_586b5d5946c7472d838767d3af02dea7, shots=692).result().get_counts(qc)
RESULT = counts

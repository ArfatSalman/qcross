...
defns = get_custom_get_definitions("TGate", "iSwapGate", "SXdgGate", "CRZGate", "CHGate", "CUGate", "RCCXGate", "RZZGate", "RYYGate", "XGate", "C3SXGate", "CSXGate", "RZGate", "CU1Gate", "SGate")
...
qr_01ad6e = circuit.declare("qr_01ad6e", "BIT", 2)

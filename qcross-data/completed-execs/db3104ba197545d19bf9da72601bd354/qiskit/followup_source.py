...
qc.append(CRXGate(5.987304452123941), qargs=[qr[1], qr[3]], cargs=[])
...
backend_53d282b25db34dfc9657ce2cbb9cac29 = Aer.get_backend('aer_simulator_density_matrix')
counts = execute(qc, backend=backend_53d282b25db34dfc9657ce2cbb9cac29, shots=5542).result().get_counts(qc)
RESULT = counts

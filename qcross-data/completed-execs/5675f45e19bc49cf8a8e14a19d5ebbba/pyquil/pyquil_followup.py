...
defns = get_custom_get_definitions("CRZGate", "SXdgGate", "iSwapGate", "CZGate", "RZZGate", "CRXGate", "RYYGate", "CU1Gate", "TGate", "RZGate", "XGate", "CSXGate", "ECRGate", "SXGate", "CHGate")
...
qr_a954bd = circuit.declare("qr_a954bd", "BIT", 8)

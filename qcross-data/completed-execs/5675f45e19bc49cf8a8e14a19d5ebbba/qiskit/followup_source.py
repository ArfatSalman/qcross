...
qr_a954bd = QuantumRegister(8, name='qr_a954bd')
qc.add_register(qr_a954bd)
# SECTION
# NAME: MEASUREMENT
...
backend_bfeb7c88cf2a41c59843b25cc431acce = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_bfeb7c88cf2a41c59843b25cc431acce, shots=346).result().get_counts(qc)
RESULT = counts

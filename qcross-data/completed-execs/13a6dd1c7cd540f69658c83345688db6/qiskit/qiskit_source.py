...
backend_81325f9ab19146c99cce372e87970bbd = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_81325f9ab19146c99cce372e87970bbd, shots=346).result().get_counts(qc)
RESULT = counts
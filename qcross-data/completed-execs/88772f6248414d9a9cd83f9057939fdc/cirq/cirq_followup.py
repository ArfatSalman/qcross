...
circuit.append(Gates.CSXGate( qr[3], qr[6] ))
...
circuit.append(Gates.C3SXGate( qr[5], qr[0], qr[8], qr[1] ))
...
circuit.append(Gates.C3SXGate( qr[4], qr[7], qr[3], qr[5] ))
circuit.append(Gates.SXGate( qr[5] ))
circuit.append(Gates.CU1Gate(3.2142159669963557)( qr[0], qr[7] ))
circuit.append(Gates.CRZGate(1.4112277317699358)( qr[1], qr[0] ))
circuit.append(Gates.ZGate( qr[3] ))
...
circuit.append(Gates.CRZGate(2.586208953975239)( qr[4], qr[3] ))
circuit.append(Gates.U2Gate(2.5163050709890156, 2.1276323672732023)( qr[3] ))
circuit.append(Gates.TGate( qr[0] ))
circuit.append(Gates.CCXGate( qr[5], qr[2], qr[4] ))
circuit.append(Gates.RCCXGate( qr[6], qr[5], qr[4] ))
circuit.append(Gates.TGate( qr[5] ))
circuit.append(Gates.RZGate(5.014941143947427)( qr[4] ))

...
defns = get_custom_get_definitions("CCXGate", "RCCXGate", "SdgGate", "RZGate", "XGate", "CUGate", "TGate", "U2Gate", "CHGate", "CSXGate", "ZGate", "C3SXGate", "SGate", "CRZGate", "CU1Gate", "SXGate")
...
circuit.inst(Gates.C3SXGate( 5, 0, 8, 1 ))
circuit.inst(Gates.ZGate( 3 ))
circuit.inst(Gates.XGate( 1 ))
circuit.inst(Gates.SGate( 5 ))
circuit.inst(Gates.SGate( 0 ))
circuit.inst(Gates.C3SXGate( 4, 7, 3, 5 ))
circuit.inst(Gates.SXGate( 5 ))
circuit.inst(Gates.CU1Gate(3.2142159669963557, 0, 7 ))
circuit.inst(Gates.CRZGate(1.4112277317699358, 1, 0 ))
circuit.inst(Gates.ZGate( 3 ))
...
circuit.inst(Gates.CCXGate( 5, 2, 4 ))
circuit.inst(Gates.RCCXGate( 6, 5, 4 ))
circuit.inst(Gates.TGate( 5 ))
circuit.inst(Gates.RZGate(5.014941143947427, 4 ))

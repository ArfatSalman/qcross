...
backend_ed88c349e83948ea87a5200797d5a2b0 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_ed88c349e83948ea87a5200797d5a2b0, shots=3919).result().get_counts(qc)
RESULT = counts

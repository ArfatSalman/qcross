...
backend_dd470f116b2c4144aa0065aada8e066d = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_dd470f116b2c4144aa0065aada8e066d, shots=3919).result().get_counts(qc)
RESULT = counts
...
circuit.append(Gates.CUGate(0.5112149185250571, 5.897054719225356, 2.3864521352475245, 5.987304452123941)( qr[6], qr[0] ))
circuit.append(Gates.SdgGate( qr[2] ))
circuit.append(Gates.C3SXGate( qr[6], qr[3], qr[5], qr[8] ))
...
circuit.append(Gates.C3SXGate( qr[2], qr[7], qr[4], qr[6] ))
circuit.append(Gates.SXGate( qr[6] ))
circuit.append(Gates.CU1Gate(3.2142159669963557)( qr[3], qr[7] ))
circuit.append(Gates.CRZGate(1.4112277317699358)( qr[8], qr[3] ))
circuit.append(Gates.ZGate( qr[4] ))
circuit.append(Gates.CSXGate( qr[6], qr[4] ))
circuit.append(Gates.ZGate( qr[5] ))
circuit.append(Gates.CHGate( qr[0], qr[2] ))
circuit.append(Gates.CSXGate( qr[7], qr[6] ))
circuit.append(Gates.CRZGate(2.586208953975239)( qr[2], qr[4] ))
circuit.append(Gates.U2Gate(2.5163050709890156, 2.1276323672732023)( qr[4] ))
circuit.append(Gates.TGate( qr[3] ))
circuit.append(Gates.CCXGate( qr[6], qr[0], qr[2] ))
circuit.append(Gates.RCCXGate( qr[1], qr[6], qr[2] ))
circuit.append(Gates.TGate( qr[6] ))
circuit.append(Gates.RZGate(5.014941143947427)( qr[2] ))
circuit.append(Gates.CRXGate(5.970852306777193)( qr[2], qr[3] ))

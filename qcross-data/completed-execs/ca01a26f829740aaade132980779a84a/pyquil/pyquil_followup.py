...
p_e0e1ec = circuit.declare('p_e0e1ec', 'REAL')
p_d7df24 = circuit.declare('p_d7df24', 'REAL')

defns = get_custom_get_definitions("XGate", "RZGate", "ZGate", "CHGate", "CRXGate", "C3SXGate")

circuit += defns

circuit.inst(Gates.RZGate(p_d7df24, 4 ))
circuit.inst(Gates.ZGate( 6 ))
circuit.inst(Gates.XGate( 3 ))
circuit.inst(Gates.CRXGate(p_e0e1ec, 2, 5 ))

...
circuit.append(Gates.CRXGate(2.0099472182748075)( qr[0], qr[4] ))
circuit.append(Gates.C3SXGate( qr[5], qr[2], qr[6], qr[0] ))
circuit.append(Gates.CHGate( qr[1], qr[5] ))
circuit.append(Gates.C3SXGate( qr[2], qr[0], qr[6], qr[4] ))

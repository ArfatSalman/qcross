...
qc.append(CU1Gate(5.154187354656876), qargs=[qr[0], qr[3]], cargs=[])
...
backend_9c0024b74f204273a0a3679d5d7f1e5b = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_9c0024b74f204273a0a3679d5d7f1e5b, shots=692).result().get_counts(qc)
RESULT = counts

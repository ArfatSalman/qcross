...
backend_fcfe44ceb20143709c335b2fb8760a14 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_fcfe44ceb20143709c335b2fb8760a14, shots=489).result().get_counts(qc)
RESULT = counts

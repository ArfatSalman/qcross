...
qc.append(RYYGate(1.6723037552953224), qargs=[qr[4], qr[3]], cargs=[])
...
qc.append(RYYGate(5.398622178940033), qargs=[qr[4], qr[3]], cargs=[])
...
backend_a0870aff13674ff99a78c7e385e4cba6 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_a0870aff13674ff99a78c7e385e4cba6, shots=979).result().get_counts(qc)
RESULT = counts

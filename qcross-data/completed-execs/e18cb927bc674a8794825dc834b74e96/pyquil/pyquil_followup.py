...
defns = get_custom_get_definitions("CHGate", "ECRGate", "SGate", "RYYGate", "CSXGate", "TGate", "CRXGate", "CUGate", "CU1Gate", "UGate", "ZGate", "XGate", "SXdgGate", "CRZGate", "RZGate")
...
circuit.inst(Gates.RYYGate(1.6723037552953224)( 4, 3 ))
...
circuit.inst(Gates.RYYGate(5.398622178940033)( 4, 3 ))

...
p_3aa544 = circuit.declare('p_3aa544', 'REAL')

defns = get_custom_get_definitions("SGate", "ZGate", "RZGate", "RYYGate", "CRXGate", "CHGate", "SdgGate", "CCXGate", "XGate", "CSXGate", "iSwapGate", "SXdgGate")

circuit += defns

circuit.inst(Gates.RZGate(p_3aa544, 0 ))

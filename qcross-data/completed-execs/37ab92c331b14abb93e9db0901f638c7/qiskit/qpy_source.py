...
backend_daf22eac97374058bbc47b408caf7c75 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_daf22eac97374058bbc47b408caf7c75, shots=489).result().get_counts(qc)
RESULT = counts

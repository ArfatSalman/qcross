...
backend_33c8b20acdff448ab8bf695ac2d3d9ee = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_33c8b20acdff448ab8bf695ac2d3d9ee, shots=346).result().get_counts(qc)
RESULT = counts

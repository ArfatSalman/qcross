...
qr_df4caf = QuantumRegister(5, name='qr_df4caf')
qc.add_register(qr_df4caf)
# SECTION
# NAME: MEASUREMENT
...
backend_80f5d5cd0f0d4fedb53db37ff796340c = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_80f5d5cd0f0d4fedb53db37ff796340c, shots=5542).result().get_counts(qc)
RESULT = counts

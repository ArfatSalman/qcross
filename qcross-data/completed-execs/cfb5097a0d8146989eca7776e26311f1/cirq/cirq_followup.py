...
circuit.append(Gates.CRZGate(4.2641612072511235)( qr[7], qr[9] ))
circuit.append(Gates.CRXGate(5.987304452123941)( qr[6], qr[2] ))
circuit.append(Gates.CCXGate( qr[8], qr[0], qr[2] ))
circuit.append(Gates.ZGate( qr[5] ))
circuit.append(Gates.TGate( qr[0] ))
circuit.append(Gates.XGate( qr[4] ))
circuit.append(Gates.CRZGate(4.167661441102218)( qr[6], qr[7] ))
circuit.append(Gates.RZGate(4.229610589867865)( qr[6] ))
circuit.append(Gates.SXGate( qr[5] ))
circuit.append(Gates.CSXGate( qr[3], qr[4] ))
circuit.append(Gates.CCXGate( qr[3], qr[0], qr[8] ))
circuit.append(Gates.C3SXGate( qr[5], qr[3], qr[1], qr[0] ))
circuit.append(Gates.CSXGate( qr[1], qr[5] ))
circuit.append(Gates.ZGate( qr[1] ))
circuit.append(Gates.CHGate( qr[2], qr[6] ))
circuit.append(Gates.CSXGate( qr[5], qr[1] ))
circuit.append(Gates.CRZGate(2.586208953975239)( qr[6], qr[5] ))

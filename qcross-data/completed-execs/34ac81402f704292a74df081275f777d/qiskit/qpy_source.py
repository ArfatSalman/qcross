...
backend_ff14ce1120d24928b5cc95cfc90527c9 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_ff14ce1120d24928b5cc95cfc90527c9, shots=3919).result().get_counts(qc)
RESULT = counts

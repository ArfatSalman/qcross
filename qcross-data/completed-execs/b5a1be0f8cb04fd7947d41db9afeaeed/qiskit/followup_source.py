...
backend_d983531313364e4789fe3adb748308d2 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_d983531313364e4789fe3adb748308d2, shots=979).result().get_counts(qc)
RESULT = counts

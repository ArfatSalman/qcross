...
defns = get_custom_get_definitions("SGate", "CSXGate", "SXdgGate", "RYYGate", "CUGate", "RZGate", "CU1Gate", "CRXGate", "ZGate", "CHGate", "XGate", "TGate", "CRZGate", "ECRGate", "UGate")
...
circuit.inst(Gates.CUGate(5.708725119517347, 4.167661441102218, 4.623446645668956, 3.865496458458116, 3, 2 ))

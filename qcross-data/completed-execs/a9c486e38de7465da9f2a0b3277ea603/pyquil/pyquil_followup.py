...
defns = get_custom_get_definitions("CCXGate", "DCXGate", "RCCXGate", "XGate", "RZGate", "CRXGate", "TGate", "U1Gate", "RXXGate", "CSXGate", "ZGate", "C3SXGate", "CRZGate", "ECRGate", "SXGate")
...
subcircuit = Program()
subcircuit.inst(Gates.U1Gate(0.9849192481800918, 3 ))
...
qr_585683 = circuit.declare("qr_585683", "BIT", 8)

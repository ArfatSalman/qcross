...
p_64ae37 = Symbol('p_64ae37')
p_e820f6 = Symbol('p_e820f6')
p_a4b6c0 = Symbol('p_a4b6c0')

circuit = cirq.Circuit()

circuit.append(Gates.RZZGate(p_64ae37)( qr[1], qr[0] ))
...
circuit.append(Gates.XGate( qr[1] ))
circuit.append(Gates.RYYGate(p_a4b6c0)( qr[0], qr[1] ))
circuit.append(Gates.TGate( qr[1] ))
circuit.append(Gates.SXGate( qr[1] ))
circuit.append(Gates.CRXGate(p_e820f6)( qr[0], qr[1] ))

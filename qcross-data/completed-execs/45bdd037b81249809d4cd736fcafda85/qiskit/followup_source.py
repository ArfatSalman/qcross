...
# SECTION
# NAME: PARAMETERS
p_64ae37 = Parameter('p_64ae37')
p_e820f6 = Parameter('p_e820f6')
p_a4b6c0 = Parameter('p_a4b6c0')
...
qc.append(RZZGate(p_64ae37), qargs=[qr[1], qr[0]], cargs=[])
...
qc.append(XGate(), qargs=[qr[1]], cargs=[])
qc.append(RYYGate(p_a4b6c0), qargs=[qr[0], qr[1]], cargs=[])
qc.append(TGate(), qargs=[qr[1]], cargs=[])
qc.append(SXGate(), qargs=[qr[1]], cargs=[])
qc.append(CRXGate(p_e820f6), qargs=[qr[0], qr[1]], cargs=[])
...
backend_6979bcf133324003840fe77b9933f8d7 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_6979bcf133324003840fe77b9933f8d7, shots=346).result().get_counts(qc)
RESULT = counts

...
p_478f57 = circuit.declare('p_478f57', 'REAL')
p_be710f = circuit.declare('p_be710f', 'REAL')
p_fb13a2 = circuit.declare('p_fb13a2', 'REAL')

defns = get_custom_get_definitions("CCXGate", "UGate", "XGate", "RZGate", "CRXGate", "TGate", "U2Gate", "SXdgGate", "CHGate", "CSXGate", "ZGate", "C3SXGate", "CRZGate", "ECRGate", "SXGate")

circuit += defns

circuit.inst(Gates.RZGate(6.163759533339787, 3 ))
circuit.inst(Gates.CRZGate(p_fb13a2, 6, 3 ))
...
circuit.inst(Gates.U2Gate(p_be710f, 2.1276323672732023)( 2 ))
...
circuit.inst(Gates.UGate(5.080799300534071, p_478f57, 2.271164628944128)( 2 ))

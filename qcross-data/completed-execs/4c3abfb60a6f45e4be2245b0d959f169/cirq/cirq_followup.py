...
p_478f57 = Symbol('p_478f57')
p_be710f = Symbol('p_be710f')
p_fb13a2 = Symbol('p_fb13a2')

circuit = cirq.Circuit()

circuit.append(Gates.RZGate(6.163759533339787)( qr[3] ))
circuit.append(Gates.CRZGate(p_fb13a2)( qr[6], qr[3] ))
...
circuit.append(Gates.U2Gate(p_be710f, 2.1276323672732023)( qr[2] ))
...
circuit.append(Gates.UGate(5.080799300534071, p_478f57, 2.271164628944128)( qr[2] ))

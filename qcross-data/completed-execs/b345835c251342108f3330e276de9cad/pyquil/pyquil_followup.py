...
defns = get_custom_get_definitions("RZGate", "CRXGate", "CSXGate", "SdgGate", "RYYGate", "CHGate", "SXdgGate", "CCXGate", "TGate", "SGate", "iSwapGate", "XGate", "ZGate")
...
qr_5c94dd = circuit.declare("qr_5c94dd", "BIT", 10)

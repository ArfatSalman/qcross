...
defns = get_custom_get_definitions("CU1Gate", "CRZGate", "RYYGate", "CSXGate", "RZZGate", "ZGate", "SXGate", "XGate", "RZGate", "CRXGate", "C3SXGate")
...
qr_a60cf6 = circuit.declare("qr_a60cf6", "BIT", 4)

...
qr_a60cf6 = QuantumRegister(4, name='qr_a60cf6')
qc.add_register(qr_a60cf6)
# SECTION
# NAME: MEASUREMENT
...
backend_bfded2b99bd74291950307b8a99e2c7b = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_bfded2b99bd74291950307b8a99e2c7b, shots=2771).result().get_counts(qc)
RESULT = counts

...
p_9722a3 = Symbol('p_9722a3')
p_3fb19a = Symbol('p_3fb19a')
p_7c8cdc = Symbol('p_7c8cdc')
p_3481ec = Symbol('p_3481ec')

circuit = cirq.Circuit()

circuit.append(Gates.RZGate(p_3481ec)( qr[4] ))
circuit.append(Gates.ZGate( qr[6] ))
circuit.append(Gates.XGate( qr[3] ))
circuit.append(Gates.CRXGate(p_9722a3)( qr[2], qr[5] ))
...
circuit.append(Gates.RZGate(p_7c8cdc)( qr[1] ))
circuit.append(Gates.C3SXGate( qr[0], qr[2], qr[1], qr[3] ))
circuit.append(Gates.CU1Gate(p_3fb19a)( qr[4], qr[0] ))

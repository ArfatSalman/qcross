...
p_9722a3 = circuit.declare('p_9722a3', 'REAL')
p_3fb19a = circuit.declare('p_3fb19a', 'REAL')
p_7c8cdc = circuit.declare('p_7c8cdc', 'REAL')
p_3481ec = circuit.declare('p_3481ec', 'REAL')

defns = get_custom_get_definitions("CHGate", "CU1Gate", "ECRGate", "ZGate", "RCCXGate", "SdgGate", "XGate", "SGate", "RZGate", "CRXGate", "C3SXGate")

circuit += defns

circuit.inst(Gates.RZGate(p_3481ec, 4 ))
circuit.inst(Gates.ZGate( 6 ))
circuit.inst(Gates.XGate( 3 ))
circuit.inst(Gates.CRXGate(p_9722a3, 2, 5 ))
...
circuit.inst(Gates.RZGate(p_7c8cdc, 1 ))
circuit.inst(Gates.C3SXGate( 0, 2, 1, 3 ))
circuit.inst(Gates.CU1Gate(p_3fb19a, 4, 0 ))

...
qc.append(CRXGate(p_2a440e), qargs=[qr[0], qr[1]], cargs=[])
...
qc = qc.bind_parameters({p_2a440e: 5.987304452123941})
# SECTION
...
backend_43cb868e7276462b9534b3135c9d8e2e = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_43cb868e7276462b9534b3135c9d8e2e, shots=346).result().get_counts(qc)
RESULT = counts

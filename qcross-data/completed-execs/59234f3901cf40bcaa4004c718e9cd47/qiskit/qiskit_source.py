...
backend_4a12c40d8d784d7b831ce5642e060063 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_4a12c40d8d784d7b831ce5642e060063, shots=489).result().get_counts(qc)
RESULT = counts
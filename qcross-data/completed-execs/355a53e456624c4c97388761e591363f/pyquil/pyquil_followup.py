...
circuit.inst(Gates.CRXGate(5.987304452123941, 6, 7 ))
circuit.inst(Gates.CRZGate(1.0296448789776642, 3, 7 ))
circuit.inst(Gates.C3SXGate( 6, 1, 7, 4 ))
circuit.inst(Gates.ZGate( 5 ))
circuit.inst(Gates.XGate( 3 ))
circuit.inst(Gates.RYYGate(1.740253089260498)( 7, 1 ))

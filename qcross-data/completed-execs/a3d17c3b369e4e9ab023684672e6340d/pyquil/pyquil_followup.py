...
defns = get_custom_get_definitions("CSXGate", "CCXGate", "CRXGate", "CRZGate", "TGate", "C3SXGate", "RZGate", "ZGate", "CHGate", "XGate", "SXGate")
...
qr_b22c4b = circuit.declare("qr_b22c4b", "BIT", 8)

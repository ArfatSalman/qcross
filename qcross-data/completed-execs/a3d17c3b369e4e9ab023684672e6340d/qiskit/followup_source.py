...
qr_b22c4b = QuantumRegister(8, name='qr_b22c4b')
qc.add_register(qr_b22c4b)
# SECTION
# NAME: MEASUREMENT
...
backend_0f7c972d627f4b86975058aeea706366 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_0f7c972d627f4b86975058aeea706366, shots=5542).result().get_counts(qc)
RESULT = counts

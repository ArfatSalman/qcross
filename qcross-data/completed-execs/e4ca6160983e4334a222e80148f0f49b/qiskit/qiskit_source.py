...
backend_0ee7c86c64a04637bd46d1484445d514 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_0ee7c86c64a04637bd46d1484445d514, shots=3919).result().get_counts(qc)
RESULT = counts
...
backend_7589256a075c48be865c2db85e045534 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_7589256a075c48be865c2db85e045534, shots=1959).result().get_counts(qc)
RESULT = counts

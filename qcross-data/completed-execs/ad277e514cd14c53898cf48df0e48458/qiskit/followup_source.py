...
qc = transpile(qc, basis_gates=None, optimization_level=2, coupling_map=[[0,
    1], [0, 7], [1, 0], [1, 5], [1, 8], [1, 9], [2, 7], [3, 7], [4, 7], [5,
    1], [5, 6], [6, 5], [7, 0], [7, 2], [7, 3], [7, 4], [8, 1], [9, 1]])
# SECTION
# NAME: EXECUTION

from qiskit import Aer, transpile, execute
backend_fd912a40115441fb94e58b84687a57dd = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_fd912a40115441fb94e58b84687a57dd, shots=2771).result().get_counts(qc)
RESULT = counts

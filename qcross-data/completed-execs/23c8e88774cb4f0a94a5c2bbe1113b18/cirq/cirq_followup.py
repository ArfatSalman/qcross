...
p_81afec = Symbol('p_81afec')
p_fba062 = Symbol('p_fba062')
p_592b92 = Symbol('p_592b92')
p_4dd0b9 = Symbol('p_4dd0b9')

circuit = cirq.Circuit()

circuit.append(Gates.RZGate(p_fba062)( qr[1] ))
...
circuit.append(Gates.CRXGate(p_592b92)( qr[0], qr[2] ))
circuit.append(Gates.SGate( qr[2] ))
circuit.append(Gates.CCXGate( qr[1], qr[0], qr[2] ))
circuit.append(Gates.CHGate( qr[2], qr[0] ))
circuit.append(Gates.CHGate( qr[1], qr[2] ))
circuit.append(Gates.RYYGate(p_81afec)( qr[1], qr[0] ))
...
circuit.append(Gates.CRZGate(p_4dd0b9)( qr[2], qr[1] ))

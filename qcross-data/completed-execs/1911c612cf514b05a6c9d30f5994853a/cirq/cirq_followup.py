...
circuit.append(Gates.CRZGate(4.2641612072511235)( qr[2], qr[8] ))
circuit.append(Gates.CRXGate(5.987304452123941)( qr[5], qr[3] ))
circuit.append(Gates.CCXGate( qr[1], qr[6], qr[3] ))
...
circuit.append(Gates.CCXGate( qr[4], qr[6], qr[1] ))
circuit.append(Gates.C3SXGate( qr[9], qr[4], qr[0], qr[6] ))
circuit.append(Gates.CSXGate( qr[0], qr[9] ))
circuit.append(Gates.ZGate( qr[0] ))
circuit.append(Gates.CHGate( qr[3], qr[5] ))
circuit.append(Gates.CSXGate( qr[9], qr[0] ))
circuit.append(Gates.CRZGate(2.586208953975239)( qr[5], qr[9] ))
circuit.append(Gates.U2Gate(2.5163050709890156, 2.1276323672732023)( qr[9] ))
...
circuit.append(Gates.CRXGate(5.970852306777193)( qr[3], qr[5] ))
circuit.append(Gates.UGate(5.080799300534071, 5.023617931957853, 2.271164628944128)( qr[9] ))
circuit.append(Gates.ECRGate( qr[4], qr[7] ))

...
backend_3adf1b7200b249d681a366ec95c9d372 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_3adf1b7200b249d681a366ec95c9d372, shots=346).result().get_counts(qc)
RESULT = counts

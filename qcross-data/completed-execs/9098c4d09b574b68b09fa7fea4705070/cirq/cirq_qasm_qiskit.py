...
p_eed10c = Symbol('p_eed10c')
p_55f179 = Symbol('p_55f179')
p_3b8fbf = Symbol('p_3b8fbf')
p_0989aa = Symbol('p_0989aa')
p_d3bd13 = Symbol('p_d3bd13')
p_c0fb12 = Symbol('p_c0fb12')

circuit = cirq.Circuit()

circuit.append(Gates.RZGate(p_3b8fbf)( qr[4] ))
circuit.append(Gates.ZGate( qr[3] ))
circuit.append(Gates.CRZGate(p_0989aa)( qr[2], qr[4] ))
circuit.append(Gates.CUGate(p_eed10c, p_c0fb12, p_d3bd13, p_55f179)( qr[2], qr[3] ))

...
backend_3caa5f72697b49e397937ca603153d68 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_3caa5f72697b49e397937ca603153d68, shots=346).result().get_counts(qc)
RESULT = counts

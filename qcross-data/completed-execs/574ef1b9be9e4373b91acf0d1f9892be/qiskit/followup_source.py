...
# SECTION
# NAME: PARAMETERS
p_845551 = Parameter('p_845551')
p_1ada4b = Parameter('p_1ada4b')
p_2b124e = Parameter('p_2b124e')
p_f7bbfa = Parameter('p_f7bbfa')
p_f1397b = Parameter('p_f1397b')
p_b60795 = Parameter('p_b60795')
p_505de8 = Parameter('p_505de8')
...
qc.append(RZGate(p_b60795), qargs=[qr[4]], cargs=[])
qc.append(ZGate(), qargs=[qr[3]], cargs=[])
qc.append(CRZGate(4.2641612072511235), qargs=[qr[2], qr[4]], cargs=[])
qc.append(CUGate(p_2b124e, 5.897054719225356, p_f7bbfa, 5.987304452123941),
...
qc.append(CU1Gate(p_f1397b), qargs=[qr[3], qr[0]], cargs=[])
qc.append(UGate(p_505de8, 0.07157463504881167, 1.4112277317699358), qargs=[
    qr[5]], cargs=[])
qc.append(RZZGate(p_1ada4b), qargs=[qr[0], qr[5]], cargs=[])
...
qc.append(CU1Gate(p_845551), qargs=[qr[1], qr[4]], cargs=[])
...
backend_43e30240a5f349dd83e856345fac8a25 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_43e30240a5f349dd83e856345fac8a25, shots=1385).result().get_counts(qc)
RESULT = counts

...
subcircuit.append(CRYGate(6.016631690603051), qargs=[qr[1], qr[2]], cargs=[])
subcircuit.append(SXGate(), qargs=[qr[7]], cargs=[])
subcircuit.append(RZGate(5.116009661150895), qargs=[qr[5]], cargs=[])
...
subcircuit.append(CXGate(), qargs=[qr[3], qr[8]], cargs=[])
subcircuit.append(CHGate(), qargs=[qr[1], qr[4]], cargs=[])
subcircuit.append(DCXGate(), qargs=[qr[4], qr[5]], cargs=[])
...
qr_7f32f3 = QuantumRegister(10, name='qr_7f32f3')
qc.add_register(qr_7f32f3)
# SECTION
# NAME: MEASUREMENT
...
backend_15797438757d461d8e8ec3337bfd73ce = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_15797438757d461d8e8ec3337bfd73ce, shots=3919).result().get_counts(qc)
RESULT = counts

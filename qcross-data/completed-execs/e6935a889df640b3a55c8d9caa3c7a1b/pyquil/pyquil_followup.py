...
defns = get_custom_get_definitions("CRZGate", "CU1Gate", "CXGate", "TGate", "XGate", "CSXGate", "U2Gate", "C3SXGate", "DCXGate", "SGate", "RCCXGate", "CRYGate", "CUGate", "RZGate", "ZGate", "CCXGate", "SdgGate", "SXGate", "CHGate")
...
subcircuit = Program()
subcircuit.inst(Gates.CRYGate(6.016631690603051, 1, 2 ))
...
qr_7f32f3 = circuit.declare("qr_7f32f3", "BIT", 10)

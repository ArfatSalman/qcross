...
subcircuit.append(Gates.CRYGate(6.016631690603051)( qr[1], qr[2] ))
subcircuit.append(Gates.SXGate( qr[7] ))
subcircuit.append(Gates.RZGate(5.116009661150895)( qr[5] ))
subcircuit.append(Gates.RCCXGate( qr[2], qr[5], qr[0] ))
subcircuit.append(Gates.CUGate(2.862865991712737, 6.0504088665633065, 1.7203758404994713, 2.8704483107274004)( qr[3], qr[1] ))
subcircuit.append(Gates.CXGate( qr[3], qr[8] ))
subcircuit.append(Gates.CHGate( qr[1], qr[4] ))
subcircuit.append(Gates.DCXGate( qr[4], qr[5] ))
subcircuit.append(Gates.RZGate(3.2374432046466546)( qr[4] ))

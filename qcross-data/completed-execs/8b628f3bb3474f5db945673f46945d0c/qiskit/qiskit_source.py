...
backend_2d7fd92d761a4646a38fe3b09bf23aa7 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_2d7fd92d761a4646a38fe3b09bf23aa7, shots=346).result().get_counts(qc)
RESULT = counts
...
backend_e81dc0aa6c0a457aba22d01d0e8d9779 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_e81dc0aa6c0a457aba22d01d0e8d9779, shots=3919).result().get_counts(qc)
RESULT = counts

...
backend_a26cf9468b0440359738b3fc85077db2 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_a26cf9468b0440359738b3fc85077db2, shots=346).result().get_counts(qc)
RESULT = counts
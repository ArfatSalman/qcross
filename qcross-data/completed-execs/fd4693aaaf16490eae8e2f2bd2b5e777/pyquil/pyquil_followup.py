...
defns = get_custom_get_definitions("XGate", "RYYGate", "CRZGate", "RZZGate", "CRXGate", "iSwapGate", "SXGate", "CYGate", "ECRGate", "CHGate", "RXGate", "TGate", "IGate", "CSXGate", "RZGate", "SXdgGate", "RXXGate")
...
subcircuit = Program()
subcircuit.inst(Gates.RZGate(5.870272810031044, 1 ))
subcircuit.inst(Gates.RXGate(1.350257477660173, 1 ))
subcircuit.inst(Gates.RXXGate(1.8331092502981063)( 1, 0 ))

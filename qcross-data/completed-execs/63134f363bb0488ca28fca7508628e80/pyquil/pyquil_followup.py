...
defns = get_custom_get_definitions("CHGate", "CU1Gate", "RZZGate", "SXGate", "ECRGate", "SXdgGate", "TGate", "RZGate", "iSwapGate", "XGate", "CRZGate", "CRXGate", "RYYGate", "CSXGate")
...
qr_ad7583 = circuit.declare("qr_ad7583", "BIT", 3)

...
qr_ad7583 = QuantumRegister(3, name='qr_ad7583')
qc.add_register(qr_ad7583)
# SECTION
# NAME: MEASUREMENT
...
backend_c1aec010918e46e0a20977cf4e7a716b = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_c1aec010918e46e0a20977cf4e7a716b, shots=346).result().get_counts(qc)
RESULT = counts

...
p_c023d7 = Symbol('p_c023d7')
p_a6faff = Symbol('p_a6faff')
p_52a14b = Symbol('p_52a14b')
p_a30acb = Symbol('p_a30acb')

circuit = cirq.Circuit()

circuit.append(Gates.RZGate(p_a30acb)( qr[3] ))
circuit.append(Gates.SXdgGate( qr[2] ))
circuit.append(Gates.CSXGate( qr[1], qr[0] ))
circuit.append(Gates.ECRGate( qr[3], qr[2] ))
circuit.append(Gates.CRXGate(p_a6faff)( qr[4], qr[3] ))
...
circuit.append(Gates.CUGate(5.708725119517347, p_52a14b, 4.623446645668956, 3.865496458458116)( qr[1], qr[4] ))
...
circuit.append(Gates.UGate(5.887184334931191, p_c023d7, 1.4112277317699358)( qr[4] ))

...
backend_6800645e0c294042ac2490080bf24854 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_6800645e0c294042ac2490080bf24854, shots=979).result().get_counts(qc)
RESULT = counts
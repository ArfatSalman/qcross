...
p_dc6cae = Parameter('p_dc6cae')
p_a82420 = Parameter('p_a82420')
p_0e227b = Parameter('p_0e227b')
# SECTION
# NAME: CIRCUIT
...
qc.append(RZGate(p_dc6cae), qargs=[qr[1]], cargs=[])
...
qc.append(CRZGate(p_a82420), qargs=[qr[2], qr[1]], cargs=[])
qc.append(SGate(), qargs=[qr[2]], cargs=[])
qc.append(CRZGate(p_0e227b), qargs=[qr[2], qr[1]], cargs=[])
# SECTION
# NAME: MEASUREMENT
...
qc = qc.bind_parameters({p_dc6cae: 6.163759533339787, p_a82420: 4.167661441102218, p_0e227b: 0.05525155902669336})
# SECTION
...
backend_2f75052492124b2eb553f80850eacdc4 = Aer.get_backend('aer_simulator_matrix_product_state')

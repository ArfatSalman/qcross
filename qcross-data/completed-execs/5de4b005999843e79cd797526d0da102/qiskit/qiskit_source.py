...
backend_2f75052492124b2eb553f80850eacdc4 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_2f75052492124b2eb553f80850eacdc4, shots=489).result().get_counts(qc)
RESULT = counts
...
p_706b04 = circuit.declare('p_706b04', 'REAL')

defns = get_custom_get_definitions("CRZGate", "RCCXGate", "RZGate", "XGate", "ZGate", "SdgGate", "CCXGate")
...
circuit.inst(Gates.RZGate(p_706b04, 0 ))

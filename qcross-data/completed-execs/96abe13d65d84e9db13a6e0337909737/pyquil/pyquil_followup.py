...
p_b836ef = circuit.declare('p_b836ef', 'REAL')
p_817e70 = circuit.declare('p_817e70', 'REAL')

defns = get_custom_get_definitions("ZGate", "CU1Gate", "SXGate", "C3SXGate", "CUGate", "TGate", "XGate", "U2Gate", "CRXGate", "RZGate", "RZZGate", "CRZGate", "CSXGate", "RYYGate")

circuit += defns

circuit.inst(Gates.RZGate(p_817e70, 4 ))
...
circuit.inst(Gates.CRZGate(p_b836ef, 1, 7 ))
...
params = {
    "p_b836ef": 4.167661441102218,
    "p_817e70": 6.163759533339787
}

...
p_b836ef = Parameter('p_b836ef')
p_817e70 = Parameter('p_817e70')
# SECTION
# NAME: CIRCUIT
...
qc.append(RZGate(p_817e70), qargs=[qr[4]], cargs=[])
...
qc.append(CRZGate(p_b836ef), qargs=[qr[1], qr[7]], cargs=[])
...
qc = qc.bind_parameters({p_b836ef: 4.167661441102218, p_817e70: 6.163759533339787})
# SECTION
# NAME: OPTIMIZATION_LEVEL
from qiskit import transpile
qc = transpile(qc, basis_gates=None, optimization_level=2, coupling_map=[[0,
    1], [0, 8], [1, 0], [2, 10], [3, 4], [4, 3], [4, 6], [4, 8], [4, 10], [
    5, 9], [6, 4], [7, 9], [8, 0], [8, 4], [8, 9], [9, 5], [9, 7], [9, 8],
    [10, 2], [10, 4], [10, 11], [11, 10]])
# SECTION
...
backend_7e2e3a06921b4858bb9b10934edba72c = Aer.get_backend('aer_simulator_matrix_product_state')
counts = execute(qc, backend=backend_7e2e3a06921b4858bb9b10934edba72c, shots=2771).result().get_counts(qc)
RESULT = counts

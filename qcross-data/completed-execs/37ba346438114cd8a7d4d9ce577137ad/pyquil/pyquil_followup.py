...
defns = get_custom_get_definitions("RCCXGate", "TGate", "SGate", "ECRGate", "UGate", "CUGate", "CRXGate", "YGate", "SXdgGate", "CRZGate", "RZZGate", "XGate", "RYYGate", "CHGate", "CU1Gate", "CYGate", "RZGate", "CSXGate", "ZGate")
...
subcircuit.inst(Gates.CYGate( 0, 2 ))
subcircuit.inst(Gates.CRZGate(2.008796895454228, 0, 3 ))
subcircuit.inst(Gates.YGate( 0 ))
subcircuit.inst(Gates.RCCXGate( 4, 1, 2 ))

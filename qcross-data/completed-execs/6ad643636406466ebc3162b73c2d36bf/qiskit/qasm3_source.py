...
qr_1ddace = QuantumRegister(2, name='qr_1ddace')
qc.add_register(qr_1ddace)
# SECTION
# NAME: MEASUREMENT
...
backend_a6e6c07ec1cd400dbcf41230ec836d4e = Aer.get_backend('aer_simulator_matrix_product_state')
counts = execute(qc, backend=backend_a6e6c07ec1cd400dbcf41230ec836d4e, shots=2771).result().get_counts(qc)
RESULT = counts

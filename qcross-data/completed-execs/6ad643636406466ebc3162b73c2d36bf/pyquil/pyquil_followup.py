...
defns = get_custom_get_definitions("C3SXGate", "U2Gate", "CSXGate", "RYYGate", "CUGate", "RZZGate", "RZGate", "CU1Gate", "CRXGate", "ZGate", "SdgGate", "XGate", "TGate", "CRZGate", "SXGate")
...
qr_1ddace = circuit.declare("qr_1ddace", "BIT", 2)

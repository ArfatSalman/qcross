...
qc.append(C3SXGate(), qargs=[qr[0], qr[1], qr[6], qr[5]], cargs=[])
...
backend_55bfdaca73e949b1819699e5453dfd24 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_55bfdaca73e949b1819699e5453dfd24, shots=1959).result().get_counts(qc)
RESULT = counts

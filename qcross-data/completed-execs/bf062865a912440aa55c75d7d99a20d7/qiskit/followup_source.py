...
qr_2671ef = QuantumRegister(7, name='qr_2671ef')
qc.add_register(qr_2671ef)
# SECTION
# NAME: MEASUREMENT
...
backend_2b044be3e35e4c49a44051ccbfa904e3 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_2b044be3e35e4c49a44051ccbfa904e3, shots=1385).result().get_counts(qc)
RESULT = counts

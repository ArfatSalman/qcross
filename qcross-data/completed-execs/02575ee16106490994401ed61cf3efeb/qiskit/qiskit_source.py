...
backend_8abbcedc4d964e458f92ad1009ef1410 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_8abbcedc4d964e458f92ad1009ef1410, shots=1959).result().get_counts(qc)
RESULT = counts
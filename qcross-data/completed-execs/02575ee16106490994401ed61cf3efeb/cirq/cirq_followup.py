...
p_16376b = Symbol('p_16376b')
p_91bc37 = Symbol('p_91bc37')
p_7e21af = Symbol('p_7e21af')
...
circuit.append(Gates.CRXGate(p_7e21af)( qr[2], qr[5] ))
...
circuit.append(Gates.CRXGate(p_16376b)( qr[4], qr[6] ))
...
circuit.append(Gates.CRZGate(p_91bc37)( qr[0], qr[6] ))

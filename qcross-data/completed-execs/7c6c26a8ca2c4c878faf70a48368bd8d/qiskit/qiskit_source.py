...
backend_f3365cf1c9bb4040b8a2d05e49b73029 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_f3365cf1c9bb4040b8a2d05e49b73029, shots=2771).result().get_counts(qc)
RESULT = counts
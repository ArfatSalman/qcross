...
qr_5690fa = QuantumRegister(6, name='qr_5690fa')
qc.add_register(qr_5690fa)
# SECTION
# NAME: MEASUREMENT
...
backend_56d90fa6e95943328ed64365337eace7 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_56d90fa6e95943328ed64365337eace7, shots=489).result().get_counts(qc)
RESULT = counts

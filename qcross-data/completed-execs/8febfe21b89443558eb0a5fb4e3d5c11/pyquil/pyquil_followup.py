...
defns = get_custom_get_definitions("SXdgGate", "XGate", "RZGate", "CSXGate", "SGate", "ZGate", "CHGate", "CRXGate", "RYYGate", "SdgGate", "CCXGate", "iSwapGate")
...
qr_5690fa = circuit.declare("qr_5690fa", "BIT", 6)

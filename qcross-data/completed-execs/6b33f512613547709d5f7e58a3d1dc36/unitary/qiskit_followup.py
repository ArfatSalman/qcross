...
qc = transpile(qc, basis_gates=None, optimization_level=0, coupling_map=[[0, 1], [0, 5], [1, 0], [1, 3], [1, 4], [1, 7], [2, 7], [3, 1], [3, 6], [4, 1], [5, 0], [6, 3], [7, 1], [7, 2]])
# SECTION
# NAME: EXECUTION

from qiskit import Aer, transpile, execute
backend_cde2cd5054c645bdb7ba471d657e6818 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_cde2cd5054c645bdb7ba471d657e6818, shots=2771).result().get_counts(qc)
RESULT = counts

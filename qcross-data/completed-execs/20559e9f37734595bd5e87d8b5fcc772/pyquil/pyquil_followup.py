...
p_63bd3e = circuit.declare('p_63bd3e', 'REAL')
p_012673 = circuit.declare('p_012673', 'REAL')
p_a310fa = circuit.declare('p_a310fa', 'REAL')

defns = get_custom_get_definitions("ECRGate", "CCXGate", "RYYGate", "RZGate", "CHGate", "XGate", "SGate", "TGate", "RCCXGate", "CSXGate", "CRXGate", "SdgGate", "SXdgGate", "ZGate", "iSwapGate")

circuit += defns

circuit.inst(Gates.RZGate(p_a310fa, 1 ))
...
circuit.inst(Gates.CRXGate(p_012673, 0, 2 ))
circuit.inst(Gates.SGate( 2 ))
circuit.inst(Gates.CCXGate( 1, 0, 2 ))
circuit.inst(Gates.CHGate( 2, 0 ))
circuit.inst(Gates.CHGate( 1, 2 ))
circuit.inst(Gates.RYYGate(p_63bd3e)( 1, 0 ))

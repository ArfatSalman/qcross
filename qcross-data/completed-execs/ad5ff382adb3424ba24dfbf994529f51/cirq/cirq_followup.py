...
p_66d141 = Symbol('p_66d141')
p_637123 = Symbol('p_637123')
...
circuit.append(Gates.U2Gate(4.214504315296764, p_66d141)( qr[10] ))
circuit.append(Gates.CSXGate( qr[3], qr[2] ))
circuit.append(Gates.CHGate( qr[0], qr[7] ))
circuit.append(Gates.CU1Gate(p_637123)( qr[9], qr[0] ))
...
circuit = cirq.resolve_parameters(circuit, {
    "p_66d141": 4.6235667602042065,
    "p_637123": 4.028174522740928
}, recursive=True)

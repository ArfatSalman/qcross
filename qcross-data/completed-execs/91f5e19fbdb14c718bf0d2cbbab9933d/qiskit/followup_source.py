...
backend_795fd5c8229c4c58bb5406caade07327 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_795fd5c8229c4c58bb5406caade07327, shots=7838).result().get_counts(qc)
RESULT = counts

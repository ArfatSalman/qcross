...
p_c44195 = Symbol('p_c44195')
p_79c15b = Symbol('p_79c15b')
p_d72302 = Symbol('p_d72302')
p_f05a11 = Symbol('p_f05a11')
p_381d88 = Symbol('p_381d88')
p_3f6521 = Symbol('p_3f6521')
p_24e500 = Symbol('p_24e500')
...
circuit.append(Gates.XGate( qr[1] ))
circuit.append(Gates.RYYGate(p_79c15b)( qr[0], qr[1] ))
...
circuit.append(Gates.CRZGate(p_24e500)( qr[0], qr[1] ))
circuit.append(Gates.SXGate( qr[1] ))
circuit.append(Gates.RZGate(p_381d88)( qr[1] ))
circuit.append(Gates.RZGate(5.512260524440591)( qr[1] ))
circuit.append(Gates.CU1Gate(p_3f6521)( qr[0], qr[1] ))
circuit.append(Gates.XGate( qr[1] ))
circuit.append(Gates.RZZGate(6.086884486572108)( qr[0], qr[1] ))
circuit.append(Gates.XGate( qr[1] ))
circuit.append(Gates.SXdgGate( qr[0] ))
circuit.append(Gates.RYYGate(p_c44195)( qr[0], qr[1] ))
circuit.append(Gates.SXGate( qr[1] ))
circuit.append(Gates.RZGate(p_f05a11)( qr[1] ))
circuit.append(Gates.XGate( qr[1] ))
circuit.append(Gates.RYYGate(p_d72302)( qr[1], qr[0] ))

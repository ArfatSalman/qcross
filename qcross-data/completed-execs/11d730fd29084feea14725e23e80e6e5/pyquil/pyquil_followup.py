...
defns = get_custom_get_definitions("SdgGate", "CSXGate", "ZGate")

qc_1 += defns

qc_1.inst(Gates.CSXGate( 1, 2 ))
qc_1.inst(Gates.SdgGate( 0 ))
...
defns = get_custom_get_definitions("C3SXGate", "CUGate", "XGate", "RZGate", "SGate")

qc_2 += defns

qc_2.inst(Gates.RZGate(6.163759533339787, 4 ))
qc_2.inst(Gates.CUGate(0.5112149185250571, 5.897054719225356, 2.3864521352475245, 5.987304452123941, 0, 2 ))
qc_2.inst(Gates.C3SXGate( 0, 4, 3, 1 ))
qc_2.inst(Gates.XGate( 1 ))
qc_2.inst(Gates.SGate( 0 ))

...
qr_1 = [cirq.NamedQubit('q' + str(i)) for i in range(4)]



qc_1 = cirq.Circuit()

qc_1.append(Gates.CSXGate( qr_1[1], qr_1[2] ))
qc_1.append(Gates.SdgGate( qr_1[0] ))
...
counts = get_qiskit_like_output(result_1, keys=['cr0', 'cr1', 'cr2', 'cr3'])
...
qc_2.append(Gates.CUGate(0.5112149185250571, 5.897054719225356, 2.3864521352475245, 5.987304452123941)( qr_2[0], qr_2[2] ))
qc_2.append(Gates.C3SXGate( qr_2[0], qr_2[4], qr_2[3], qr_2[1] ))
qc_2.append(Gates.XGate( qr_2[1] ))
qc_2.append(Gates.SGate( qr_2[0] ))

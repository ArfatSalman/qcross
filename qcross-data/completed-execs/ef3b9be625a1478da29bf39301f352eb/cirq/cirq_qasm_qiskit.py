...
p_86f185 = Symbol('p_86f185')
p_6b43a3 = Symbol('p_6b43a3')
p_7d2faf = Symbol('p_7d2faf')
p_85477f = Symbol('p_85477f')
p_f407a3 = Symbol('p_f407a3')
p_eb055e = Symbol('p_eb055e')
p_e75067 = Symbol('p_e75067')
p_93dcc8 = Symbol('p_93dcc8')
p_0d2e3c = Symbol('p_0d2e3c')

circuit = cirq.Circuit()

circuit.append(Gates.RZGate(p_86f185)( qr[3] ))
circuit.append(Gates.SXdgGate( qr[2] ))
circuit.append(Gates.CSXGate( qr[1], qr[0] ))
circuit.append(Gates.ECRGate( qr[3], qr[2] ))
circuit.append(Gates.CRXGate(p_7d2faf)( qr[4], qr[3] ))
circuit.append(Gates.SGate( qr[0] ))
circuit.append(Gates.CRZGate(p_0d2e3c)( qr[3], qr[4] ))
circuit.append(Gates.CHGate( qr[1], qr[4] ))
circuit.append(Gates.RYYGate(p_85477f)( qr[0], qr[2] ))
circuit.append(Gates.ZGate( qr[2] ))
circuit.append(Gates.TGate( qr[4] ))
circuit.append(Gates.CSXGate( qr[1], qr[4] ))
circuit.append(Gates.XGate( qr[0] ))
circuit.append(Gates.SGate( qr[4] ))
circuit.append(Gates.CUGate(p_f407a3, p_e75067, p_93dcc8, p_eb055e)( qr[1], qr[4] ))
circuit.append(Gates.RZGate(p_6b43a3)( qr[1] ))

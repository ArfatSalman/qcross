...
defns = get_custom_get_definitions("SXdgGate", "ZGate", "TGate", "CCXGate", "CU1Gate", "CRZGate", "CSXGate", "U3Gate", "CU3Gate", "XGate", "CRXGate", "SdgGate", "RZGate", "RCCXGate", "RZXGate", "CHGate", "RZZGate", "SXGate", "U2Gate")
...
subcircuit = Program()
subcircuit.inst(Gates.RCCXGate( 9, 8, 10 ))
subcircuit.inst(Gates.SXGate( 0 ))
subcircuit.inst(Gates.CU3Gate(6.098289949996356, 4.146230384738817, 0.11533301439286255, 1, 7 ))
subcircuit.inst(Gates.CU3Gate(3.7674033529905295, 0.6709962385192909, 3.8345171956107813, 1, 0 ))
subcircuit.inst(Gates.U3Gate(0.4078064702026739, 5.832988635031908, 2.616274217198572)( 3 ))
subcircuit.inst(Gates.RZXGate(4.323598228390759)( 0, 4 ))
subcircuit.inst(Gates.CRXGate(0.8150142826185788, 10, 8 ))
subcircuit.inst(Gates.CU1Gate(3.8153974705031524, 0, 10 ))

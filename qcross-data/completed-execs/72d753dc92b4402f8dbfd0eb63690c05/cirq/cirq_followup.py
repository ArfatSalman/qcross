...
subcircuit.append(Gates.CPhaseGate(3.326780904591333)( qr[1], qr[0] ))
subcircuit.append(Gates.IGate( qr[2] ))
subcircuit.append(Gates.PhaseGate(0.4827903095199283)( qr[4] ))
subcircuit.append(Gates.RZXGate(1.1412693567569159)( qr[1], qr[2] ))
subcircuit.append(Gates.CYGate( qr[4], qr[0] ))
subcircuit.append(Gates.SwapGate( qr[3], qr[0] ))
...
circuit.append(Gates.C3SXGate( qr[3], qr[5], qr[1], qr[0] ))
circuit.append(Gates.CCXGate( qr[3], qr[4], qr[1] ))
circuit.append(Gates.C3SXGate( qr[5], qr[2], qr[4], qr[1] ))
circuit.append(Gates.ZGate( qr[1] ))
circuit.append(Gates.ZGate( qr[0] ))
circuit.append(Gates.TGate( qr[5] ))
circuit.append(Gates.RCCXGate( qr[4], qr[2], qr[5] ))
circuit.append(Gates.SGate( qr[4] ))
circuit.append(Gates.CRZGate(4.167661441102218)( qr[3], qr[4] ))
circuit.append(Gates.RZGate(4.229610589867865)( qr[3] ))
circuit.append(Gates.C3SXGate( qr[1], qr[0], qr[3], qr[2] ))
...
circuit.append(Gates.CRZGate(4.833923139882297)( qr[1], qr[4] ))
circuit.append(Gates.CU1Gate(4.028174522740928)( qr[3], qr[5] ))
circuit.append(Gates.C3SXGate( qr[2], qr[1], qr[5], qr[0] ))
circuit.append(Gates.CRZGate(2.586208953975239)( qr[0], qr[4] ))
circuit.append(Gates.CRXGate(2.6687018103754414)( qr[5], qr[4] ))

...
defns = get_custom_get_definitions("TGate", "RCCXGate", "ZGate", "CU1Gate", "U2Gate", "CHGate", "RZGate", "SdgGate", "CCXGate", "CSXGate", "CRZGate", "XGate")
...
qr_efd648 = circuit.declare("qr_efd648", "BIT", 4)

...
qr_efd648 = QuantumRegister(4, name='qr_efd648')
qc.add_register(qr_efd648)
# SECTION
# NAME: MEASUREMENT
...
backend_d9b18520bbd24aff9d375ca44a251a14 = Aer.get_backend('statevector_simulator')
counts = execute(qc, backend=backend_d9b18520bbd24aff9d375ca44a251a14, shots=7838).result().get_counts(qc)
RESULT = counts

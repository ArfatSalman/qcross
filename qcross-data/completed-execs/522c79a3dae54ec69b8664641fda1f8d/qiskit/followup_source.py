...
qc = transpile(qc, basis_gates=None, optimization_level=0, coupling_map=[[0,
    1], [0, 5], [0, 6], [1, 0], [1, 7], [2, 5], [3, 4], [4, 3], [4, 5], [5,
    0], [5, 2], [5, 4], [6, 0], [7, 1]])
# SECTION
# NAME: EXECUTION

from qiskit import Aer, transpile, execute
backend_32af282e04de487f9b3528181264875e = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_32af282e04de487f9b3528181264875e, shots=2771).result().get_counts(qc)
RESULT = counts

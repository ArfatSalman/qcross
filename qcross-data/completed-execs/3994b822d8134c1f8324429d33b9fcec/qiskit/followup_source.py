...
qc = transpile(qc, basis_gates=None, optimization_level=2, coupling_map=[[0,
    1], [0, 4], [1, 0], [1, 2], [1, 5], [2, 1], [2, 3], [3, 2], [4, 0], [5, 1]]
    )
# SECTION
# NAME: EXECUTION

from qiskit import Aer, transpile, execute
backend_c58446dea5fc4aa1b9573b5d2dbdcf03 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_c58446dea5fc4aa1b9573b5d2dbdcf03, shots=1385).result().get_counts(qc)
RESULT = counts

...
qr_72e5da = QuantumRegister(4, name='qr_72e5da')
qc.add_register(qr_72e5da)
# SECTION
# NAME: MEASUREMENT
...
backend_3426a24c8b70409f8e7df7c148973fb8 = Aer.get_backend('statevector_simulator')
counts = execute(qc, backend=backend_3426a24c8b70409f8e7df7c148973fb8, shots=979).result().get_counts(qc)
RESULT = counts

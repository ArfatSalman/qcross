...
defns = get_custom_get_definitions("CHGate", "CUGate", "CRZGate", "RZGate", "ZGate", "ECRGate", "TGate", "SGate", "CRXGate", "RYYGate", "XGate", "CSXGate", "SXdgGate")
...
qr_72e5da = circuit.declare("qr_72e5da", "BIT", 4)

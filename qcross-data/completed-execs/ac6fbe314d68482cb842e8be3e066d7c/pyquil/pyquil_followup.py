...
defns = get_custom_get_definitions("CUGate", "RCCXGate", "CRZGate", "SGate", "CU1Gate", "RYYGate", "UGate", "ZGate", "CXGate", "PhaseGate", "RZZGate", "SXGate", "TGate", "RZGate", "C3SXGate", "CCXGate")
...
subcircuit = Program()
subcircuit.inst(Gates.CUGate(5.0063780207098425, 3.1562533916051736, 4.940217775579305, 2.419481683937988, 1, 2 ))
subcircuit.inst(Gates.RYYGate(0.6724371252296606)( 0, 5 ))
subcircuit.inst(Gates.CXGate( 2, 0 ))
subcircuit.inst(Gates.PhaseGate(5.5146057452272546, 1 ))

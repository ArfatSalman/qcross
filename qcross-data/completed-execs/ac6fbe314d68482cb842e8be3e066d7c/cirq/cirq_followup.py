...
subcircuit.append(Gates.CUGate(5.0063780207098425, 3.1562533916051736, 4.940217775579305, 2.419481683937988)( qr[1], qr[2] ))
subcircuit.append(Gates.RYYGate(0.6724371252296606)( qr[0], qr[5] ))
subcircuit.append(Gates.CXGate( qr[2], qr[0] ))
subcircuit.append(Gates.PhaseGate(5.5146057452272546)( qr[1] ))

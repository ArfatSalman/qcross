...
qr_95bc21 = QuantumRegister(4, name='qr_95bc21')
qc.add_register(qr_95bc21)
# SECTION
# NAME: MEASUREMENT
...
backend_f9054b51c9f145e2b15426906517c8f0 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_f9054b51c9f145e2b15426906517c8f0, shots=1959).result().get_counts(qc)
RESULT = counts

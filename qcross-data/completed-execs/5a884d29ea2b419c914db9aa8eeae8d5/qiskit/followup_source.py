...
qr_447971 = QuantumRegister(1, name='qr_447971')
qc.add_register(qr_447971)
# SECTION
# NAME: MEASUREMENT
...
backend_611f4ede432d44698d4f6daf5d3e88c1 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_611f4ede432d44698d4f6daf5d3e88c1, shots=3919).result().get_counts(qc)
RESULT = counts

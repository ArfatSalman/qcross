...
backend_dd017d0cf5eb4d56aaabe2dc65d99988 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_dd017d0cf5eb4d56aaabe2dc65d99988, shots=1959).result().get_counts(qc)
RESULT = counts
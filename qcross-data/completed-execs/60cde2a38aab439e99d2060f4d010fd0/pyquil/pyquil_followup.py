...
defns = get_custom_get_definitions("CUGate", "SGate", "RCCXGate", "ZGate", "RZGate", "C3SXGate", "CCXGate", "CRZGate", "TGate")
...
circuit.inst(Gates.CUGate(0.5112149185250571, 5.897054719225356, 2.3864521352475245, 5.987304452123941, 5, 1 ))
circuit.inst(Gates.C3SXGate( 3, 2, 0, 5 ))
circuit.inst(Gates.CCXGate( 3, 4, 0 ))
circuit.inst(Gates.C3SXGate( 2, 1, 4, 0 ))
circuit.inst(Gates.ZGate( 0 ))
circuit.inst(Gates.ZGate( 5 ))
circuit.inst(Gates.TGate( 2 ))
circuit.inst(Gates.RCCXGate( 4, 1, 2 ))

...
p_8a6d1c = Symbol('p_8a6d1c')
p_542aed = Symbol('p_542aed')
p_f2c1b9 = Symbol('p_f2c1b9')

circuit = cirq.Circuit()

circuit.append(Gates.RZGate(p_8a6d1c)( qr[3] ))
circuit.append(Gates.CRZGate(4.2641612072511235)( qr[6], qr[3] ))
circuit.append(Gates.CRXGate(p_542aed)( qr[1], qr[7] ))
...
circuit.append(Gates.RZGate(p_f2c1b9)( qr[1] ))

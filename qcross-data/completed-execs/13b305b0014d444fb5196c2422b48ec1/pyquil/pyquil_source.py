...
circuit.inst(
    Gates.CU3Gate(4.577871395666417, 2.824995733037649, 4.570764402928323, 2, 0)
)
...
circuit.inst(
    Gates.CU3Gate(3.3468514586446996, 0.09605123198475385, 1.9104022337738353, 2, 0)
)
...
circuit.inst(
    Gates.CU3Gate(1.4776100383750288, 4.796549499287292, 5.831783083594262, 3, 1)
)
circuit.inst(Gates.C3XGate(2, 0, 3, 1))
circuit.inst(
    Gates.CU3Gate(2.6606132436968934, 0.25042616078481367, 0.47890039592537104, 3, 0)
)

...
p_4b26a9 = Symbol('p_4b26a9')

circuit = cirq.Circuit()

circuit.append(Gates.RZGate(6.163759533339787)( qr[0] ))
circuit.append(Gates.RZZGate(4.066449154047175)( qr[3], qr[2] ))
...
circuit.append(Gates.CU1Gate(5.154187354656876)( qr[2], qr[1] ))
circuit.append(Gates.CHGate( qr[2], qr[3] ))
circuit.append(Gates.CHGate( qr[0], qr[3] ))
circuit.append(Gates.C3SXGate( qr[2], qr[1], qr[0], qr[3] ))
...
circuit.append(Gates.RCCXGate( qr[0], qr[1], qr[2] ))
circuit.append(Gates.RYYGate(1.740253089260498)( qr[3], qr[1] ))
circuit.append(Gates.RCCXGate( qr[3], qr[2], qr[1] ))
circuit.append(Gates.SXdgGate( qr[1] ))
circuit.append(Gates.SGate( qr[2] ))
circuit.append(Gates.CRZGate(p_4b26a9)( qr[1], qr[0] ))
circuit.append(Gates.C3SXGate( qr[0], qr[3], qr[1], qr[2] ))
circuit.append(Gates.RYYGate(5.398622178940033)( qr[3], qr[1] ))
circuit.append(Gates.SXdgGate( qr[1] ))
circuit.append(Gates.CU1Gate(3.2142159669963557)( qr[1], qr[2] ))

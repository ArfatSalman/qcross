...
qc.append(RZZGate(4.066449154047175), qargs=[qr[3], qr[2]], cargs=[])
...
qc.append(C3SXGate(), qargs=[qr[2], qr[1], qr[0], qr[3]], cargs=[])
...
qc.append(RYYGate(1.740253089260498), qargs=[qr[3], qr[1]], cargs=[])
qc.append(RCCXGate(), qargs=[qr[3], qr[2], qr[1]], cargs=[])
qc.append(SXdgGate(), qargs=[qr[1]], cargs=[])
qc.append(SGate(), qargs=[qr[2]], cargs=[])
qc.append(CRZGate(p_4b26a9), qargs=[qr[1], qr[0]], cargs=[])
qc.append(C3SXGate(), qargs=[qr[0], qr[3], qr[1], qr[2]], cargs=[])
qc.append(RYYGate(5.398622178940033), qargs=[qr[3], qr[1]], cargs=[])
qc.append(SXdgGate(), qargs=[qr[1]], cargs=[])
qc.append(CU1Gate(3.2142159669963557), qargs=[qr[1], qr[2]], cargs=[])
...
qc = qc.bind_parameters({p_4b26a9: 2.9790366726895714})
# SECTION
...
backend_376dd1b22dea4a41ba8265795ffcf0db = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_376dd1b22dea4a41ba8265795ffcf0db, shots=692).result().get_counts(qc)
RESULT = counts

...
qr_bfc7e6 = QuantumRegister(6, name='qr_bfc7e6')
qc.add_register(qr_bfc7e6)
# SECTION
# NAME: MEASUREMENT
...
backend_79931a706bc948faa3a463950f651040 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_79931a706bc948faa3a463950f651040, shots=7838).result().get_counts(qc)
RESULT = counts

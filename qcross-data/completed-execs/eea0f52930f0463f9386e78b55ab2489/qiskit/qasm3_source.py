...
qr_d2b925 = QuantumRegister(8, name='qr_d2b925')
qc.add_register(qr_d2b925)
# SECTION
# NAME: MEASUREMENT
...
backend_7b70b0bed43d402f9b36724ad848574f = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_7b70b0bed43d402f9b36724ad848574f, shots=692).result().get_counts(qc)
RESULT = counts

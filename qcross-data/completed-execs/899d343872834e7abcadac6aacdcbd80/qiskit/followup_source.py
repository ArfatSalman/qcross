...
qc_1.append(CHGate(), qargs=[qr_1[1], qr_1[0]], cargs=[])
...
backend_2e55a5c98cd64acf8f48eeb799239456 = Aer.get_backend('qasm_simulator')
counts_1 = execute(qc_1, backend=backend_2e55a5c98cd64acf8f48eeb799239456, shots=489).result().get_counts(qc_1)
counts_2 = execute(qc_2, backend=backend_2e55a5c98cd64acf8f48eeb799239456, shots=489).result().get_counts(qc_2)

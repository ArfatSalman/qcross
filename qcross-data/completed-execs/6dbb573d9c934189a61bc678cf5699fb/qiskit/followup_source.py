...
backend_d7887cfda41b4476853a9b1e725390e2 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_d7887cfda41b4476853a9b1e725390e2, shots=2771).result().get_counts(qc)
RESULT = counts

...
qc = transpile(qc, basis_gates=None, optimization_level=2, coupling_map=[[0,
    1], [0, 3], [1, 0], [1, 2], [1, 4], [1, 5], [2, 1], [3, 0], [4, 1], [5, 1]]
    )
# SECTION
# NAME: EXECUTION

from qiskit import Aer, transpile, execute
backend_23f377d0eb9440b09b8e5c7edd14d659 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_23f377d0eb9440b09b8e5c7edd14d659, shots=1385).result().get_counts(qc)
RESULT = counts

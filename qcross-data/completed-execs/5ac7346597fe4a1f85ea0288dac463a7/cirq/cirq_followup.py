...
p_946f6c = Symbol('p_946f6c')
p_ad8fd1 = Symbol('p_ad8fd1')

circuit = cirq.Circuit()

circuit.append(Gates.RZGate(6.163759533339787)( qr[3] ))
circuit.append(Gates.CRZGate(p_946f6c)( qr[6], qr[2] ))
...
circuit.append(Gates.U2Gate(p_ad8fd1, 2.1276323672732023)( qr[2] ))

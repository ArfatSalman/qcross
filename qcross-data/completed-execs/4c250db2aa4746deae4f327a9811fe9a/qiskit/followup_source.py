...
qc = transpile(qc, basis_gates=None, optimization_level=0, coupling_map=[[0,
    1], [0, 4], [0, 5], [1, 0], [2, 6], [3, 6], [3, 7], [4, 0], [4, 6], [5,
    0], [6, 2], [6, 3], [6, 4], [7, 3]])
# SECTION
# NAME: EXECUTION

from qiskit import Aer, transpile, execute
backend_fb3664c72aed43a7906d8b12ebbc3aff = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_fb3664c72aed43a7906d8b12ebbc3aff, shots=1385).result().get_counts(qc)
RESULT = counts

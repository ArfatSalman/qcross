...
backend_25f7b56ccb59469fbef1b8dfe17f29a9 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_25f7b56ccb59469fbef1b8dfe17f29a9, shots=1385).result().get_counts(qc)
RESULT = counts
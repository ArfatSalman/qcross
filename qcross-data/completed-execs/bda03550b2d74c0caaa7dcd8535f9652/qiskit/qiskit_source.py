...
backend_32c9e2f7d63c4bd9aa7c3616c17b9964 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_32c9e2f7d63c4bd9aa7c3616c17b9964, shots=346).result().get_counts(qc)
RESULT = counts
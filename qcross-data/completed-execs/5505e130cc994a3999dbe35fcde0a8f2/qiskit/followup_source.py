...
backend_688179c2e7ca47e5bf8b106eb7c77e5c = Aer.get_backend('aer_simulator_density_matrix')
counts = execute(qc, backend=backend_688179c2e7ca47e5bf8b106eb7c77e5c, shots=1385).result().get_counts(qc)
RESULT = counts

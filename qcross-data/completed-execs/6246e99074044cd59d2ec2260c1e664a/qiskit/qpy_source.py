...
backend_8dfcc0dfa87b42d59990cd28b41a6e85 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_8dfcc0dfa87b42d59990cd28b41a6e85, shots=2771).result().get_counts(qc)
RESULT = counts

...
defns = get_custom_get_definitions("U2Gate", "ZGate", "CU1Gate", "RZZGate", "CRZGate", "XGate", "RZGate", "C3SXGate", "CSXGate", "TGate", "CPhaseGate", "RYYGate", "SXGate", "CUGate", "CRXGate", "RZXGate")
...
subcircuit.inst(Gates.RZXGate(1.1412693567569159)( 0, 6 ))

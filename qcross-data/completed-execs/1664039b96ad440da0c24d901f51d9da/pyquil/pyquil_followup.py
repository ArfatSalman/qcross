...
defns = get_custom_get_definitions("SGate", "TGate", "RCCXGate", "RZZGate", "ZGate", "CRXGate", "ECRGate", "SdgGate", "CU1Gate", "CHGate", "U2Gate", "RZGate", "C3SXGate", "CSXGate", "CRZGate", "XGate")
...
qr_52e5d8 = circuit.declare("qr_52e5d8", "BIT", 3)

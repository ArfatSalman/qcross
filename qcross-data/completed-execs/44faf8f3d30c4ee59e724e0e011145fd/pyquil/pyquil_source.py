...
defns = get_custom_get_definitions("CSXGate", "U2Gate", "CUGate", "iSwapGate", "RCCXGate", "CU1Gate", "CCXGate", "SdgGate", "SXGate", "XGate", "CRXGate", "C3SXGate", "SGate", "CHGate", "CRZGate", "TGate", "RZGate", "ZGate")
...
circuit.inst(Gates.CU1Gate(2.5476776328466872, 2, 5 ))

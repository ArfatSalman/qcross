...
backend_b2a375e4d4ed45af8c0f02bbfc13fcb8 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_b2a375e4d4ed45af8c0f02bbfc13fcb8, shots=2771).result().get_counts(qc)
RESULT = counts
...
defns = get_custom_get_definitions("SGate", "SXGate", "C3SXGate", "ZGate", "CU1Gate", "RZGate", "CRZGate", "CHGate", "SdgGate", "CUGate", "XGate", "CSXGate")
...
circuit.inst(Gates.CRZGate(2.586208953975239, 0, 8 ))

...
subcircuit.append(Gates.CZGate( qr[0], qr[3] ))
subcircuit.append(Gates.IGate( qr[1] ))
subcircuit.append(Gates.CZGate( qr[0], qr[3] ))
subcircuit.append(Gates.XGate( qr[2] ))
subcircuit.append(Gates.SXdgGate( qr[0] ))
subcircuit.append(Gates.SXGate( qr[0] ))
subcircuit.append(Gates.CSwapGate( qr[3], qr[2], qr[1] ))
subcircuit.append(Gates.YGate( qr[0] ))
subcircuit.append(Gates.ZGate( qr[3] ))

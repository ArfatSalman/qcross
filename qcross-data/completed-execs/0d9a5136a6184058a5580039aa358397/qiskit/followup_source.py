...
subcircuit.append(CZGate(), qargs=[qr[0], qr[3]], cargs=[])
...
subcircuit.append(ZGate(), qargs=[qr[3]], cargs=[])
...
backend_542e6bdbe751471e9cb5429876ce63af = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_542e6bdbe751471e9cb5429876ce63af, shots=692).result().get_counts(qc)
RESULT = counts

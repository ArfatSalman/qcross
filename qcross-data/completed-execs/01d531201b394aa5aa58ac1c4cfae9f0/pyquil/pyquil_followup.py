...
defns = get_custom_get_definitions("RZGate", "XGate")
...
defns = get_custom_get_definitions("CRXGate", "ZGate", "C3SXGate")

qc_2 += defns

qc_2.inst(Gates.ZGate( 4 ))
qc_2.inst(Gates.CRXGate(2.0099472182748075, 2, 3 ))
qc_2.inst(Gates.C3SXGate( 4, 0, 1, 2 ))

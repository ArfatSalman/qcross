...
subcircuit.append(U3Gate(5.007412428963378,4.658325508156331,3.8184561666262637), qargs=[qr[2]], cargs=[])
...
backend_32a5635ea1b44ad380b5e027af062f64 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_32a5635ea1b44ad380b5e027af062f64, shots=1385).result().get_counts(qc)
RESULT = counts

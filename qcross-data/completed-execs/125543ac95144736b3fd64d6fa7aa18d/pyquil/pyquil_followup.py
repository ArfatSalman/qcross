...
defns = get_custom_get_definitions("RZGate", "ZGate", "U3Gate", "C3SXGate", "CRXGate", "CZGate", "CCXGate", "CUGate", "CRZGate")
...
subcircuit = Program()
subcircuit.inst(Gates.U3Gate(5.007412428963378, 4.658325508156331, 3.8184561666262637)( 2 ))

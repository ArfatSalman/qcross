...
subcircuit.append(UGate(5.01836135520768,5.190931186022931,1.2128092629174942), qargs=[qr[5]], cargs=[])
subcircuit.append(RC3XGate(), qargs=[qr[5], qr[3], qr[0], qr[4]], cargs=[])
...
backend_1c280c5687d44b699344a94328b160c7 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_1c280c5687d44b699344a94328b160c7, shots=1385).result().get_counts(qc)
RESULT = counts

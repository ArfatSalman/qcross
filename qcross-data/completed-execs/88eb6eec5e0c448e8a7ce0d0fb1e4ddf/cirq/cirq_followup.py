...
circuit.append(Gates.CRXGate(5.987304452123941)( qr[5], qr[0] ))
circuit.append(Gates.CRZGate(1.0296448789776642)( qr[4], qr[0] ))
circuit.append(Gates.C3SXGate( qr[5], qr[6], qr[0], qr[3] ))
circuit.append(Gates.ZGate( qr[2] ))
circuit.append(Gates.XGate( qr[4] ))
circuit.append(Gates.RYYGate(1.740253089260498)( qr[0], qr[6] ))
...
circuit.append(Gates.CRXGate(5.94477504571567)( qr[0], qr[1] ))

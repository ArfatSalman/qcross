...
qc.append(CU1Gate(4.028174522740928), qargs=[qr[6], qr[0]], cargs=[])
# SECTION
# NAME: MEASUREMENT
...
backend_5a15e4b1df134022a4d34f990dd236de = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_5a15e4b1df134022a4d34f990dd236de, shots=1959).result().get_counts(qc)
RESULT = counts

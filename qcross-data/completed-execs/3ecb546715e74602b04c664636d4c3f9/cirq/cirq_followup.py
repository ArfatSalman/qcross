...
circuit.append(Gates.C3SXGate( qr[3], qr[4], qr[6], qr[2] ))
circuit.append(Gates.CHGate( qr[0], qr[3] ))
circuit.append(Gates.C3SXGate( qr[4], qr[2], qr[6], qr[1] ))
...
circuit.append(Gates.C3SXGate( qr[4], qr[2], qr[6], qr[5] ))
...
circuit.append(Gates.CU1Gate(4.028174522740928)( qr[6], qr[0] ))

...
defns = get_custom_get_definitions("CU1Gate", "RZZGate", "CRXGate", "CUGate", "RZGate", "ZGate", "TGate", "CRZGate", "RYYGate", "CSXGate", "C3SXGate", "SXGate", "U2Gate", "XGate", "SdgGate")
...
qr_de560b = circuit.declare("qr_de560b", "BIT", 8)

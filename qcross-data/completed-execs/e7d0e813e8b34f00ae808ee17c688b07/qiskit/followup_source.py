...
qr_de560b = QuantumRegister(8, name='qr_de560b')
qc.add_register(qr_de560b)
# SECTION
# NAME: MEASUREMENT
...
backend_d08eabcb30da4914bbdb83dd3725efe2 = Aer.get_backend('statevector_simulator')
counts = execute(qc, backend=backend_d08eabcb30da4914bbdb83dd3725efe2, shots=2771).result().get_counts(qc)
RESULT = counts

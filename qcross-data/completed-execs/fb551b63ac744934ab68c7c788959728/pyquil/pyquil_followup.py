...
defns = get_custom_get_definitions("RZGate", "ZGate", "RCCXGate", "CHGate", "CSXGate", "SdgGate", "XGate", "CRZGate", "CCXGate", "U2Gate")

circuit += defns

circuit.inst(Gates.RZGate(6.163759533339787, 4 ))
circuit.inst(Gates.CRZGate(4.2641612072511235, 0, 6 ))
circuit.inst(Gates.ZGate( 9 ))
circuit.inst(Gates.CCXGate( 7, 5, 1 ))
circuit.inst(Gates.ZGate( 6 ))
circuit.inst(Gates.XGate( 1 ))
circuit.inst(Gates.RCCXGate( 3, 0, 10 ))
circuit.inst(Gates.RZGate(4.229610589867865, 2 ))
circuit.inst(Gates.CCXGate( 1, 3, 6 ))
circuit.inst(Gates.SdgGate( 1 ))
circuit.inst(Gates.U2Gate(4.214504315296764, 4.6235667602042065)( 3 ))
circuit.inst(Gates.CSXGate( 4, 6 ))

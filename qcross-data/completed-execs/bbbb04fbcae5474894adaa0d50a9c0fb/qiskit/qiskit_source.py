...
backend_528b814b486c4211a23a6c6eef488fb5 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_528b814b486c4211a23a6c6eef488fb5, shots=346).result().get_counts(qc)
RESULT = counts
...
backend_6e2d8bf1af55489a92d00168481c28fa = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_6e2d8bf1af55489a92d00168481c28fa, shots=979).result().get_counts(qc)
RESULT = counts
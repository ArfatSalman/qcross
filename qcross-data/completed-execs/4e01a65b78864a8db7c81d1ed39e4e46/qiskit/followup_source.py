...
backend_659ba09806b942fb89f189b70f4f3b44 = Aer.get_backend('aer_simulator_statevector')
counts = execute(qc, backend=backend_659ba09806b942fb89f189b70f4f3b44, shots=979).result().get_counts(qc)
RESULT = counts

...
defns = get_custom_get_definitions("RYYGate", "CHGate", "XGate", "ECRGate", "ZGate", "TGate", "CSXGate", "CUGate", "CRZGate", "CU1Gate", "CRXGate", "UGate", "SXdgGate", "SGate", "RZGate")
...
qr_e684da = circuit.declare("qr_e684da", "BIT", 3)

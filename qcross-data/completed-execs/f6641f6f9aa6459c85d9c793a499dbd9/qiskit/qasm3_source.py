...
backend_d67f7f243b184c4aa47c4e13a8ca6c5c = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_d67f7f243b184c4aa47c4e13a8ca6c5c, shots=692).result().get_counts(qc)
RESULT = counts

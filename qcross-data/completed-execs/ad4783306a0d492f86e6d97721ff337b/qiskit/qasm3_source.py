...
backend_dcc42fc1a1744b0ca762f4f8f4c943d1 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_dcc42fc1a1744b0ca762f4f8f4c943d1, shots=692).result().get_counts(qc)
RESULT = counts

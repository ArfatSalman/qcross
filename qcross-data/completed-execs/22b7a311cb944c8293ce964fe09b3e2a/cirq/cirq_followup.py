...
p_1b6af5 = Symbol('p_1b6af5')
p_224ae5 = Symbol('p_224ae5')
p_e5c76f = Symbol('p_e5c76f')
p_88b560 = Symbol('p_88b560')
p_772597 = Symbol('p_772597')
p_7edefd = Symbol('p_7edefd')
p_b289d6 = Symbol('p_b289d6')

circuit = cirq.Circuit()

circuit.append(Gates.RZGate(p_772597)( qr[4] ))
circuit.append(Gates.ZGate( qr[6] ))
circuit.append(Gates.XGate( qr[6] ))
circuit.append(Gates.CRXGate(p_7edefd)( qr[0], qr[6] ))
...
circuit.append(Gates.CRZGate(p_1b6af5)( qr[1], qr[7] ))
...
circuit.append(Gates.CRXGate(p_e5c76f)( qr[6], qr[4] ))
circuit.append(Gates.RZZGate(p_88b560)( qr[7], qr[0] ))
circuit.append(Gates.CSXGate( qr[0], qr[2] ))
circuit.append(Gates.ZGate( qr[6] ))
circuit.append(Gates.RZGate(p_b289d6)( qr[4] ))
circuit.append(Gates.CRXGate(p_224ae5)( qr[0], qr[3] ))

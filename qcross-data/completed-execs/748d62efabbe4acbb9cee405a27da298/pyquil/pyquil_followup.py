...
defns = get_custom_get_definitions("SdgGate", "TGate", "CSXGate", "CRXGate", "XGate", "CCXGate", "SXdgGate", "RZGate", "SGate", "ZGate", "CHGate", "RYYGate", "iSwapGate")
...
qr_b88ac6 = circuit.declare("qr_b88ac6", "BIT", 10)

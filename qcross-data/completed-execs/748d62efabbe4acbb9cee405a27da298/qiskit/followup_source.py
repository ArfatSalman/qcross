...
qr_b88ac6 = QuantumRegister(10, name='qr_b88ac6')
qc.add_register(qr_b88ac6)
# SECTION
# NAME: MEASUREMENT
...
backend_f0450be47e684f7eb2c18202251f8c5c = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_f0450be47e684f7eb2c18202251f8c5c, shots=489).result().get_counts(qc)
RESULT = counts

...
defns = get_custom_get_definitions("SdgGate", "RCCXGate", "C3SXGate", "CSXGate", "CRXGate", "XGate", "CU1Gate", "RZGate", "ECRGate", "SGate", "YGate", "ZGate", "CHGate")
...
subcircuit.inst(Gates.RCCXGate( 3, 6, 0 ))
subcircuit.inst(Gates.ZGate( 5 ))

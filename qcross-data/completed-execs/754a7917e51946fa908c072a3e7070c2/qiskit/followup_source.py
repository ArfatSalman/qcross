...
qr_94b63d = QuantumRegister(4, name='qr_94b63d')
qc.add_register(qr_94b63d)
# SECTION
# NAME: MEASUREMENT
...
backend_b93fda733545427d9fb28d7aa983df03 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_b93fda733545427d9fb28d7aa983df03, shots=979).result().get_counts(qc)
RESULT = counts

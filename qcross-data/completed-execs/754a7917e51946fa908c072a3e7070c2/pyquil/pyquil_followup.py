...
defns = get_custom_get_definitions("TGate", "SGate", "ZGate", "CHGate", "RYYGate", "CRZGate", "SXdgGate", "XGate", "RZGate", "CSXGate", "ECRGate", "CRXGate")
...
qr_94b63d = circuit.declare("qr_94b63d", "BIT", 4)

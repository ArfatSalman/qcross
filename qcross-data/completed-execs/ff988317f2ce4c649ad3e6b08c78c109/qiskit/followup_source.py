...
backend_918a7cc9b5d64049950bdaa60ac1bb15 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_918a7cc9b5d64049950bdaa60ac1bb15, shots=5542).result().get_counts(qc)
RESULT = counts

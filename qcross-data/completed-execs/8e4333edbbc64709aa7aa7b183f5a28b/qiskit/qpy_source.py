...
backend_367dae096e0c44ec9acac2b30606a907 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_367dae096e0c44ec9acac2b30606a907, shots=489).result().get_counts(qc)
RESULT = counts

...
defns = get_custom_get_definitions("U1Gate", "RXGate", "XGate", "RZGate", "CUGate", "RZZGate", "PhaseGate", "CRYGate", "CU1Gate", "iSwapGate", "CHGate", "TdgGate", "CSXGate")
...
subcircuit = Program()
subcircuit.inst(Gates.PhaseGate(1.6723037552953224, 1 ))
...
qr_b9c73c = circuit.declare("qr_b9c73c", "BIT", 7)

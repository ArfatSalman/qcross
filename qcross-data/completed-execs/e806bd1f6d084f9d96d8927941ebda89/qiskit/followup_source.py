...
subcircuit.append(PhaseGate(1.6723037552953224), qargs=[qr[1]], cargs=[])
...
qr_b9c73c = QuantumRegister(7, name='qr_b9c73c')
subcircuit.add_register(qr_b9c73c)
# SECTION
# NAME: MEASUREMENT
...
backend_6414635ecce14ae398d5bfdc07a373e5 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_6414635ecce14ae398d5bfdc07a373e5, shots=692).result().get_counts(qc)
RESULT = counts

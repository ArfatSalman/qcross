...
subcircuit.append(TdgGate(), qargs=[qr[5]], cargs=[])
...
qr_fb42de = QuantumRegister(3, name='qr_fb42de')
qc.add_register(qr_fb42de)
# SECTION
# NAME: MEASUREMENT
...
backend_642364bbd9374ca6bc508c5a627aaade = Aer.get_backend('aer_simulator')
counts = execute(qc, backend=backend_642364bbd9374ca6bc508c5a627aaade, shots=3919).result().get_counts(qc)
RESULT = counts

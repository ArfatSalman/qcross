...
defns = get_custom_get_definitions("CXGate", "TdgGate", "SdgGate", "SXGate", "CUGate", "SGate", "ZGate", "RZGate", "XGate", "CU1Gate", "CSXGate", "C3SXGate")
...
subcircuit = Program()
subcircuit.inst(Gates.TdgGate( 5 ))
...
qr_fb42de = circuit.declare("qr_fb42de", "BIT", 3)

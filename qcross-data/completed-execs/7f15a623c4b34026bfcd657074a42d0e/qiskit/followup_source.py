...
backend_fa0893ca5b64494a8cd90686b72830ad = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_fa0893ca5b64494a8cd90686b72830ad, shots=489).result().get_counts(qc)
RESULT = counts

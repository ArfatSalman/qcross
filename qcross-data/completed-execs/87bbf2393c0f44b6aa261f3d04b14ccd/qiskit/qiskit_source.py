...
backend_fe5b80cdca6f4153abf919e4d7b0e00a = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_fe5b80cdca6f4153abf919e4d7b0e00a, shots=5542).result().get_counts(qc)
RESULT = counts
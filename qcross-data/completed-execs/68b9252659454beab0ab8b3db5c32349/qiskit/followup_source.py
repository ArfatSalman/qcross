...
qc.append(RZGate(p_2184fc), qargs=[qr[4]], cargs=[])
...
backend_87f66f36b35945f6be92f88c8daa5044 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_87f66f36b35945f6be92f88c8daa5044, shots=2771).result().get_counts(qc)
RESULT = counts

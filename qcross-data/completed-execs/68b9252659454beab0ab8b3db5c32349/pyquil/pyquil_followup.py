...
p_2184fc = circuit.declare('p_2184fc', 'REAL')

defns = get_custom_get_definitions("C3SXGate", "SXGate", "CRXGate", "XGate", "CU1Gate", "CSXGate", "RZGate", "ZGate", "RYYGate", "CRZGate", "RZZGate")

circuit += defns

circuit.inst(Gates.RZGate(p_2184fc, 4 ))

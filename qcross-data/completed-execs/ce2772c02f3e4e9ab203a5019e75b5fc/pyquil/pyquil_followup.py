...
defns = get_custom_get_definitions("CRZGate", "U3Gate", "CRXGate", "RZGate", "TGate", "ZGate", "CCXGate")
...
subcircuit = Program()
subcircuit.inst(Gates.U3Gate(5.007412428963378, 4.658325508156331, 3.8184561666262637)( 8 ))
subcircuit.inst(Gates.CRXGate(4.736752714049485, 7, 9 ))

...
backend_11944495b3b542249b25e3aeea4eea9e = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_11944495b3b542249b25e3aeea4eea9e, shots=489).result().get_counts(qc)
RESULT = counts

...
circuit.append(Gates.CRZGate(4.2641612072511235)( qr[6], qr[7] ))
circuit.append(Gates.CRXGate(5.987304452123941)( qr[0], qr[5] ))
circuit.append(Gates.CCXGate( qr[3], qr[9], qr[5] ))
...
circuit.append(Gates.CCXGate( qr[8], qr[9], qr[3] ))
circuit.append(Gates.C3SXGate( qr[1], qr[8], qr[4], qr[9] ))

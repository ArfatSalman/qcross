...
circuit.append(Gates.CCXGate( qr[9], qr[3], qr[8] ))
circuit.append(Gates.ZGate( qr[2] ))
circuit.append(Gates.XGate( qr[8] ))
circuit.append(Gates.RCCXGate( qr[0], qr[6], qr[10] ))
...
circuit.append(Gates.CU1Gate(4.028174522740928)( qr[3], qr[4] ))
...
circuit.append(Gates.RZZGate(3.950837470808744)( qr[1], qr[4] ))
circuit.append(Gates.TGate( qr[4] ))
circuit.append(Gates.TGate( qr[5] ))
circuit.append(Gates.SXdgGate( qr[9] ))
circuit.append(Gates.RZGate(4.722103101046168)( qr[2] ))
circuit.append(Gates.CRZGate(0.6393443962862078)( qr[9], qr[7] ))
circuit.append(Gates.CU1Gate(2.5476776328466872)( qr[7], qr[10] ))

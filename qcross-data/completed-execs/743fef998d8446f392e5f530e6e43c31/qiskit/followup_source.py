...
qc.append(CCXGate(), qargs=[qr[9], qr[3], qr[8]], cargs=[])
qc.append(ZGate(), qargs=[qr[2]], cargs=[])
qc.append(XGate(), qargs=[qr[8]], cargs=[])
qc.append(RCCXGate(), qargs=[qr[0], qr[6], qr[10]], cargs=[])
...
qc.append(CU1Gate(4.028174522740928), qargs=[qr[3], qr[4]], cargs=[])
...
qc.append(RZZGate(3.950837470808744), qargs=[qr[1], qr[4]], cargs=[])
qc.append(TGate(), qargs=[qr[4]], cargs=[])
qc.append(TGate(), qargs=[qr[5]], cargs=[])
qc.append(SXdgGate(), qargs=[qr[9]], cargs=[])
qc.append(RZGate(4.722103101046168), qargs=[qr[2]], cargs=[])
qc.append(CRZGate(0.6393443962862078), qargs=[qr[9], qr[7]], cargs=[])
qc.append(CU1Gate(2.5476776328466872), qargs=[qr[7], qr[10]], cargs=[])
...
backend_451d90a1e5f342c9b0d1ae66056aa993 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_451d90a1e5f342c9b0d1ae66056aa993, shots=7838).result().get_counts(qc)
RESULT = counts

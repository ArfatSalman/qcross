...
backend_1fdeda92e8e540f08733cac5853fd6ae = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_1fdeda92e8e540f08733cac5853fd6ae, shots=346).result().get_counts(qc)
RESULT = counts
...
backend_b1f43a39365f4d29a014935352054e39 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_b1f43a39365f4d29a014935352054e39, shots=346).result().get_counts(qc)
RESULT = counts
...
backend_a0dc14a000a0480892e1c00da3f32766 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_a0dc14a000a0480892e1c00da3f32766, shots=489).result().get_counts(qc)
RESULT = counts
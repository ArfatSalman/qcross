...
qr_c8e66a = QuantumRegister(2, name='qr_c8e66a')
qc.add_register(qr_c8e66a)
# SECTION
# NAME: MEASUREMENT
...
backend_b970f912540347a097e17d045d2ed8c6 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_b970f912540347a097e17d045d2ed8c6, shots=1959).result().get_counts(qc)
RESULT = counts

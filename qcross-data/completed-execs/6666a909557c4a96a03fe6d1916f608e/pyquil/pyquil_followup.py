...
defns = get_custom_get_definitions("ECRGate", "CHGate", "CSXGate", "RZZGate", "RYYGate", "SGate", "CRXGate", "C3SXGate", "XGate", "U2Gate", "TGate", "CU1Gate", "SdgGate", "ZGate", "CRZGate", "RZGate", "RCCXGate")
...
qr_c8e66a = circuit.declare("qr_c8e66a", "BIT", 2)

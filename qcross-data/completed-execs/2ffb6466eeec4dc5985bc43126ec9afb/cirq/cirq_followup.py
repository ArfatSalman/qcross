...
circuit.append(Gates.C3SXGate( qr[4], qr[0], qr[2], qr[5] ))
circuit.append(Gates.CU1Gate(3.2142159669963557)( qr[1], qr[4] ))
circuit.append(Gates.CRXGate(5.94477504571567)( qr[1], qr[6] ))
...
circuit.append(Gates.CRZGate(4.833923139882297)( qr[4], qr[6] ))
circuit.append(Gates.CU1Gate(4.028174522740928)( qr[2], qr[1] ))
circuit.append(Gates.C3SXGate( qr[0], qr[4], qr[3], qr[1] ))
circuit.append(Gates.CRZGate(2.586208953975239)( qr[6], qr[0] ))
...
circuit.append(Gates.RZZGate(3.950837470808744)( qr[5], qr[1] ))

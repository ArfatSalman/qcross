...
defns = get_custom_get_definitions("CHGate", "ZGate", "RZGate", "ECRGate", "C3SXGate", "CRXGate", "XGate")
...
circuit.inst(Gates.C3SXGate( 5, 6, 3, 0 ))
circuit.inst(Gates.CHGate( 1, 5 ))
circuit.inst(Gates.C3SXGate( 6, 0, 3, 2 ))

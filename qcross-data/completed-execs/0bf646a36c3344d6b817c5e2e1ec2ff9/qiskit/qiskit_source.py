...
backend_401daed104044560ae8fa2c1795b5a8c = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_401daed104044560ae8fa2c1795b5a8c, shots=1959).result().get_counts(qc)
RESULT = counts
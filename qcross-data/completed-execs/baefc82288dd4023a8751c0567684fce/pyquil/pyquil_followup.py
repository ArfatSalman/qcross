...
defns = get_custom_get_definitions("CCXGate", "ECRGate", "CRZGate", "CSXGate", "U2Gate", "ZGate", "SXGate", "XGate", "RZGate", "CHGate", "UGate", "SXdgGate", "TGate", "CRXGate", "C3SXGate")
...
qr_6cf934 = circuit.declare("qr_6cf934", "BIT", 10)

...
qc = transpile(qc, basis_gates=None, optimization_level=2, coupling_map=[[0,
    1], [0, 8], [1, 0], [2, 5], [2, 8], [3, 7], [4, 7], [5, 2], [5, 9], [6,
    8], [7, 3], [7, 4], [7, 8], [8, 0], [8, 2], [8, 6], [8, 7], [9, 5]])
# SECTION
# NAME: EXECUTION

from qiskit import Aer, transpile, execute
backend_a5e1fa52181c4200864bafdf31fb52b4 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_a5e1fa52181c4200864bafdf31fb52b4, shots=2771).result().get_counts(qc)
RESULT = counts

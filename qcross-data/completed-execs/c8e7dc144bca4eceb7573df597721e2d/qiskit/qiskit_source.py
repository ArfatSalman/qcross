...
qc.append(UGate(3.4183332103477166,1.1450785027645094,1.308491043619365), qargs=[qr[6]], cargs=[])
...
backend_4e3742fd62d84a3092996b82516c0d38 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_4e3742fd62d84a3092996b82516c0d38, shots=7838).result().get_counts(qc)
RESULT = counts
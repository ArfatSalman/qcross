...
backend_6523a9e09d1c453389895662e99fb982 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_6523a9e09d1c453389895662e99fb982, shots=7838).result().get_counts(qc)
RESULT = counts

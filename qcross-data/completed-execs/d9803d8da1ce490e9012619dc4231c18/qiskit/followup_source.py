...
backend_934109a3ed6e41cb93b8c7e93e01740f = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_934109a3ed6e41cb93b8c7e93e01740f, shots=489).result().get_counts(qc)
RESULT = counts

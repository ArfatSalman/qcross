...
p_6dfb4c = Symbol('p_6dfb4c')
p_04b4f9 = Symbol('p_04b4f9')
p_8c0743 = Symbol('p_8c0743')
p_d5d1b2 = Symbol('p_d5d1b2')
p_9a86da = Symbol('p_9a86da')

circuit = cirq.Circuit()

circuit.append(Gates.RZGate(p_8c0743)( qr[3] ))
circuit.append(Gates.SXdgGate( qr[2] ))
circuit.append(Gates.CSXGate( qr[1], qr[0] ))
circuit.append(Gates.ECRGate( qr[3], qr[2] ))
circuit.append(Gates.CRXGate(p_6dfb4c)( qr[4], qr[3] ))
circuit.append(Gates.SGate( qr[0] ))
circuit.append(Gates.CRZGate(p_9a86da)( qr[3], qr[4] ))
...
circuit.append(Gates.CUGate(p_d5d1b2, p_04b4f9, 4.623446645668956, 3.865496458458116)( qr[1], qr[4] ))
...
circuit.append(Gates.UGate(5.887184334931191, p_96fafa, 1.4112277317699358)( qr[4] ))

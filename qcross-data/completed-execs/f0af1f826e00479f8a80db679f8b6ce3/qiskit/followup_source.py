...
qr_cb59ff = QuantumRegister(7, name='qr_cb59ff')
qc.add_register(qr_cb59ff)
# SECTION
# NAME: MEASUREMENT
...
backend_c5ea445c050b4d5280da2e42df3f4a43 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_c5ea445c050b4d5280da2e42df3f4a43, shots=5542).result().get_counts(qc)
RESULT = counts

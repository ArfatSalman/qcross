...
qr_88b06c = QuantumRegister(4, name='qr_88b06c')
qc.add_register(qr_88b06c)
# SECTION
# NAME: MEASUREMENT
...
backend_71f6a6ba0166474582079adf3a27bd15 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_71f6a6ba0166474582079adf3a27bd15, shots=2771).result().get_counts(qc)
RESULT = counts

...
defns = get_custom_get_definitions("SXGate", "RYYGate", "RZZGate", "RZGate", "U2Gate", "C3SXGate", "CRXGate", "CSXGate", "CRZGate", "ZGate", "CU1Gate", "CUGate", "XGate")
...
qr_88b06c = circuit.declare("qr_88b06c", "BIT", 4)

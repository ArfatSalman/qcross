...
# SECTION
# NAME: PARAMETERS
p_a23f9e = Parameter('p_a23f9e')
p_ee9728 = Parameter('p_ee9728')
...
qc.append(CUGate(p_a23f9e, 5.897054719225356, 2.3864521352475245, 
...
qc.append(U2Gate(p_ee9728, 2.1276323672732023), qargs=[qr[2]], cargs=[])
...
backend_00fab727c8e640e695d5eb30e5b34013 = Aer.get_backend('aer_simulator')
counts = execute(qc, backend=backend_00fab727c8e640e695d5eb30e5b34013, shots=3919).result().get_counts(qc)
RESULT = counts

...
p_a23f9e = circuit.declare('p_a23f9e', 'REAL')
p_ee9728 = circuit.declare('p_ee9728', 'REAL')

defns = get_custom_get_definitions("CRZGate", "U2Gate", "C3SXGate", "RCCXGate", "CU1Gate", "CUGate", "SGate", "RZGate", "TGate", "XGate", "CSXGate", "ZGate", "SdgGate", "SXGate", "CHGate", "CCXGate")

circuit += defns

circuit.inst(Gates.RZGate(6.163759533339787, 8 ))
circuit.inst(Gates.CSXGate( 2, 4 ))
circuit.inst(Gates.CUGate(p_a23f9e, 5.897054719225356, 2.3864521352475245, 5.987304452123941, 0, 6 ))
...
circuit.inst(Gates.U2Gate(p_ee9728, 2.1276323672732023)( 2 ))
...
params = {
    "p_a23f9e": 0.5112149185250571,
    "p_ee9728": 2.5163050709890156
}

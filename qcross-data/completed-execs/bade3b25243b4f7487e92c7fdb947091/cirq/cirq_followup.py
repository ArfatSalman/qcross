...
p_fd7a6b = Symbol('p_fd7a6b')
p_30589b = Symbol('p_30589b')
p_7d81a4 = Symbol('p_7d81a4')

circuit = cirq.Circuit()

circuit.append(Gates.RZGate(p_30589b)( qr[1] ))
...
circuit.append(Gates.CRXGate(p_7d81a4)( qr[0], qr[2] ))
circuit.append(Gates.SGate( qr[2] ))
circuit.append(Gates.CCXGate( qr[1], qr[0], qr[2] ))
circuit.append(Gates.CHGate( qr[2], qr[0] ))
circuit.append(Gates.CHGate( qr[1], qr[2] ))
circuit.append(Gates.RYYGate(p_fd7a6b)( qr[1], qr[0] ))

...
defns = get_custom_get_definitions("RZGate", "RCCXGate", "CRXGate", "CSXGate", "SdgGate", "RYYGate", "CHGate", "SXdgGate", "CCXGate", "ECRGate", "TGate", "SGate", "iSwapGate", "XGate", "ZGate")
...
qr_ba72d1 = circuit.declare("qr_ba72d1", "BIT", 5)

...
qr_ba72d1 = QuantumRegister(5, name='qr_ba72d1')
qc.add_register(qr_ba72d1)
# SECTION
# NAME: MEASUREMENT
...
backend_2e5306c39ddf40b3b814a2e47bd839e7 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_2e5306c39ddf40b3b814a2e47bd839e7, shots=489).result().get_counts(qc)
RESULT = counts

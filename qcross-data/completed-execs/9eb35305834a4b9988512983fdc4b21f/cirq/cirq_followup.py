...
p_a2a414 = Symbol('p_a2a414')
p_560035 = Symbol('p_560035')
p_47c65c = Symbol('p_47c65c')
p_0a6c0e = Symbol('p_0a6c0e')
p_fa3e46 = Symbol('p_fa3e46')
p_26dfb8 = Symbol('p_26dfb8')

circuit = cirq.Circuit()

circuit.append(Gates.RZGate(p_0a6c0e)( qr[8] ))
circuit.append(Gates.CSXGate( qr[2], qr[4] ))
circuit.append(Gates.CUGate(p_a2a414, p_560035, p_26dfb8, p_47c65c)( qr[0], qr[6] ))
...
circuit.append(Gates.CU1Gate(p_fa3e46)( qr[8], qr[3] ))

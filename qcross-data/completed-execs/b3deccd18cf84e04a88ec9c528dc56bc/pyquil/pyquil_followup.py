...
defns = get_custom_get_definitions("SXGate", "CSXGate", "CU1Gate", "ECRGate", "CRZGate", "RZGate", "CHGate", "SXdgGate", "XGate", "TGate", "IGate", "HGate", "CRXGate", "RZZGate", "RYYGate", "iSwapGate")
...
qr_ff09ea = circuit.declare("qr_ff09ea", "BIT", 5)

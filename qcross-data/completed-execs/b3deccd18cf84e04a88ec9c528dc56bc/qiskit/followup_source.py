...
qr_ff09ea = QuantumRegister(5, name='qr_ff09ea')
qc.add_register(qr_ff09ea)
# SECTION
# NAME: MEASUREMENT
...
backend_3f8e0108c2074cf688d7a759f41ffeff = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_3f8e0108c2074cf688d7a759f41ffeff, shots=346).result().get_counts(qc)
RESULT = counts

...
qc = transpile(qc, basis_gates=None, optimization_level=2, coupling_map=[[0,
    1], [1, 0], [1, 4], [1, 6], [1, 8], [2, 7], [3, 4], [4, 1], [4, 3], [4,
    7], [5, 7], [5, 9], [6, 1], [7, 2], [7, 4], [7, 5], [8, 1], [9, 5]])
# SECTION
# NAME: EXECUTION

from qiskit import Aer, transpile, execute
backend_82023350dcbe44d5b7b9ffc5a05e1514 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_82023350dcbe44d5b7b9ffc5a05e1514, shots=2771).result().get_counts(qc)
RESULT = counts

...
backend_e42a58bf87aa4ed59d422c68387de2d9 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_e42a58bf87aa4ed59d422c68387de2d9, shots=979).result().get_counts(qc)
RESULT = counts
...
defns = get_custom_get_definitions("CCXGate", "ZGate", "RZGate", "SXGate", "TGate", "CRZGate", "CSXGate", "XGate", "CRXGate")

circuit += defns

circuit.inst(Gates.RZGate(6.163759533339787, 8 ))
circuit.inst(Gates.CRZGate(4.2641612072511235, 5, 8 ))
circuit.inst(Gates.CRXGate(5.987304452123941, 4, 1 ))
circuit.inst(Gates.CCXGate( 7, 6, 1 ))
circuit.inst(Gates.ZGate( 0 ))
circuit.inst(Gates.TGate( 6 ))
circuit.inst(Gates.XGate( 9 ))
circuit.inst(Gates.CRZGate(4.167661441102218, 4, 5 ))
circuit.inst(Gates.RZGate(4.229610589867865, 4 ))
circuit.inst(Gates.SXGate( 0 ))
circuit.inst(Gates.CSXGate( 3, 9 ))

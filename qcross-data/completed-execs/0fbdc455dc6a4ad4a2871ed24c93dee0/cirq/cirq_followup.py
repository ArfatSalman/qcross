...
p_5d06b8 = Symbol('p_5d06b8')
p_97a6da = Symbol('p_97a6da')
p_9bb2df = Symbol('p_9bb2df')
p_1f1cd8 = Symbol('p_1f1cd8')
p_38c5ce = Symbol('p_38c5ce')

circuit = cirq.Circuit()

circuit.append(Gates.RZGate(6.163759533339787)( qr[7] ))
circuit.append(Gates.CRZGate(4.2641612072511235)( qr[8], qr[7] ))
circuit.append(Gates.CRXGate(5.987304452123941)( qr[6], qr[4] ))
circuit.append(Gates.CCXGate( qr[3], qr[1], qr[4] ))
circuit.append(Gates.ZGate( qr[5] ))
circuit.append(Gates.TGate( qr[1] ))
circuit.append(Gates.XGate( qr[2] ))
circuit.append(Gates.CRZGate(4.167661441102218)( qr[6], qr[8] ))
circuit.append(Gates.RZGate(p_9bb2df)( qr[6] ))
circuit.append(Gates.SXGate( qr[5] ))
circuit.append(Gates.CSXGate( qr[0], qr[2] ))
circuit.append(Gates.CCXGate( qr[0], qr[1], qr[3] ))
circuit.append(Gates.C3SXGate( qr[5], qr[0], qr[9], qr[1] ))
circuit.append(Gates.CSXGate( qr[9], qr[5] ))
circuit.append(Gates.ZGate( qr[9] ))
circuit.append(Gates.CHGate( qr[4], qr[6] ))
circuit.append(Gates.CSXGate( qr[5], qr[9] ))
circuit.append(Gates.CRZGate(p_5d06b8)( qr[6], qr[5] ))
...
circuit.append(Gates.RZGate(5.014941143947427)( qr[6] ))
circuit.append(Gates.CRXGate(5.970852306777193)( qr[4], qr[6] ))
circuit.append(Gates.UGate(p_38c5ce, p_1f1cd8, p_97a6da)( qr[5] ))
circuit.append(cirq.measure(qr[9], key='cr0'))

...
qr_ab2d33 = QuantumRegister(8, name='qr_ab2d33')
qc.add_register(qr_ab2d33)
# SECTION
# NAME: MEASUREMENT
...
backend_4fa4919a17fa4859bb8230d40d9c6b09 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_4fa4919a17fa4859bb8230d40d9c6b09, shots=979).result().get_counts(qc)
RESULT = counts

...
backend_b49976f5c85142f48cff79dda0429732 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_b49976f5c85142f48cff79dda0429732, shots=346).result().get_counts(qc)
RESULT = counts
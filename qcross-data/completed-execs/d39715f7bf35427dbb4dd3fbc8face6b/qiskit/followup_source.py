...
backend_47b88b241aba4eeca25d9bbc46b24f01 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_47b88b241aba4eeca25d9bbc46b24f01, shots=1959).result().get_counts(qc)
RESULT = counts

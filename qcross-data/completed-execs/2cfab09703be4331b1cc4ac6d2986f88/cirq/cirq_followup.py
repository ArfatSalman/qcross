...
circuit.append(Gates.CRXGate(5.970852306777193)( qr[0], qr[6] ))
circuit.append(Gates.UGate(5.080799300534071, 5.023617931957853, 2.271164628944128)( qr[1] ))
circuit.append(Gates.ECRGate( qr[8], qr[5] ))

...
qr_9b2f87 = QuantumRegister(6, name='qr_9b2f87')
qc.add_register(qr_9b2f87)
# SECTION
# NAME: MEASUREMENT
...
backend_277c7a729c5c4dea804141006933685a = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_277c7a729c5c4dea804141006933685a, shots=489).result().get_counts(qc)
RESULT = counts

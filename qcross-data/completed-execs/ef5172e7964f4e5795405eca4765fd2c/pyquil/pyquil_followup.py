...
defns = get_custom_get_definitions("CHGate", "SGate", "CCXGate", "SXdgGate", "XGate", "iSwapGate", "RZGate", "CRXGate", "CSXGate", "RYYGate", "SdgGate")
...
qr_9b2f87 = circuit.declare("qr_9b2f87", "BIT", 6)

...
qr_2e30ba = QuantumRegister(10, name='qr_2e30ba')
qc.add_register(qr_2e30ba)
# SECTION
# NAME: MEASUREMENT
...
backend_9bccc3749b38455da4d6c4b2a838abd0 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_9bccc3749b38455da4d6c4b2a838abd0, shots=7838).result().get_counts(qc)
RESULT = counts

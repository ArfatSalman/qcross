...
backend_fed995f1ddba4113948d1ae9be2e570a = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_fed995f1ddba4113948d1ae9be2e570a, shots=692).result().get_counts(qc)
RESULT = counts

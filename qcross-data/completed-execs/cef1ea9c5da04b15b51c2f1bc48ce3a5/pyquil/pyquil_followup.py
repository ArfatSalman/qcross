...
defns = get_custom_get_definitions("RZGate", "ZGate", "C3SXGate", "RCCXGate", "RZZGate", "CUGate", "CU1Gate", "CRZGate", "UGate", "CCXGate", "SGate", "TGate")
...
circuit.inst(Gates.C3SXGate( 4, 1, 5, 2 ))
...
circuit.inst(Gates.C3SXGate( 5, 2, 4, 3 ))

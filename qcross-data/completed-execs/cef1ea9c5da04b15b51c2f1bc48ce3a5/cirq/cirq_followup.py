...
circuit.append(Gates.C3SXGate( qr[4], qr[1], qr[5], qr[2] ))
...
circuit.append(Gates.CRZGate(4.167661441102218)( qr[4], qr[0] ))
circuit.append(Gates.RZGate(4.229610589867865)( qr[4] ))
circuit.append(Gates.C3SXGate( qr[5], qr[2], qr[4], qr[3] ))

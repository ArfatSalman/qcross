...
qc.append(C3SXGate(), qargs=[qr[4], qr[1], qr[5], qr[2]], cargs=[])
...
qc.append(CRZGate(4.167661441102218), qargs=[qr[4], qr[0]], cargs=[])
qc.append(RZGate(4.229610589867865), qargs=[qr[4]], cargs=[])
qc.append(C3SXGate(), qargs=[qr[5], qr[2], qr[4], qr[3]], cargs=[])
...
backend_d4d9a67afe9a43dc809a913c20ef5837 = Aer.get_backend('aer_simulator_statevector')
counts = execute(qc, backend=backend_d4d9a67afe9a43dc809a913c20ef5837, shots=1385).result().get_counts(qc)
RESULT = counts

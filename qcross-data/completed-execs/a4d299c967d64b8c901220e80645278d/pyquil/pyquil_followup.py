...
p_89b747 = circuit.declare('p_89b747', 'REAL')

defns = get_custom_get_definitions("CCXGate", "RCCXGate", "RZGate", "TGate", "CUGate", "ZGate", "C3SXGate", "CRZGate")
...
circuit.inst(Gates.CUGate(0.5112149185250571, 5.897054719225356, p_89b747, 5.987304452123941, 2, 3 ))

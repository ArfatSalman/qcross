...
p_340c8c = Symbol('p_340c8c')
p_a4a463 = Symbol('p_a4a463')
p_011c31 = Symbol('p_011c31')
p_cb453e = Symbol('p_cb453e')

circuit = cirq.Circuit()

circuit.append(Gates.RZGate(p_a4a463)( qr[3] ))
...
circuit.append(Gates.CRZGate(p_340c8c)( qr[1], qr[2] ))
circuit.append(Gates.U2Gate(p_011c31, 2.1276323672732023)( qr[2] ))
...
circuit.append(Gates.CRXGate(p_cb453e)( qr[7], qr[1] ))

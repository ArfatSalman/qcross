...
defns = get_custom_get_definitions("C3SXGate", "CUGate", "DCXGate", "CRXGate", "XGate", "CU3Gate", "SXGate", "RZGate", "ECRGate", "ZGate", "U2Gate", "RYYGate", "CRZGate")
...
qr_757101 = circuit.declare("qr_757101", "BIT", 4)

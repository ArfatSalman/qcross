...
qr_757101 = QuantumRegister(4, name='qr_757101')
qc.add_register(qr_757101)
# SECTION
# NAME: MEASUREMENT
...
backend_90525330818f4eefbb43ddd9b4ed86bc = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_90525330818f4eefbb43ddd9b4ed86bc, shots=2771).result().get_counts(qc)
RESULT = counts

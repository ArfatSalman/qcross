...
defns = get_custom_get_definitions("RYYGate", "ZGate", "CHGate", "XGate", "CSXGate", "CUGate", "RZGate", "SGate", "CRXGate", "CRZGate", "CU1Gate", "SXdgGate", "UGate", "TGate", "ECRGate")
...
circuit.inst(Gates.CUGate(5.708725119517347, 4.167661441102218, 4.623446645668956, 3.865496458458116, 4, 2 ))
circuit.inst(Gates.RZGate(4.229610589867865, 4 ))
circuit.inst(Gates.RYYGate(5.398622178940033)( 1, 0 ))
circuit.inst(Gates.CU1Gate(3.2142159669963557, 3, 1 ))

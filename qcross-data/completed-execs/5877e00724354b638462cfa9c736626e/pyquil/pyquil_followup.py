...
defns = get_custom_get_definitions("SXdgGate", "ECRGate", "CSXGate", "CHGate", "iSwapGate", "SGate", "CRXGate", "XGate", "ZGate", "TGate", "UGate", "SdgGate", "RZGate", "CRZGate", "CCXGate", "RYYGate", "RCCXGate")
...
qr_cf3609 = circuit.declare("qr_cf3609", "BIT", 5)

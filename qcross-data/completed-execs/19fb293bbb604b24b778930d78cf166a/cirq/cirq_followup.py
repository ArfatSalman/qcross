...
subcircuit.append(Gates.U2Gate(6.2047416485134805, 2.0463536199036456)( qr[0] ))
subcircuit.append(Gates.CRXGate(4.63837786161633)( qr[3], qr[2] ))
subcircuit.append(Gates.SGate( qr[1] ))
subcircuit.append(Gates.CXGate( qr[0], qr[3] ))
subcircuit.append(Gates.RXXGate(3.855749700561927)( qr[1], qr[3] ))
subcircuit.append(Gates.CHGate( qr[2], qr[0] ))

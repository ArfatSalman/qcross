...
defns = get_custom_get_definitions("CRZGate", "TGate", "RXXGate", "RZGate", "RCCXGate", "C3SXGate", "SXdgGate", "iSwapGate", "CHGate", "CXGate", "U2Gate", "XGate", "CU1Gate", "RYYGate", "SGate", "CSXGate", "CUGate", "RZZGate", "CRXGate")
...
subcircuit = Program()
subcircuit.inst(Gates.U2Gate(6.2047416485134805, 2.0463536199036456)( 0 ))
subcircuit.inst(Gates.CRXGate(4.63837786161633, 3, 2 ))
...
qr_db9ff5 = circuit.declare("qr_db9ff5", "BIT", 1)

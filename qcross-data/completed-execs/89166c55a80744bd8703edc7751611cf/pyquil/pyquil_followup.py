...
defns = get_custom_get_definitions("SXdgGate", "XGate", "RZGate", "ZGate", "RCCXGate", "CSXGate", "CHGate", "RZZGate", "SdgGate", "TGate", "CCXGate", "CU1Gate", "CRZGate", "U2Gate")

circuit += defns

circuit.inst(Gates.RZGate(6.163759533339787, 8 ))
circuit.inst(Gates.CRZGate(4.2641612072511235, 7, 2 ))
circuit.inst(Gates.ZGate( 1 ))
circuit.inst(Gates.CCXGate( 4, 9, 10 ))
circuit.inst(Gates.ZGate( 2 ))
circuit.inst(Gates.XGate( 10 ))
circuit.inst(Gates.RCCXGate( 6, 7, 0 ))
circuit.inst(Gates.RZGate(4.229610589867865, 3 ))
circuit.inst(Gates.CCXGate( 10, 6, 2 ))
circuit.inst(Gates.SdgGate( 10 ))
circuit.inst(Gates.U2Gate(4.214504315296764, 4.6235667602042065)( 6 ))
circuit.inst(Gates.CSXGate( 8, 2 ))
circuit.inst(Gates.CHGate( 3, 10 ))
circuit.inst(Gates.CU1Gate(4.028174522740928, 9, 3 ))
circuit.inst(Gates.RZGate(5.0063780207098425, 7 ))
circuit.inst(Gates.U2Gate(2.5163050709890156, 2.1276323672732023)( 2 ))
circuit.inst(Gates.TGate( 3 ))
circuit.inst(Gates.RZZGate(3.950837470808744)( 5, 3 ))
circuit.inst(Gates.TGate( 3 ))
...
circuit += MEASURE(10, qr[7])
circuit += MEASURE(0, qr[8])
circuit += MEASURE(9, qr[9])
circuit += MEASURE(6, qr[10])

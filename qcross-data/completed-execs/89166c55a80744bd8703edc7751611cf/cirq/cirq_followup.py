...
circuit.append(Gates.CRZGate(4.2641612072511235)( qr[7], qr[2] ))
circuit.append(Gates.ZGate( qr[1] ))
circuit.append(Gates.CCXGate( qr[4], qr[9], qr[10] ))
circuit.append(Gates.ZGate( qr[2] ))
circuit.append(Gates.XGate( qr[10] ))
circuit.append(Gates.RCCXGate( qr[6], qr[7], qr[0] ))
circuit.append(Gates.RZGate(4.229610589867865)( qr[3] ))
circuit.append(Gates.CCXGate( qr[10], qr[6], qr[2] ))
circuit.append(Gates.SdgGate( qr[10] ))
circuit.append(Gates.U2Gate(4.214504315296764, 4.6235667602042065)( qr[6] ))
circuit.append(Gates.CSXGate( qr[8], qr[2] ))
circuit.append(Gates.CHGate( qr[3], qr[10] ))
circuit.append(Gates.CU1Gate(4.028174522740928)( qr[9], qr[3] ))
circuit.append(Gates.RZGate(5.0063780207098425)( qr[7] ))
circuit.append(Gates.U2Gate(2.5163050709890156, 2.1276323672732023)( qr[2] ))
circuit.append(Gates.TGate( qr[3] ))
circuit.append(Gates.RZZGate(3.950837470808744)( qr[5], qr[3] ))
circuit.append(Gates.TGate( qr[3] ))
...
circuit.append(cirq.measure(qr[10], key='cr7'))
circuit.append(cirq.measure(qr[0], key='cr8'))
circuit.append(cirq.measure(qr[9], key='cr9'))
circuit.append(cirq.measure(qr[6], key='cr10'))

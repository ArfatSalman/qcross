...
backend_d064700a76ea4578bbb797f5bd43f2ab = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_d064700a76ea4578bbb797f5bd43f2ab, shots=346).result().get_counts(qc)
RESULT = counts

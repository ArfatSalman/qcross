...
subcircuit.append(Gates.RZZGate(5.2545763615896)( qr[5], qr[0] ))
subcircuit.append(Gates.DCXGate( qr[7], qr[8] ))
subcircuit.append(Gates.CPhaseGate(1.672427069032094)( qr[10], qr[3] ))

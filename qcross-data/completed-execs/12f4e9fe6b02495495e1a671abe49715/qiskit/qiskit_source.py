...
backend_cb3133037ff74bf4b7fe84074876f69c = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_cb3133037ff74bf4b7fe84074876f69c, shots=7838).result().get_counts(qc)
RESULT = counts
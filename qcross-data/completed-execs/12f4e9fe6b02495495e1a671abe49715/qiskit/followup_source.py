...
qr_67c9ba = QuantumRegister(10, name='qr_67c9ba')
qc.add_register(qr_67c9ba)
# SECTION
# NAME: MEASUREMENT
...
backend_cb3133037ff74bf4b7fe84074876f69c = Aer.get_backend(
    'aer_simulator_statevector')
counts = execute(qc, backend=backend_cb3133037ff74bf4b7fe84074876f69c,

...
p_336c93 = Symbol('p_336c93')
p_444d74 = Symbol('p_444d74')
p_1d52fe = Symbol('p_1d52fe')

circuit = cirq.Circuit()

circuit.append(Gates.RZGate(6.163759533339787)( qr[8] ))
circuit.append(Gates.CSXGate( qr[2], qr[4] ))
circuit.append(Gates.CUGate(p_336c93, p_1d52fe, 2.3864521352475245, 5.987304452123941)( qr[0], qr[6] ))
...
circuit.append(Gates.U2Gate(p_444d74, 2.1276323672732023)( qr[2] ))

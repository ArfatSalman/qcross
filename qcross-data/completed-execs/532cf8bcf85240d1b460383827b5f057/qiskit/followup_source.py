...
qr_6fdabf = QuantumRegister(9, name='qr_6fdabf')
qc.add_register(qr_6fdabf)
# SECTION
# NAME: MEASUREMENT
...
backend_d92f881d61464e9cb356855937910376 = Aer.get_backend(
    'statevector_simulator')
counts = execute(qc, backend=backend_d92f881d61464e9cb356855937910376,

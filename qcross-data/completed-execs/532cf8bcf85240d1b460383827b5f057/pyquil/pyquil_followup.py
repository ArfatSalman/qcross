...
defns = get_custom_get_definitions("CRZGate", "CSXGate", "TGate", "U2Gate", "ZGate", "XGate", "RZGate", "SdgGate", "RZZGate", "RCCXGate", "CU1Gate", "ECRGate", "CHGate", "CRXGate", "SGate", "C3SXGate")
...
qr_6fdabf = circuit.declare("qr_6fdabf", "BIT", 9)

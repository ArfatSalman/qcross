...
defns = get_custom_get_definitions("ZGate", "XGate", "RZGate", "SdgGate", "RCCXGate", "CU1Gate", "ECRGate", "CHGate", "CRXGate", "SGate", "C3SXGate")
...
qr_1fc186 = circuit.declare("qr_1fc186", "BIT", 2)

...
qr_1fc186 = QuantumRegister(2, name='qr_1fc186')
qc.add_register(qr_1fc186)
# SECTION
# NAME: MEASUREMENT
...
backend_5d5fb6d3e6fe4c82ab2a7db7adf8a9d4 = Aer.get_backend('statevector_simulator')
counts = execute(qc, backend=backend_5d5fb6d3e6fe4c82ab2a7db7adf8a9d4, shots=1959).result().get_counts(qc)
RESULT = counts

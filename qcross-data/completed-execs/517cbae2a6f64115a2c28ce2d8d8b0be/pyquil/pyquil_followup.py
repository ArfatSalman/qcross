...
defns = get_custom_get_definitions("TGate", "iSwapGate", "SXdgGate", "CRZGate", "CHGate", "CCXGate", "RYYGate", "RCCXGate", "CRXGate", "XGate", "SdgGate", "ECRGate", "CSXGate", "RZGate", "ZGate", "SGate")
...
qr_3041cb = circuit.declare("qr_3041cb", "BIT", 4)

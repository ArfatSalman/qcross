...
backend_a26eb2815f2a47f0b19dd36400f19d39 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_a26eb2815f2a47f0b19dd36400f19d39, shots=489).result().get_counts(qc)
RESULT = counts
...
backend_38ec8ed04466445688d90551297a06c2 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_38ec8ed04466445688d90551297a06c2, shots=1959).result().get_counts(qc)
RESULT = counts
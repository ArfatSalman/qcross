...
backend_a2824a9b0e12414fa599a83675f6c27b = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_a2824a9b0e12414fa599a83675f6c27b, shots=2771).result().get_counts(qc)
RESULT = counts
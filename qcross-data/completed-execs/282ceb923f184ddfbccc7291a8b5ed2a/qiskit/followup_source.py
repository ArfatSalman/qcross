...
subcircuit.append(CU3Gate(4.501598818751339, 3.831363380793745, 0.29379897242098046), qargs=[qr[0], qr[2]], cargs=[])
...
qr_08b1f4 = QuantumRegister(3, name='qr_08b1f4')
qc.add_register(qr_08b1f4)
# SECTION
# NAME: MEASUREMENT
...
backend_de1baf0eae334b83b634305ab653f5ba = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_de1baf0eae334b83b634305ab653f5ba, shots=692).result().get_counts(qc)
RESULT = counts

...
qc_1.inst(Gates.RZGate(4.229610589867865, 1 ))
...
defns = get_custom_get_definitions("XGate", "CRZGate", "ZGate", "RCCXGate", "CCXGate")

qc_2 += defns

qc_2.inst(Gates.CRZGate(4.2641612072511235, 2, 0 ))
qc_2.inst(Gates.ZGate( 7 ))
qc_2.inst(Gates.CCXGate( 1, 5, 3 ))
qc_2.inst(Gates.ZGate( 0 ))
qc_2.inst(Gates.XGate( 3 ))
qc_2.inst(Gates.RCCXGate( 6, 2, 4 ))
qc_2.inst(Gates.CCXGate( 3, 6, 0 ))

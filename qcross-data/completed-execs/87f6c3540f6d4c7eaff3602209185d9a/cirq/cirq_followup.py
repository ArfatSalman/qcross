...
qc_1.append(Gates.RZGate(4.229610589867865)( qr_1[1] ))
...
qr_2 = [cirq.NamedQubit('q' + str(i)) for i in range(8)]



qc_2 = cirq.Circuit()

qc_2.append(Gates.CRZGate(4.2641612072511235)( qr_2[2], qr_2[0] ))
qc_2.append(Gates.ZGate( qr_2[7] ))
qc_2.append(Gates.CCXGate( qr_2[1], qr_2[5], qr_2[3] ))
qc_2.append(Gates.ZGate( qr_2[0] ))
qc_2.append(Gates.XGate( qr_2[3] ))
qc_2.append(Gates.RCCXGate( qr_2[6], qr_2[2], qr_2[4] ))
qc_2.append(Gates.CCXGate( qr_2[3], qr_2[6], qr_2[0] ))
...
# result_dict = dict(result.multi_measurement_histogram()
# keys = list(map(lambda arr: reduce(lambda x, y: str(x) + str(y), arr[::-1]), result_dict.keys()))
counts = get_qiskit_like_output(result_2, keys=['cr0', 'cr1', 'cr2', 'cr3', 'cr4', 'cr5', 'cr6', 'cr7'])

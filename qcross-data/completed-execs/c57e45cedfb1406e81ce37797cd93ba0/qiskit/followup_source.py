...
qc = transpile(qc, basis_gates=None, optimization_level=2, coupling_map=[[0,
    1], [1, 0], [1, 4], [1, 6], [2, 4], [3, 4], [4, 1], [4, 2], [4, 3], [4,
    7], [5, 7], [6, 1], [7, 4], [7, 5]])
# SECTION
# NAME: EXECUTION

from qiskit import Aer, transpile, execute
backend_3dbc549eecc14930aa87c3c89820b5d0 = Aer.get_backend('aer_simulator_density_matrix')
counts = execute(qc, backend=backend_3dbc549eecc14930aa87c3c89820b5d0, shots=1385).result().get_counts(qc)
RESULT = counts

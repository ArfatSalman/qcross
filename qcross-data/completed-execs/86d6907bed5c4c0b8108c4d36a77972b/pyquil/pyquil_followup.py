...
defns = get_custom_get_definitions("C3SXGate", "SXGate", "RZGate", "ZGate", "CUGate", "CU1Gate", "SdgGate", "XGate", "CRZGate", "SGate", "CSXGate")
...
qr_ee7d65 = circuit.declare("qr_ee7d65", "BIT", 2)

...
qr_ee7d65 = QuantumRegister(2, name='qr_ee7d65')
qc.add_register(qr_ee7d65)
# SECTION
# NAME: MEASUREMENT
...
backend_588a67acb2a8497794c3ae47f2f12b83 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_588a67acb2a8497794c3ae47f2f12b83, shots=3919).result().get_counts(qc)
RESULT = counts

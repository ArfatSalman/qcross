...
backend_4c3dcfabaaed4294b55b37dfa48c1d53 = Aer.get_backend('statevector_simulator')
counts = execute(qc, backend=backend_4c3dcfabaaed4294b55b37dfa48c1d53, shots=692).result().get_counts(qc)
RESULT = counts

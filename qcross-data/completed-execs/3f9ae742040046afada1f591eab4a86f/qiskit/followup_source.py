...
qr_4c652a = QuantumRegister(6, name='qr_4c652a')
qc.add_register(qr_4c652a)
# SECTION
# NAME: MEASUREMENT
...
backend_15f5f9f4d7c946e39cc59abbb7dbbd99 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_15f5f9f4d7c946e39cc59abbb7dbbd99, shots=1385).result().get_counts(qc)
RESULT = counts

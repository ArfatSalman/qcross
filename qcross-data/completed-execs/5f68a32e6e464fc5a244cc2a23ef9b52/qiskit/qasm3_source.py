...
backend_9fb629b76969417a9b8b21ff6e747280 = Aer.get_backend('aer_simulator_density_matrix')
counts = execute(qc, backend=backend_9fb629b76969417a9b8b21ff6e747280, shots=2771).result().get_counts(qc)
RESULT = counts

...
backend_65193fcde8f9496b995e6a748c96204b = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_65193fcde8f9496b995e6a748c96204b, shots=2771).result().get_counts(qc)
RESULT = counts

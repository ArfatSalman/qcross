...
backend_49c76cd29b3044728e9b87c115f1c78e = Aer.get_backend('aer_simulator_density_matrix')
counts = execute(qc, backend=backend_49c76cd29b3044728e9b87c115f1c78e, shots=489).result().get_counts(qc)
RESULT = counts

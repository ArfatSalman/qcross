...
backend_7554bbe9a8cf48689ad95af1d85c59c3 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_7554bbe9a8cf48689ad95af1d85c59c3, shots=489).result().get_counts(qc)
RESULT = counts
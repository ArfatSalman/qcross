...
backend_87e213ac217346b1b0c0a5adcfc3ade3 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_87e213ac217346b1b0c0a5adcfc3ade3, shots=2771).result().get_counts(qc)
RESULT = counts

...
qr_036be1 = QuantumRegister(1, name='qr_036be1')
qc.add_register(qr_036be1)
# SECTION
# NAME: MEASUREMENT
...
backend_2b6bbb22497f4eee945e0ecd8a79bc42 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_2b6bbb22497f4eee945e0ecd8a79bc42, shots=7838).result().get_counts(qc)
RESULT = counts

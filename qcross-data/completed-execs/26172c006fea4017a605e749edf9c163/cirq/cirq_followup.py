...
p_137b9d = Symbol('p_137b9d')
p_191018 = Symbol('p_191018')
p_d06829 = Symbol('p_d06829')

circuit = cirq.Circuit()

circuit.append(Gates.RZGate(p_191018)( qr[1] ))
...
circuit.append(Gates.CRXGate(p_d06829)( qr[0], qr[2] ))
circuit.append(Gates.SGate( qr[2] ))
circuit.append(Gates.CCXGate( qr[1], qr[0], qr[2] ))
circuit.append(Gates.CHGate( qr[2], qr[0] ))
circuit.append(Gates.CHGate( qr[1], qr[2] ))
circuit.append(Gates.RYYGate(p_137b9d)( qr[1], qr[0] ))

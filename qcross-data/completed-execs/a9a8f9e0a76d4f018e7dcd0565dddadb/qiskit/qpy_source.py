...
qc = transpile(qc, basis_gates=['cx', 'h', 's', 't'], optimization_level=2, coupling_map=[[0, 1], [0, 2], [1, 0], [1, 3], [1, 4], [2, 0], [3, 1], [4, 1]])
# SECTION
# NAME: EXECUTION

from qiskit import Aer, transpile, execute
backend_9513948f69b143bfbee1134a3057a68b = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_9513948f69b143bfbee1134a3057a68b, shots=692).result().get_counts(qc)
RESULT = counts

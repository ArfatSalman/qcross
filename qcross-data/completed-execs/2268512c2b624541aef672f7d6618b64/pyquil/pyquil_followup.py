...
defns = get_custom_get_definitions("XGate", "PhaseGate", "CU1Gate", "RZZGate", "CXGate", "iSwapGate", "CUGate", "ECRGate", "CHGate", "RXGate", "TGate", "RCCXGate", "CSXGate", "RZGate", "C3SXGate", "SXdgGate")
...
qr_ac5d59 = circuit.declare("qr_ac5d59", "BIT", 8)

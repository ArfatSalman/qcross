...
backend_8182d3392d3041db8008710b5a49cd52 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_8182d3392d3041db8008710b5a49cd52, shots=1385).result().get_counts(qc)
RESULT = counts
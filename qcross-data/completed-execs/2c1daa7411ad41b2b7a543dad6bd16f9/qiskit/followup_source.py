...
qc.append(SGate(), qargs=[qr[0]], cargs=[])
qc.append(CRZGate(0.05525155902669336), qargs=[qr[0], qr[2]], cargs=[])
qc.append(RYYGate(3.2287759437031154), qargs=[qr[2], qr[0]], cargs=[])
...
backend_ee4ba5cf8bee406897355d3dff6c9c8f = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_ee4ba5cf8bee406897355d3dff6c9c8f, shots=489).result().get_counts(qc)
RESULT = counts

...
backend_fd87320f71dc470baaf4523d520dcf6e = Aer.get_backend('aer_simulator_statevector')
counts = execute(qc, backend=backend_fd87320f71dc470baaf4523d520dcf6e, shots=346).result().get_counts(qc)
RESULT = counts

...
qc_1.append(CCXGate(), qargs=[qr_1[5], qr_1[4], qr_1[6]], cargs=[])
...
backend_820dde03506a4ea49f77e8c875f6f550 = Aer.get_backend('qasm_simulator')
counts_1 = execute(qc_1, backend=backend_820dde03506a4ea49f77e8c875f6f550, shots=7838).result().get_counts(qc_1)
counts_2 = execute(qc_2, backend=backend_820dde03506a4ea49f77e8c875f6f550, shots=7838).result().get_counts(qc_2)

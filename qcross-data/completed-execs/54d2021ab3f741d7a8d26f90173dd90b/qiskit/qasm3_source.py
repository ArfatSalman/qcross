...
backend_f7e31347976c4e98a8443c15de068d7d = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_f7e31347976c4e98a8443c15de068d7d, shots=346).result().get_counts(qc)
RESULT = counts

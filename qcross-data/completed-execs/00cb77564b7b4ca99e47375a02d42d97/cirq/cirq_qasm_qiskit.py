...
p_c390ca = Symbol('p_c390ca')
p_15b94a = Symbol('p_15b94a')
p_c440e1 = Symbol('p_c440e1')
p_1f446e = Symbol('p_1f446e')
...
circuit.append(Gates.CRZGate(p_1f446e)( qr[3], qr[4] ))
...
circuit.append(Gates.CUGate(p_c440e1, 4.167661441102218, 4.623446645668956, 3.865496458458116)( qr[1], qr[4] ))
circuit.append(Gates.RZGate(p_c390ca)( qr[1] ))
circuit.append(Gates.RYYGate(5.398622178940033)( qr[0], qr[2] ))
circuit.append(Gates.CU1Gate(3.2142159669963557)( qr[3], qr[0] ))
circuit.append(Gates.UGate(p_15b94a, 0.07157463504881167, 1.4112277317699358)( qr[4] ))

...
qc = transpile(qc, basis_gates=['rx', 'ry', 'rz', 'p', 'cx'],
    optimization_level=2, coupling_map=[[0, 1], [1, 0]])
# SECTION
# NAME: EXECUTION

from qiskit import Aer, transpile, execute
backend_985590cfa82040b2a25ab4a09e2a8b1f = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_985590cfa82040b2a25ab4a09e2a8b1f, shots=346).result().get_counts(qc)
RESULT = counts

...
qc.append(CRXGate(5.987304452123941), qargs=[qr[5], qr[1]], cargs=[])
...
qc.append(C3SXGate(), qargs=[qr[4], qr[6], qr[0], qr[8]], cargs=[])
# SECTION
...
from qiskit import Aer, transpile, execute
backend_d4b11379d5dd4ee8803a3e5a86123284 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_d4b11379d5dd4ee8803a3e5a86123284, shots=5542).result().get_counts(qc)
RESULT = counts

...
defns = get_custom_get_definitions("CSXGate", "CHGate", "ZGate", "RZGate", "CRZGate", "TGate", "RZZGate", "SdgGate", "C3XGate", "CU1Gate", "U2Gate", "XGate", "RCCXGate", "CCXGate")
...
subcircuit = Program()
subcircuit.inst(Gates.CRZGate(4.747288222618085, 8, 3 ))
subcircuit.inst(Gates.C3XGate( 2, 7, 0, 5 ))

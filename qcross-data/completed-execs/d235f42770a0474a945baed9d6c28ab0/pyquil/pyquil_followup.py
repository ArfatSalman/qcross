...
p_70f5ad = circuit.declare('p_70f5ad', 'REAL')

defns = get_custom_get_definitions("RYYGate", "iSwapGate", "XGate", "CHGate", "ECRGate", "RZZGate", "TGate", "ZGate", "CSXGate", "CU1Gate", "CRZGate", "RXGate", "SXGate", "CPhaseGate", "HGate", "CRXGate", "SXdgGate", "RZGate")

circuit += defns

circuit.inst(Gates.RZZGate(p_70f5ad)( 1, 0 ))
...
subcircuit.inst(Gates.RXGate(3.3705408413231095, 0 ))
subcircuit.inst(Gates.ZGate( 1 ))
subcircuit.inst(Gates.CPhaseGate(3.6662500915709098, 1, 0 ))

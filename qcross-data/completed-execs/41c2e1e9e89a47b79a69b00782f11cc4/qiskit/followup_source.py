...
qc = transpile(qc, basis_gates=None, optimization_level=2, coupling_map=[[0,
    1], [1, 0], [1, 10], [2, 4], [2, 6], [3, 9], [4, 2], [4, 9], [4, 10], [
    5, 9], [6, 2], [7, 8], [8, 7], [8, 10], [9, 3], [9, 4], [9, 5], [10, 1],
    [10, 4], [10, 8]])
# SECTION
# NAME: EXECUTION

from qiskit import Aer, transpile, execute
backend_32873a13a7ae41e395c5b7f7c73577d2 = Aer.get_backend('aer_simulator_density_matrix')
counts = execute(qc, backend=backend_32873a13a7ae41e395c5b7f7c73577d2, shots=2771).result().get_counts(qc)
RESULT = counts

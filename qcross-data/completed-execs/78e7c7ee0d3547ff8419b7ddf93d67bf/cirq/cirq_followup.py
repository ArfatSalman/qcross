...
circuit.append(Gates.CRXGate(2.0099472182748075)( qr[1], qr[5] ))
circuit.append(Gates.C3SXGate( qr[6], qr[0], qr[2], qr[1] ))
circuit.append(Gates.CHGate( qr[4], qr[6] ))
circuit.append(Gates.C3SXGate( qr[0], qr[1], qr[2], qr[5] ))
circuit.append(Gates.ZGate( qr[1] ))
circuit.append(Gates.ECRGate( qr[6], qr[3] ))
circuit.append(Gates.SdgGate( qr[6] ))
circuit.append(Gates.RCCXGate( qr[1], qr[5], qr[0] ))
...
circuit.append(Gates.CU1Gate(4.028174522740928)( qr[2], qr[4] ))

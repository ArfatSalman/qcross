...
backend_5aaf1ecae0454232950256832314785a = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_5aaf1ecae0454232950256832314785a, shots=1959).result().get_counts(qc)
RESULT = counts

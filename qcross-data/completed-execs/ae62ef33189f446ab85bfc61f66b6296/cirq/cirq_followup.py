...
p_3dbf71 = Symbol('p_3dbf71')
p_4ceee3 = Symbol('p_4ceee3')
...
circuit.append(Gates.RZGate(p_3dbf71)( qr[1] ))
circuit.append(Gates.CRXGate(5.970852306777193)( qr[7], qr[1] ))
circuit.append(Gates.UGate(p_4ceee3, 5.023617931957853, 2.271164628944128)( qr[2] ))

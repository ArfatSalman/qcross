...
# SECTION
# NAME: PARAMETERS
p_3dbf71 = Parameter('p_3dbf71')
p_4ceee3 = Parameter('p_4ceee3')
...
qc.append(RZGate(p_3dbf71), qargs=[qr[1]], cargs=[])
qc.append(CRXGate(5.970852306777193), qargs=[qr[7], qr[1]], cargs=[])
qc.append(UGate(p_4ceee3, 5.023617931957853, 2.271164628944128), qargs=[qr[
    2]], cargs=[])
...
qc = qc.bind_parameters({
    p_3dbf71: 5.014941143947427,
    p_4ceee3: 5.080799300534071,
})
...
backend_79f71eaa6b5740638c89d9eabc02532c = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_79f71eaa6b5740638c89d9eabc02532c, shots=5542).result().get_counts(qc)
RESULT = counts

...
p_3dbf71 = circuit.declare('p_3dbf71', 'REAL')
p_4ceee3 = circuit.declare('p_4ceee3', 'REAL')
...
circuit.inst(Gates.RZGate(p_3dbf71, 1 ))
circuit.inst(Gates.CRXGate(5.970852306777193, 7, 1 ))
circuit.inst(Gates.UGate(p_4ceee3, 5.023617931957853, 2.271164628944128)( 2 ))

...
backend_ab218a75f03f4a26bba25c818386af7c = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_ab218a75f03f4a26bba25c818386af7c, shots=346).result().get_counts(qc)
RESULT = counts
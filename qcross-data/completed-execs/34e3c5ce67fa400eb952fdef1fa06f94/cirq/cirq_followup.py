...
p_0040c3 = Symbol('p_0040c3')
p_f18554 = Symbol('p_f18554')
p_52e5d8 = Symbol('p_52e5d8')
...
circuit.append(Gates.CU1Gate(p_0040c3)( qr[4], qr[0] ))
circuit.append(Gates.CRXGate(p_f18554)( qr[4], qr[6] ))
...
circuit.append(Gates.U2Gate(p_52e5d8, 2.1276323672732023)( qr[2] ))

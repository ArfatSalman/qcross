...
p_0040c3 = circuit.declare('p_0040c3', 'REAL')
p_f18554 = circuit.declare('p_f18554', 'REAL')
p_52e5d8 = circuit.declare('p_52e5d8', 'REAL')

defns = get_custom_get_definitions("CHGate", "SdgGate", "ECRGate", "RZGate", "U2Gate", "C3SXGate", "CRXGate", "SGate", "CSXGate", "CRZGate", "ZGate", "CU1Gate", "TGate", "RCCXGate", "XGate")
...
circuit.inst(Gates.CU1Gate(p_0040c3, 4, 0 ))
circuit.inst(Gates.CRXGate(p_f18554, 4, 6 ))
...
circuit.inst(Gates.U2Gate(p_52e5d8, 2.1276323672732023)( 2 ))

...
# SECTION
# NAME: PARAMETERS
p_0040c3 = Parameter('p_0040c3')
p_f18554 = Parameter('p_f18554')
p_52e5d8 = Parameter('p_52e5d8')
...
qc.append(CU1Gate(p_0040c3), qargs=[qr[4], qr[0]], cargs=[])
qc.append(CRXGate(p_f18554), qargs=[qr[4], qr[6]], cargs=[])
...
qc.append(U2Gate(p_52e5d8, 2.1276323672732023), qargs=[qr[2]], cargs=[])
...
qc = qc.bind_parameters({
    p_0040c3: 3.2142159669963557,
    p_f18554: 5.94477504571567,
    p_52e5d8: 2.5163050709890156,
})
...
backend_2d0ab1986654407381556e9f99420925 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_2d0ab1986654407381556e9f99420925, shots=1959).result().get_counts(qc)
RESULT = counts

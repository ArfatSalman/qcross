...
qr_9dad5d = QuantumRegister(2, name='qr_9dad5d')
qc.add_register(qr_9dad5d)
# SECTION
# NAME: MEASUREMENT
...
backend_44c6da1415db457cb88799c982125fb0 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_44c6da1415db457cb88799c982125fb0, shots=489).result().get_counts(qc)
RESULT = counts

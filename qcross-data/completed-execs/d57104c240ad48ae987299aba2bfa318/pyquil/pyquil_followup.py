...
defns = get_custom_get_definitions("XGate", "RYYGate", "CRXGate", "iSwapGate", "CCXGate", "CHGate", "CSXGate", "RZGate", "SGate", "SXdgGate", "SdgGate")
...
qr_9dad5d = circuit.declare("qr_9dad5d", "BIT", 2)

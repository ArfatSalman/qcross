...
backend_79772a8259d44d56a5bdf21e6b9a5e2f = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_79772a8259d44d56a5bdf21e6b9a5e2f, shots=489).result().get_counts(qc)
RESULT = counts
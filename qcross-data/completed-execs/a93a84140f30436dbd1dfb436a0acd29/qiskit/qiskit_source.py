...
backend_a58d06c2727d44298401734b0990e6f4 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_a58d06c2727d44298401734b0990e6f4, shots=1385).result().get_counts(qc)
RESULT = counts
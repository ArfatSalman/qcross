...
qc.append(CRZGate(4.2641612072511235), qargs=[qr[1], qr[4]], cargs=[])
...
qc.append(CU1Gate(4.028174522740928), qargs=[qr[2], qr[4]], cargs=[])
...
backend_744a44ec683449538b7217c025b7911c = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_744a44ec683449538b7217c025b7911c, shots=1385).result().get_counts(qc)
RESULT = counts

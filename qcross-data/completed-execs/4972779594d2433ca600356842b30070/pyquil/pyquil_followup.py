...
defns = get_custom_get_definitions("ZGate", "RZGate", "CRZGate", "XGate", "RCCXGate", "CCXGate")

circuit += defns

circuit.inst(Gates.RZGate(6.163759533339787, 10 ))
circuit.inst(Gates.CRZGate(4.2641612072511235, 4, 8 ))
circuit.inst(Gates.ZGate( 0 ))
circuit.inst(Gates.CCXGate( 3, 5, 6 ))
circuit.inst(Gates.ZGate( 8 ))
circuit.inst(Gates.XGate( 6 ))
circuit.inst(Gates.RCCXGate( 7, 4, 9 ))

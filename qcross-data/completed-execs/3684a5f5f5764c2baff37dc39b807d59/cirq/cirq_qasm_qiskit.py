...
p_660fb5 = Symbol('p_660fb5')
p_773c06 = Symbol('p_773c06')
p_bfa20f = Symbol('p_bfa20f')
p_77ac42 = Symbol('p_77ac42')
p_a65f95 = Symbol('p_a65f95')
...
subcircuit.append(Gates.RXGate(0.7631154445516055)( qr[3] ))
subcircuit.append(Gates.CXGate( qr[3], qr[7] ))
...
circuit.append(Gates.RYYGate(p_bfa20f)( qr[6], qr[7] ))
circuit.append(Gates.CRZGate(4.167661441102218)( qr[1], qr[7] ))
circuit.append(Gates.RZGate(p_77ac42)( qr[1] ))
...
circuit.append(Gates.RZZGate(p_660fb5)( qr[7], qr[0] ))
...
circuit.append(Gates.CUGate(p_773c06, 5.0063780207098425, 3.1562533916051736, 4.940217775579305)( qr[6], qr[2] ))
...
circuit.append(Gates.RZZGate(p_a65f95)( qr[3], qr[4] ))
...
circuit.append(Gates.ECRGate( qr[6], qr[2] ))

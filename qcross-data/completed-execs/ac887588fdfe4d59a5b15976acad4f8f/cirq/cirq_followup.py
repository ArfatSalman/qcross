...
circuit.append(Gates.RZZGate(4.066449154047175)( qr[0], qr[3] ))
circuit.append(Gates.iSwapGate( qr[0], qr[3] ))
circuit.append(Gates.CSXGate( qr[2], qr[1] ))
circuit.append(Gates.XGate( qr[0] ))
circuit.append(Gates.CUGate(0.5112149185250571, 5.897054719225356, 2.3864521352475245, 5.987304452123941)( qr[1], qr[0] ))
circuit.append(Gates.CU1Gate(5.154187354656876)( qr[3], qr[1] ))
circuit.append(Gates.CHGate( qr[3], qr[0] ))
circuit.append(Gates.CHGate( qr[2], qr[0] ))
circuit.append(Gates.C3SXGate( qr[3], qr[1], qr[2], qr[0] ))
circuit.append(Gates.C3SXGate( qr[3], qr[2], qr[1], qr[0] ))

...
circuit.append(Gates.CRZGate(4.2641612072511235)( qr[2], qr[0] ))
circuit.append(Gates.CUGate(0.5112149185250571, 5.897054719225356, 2.3864521352475245, 5.987304452123941)( qr[2], qr[3] ))
circuit.append(Gates.C3SXGate( qr[1], qr[0], qr[5], qr[2] ))
circuit.append(Gates.CCXGate( qr[1], qr[4], qr[5] ))
circuit.append(Gates.C3SXGate( qr[0], qr[3], qr[4], qr[5] ))
...
circuit.append(Gates.CRZGate(4.167661441102218)( qr[1], qr[4] ))
circuit.append(Gates.RZGate(4.229610589867865)( qr[1] ))
circuit.append(Gates.C3SXGate( qr[5], qr[2], qr[1], qr[3] ))
...
circuit.append(Gates.RZZGate(5.1829934776392745)( qr[5], qr[4] ))

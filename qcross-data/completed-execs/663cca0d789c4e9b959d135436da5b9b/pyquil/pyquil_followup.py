...
defns = get_custom_get_definitions("RCCXGate", "UGate", "ZGate", "CU1Gate", "RZZGate", "CRZGate", "C3SXGate", "RZGate", "TGate", "SGate", "CCXGate", "SXGate", "CUGate")
...
circuit.inst(Gates.C3SXGate( 1, 0, 5, 2 ))
circuit.inst(Gates.CCXGate( 1, 4, 5 ))
circuit.inst(Gates.C3SXGate( 0, 3, 4, 5 ))
circuit.inst(Gates.ZGate( 5 ))
circuit.inst(Gates.ZGate( 2 ))
circuit.inst(Gates.TGate( 0 ))
circuit.inst(Gates.RCCXGate( 4, 3, 0 ))
circuit.inst(Gates.SGate( 4 ))
circuit.inst(Gates.CRZGate(4.167661441102218, 1, 4 ))
circuit.inst(Gates.RZGate(4.229610589867865, 1 ))
circuit.inst(Gates.C3SXGate( 5, 2, 1, 3 ))
...
circuit.inst(Gates.RZZGate(5.1829934776392745)( 5, 4 ))
circuit.inst(Gates.SGate( 0 ))
circuit.inst(Gates.SXGate( 5 ))
circuit.inst(Gates.ZGate( 0 ))

qr_b001ba = circuit.declare("qr_b001ba", "BIT", 10)

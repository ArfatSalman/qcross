...
defns = get_custom_get_definitions("CHGate", "CCXGate", "ZGate", "RZGate", "XGate", "TGate", "SXGate", "SGate", "SdgGate", "C3SXGate", "CU1Gate", "U2Gate", "CUGate", "CSXGate", "CRZGate")

circuit += defns

circuit.inst(Gates.RZGate(6.163759533339787, 3 ))
circuit.inst(Gates.CSXGate( 1, 7 ))
circuit.inst(Gates.CUGate(0.5112149185250571, 5.897054719225356, 2.3864521352475245, 5.987304452123941, 8, 6 ))
circuit.inst(Gates.SdgGate( 0 ))
circuit.inst(Gates.C3SXGate( 8, 3, 2, 4 ))
circuit.inst(Gates.ZGate( 1 ))
circuit.inst(Gates.XGate( 4 ))
circuit.inst(Gates.SGate( 8 ))
circuit.inst(Gates.SGate( 3 ))
circuit.inst(Gates.C3SXGate( 0, 5, 1, 8 ))
circuit.inst(Gates.SXGate( 8 ))
circuit.inst(Gates.CU1Gate(3.2142159669963557, 3, 5 ))
circuit.inst(Gates.CRZGate(1.4112277317699358, 4, 3 ))
circuit.inst(Gates.ZGate( 1 ))
circuit.inst(Gates.CSXGate( 8, 1 ))
circuit.inst(Gates.ZGate( 2 ))
circuit.inst(Gates.CHGate( 6, 0 ))
...
circuit.inst(Gates.CCXGate( 8, 6, 0 ))

...
circuit.append(Gates.CUGate(0.5112149185250571, 5.897054719225356, 2.3864521352475245, 5.987304452123941)( qr[8], qr[6] ))
circuit.append(Gates.SdgGate( qr[0] ))
circuit.append(Gates.C3SXGate( qr[8], qr[3], qr[2], qr[4] ))
...
circuit.append(Gates.C3SXGate( qr[0], qr[5], qr[1], qr[8] ))
circuit.append(Gates.SXGate( qr[8] ))
circuit.append(Gates.CU1Gate(3.2142159669963557)( qr[3], qr[5] ))
circuit.append(Gates.CRZGate(1.4112277317699358)( qr[4], qr[3] ))
circuit.append(Gates.ZGate( qr[1] ))
circuit.append(Gates.CSXGate( qr[8], qr[1] ))
circuit.append(Gates.ZGate( qr[2] ))
circuit.append(Gates.CHGate( qr[6], qr[0] ))
...
circuit.append(Gates.CCXGate( qr[8], qr[6], qr[0] ))

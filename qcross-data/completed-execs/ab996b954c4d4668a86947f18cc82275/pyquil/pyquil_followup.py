...
defns = get_custom_get_definitions("CUGate", "RCCXGate", "CSXGate", "XGate", "CU1Gate", "SXdgGate", "RYYGate", "SGate", "iSwapGate", "CRZGate", "CXGate", "CYGate", "RZZGate", "CHGate", "TGate", "RZGate", "C3SXGate", "RYGate")
...
subcircuit.inst(Gates.RYGate(1.256213604505652, 2 ))

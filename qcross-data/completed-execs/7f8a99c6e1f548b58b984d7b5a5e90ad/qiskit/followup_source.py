...
qr_960dad = QuantumRegister(5, name='qr_960dad')
qc.add_register(qr_960dad)
# SECTION
# NAME: MEASUREMENT
...
backend_647675261b874031b1f06653d4409ac9 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_647675261b874031b1f06653d4409ac9, shots=489).result().get_counts(qc)
RESULT = counts

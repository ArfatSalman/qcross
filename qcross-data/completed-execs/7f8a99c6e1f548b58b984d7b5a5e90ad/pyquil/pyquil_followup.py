...
defns = get_custom_get_definitions("SdgGate", "TGate", "RCCXGate", "CSXGate", "CRXGate", "XGate", "CCXGate", "SXdgGate", "RZGate", "ECRGate", "SGate", "ZGate", "CHGate", "RYYGate", "CRZGate", "iSwapGate")
...
qr_960dad = circuit.declare("qr_960dad", "BIT", 5)

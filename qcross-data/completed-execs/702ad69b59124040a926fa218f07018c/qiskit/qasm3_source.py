...
backend_4017db5027fd4998bcfd2047e605f3a2 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_4017db5027fd4998bcfd2047e605f3a2, shots=692).result().get_counts(qc)
RESULT = counts

...
qc_1.append(Gates.SXGate( qr_1[0] ))
...
qc_2.append(Gates.TGate( qr_2[7] ))
qc_2.append(Gates.XGate( qr_2[6] ))
qc_2.append(Gates.CRZGate(4.167661441102218)( qr_2[0], qr_2[4] ))
qc_2.append(Gates.RZGate(4.229610589867865)( qr_2[0] ))
qc_2.append(Gates.CSXGate( qr_2[2], qr_2[6] ))
qc_2.append(Gates.CCXGate( qr_2[2], qr_2[7], qr_2[3] ))

...
defns = get_custom_get_definitions("ZGate", "SXGate")

qc_1 += defns

qc_1.inst(Gates.ZGate( 0 ))
qc_1.inst(Gates.SXGate( 0 ))
...
defns = get_custom_get_definitions("CCXGate", "XGate", "TGate", "RZGate", "CRXGate", "CSXGate", "CRZGate")
...
qc_2.inst(Gates.TGate( 7 ))
qc_2.inst(Gates.XGate( 6 ))
qc_2.inst(Gates.CRZGate(4.167661441102218, 0, 4 ))
qc_2.inst(Gates.RZGate(4.229610589867865, 0 ))
qc_2.inst(Gates.CSXGate( 2, 6 ))
qc_2.inst(Gates.CCXGate( 2, 7, 3 ))

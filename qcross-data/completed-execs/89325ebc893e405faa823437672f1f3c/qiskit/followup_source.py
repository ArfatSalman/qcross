...
backend_e5f91533953840b793ed8752a0ac2005 = Aer.get_backend('aer_simulator_matrix_product_state')
counts_1 = execute(qc_1, backend=backend_e5f91533953840b793ed8752a0ac2005, shots=7838).result().get_counts(qc_1)
counts_2 = execute(qc_2, backend=backend_e5f91533953840b793ed8752a0ac2005, shots=7838).result().get_counts(qc_2)

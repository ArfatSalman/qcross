...
p_59f7ee = circuit.declare('p_59f7ee', 'REAL')

defns = get_custom_get_definitions("iSwapGate", "CSXGate", "RZZGate", "XGate", "SXdgGate", "ECRGate")

circuit += defns

circuit.inst(Gates.RZZGate(p_59f7ee)( 1, 0 ))
...
qr_00281e = circuit.declare("qr_00281e", "BIT", 8)

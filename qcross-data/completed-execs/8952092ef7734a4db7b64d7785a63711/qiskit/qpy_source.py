...
backend_f86ba0846fd84b3c861123752ee7b8a4 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_f86ba0846fd84b3c861123752ee7b8a4, shots=3919).result().get_counts(qc)
RESULT = counts

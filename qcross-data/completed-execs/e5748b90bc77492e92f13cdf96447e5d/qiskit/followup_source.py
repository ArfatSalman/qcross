...
subcircuit.append(SXdgGate(), qargs=[qr[8]], cargs=[])
...
backend_1b31f31bbfe04fb1b54fda991f80f5f1 = Aer.get_backend('aer_simulator_statevector')
counts = execute(qc, backend=backend_1b31f31bbfe04fb1b54fda991f80f5f1, shots=3919).result().get_counts(qc)
RESULT = counts

...
defns = get_custom_get_definitions("iSwapGate", "ZGate", "SwapGate", "RZXGate", "CHGate", "CU1Gate", "CRZGate", "XGate", "PhaseGate", "TGate", "CSXGate", "CUGate", "RCCXGate", "SXdgGate", "SGate", "SdgGate", "C3SXGate", "SXGate", "RZGate")
...
subcircuit = Program()
subcircuit.inst(Gates.SXdgGate( 8 ))

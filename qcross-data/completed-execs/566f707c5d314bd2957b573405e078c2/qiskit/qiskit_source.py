...
backend_cf6bccc291c749528a4050c5b5e7f12f = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_cf6bccc291c749528a4050c5b5e7f12f, shots=1385).result().get_counts(qc)
RESULT = counts
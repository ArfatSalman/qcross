...
p_67b8e6 = Symbol('p_67b8e6')
p_0ab2f5 = Symbol('p_0ab2f5')

circuit = cirq.Circuit()

circuit.append(Gates.RZGate(6.163759533339787)( qr[6] ))
circuit.append(Gates.CRZGate(4.2641612072511235)( qr[4], qr[6] ))
circuit.append(Gates.CRXGate(5.987304452123941)( qr[8], qr[3] ))
circuit.append(Gates.CCXGate( qr[0], qr[9], qr[3] ))
circuit.append(Gates.ZGate( qr[2] ))
circuit.append(Gates.TGate( qr[9] ))
circuit.append(Gates.XGate( qr[7] ))
circuit.append(Gates.CRZGate(4.167661441102218)( qr[8], qr[4] ))
circuit.append(Gates.RZGate(p_0ab2f5)( qr[8] ))
circuit.append(Gates.SXGate( qr[2] ))
circuit.append(Gates.CSXGate( qr[5], qr[7] ))
circuit.append(Gates.CCXGate( qr[5], qr[9], qr[0] ))
circuit.append(Gates.C3SXGate( qr[2], qr[5], qr[1], qr[9] ))
circuit.append(Gates.CSXGate( qr[1], qr[2] ))
circuit.append(Gates.ZGate( qr[1] ))
circuit.append(Gates.CHGate( qr[3], qr[8] ))
circuit.append(Gates.CSXGate( qr[2], qr[1] ))
circuit.append(Gates.CRZGate(p_67b8e6)( qr[8], qr[2] ))

...
backend_29fa6cf1026340f3a6f6f66e072ae491 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_29fa6cf1026340f3a6f6f66e072ae491, shots=346).result().get_counts(qc)
RESULT = counts
...
defns = get_custom_get_definitions("TGate", "CHGate", "ZGate", "SXGate", "C3XGate", "U1Gate", "CU3Gate", "CRXGate", "XGate", "ECRGate", "RZGate", "C3SXGate")
...
qr_b4e0f5 = circuit.declare("qr_b4e0f5", "BIT", 5)

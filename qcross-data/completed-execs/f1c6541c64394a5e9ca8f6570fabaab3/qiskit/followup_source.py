...
qr_b4e0f5 = QuantumRegister(5, name='qr_b4e0f5')
qc.add_register(qr_b4e0f5)
# SECTION
# NAME: MEASUREMENT
...
backend_06daca3dfa1445539f29590c19561916 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_06daca3dfa1445539f29590c19561916, shots=1959).result().get_counts(qc)
RESULT = counts

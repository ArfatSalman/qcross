...
subcircuit.append(RZGate(0.9356897707598831), qargs=[qr[1]], cargs=[])
subcircuit.append(CRYGate(0.07157463504881167), qargs=[qr[2], qr[0]], cargs=[])
...
backend_c71dda13be71422d988f7841f7578f23 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_c71dda13be71422d988f7841f7578f23, shots=692).result().get_counts(qc)
RESULT = counts

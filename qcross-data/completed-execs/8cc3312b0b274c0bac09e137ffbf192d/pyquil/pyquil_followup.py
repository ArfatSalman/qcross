...
defns = get_custom_get_definitions("CSXGate", "CU1Gate", "ECRGate", "SGate", "C3SXGate", "CRZGate", "RZGate", "CHGate", "SXdgGate", "XGate", "CRYGate", "RCCXGate", "CUGate", "TGate", "RZZGate", "RYYGate", "iSwapGate")
...
subcircuit.inst(Gates.RZGate(0.9356897707598831, 1 ))
subcircuit.inst(Gates.CRYGate(0.07157463504881167, 2, 0 ))

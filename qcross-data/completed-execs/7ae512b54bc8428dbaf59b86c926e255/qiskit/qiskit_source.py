...
backend_63338eeb62264d84bef889741249e8ef = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_63338eeb62264d84bef889741249e8ef, shots=2771).result().get_counts(qc)
RESULT = counts
...
p_04bebe = circuit.declare('p_04bebe', 'REAL')
p_1171af = circuit.declare('p_1171af', 'REAL')
p_e203ca = circuit.declare('p_e203ca', 'REAL')

defns = get_custom_get_definitions("CRZGate", "SXdgGate", "iSwapGate", "RCCXGate", "CRXGate", "RYYGate", "ZGate", "CU1Gate", "CUGate", "SGate", "RZGate", "TGate", "XGate", "CSXGate", "ECRGate", "UGate", "CHGate")

circuit += defns

circuit.inst(Gates.RZGate(p_e203ca, 3 ))
...
circuit.inst(Gates.UGate(5.887184334931191, p_1171af, 1.4112277317699358)( 4 ))

subcircuit = Program()
subcircuit.inst(Gates.iSwapGate( 1, 4 ))
subcircuit.inst(Gates.UGate(2.438459595578943, 3.326780904591333, 3.4232119351142516)( 0 ))
...
circuit.inst(Gates.CU1Gate(p_04bebe, 0, 3 ))

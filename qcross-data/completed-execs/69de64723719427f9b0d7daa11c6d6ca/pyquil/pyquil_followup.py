...
defns = get_custom_get_definitions("TGate", "RZGate", "SXdgGate", "ZGate", "UGate", "CYGate", "U1Gate", "iSwapGate", "CHGate", "XGate", "RYGate", "RYYGate", "SGate", "CSXGate", "IGate", "SdgGate", "CCXGate", "CPhaseGate", "U3Gate", "CRXGate")
...
qr_b7dec2 = circuit.declare("qr_b7dec2", "BIT", 1)

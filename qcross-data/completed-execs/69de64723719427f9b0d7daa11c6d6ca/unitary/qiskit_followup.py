...
qr_b7dec2 = QuantumRegister(1, name='qr_b7dec2')
qc.add_register(qr_b7dec2)
# SECTION
...
from qiskit import Aer, transpile, execute
backend_71227c8ca1284b679a838fa2d96db126 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_71227c8ca1284b679a838fa2d96db126, shots=489).result().get_counts(qc)
RESULT = counts

...
qc = transpile(qc, basis_gates=None, optimization_level=3, coupling_map=[[0,
    1], [0, 4], [0, 5], [0, 6], [0, 13], [1, 0], [2, 11], [2, 12], [3, 13],
    [4, 0], [5, 0], [5, 7], [6, 0], [6, 10], [6, 11], [7, 5], [8, 13], [9, 
    11], [10, 6], [11, 2], [11, 6], [11, 9], [12, 2], [13, 0], [13, 3], [13,
    8]])
# SECTION
# NAME: EXECUTION

from qiskit import Aer, transpile, execute
backend_8a25c76f107e491dbc6a4bce090c3073 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_8a25c76f107e491dbc6a4bce090c3073, shots=5542).result().get_counts(qc)
RESULT = counts

...
backend_cf9c36a17dfc498ab2b271e0e29f8398 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_cf9c36a17dfc498ab2b271e0e29f8398, shots=2771).result().get_counts(qc)
RESULT = counts
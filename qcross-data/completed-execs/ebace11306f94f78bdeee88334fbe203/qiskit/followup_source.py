...
backend_f6a66285e19741b9a74bfea338108fa0 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_f6a66285e19741b9a74bfea338108fa0, shots=1385).result().get_counts(qc)
RESULT = counts

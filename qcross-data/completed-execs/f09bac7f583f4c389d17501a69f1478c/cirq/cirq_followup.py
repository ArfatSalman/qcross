...
circuit.append(Gates.C3SXGate( qr[3], qr[0], qr[5], qr[6] ))
circuit.append(Gates.CHGate( qr[1], qr[3] ))
circuit.append(Gates.C3SXGate( qr[0], qr[6], qr[5], qr[2] ))
circuit.append(Gates.ZGate( qr[6] ))
circuit.append(Gates.ECRGate( qr[3], qr[4] ))
...
circuit.append(Gates.C3SXGate( qr[0], qr[6], qr[5], qr[4] ))

...
defns = get_custom_get_definitions("CU1Gate", "SdgGate", "ECRGate", "ZGate", "CHGate", "XGate", "RZGate", "SGate", "RCCXGate", "CRXGate", "C3SXGate")
...
circuit.inst(Gates.C3SXGate( 3, 0, 5, 6 ))
circuit.inst(Gates.CHGate( 1, 3 ))
circuit.inst(Gates.C3SXGate( 0, 6, 5, 2 ))
...
circuit.inst(Gates.C3SXGate( 0, 6, 5, 4 ))

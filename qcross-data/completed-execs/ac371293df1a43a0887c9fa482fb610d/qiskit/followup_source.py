...
backend_60aebfa7e4564c8785e527b53f6fdfc2 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_60aebfa7e4564c8785e527b53f6fdfc2, shots=692).result().get_counts(qc)
RESULT = counts

...
circuit.append(Gates.RYYGate(1.6723037552953224)( qr[2], qr[0] ))
...
circuit.append(Gates.RCCXGate( qr[2], qr[0], qr[1] ))
...
circuit.append(Gates.SGate( qr[1] ))
circuit.append(Gates.CRZGate(0.05525155902669336)( qr[1], qr[2] ))
circuit.append(Gates.RYYGate(3.2287759437031154)( qr[2], qr[1] ))

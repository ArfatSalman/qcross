...
backend_c8a01284e1f44ff39593a28d2a01cac0 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_c8a01284e1f44ff39593a28d2a01cac0, shots=3919).result().get_counts(qc)
RESULT = counts

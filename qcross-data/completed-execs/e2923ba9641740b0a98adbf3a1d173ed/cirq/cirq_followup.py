...
subcircuit.append(Gates.CU1Gate(2.0685963035149753)( qr[5], qr[0] ))
subcircuit.append(Gates.RZXGate(1.1412693567569159)( qr[1], qr[8] ))
subcircuit.append(Gates.SwapGate( qr[1], qr[6] ))
subcircuit.append(Gates.iSwapGate( qr[2], qr[6] ))
subcircuit.append(Gates.RCCXGate( qr[2], qr[5], qr[8] ))

...
backend_e8ce5db01f474734951d55640ea08ecb = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_e8ce5db01f474734951d55640ea08ecb, shots=2771).result().get_counts(qc)
RESULT = counts
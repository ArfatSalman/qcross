...
backend_a4467c630545457dbb1fa06c3a0a9353 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_a4467c630545457dbb1fa06c3a0a9353, shots=979).result().get_counts(qc)
RESULT = counts
...
p_ba5a58 = Symbol('p_ba5a58')
p_a56cab = Symbol('p_a56cab')
p_1e801f = Symbol('p_1e801f')

circuit = cirq.Circuit()

circuit.append(Gates.RZGate(p_ba5a58)( qr[3] ))
circuit.append(Gates.CRZGate(4.2641612072511235)( qr[6], qr[3] ))

subcircuit = cirq.Circuit()
subcircuit.append(Gates.CU3Gate(p_a56cab, 0.9356897707598831, p_1e801f)( qr[4], qr[7] ))
subcircuit.append(Gates.XGate( qr[9] ))

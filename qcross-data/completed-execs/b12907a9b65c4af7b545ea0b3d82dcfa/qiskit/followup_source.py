...
qr_8066b4 = QuantumRegister(1, name='qr_8066b4')
qc.add_register(qr_8066b4)
# SECTION
# NAME: MEASUREMENT
...
backend_92e00ff5ecf34be8a92f07759377799b = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_92e00ff5ecf34be8a92f07759377799b, shots=1385).result().get_counts(qc)
RESULT = counts

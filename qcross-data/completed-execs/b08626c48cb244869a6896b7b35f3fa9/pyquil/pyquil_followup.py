...
p_4c273c = circuit.declare('p_4c273c', 'REAL')
p_9c8979 = circuit.declare('p_9c8979', 'REAL')
p_a7164b = circuit.declare('p_a7164b', 'REAL')

defns = get_custom_get_definitions("C3SXGate", "ZGate", "TGate", "SGate", "RZGate", "RCCXGate", "CRZGate", "CCXGate", "CU1Gate", "UGate", "RZZGate", "SXGate", "CUGate")
...
circuit.inst(Gates.CUGate(0.5112149185250571, 5.897054719225356, p_a7164b, 5.987304452123941, 2, 3 ))
...
circuit.inst(Gates.UGate(5.887184334931191, 0.07157463504881167, p_4c273c)( 5 ))
circuit.inst(Gates.RZZGate(5.1829934776392745)( 0, 5 ))
circuit.inst(Gates.SGate( 4 ))
circuit.inst(Gates.SXGate( 0 ))
circuit.inst(Gates.ZGate( 4 ))
circuit.inst(Gates.CRZGate(p_9c8979, 0, 5 ))
...
params = {
    "p_4c273c": 1.4112277317699358,
    "p_9c8979": 4.833923139882297,
    "p_a7164b": 2.3864521352475245
}

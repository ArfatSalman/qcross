...
# SECTION
# NAME: PARAMETERS
p_4c273c = Parameter('p_4c273c')
p_9c8979 = Parameter('p_9c8979')
p_a7164b = Parameter('p_a7164b')
...
qc.append(CUGate(0.5112149185250571, 5.897054719225356, p_a7164b, 
...
qc.append(UGate(5.887184334931191, 0.07157463504881167, p_4c273c), qargs=[
    qr[5]], cargs=[])
...
qc.append(CRZGate(p_9c8979), qargs=[qr[0], qr[5]], cargs=[])
...
backend_0bd41c8ceeae40ca9152dbca0b91d408 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_0bd41c8ceeae40ca9152dbca0b91d408, shots=1385).result().get_counts(qc)
RESULT = counts

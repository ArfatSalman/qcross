...
p_4c273c = Symbol('p_4c273c')
p_9c8979 = Symbol('p_9c8979')
p_a7164b = Symbol('p_a7164b')
...
circuit.append(Gates.CUGate(0.5112149185250571, 5.897054719225356, p_a7164b, 5.987304452123941)( qr[2], qr[3] ))
...
circuit.append(Gates.UGate(5.887184334931191, 0.07157463504881167, p_4c273c)( qr[5] ))
...
circuit.append(Gates.CRZGate(p_9c8979)( qr[0], qr[5] ))

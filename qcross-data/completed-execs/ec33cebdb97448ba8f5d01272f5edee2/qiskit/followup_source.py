...
qr_ab268f = QuantumRegister(1, name='qr_ab268f')
qc.add_register(qr_ab268f)
# SECTION
# NAME: MEASUREMENT
...
backend_1d0f2a90b2a04cc8b18d465468e67ff6 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_1d0f2a90b2a04cc8b18d465468e67ff6, shots=346).result().get_counts(qc)
RESULT = counts

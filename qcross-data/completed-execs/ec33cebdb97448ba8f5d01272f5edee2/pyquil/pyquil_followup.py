...
defns = get_custom_get_definitions("TGate", "CSXGate", "SXGate", "XGate", "CRXGate", "SXdgGate", "ECRGate", "CHGate", "RYYGate", "RZZGate", "iSwapGate")
...
qr_ab268f = circuit.declare("qr_ab268f", "BIT", 1)

...
qr_d9de9b = QuantumRegister(3, name='qr_d9de9b')
qc.add_register(qr_d9de9b)
# SECTION
# NAME: MEASUREMENT
...
backend_01c41ee048034ad28363c32b09664618 = Aer.get_backend('statevector_simulator')
counts = execute(qc, backend=backend_01c41ee048034ad28363c32b09664618, shots=3919).result().get_counts(qc)
RESULT = counts

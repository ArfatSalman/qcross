...
qc_2.append(CSXGate(), qargs=[qr_2[5], qr_2[6]], cargs=[])
...
backend_7a1380f270e1482b9e052bc2a90f0678 = Aer.get_backend('qasm_simulator')
counts_1 = execute(qc_1, backend=backend_7a1380f270e1482b9e052bc2a90f0678, shots=3919).result().get_counts(qc_1)
counts_2 = execute(qc_2, backend=backend_7a1380f270e1482b9e052bc2a90f0678, shots=3919).result().get_counts(qc_2)

...
qr_8eb8fe = QuantumRegister(3, name='qr_8eb8fe')
qc.add_register(qr_8eb8fe)
# SECTION
# NAME: MEASUREMENT
...
backend_ff8452a6bca34579886bbae51fe1db2f = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_ff8452a6bca34579886bbae51fe1db2f, shots=346).result().get_counts(qc)
RESULT = counts

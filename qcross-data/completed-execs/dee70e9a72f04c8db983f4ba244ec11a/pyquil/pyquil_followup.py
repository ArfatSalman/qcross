...
p_ed2e04 = circuit.declare('p_ed2e04', 'REAL')

defns = get_custom_get_definitions("RZGate", "CRXGate", "CSXGate", "RYYGate", "SXdgGate", "CHGate", "ZGate", "TGate", "CRZGate", "SGate", "ECRGate")
...
circuit.inst(Gates.CRXGate(p_ed2e04, 4, 3 ))

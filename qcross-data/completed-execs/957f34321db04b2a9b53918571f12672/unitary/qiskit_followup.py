...
qc.append(CRXGate(2.0099472182748075), qargs=[qr[5], qr[3]], cargs=[])
qc.append(C3SXGate(), qargs=[qr[2], qr[4], qr[0], qr[5]], cargs=[])
qc.append(CHGate(), qargs=[qr[1], qr[2]], cargs=[])
qc.append(C3SXGate(), qargs=[qr[4], qr[5], qr[0], qr[3]], cargs=[])
...
from qiskit import Aer, transpile, execute
backend_ee1d02fb0e74468cab4f894dde414a09 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_ee1d02fb0e74468cab4f894dde414a09, shots=1959).result().get_counts(qc)
RESULT = counts

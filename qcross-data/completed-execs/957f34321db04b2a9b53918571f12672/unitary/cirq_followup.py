...
circuit.append(Gates.CRXGate(2.0099472182748075)( qr[5], qr[3] ))
circuit.append(Gates.C3SXGate( qr[2], qr[4], qr[0], qr[5] ))
circuit.append(Gates.CHGate( qr[1], qr[2] ))
circuit.append(Gates.C3SXGate( qr[4], qr[5], qr[0], qr[3] ))

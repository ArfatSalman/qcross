...
backend_2f623802f0e5438b9e0265e3850e3c80 = Aer.get_backend('qasm_simulator')
counts_1 = execute(qc_1, backend=backend_2f623802f0e5438b9e0265e3850e3c80, shots=7838).result().get_counts(qc_1)
counts_2 = execute(qc_2, backend=backend_2f623802f0e5438b9e0265e3850e3c80, shots=7838).result().get_counts(qc_2)

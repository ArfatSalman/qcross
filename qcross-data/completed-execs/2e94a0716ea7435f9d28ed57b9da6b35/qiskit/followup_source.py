...
subcircuit.append(U1Gate(4.654977034583802), qargs=[qr[1]], cargs=[])
...
subcircuit.append(CPhaseGate(4.167661441102218), qargs=[qr[1], qr[0]], cargs=[]
    )
subcircuit.append(IGate(), qargs=[qr[2]], cargs=[])
subcircuit.append(UGate(2.9790366726895714, 5.974354952564585, 
    3.2287759437031154), qargs=[qr[0]], cargs=[])
...
backend_9ba19dd6c18f4152adce146a70686fb8 = Aer.get_backend('aer_simulator_matrix_product_state')
counts = execute(qc, backend=backend_9ba19dd6c18f4152adce146a70686fb8, shots=489).result().get_counts(qc)
RESULT = counts

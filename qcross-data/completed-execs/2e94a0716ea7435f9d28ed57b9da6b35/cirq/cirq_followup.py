...
subcircuit.append(Gates.U1Gate(4.654977034583802)( qr[1] ))
...
subcircuit.append(Gates.CPhaseGate(4.167661441102218)( qr[1], qr[0] ))
subcircuit.append(Gates.IGate( qr[2] ))
subcircuit.append(Gates.UGate(2.9790366726895714, 5.974354952564585, 3.2287759437031154)( qr[0] ))

...
defns = get_custom_get_definitions("CHGate", "U3Gate", "SdgGate", "IGate", "UGate", "RYGate", "RYYGate", "CRXGate", "ZGate", "CYGate", "TGate", "SGate", "CCXGate", "RZGate", "CSXGate", "SXdgGate", "CPhaseGate", "XGate", "iSwapGate", "U1Gate")
...
subcircuit = Program()
subcircuit.inst(Gates.U1Gate(4.654977034583802, 1 ))
...
subcircuit.inst(Gates.CPhaseGate(4.167661441102218, 1, 0 ))
subcircuit.inst(Gates.IGate( 2 ))
subcircuit.inst(Gates.UGate(2.9790366726895714, 5.974354952564585, 3.2287759437031154)( 0 ))

...
qc.append(CUGate(5.03147076606842, 5.0063780207098425, 3.1562533916051736, 4.940217775579305), qargs=[qr[4], qr[3]], cargs=[])
# SECTION
# NAME: MEASUREMENT
...
qc = transpile(qc, basis_gates=None, optimization_level=2, coupling_map=[[0,
    1], [0, 3], [1, 0], [1, 2], [1, 4], [2, 1], [2, 5], [3, 0], [4, 1], [5, 2]]
    )
# SECTION
# NAME: EXECUTION

from qiskit import Aer, transpile, execute
backend_6dee58b5c1754bf5a54a69df8f859d70 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_6dee58b5c1754bf5a54a69df8f859d70, shots=979).result().get_counts(qc)
RESULT = counts

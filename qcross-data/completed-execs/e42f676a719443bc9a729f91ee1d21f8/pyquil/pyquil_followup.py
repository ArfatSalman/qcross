...
defns = get_custom_get_definitions("SdgGate", "C3SXGate", "CUGate", "CSXGate", "RZGate", "ZGate")
...
circuit.inst(Gates.C3SXGate( 7, 5, 2, 8 ))
circuit.inst(Gates.ZGate( 0 ))

qr_ed5edb = circuit.declare("qr_ed5edb", "BIT", 7)

...
p_e69891 = circuit.declare('p_e69891', 'REAL')
p_247eba = circuit.declare('p_247eba', 'REAL')
p_1b9590 = circuit.declare('p_1b9590', 'REAL')
p_a00224 = circuit.declare('p_a00224', 'REAL')
p_1b011b = circuit.declare('p_1b011b', 'REAL')

defns = get_custom_get_definitions("CRZGate", "U2Gate", "SXdgGate", "C3SXGate", "CRXGate", "RZZGate", "RYYGate", "CU1Gate", "CUGate", "RZGate", "TGate", "XGate", "CSXGate", "ZGate", "SdgGate", "SXGate")

circuit += defns

circuit.inst(Gates.RZGate(p_1b011b, 4 ))
circuit.inst(Gates.ZGate( 6 ))
circuit.inst(Gates.XGate( 6 ))
circuit.inst(Gates.CRXGate(5.987304452123941, 0, 6 ))
circuit.inst(Gates.CRZGate(p_247eba, 1, 6 ))
...
circuit.inst(Gates.ZGate( 6 ))
circuit.inst(Gates.RZGate(p_1b9590, 4 ))
circuit.inst(Gates.CRXGate(0.7279391018916035, 0, 3 ))
circuit.inst(Gates.CUGate(5.03147076606842, p_a00224, 3.1562533916051736, 4.940217775579305, 6, 2 ))
...
circuit.inst(Gates.RYYGate(p_e69891)( 4, 2 ))
...
params = {
    "p_e69891": 1.9669252191306448,
    "p_247eba": 1.0296448789776642,
    "p_1b9590": 3.775592041307464,
    "p_a00224": 5.0063780207098425,
    "p_1b011b": 6.163759533339787
}

...
p_e69891 = Symbol('p_e69891')
p_247eba = Symbol('p_247eba')
p_1b9590 = Symbol('p_1b9590')
p_a00224 = Symbol('p_a00224')
p_1b011b = Symbol('p_1b011b')

circuit = cirq.Circuit()

circuit.append(Gates.RZGate(p_1b011b)( qr[4] ))
circuit.append(Gates.ZGate( qr[6] ))
circuit.append(Gates.XGate( qr[6] ))
circuit.append(Gates.CRXGate(5.987304452123941)( qr[0], qr[6] ))
circuit.append(Gates.CRZGate(p_247eba)( qr[1], qr[6] ))
...
circuit.append(Gates.ZGate( qr[6] ))
circuit.append(Gates.RZGate(p_1b9590)( qr[4] ))
circuit.append(Gates.CRXGate(0.7279391018916035)( qr[0], qr[3] ))
circuit.append(Gates.CUGate(5.03147076606842, p_a00224, 3.1562533916051736, 4.940217775579305)( qr[6], qr[2] ))
...
circuit.append(Gates.RYYGate(p_e69891)( qr[4], qr[2] ))

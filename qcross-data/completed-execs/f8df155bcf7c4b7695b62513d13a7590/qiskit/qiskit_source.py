...
backend_2fa64d9040ee497f8b45e233c2dc2b73 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_2fa64d9040ee497f8b45e233c2dc2b73, shots=1959).result().get_counts(qc)
RESULT = counts
...
circuit.append(Gates.C3SXGate( qr[7], qr[8], qr[0], qr[2] ))
...
circuit.append(Gates.C3SXGate( qr[4], qr[5], qr[3], qr[7] ))
circuit.append(Gates.SXGate( qr[7] ))
circuit.append(Gates.CU1Gate(3.2142159669963557)( qr[8], qr[5] ))
circuit.append(Gates.CRZGate(1.4112277317699358)( qr[2], qr[8] ))
circuit.append(Gates.ZGate( qr[3] ))

...
backend_a4dcd70b59dd458f864a302f0ef33324 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_a4dcd70b59dd458f864a302f0ef33324, shots=3919).result().get_counts(qc)
RESULT = counts
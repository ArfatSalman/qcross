...
p_1d63ec = Symbol('p_1d63ec')

circuit = cirq.Circuit()

circuit.append(Gates.RZGate(6.163759533339787)( qr[8] ))
circuit.append(Gates.CSXGate( qr[2], qr[4] ))
circuit.append(Gates.CUGate(0.5112149185250571, p_1d63ec, 2.3864521352475245, 5.987304452123941)( qr[0], qr[6] ))

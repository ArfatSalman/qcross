...
p_bf1a11 = Symbol('p_bf1a11')
p_569154 = Symbol('p_569154')
p_ed6805 = Symbol('p_ed6805')

circuit = cirq.Circuit()

circuit.append(Gates.RZGate(p_569154)( qr[4] ))
circuit.append(Gates.ZGate( qr[6] ))
circuit.append(Gates.XGate( qr[3] ))
circuit.append(Gates.CRXGate(p_ed6805)( qr[2], qr[5] ))
...
circuit.append(Gates.RZGate(p_bf1a11)( qr[1] ))

...
circuit.append(Gates.CRXGate(5.987304452123941)( qr[0], qr[3] ))
circuit.append(Gates.CRZGate(1.0296448789776642)( qr[2], qr[3] ))
circuit.append(Gates.C3SXGate( qr[0], qr[1], qr[3], qr[7] ))

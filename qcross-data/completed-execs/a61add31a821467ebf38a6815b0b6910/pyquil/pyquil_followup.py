...
defns = get_custom_get_definitions("XGate", "ZGate", "CRZGate", "C3SXGate", "CRXGate", "RZGate")
...
circuit.inst(Gates.CRXGate(5.987304452123941, 0, 3 ))
circuit.inst(Gates.CRZGate(1.0296448789776642, 2, 3 ))
circuit.inst(Gates.C3SXGate( 0, 1, 3, 7 ))
circuit.inst(Gates.ZGate( 6 ))
circuit.inst(Gates.XGate( 2 ))

qr_54618b = circuit.declare("qr_54618b", "BIT", 9)

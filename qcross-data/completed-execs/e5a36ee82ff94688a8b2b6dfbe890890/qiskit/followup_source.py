...
# SECTION
# NAME: PARAMETERS
p_59a509 = Parameter('p_59a509')
p_8fad8a = Parameter('p_8fad8a')
...
backend_4877285f05e945e6bb9e086a006ed600 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_4877285f05e945e6bb9e086a006ed600, shots=692).result().get_counts(qc)
RESULT = counts

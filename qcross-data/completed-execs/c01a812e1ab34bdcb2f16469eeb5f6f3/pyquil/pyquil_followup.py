...
defns = get_custom_get_definitions("RZGate", "C3SXGate", "XGate", "CRXGate", "ZGate")
...
circuit.inst(Gates.CRXGate(2.0099472182748075, 6, 1 ))
circuit.inst(Gates.C3SXGate( 2, 5, 0, 6 ))

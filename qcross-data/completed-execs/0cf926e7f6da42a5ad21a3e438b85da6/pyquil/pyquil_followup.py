...
p_5e62ad = circuit.declare('p_5e62ad', 'REAL')
p_c72551 = circuit.declare('p_c72551', 'REAL')

defns = get_custom_get_definitions("RZGate", "CRZGate")

circuit += defns

circuit.inst(Gates.RZGate(p_c72551, 3 ))
circuit.inst(Gates.CRZGate(p_5e62ad, 6, 2 ))

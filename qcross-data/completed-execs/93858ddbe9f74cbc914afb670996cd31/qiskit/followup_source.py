...
backend_97f234eaf0654cd9918c0bcb39eb5393 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_97f234eaf0654cd9918c0bcb39eb5393, shots=1385).result().get_counts(qc)
RESULT = counts

...
backend_380516a1407d4bfd83f4a18c5efc4c08 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_380516a1407d4bfd83f4a18c5efc4c08, shots=2771).result().get_counts(qc)
RESULT = counts
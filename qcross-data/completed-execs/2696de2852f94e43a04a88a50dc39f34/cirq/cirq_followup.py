...
p_c17d7a = Symbol('p_c17d7a')
p_b8f691 = Symbol('p_b8f691')
p_abc7bc = Symbol('p_abc7bc')
p_61eb28 = Symbol('p_61eb28')
p_efb1d9 = Symbol('p_efb1d9')

circuit = cirq.Circuit()

circuit.append(Gates.RZGate(p_abc7bc)( qr[3] ))
circuit.append(Gates.CRZGate(p_c17d7a)( qr[6], qr[3] ))
circuit.append(Gates.CRXGate(p_efb1d9)( qr[1], qr[7] ))
circuit.append(Gates.CCXGate( qr[5], qr[9], qr[7] ))
circuit.append(Gates.ZGate( qr[2] ))
circuit.append(Gates.TGate( qr[9] ))
circuit.append(Gates.XGate( qr[8] ))
circuit.append(Gates.CRZGate(p_61eb28)( qr[1], qr[6] ))
circuit.append(Gates.RZGate(p_b8f691)( qr[1] ))

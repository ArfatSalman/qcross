...
defns = get_custom_get_definitions("CU1Gate", "RZZGate", "CCXGate", "RZGate", "ZGate", "TGate", "CRZGate", "CSXGate", "RCCXGate", "SXdgGate", "CHGate", "U2Gate", "XGate", "SdgGate")
...
qr_850574 = circuit.declare("qr_850574", "BIT", 7)

...
qr_850574 = QuantumRegister(7, name='qr_850574')
qc.add_register(qr_850574)
# SECTION
# NAME: MEASUREMENT
...
backend_aaac0cd6e2774b25ae1e40380a7dd5f3 = Aer.get_backend('aer_simulator')
counts = execute(qc, backend=backend_aaac0cd6e2774b25ae1e40380a7dd5f3, shots=7838).result().get_counts(qc)
RESULT = counts

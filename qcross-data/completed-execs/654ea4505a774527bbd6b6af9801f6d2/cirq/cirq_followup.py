...
circuit.append(Gates.CU1Gate(5.154187354656876)( qr[2], qr[3] ))
...
circuit.append(Gates.RYYGate(1.740253089260498)( qr[1], qr[3] ))
circuit.append(Gates.RCCXGate( qr[1], qr[2], qr[3] ))
circuit.append(Gates.SXdgGate( qr[3] ))
circuit.append(Gates.SGate( qr[2] ))
circuit.append(Gates.CRZGate(2.9790366726895714)( qr[3], qr[0] ))
circuit.append(Gates.C3SXGate( qr[0], qr[1], qr[3], qr[2] ))
circuit.append(Gates.RYYGate(5.398622178940033)( qr[1], qr[3] ))
circuit.append(Gates.SXdgGate( qr[3] ))

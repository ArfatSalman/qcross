...
qc = transpile(qc, basis_gates=None, optimization_level=2, coupling_map=[[0,
    1], [1, 0], [1, 3], [1, 5], [1, 7], [2, 3], [2, 4], [3, 1], [3, 2], [4,
    2], [5, 1], [6, 7], [7, 1], [7, 6]])
# SECTION
# NAME: EXECUTION

from qiskit import Aer, transpile, execute
backend_8fdaba52c5cc48b2b30202cf26051536 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_8fdaba52c5cc48b2b30202cf26051536, shots=1959).result().get_counts(qc)
RESULT = counts

...
backend_c933c3c6c2e849588eeb402969dcdc66 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_c933c3c6c2e849588eeb402969dcdc66, shots=3919).result().get_counts(qc)
RESULT = counts

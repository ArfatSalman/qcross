...
backend_7d184937c8ca46bc9114b4e69cce5fb9 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_7d184937c8ca46bc9114b4e69cce5fb9, shots=2771).result().get_counts(qc)
RESULT = counts
...
backend_d8f3706bd455416fb554d1dd2efae11c = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_d8f3706bd455416fb554d1dd2efae11c, shots=979).result().get_counts(qc)
RESULT = counts

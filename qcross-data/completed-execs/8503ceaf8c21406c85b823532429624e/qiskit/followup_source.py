...
backend_344b43180bfb4f669770f4634e96f979 = Aer.get_backend('aer_simulator')
counts = execute(qc, backend=backend_344b43180bfb4f669770f4634e96f979, shots=979).result().get_counts(qc)
RESULT = counts

...
p_cce11c = circuit.declare('p_cce11c', 'REAL')
p_8f908f = circuit.declare('p_8f908f', 'REAL')

defns = get_custom_get_definitions("CRZGate", "RZGate")

circuit += defns

circuit.inst(Gates.RZGate(p_cce11c, 3 ))
circuit.inst(Gates.CRZGate(p_8f908f, 6, 2 ))
...
params = {
    "p_cce11c": 6.163759533339787,
    "p_8f908f": 4.2641612072511235
}

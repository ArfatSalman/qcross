...
qr_1be77c = QuantumRegister(8, name='qr_1be77c')
qc.add_register(qr_1be77c)
# SECTION
...
from qiskit import Aer, transpile, execute
backend_3d89407bfe054713b4be18bf06889e5b = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_3d89407bfe054713b4be18bf06889e5b, shots=979).result().get_counts(qc)
RESULT = counts

...
backend_00c22f926e1a4e549d4935c6736958b4 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_00c22f926e1a4e549d4935c6736958b4, shots=692).result().get_counts(qc)
RESULT = counts

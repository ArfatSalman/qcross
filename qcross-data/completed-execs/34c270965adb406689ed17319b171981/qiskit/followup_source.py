...
qr_e8a509 = QuantumRegister(6, name='qr_e8a509')
qc.add_register(qr_e8a509)
# SECTION
# NAME: MEASUREMENT
...
backend_3f3fced5e9494de88fb93a9664ea00da = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_3f3fced5e9494de88fb93a9664ea00da, shots=1385).result().get_counts(qc)
RESULT = counts

...
defns = get_custom_get_definitions("RCCXGate", "C3SXGate", "CUGate", "UGate", "SXGate", "CU1Gate", "CCXGate", "RZGate", "ZGate", "SGate", "TGate", "CRZGate", "RZZGate")
...
qr_e8a509 = circuit.declare("qr_e8a509", "BIT", 6)

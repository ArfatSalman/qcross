...
backend_bbce566b395246ff889a329901e3db90 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_bbce566b395246ff889a329901e3db90, shots=2771).result().get_counts(qc)
RESULT = counts
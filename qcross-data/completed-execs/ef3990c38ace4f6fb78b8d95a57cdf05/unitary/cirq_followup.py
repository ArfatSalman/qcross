...
circuit.append(Gates.CRXGate(2.0099472182748075)( qr[1], qr[3] ))
circuit.append(Gates.C3SXGate( qr[2], qr[4], qr[0], qr[1] ))
circuit.append(Gates.CHGate( qr[5], qr[2] ))
circuit.append(Gates.C3SXGate( qr[4], qr[1], qr[0], qr[3] ))
circuit.append(Gates.ZGate( qr[1] ))
circuit.append(Gates.ECRGate( qr[2], qr[6] ))
circuit.append(Gates.SdgGate( qr[2] ))
circuit.append(Gates.RCCXGate( qr[1], qr[3], qr[4] ))
circuit.append(Gates.SGate( qr[0] ))
circuit.append(Gates.RZGate(4.229610589867865)( qr[0] ))
circuit.append(Gates.C3SXGate( qr[4], qr[1], qr[0], qr[6] ))
circuit.append(Gates.CU1Gate(3.2142159669963557)( qr[5], qr[4] ))
circuit.append(Gates.CRXGate(5.94477504571567)( qr[5], qr[2] ))
circuit.append(Gates.CHGate( qr[5], qr[4] ))
circuit.append(Gates.C3SXGate( qr[1], qr[4], qr[6], qr[5] ))

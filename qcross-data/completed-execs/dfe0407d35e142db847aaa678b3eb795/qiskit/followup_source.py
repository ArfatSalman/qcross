...
qr_00417f = QuantumRegister(7, name='qr_00417f')
qc.add_register(qr_00417f)
# SECTION
# NAME: MEASUREMENT
...
backend_e7653be38ec74f66abb1ff6adedf8ba2 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_e7653be38ec74f66abb1ff6adedf8ba2, shots=7838).result().get_counts(qc)
RESULT = counts

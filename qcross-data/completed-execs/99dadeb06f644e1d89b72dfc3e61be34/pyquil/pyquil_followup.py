...
defns = get_custom_get_definitions("RCCXGate", "XGate", "RZGate", "TGate", "CUGate", "RYYGate", "SXdgGate", "CHGate", "CSXGate", "C3SXGate", "CU1Gate", "iSwapGate", "RZZGate")
...
circuit.inst(Gates.RCCXGate( 0, 1, 3 ))
circuit.inst(Gates.RYYGate(1.740253089260498)( 2, 1 ))
circuit.inst(Gates.RCCXGate( 2, 3, 1 ))

...
qc.append(RCCXGate(), qargs=[qr[0], qr[1], qr[3]], cargs=[])
qc.append(RYYGate(1.740253089260498), qargs=[qr[2], qr[1]], cargs=[])
qc.append(RCCXGate(), qargs=[qr[2], qr[3], qr[1]], cargs=[])
...
backend_3223266d7b954f089500d87b804a7175 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_3223266d7b954f089500d87b804a7175, shots=692).result().get_counts(qc)
RESULT = counts

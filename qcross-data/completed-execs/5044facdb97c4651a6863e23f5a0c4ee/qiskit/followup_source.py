...
# SECTION
# NAME: PARAMETERS
p_8dcae8 = Parameter('p_8dcae8')
p_aa831e = Parameter('p_aa831e')
p_84ca0c = Parameter('p_84ca0c')
...
qc.append(CRZGate(p_8dcae8), qargs=[qr[6], qr[3]], cargs=[])
...
qc.append(CRZGate(p_84ca0c), qargs=[qr[1], qr[2]], cargs=[])
qc.append(U2Gate(p_aa831e, 2.1276323672732023), qargs=[qr[2]], cargs=[])
...
backend_ff5eab42d285475999f46a7914e2cbc5 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_ff5eab42d285475999f46a7914e2cbc5, shots=5542).result().get_counts(qc)
RESULT = counts

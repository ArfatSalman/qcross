...
p_8dcae8 = Symbol('p_8dcae8')
p_aa831e = Symbol('p_aa831e')
p_84ca0c = Symbol('p_84ca0c')

circuit = cirq.Circuit()

circuit.append(Gates.RZGate(6.163759533339787)( qr[3] ))
circuit.append(Gates.CRZGate(p_8dcae8)( qr[6], qr[3] ))
...
circuit.append(Gates.CRZGate(p_84ca0c)( qr[1], qr[2] ))
circuit.append(Gates.U2Gate(p_aa831e, 2.1276323672732023)( qr[2] ))

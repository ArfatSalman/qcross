...
defns = get_custom_get_definitions("TGate", "RZZGate", "SXGate", "ECRGate", "CRXGate", "RYYGate", "RXGate", "ZGate", "CU1Gate", "iSwapGate", "CHGate", "RZGate", "CPhaseGate", "CSXGate", "SXdgGate", "CRZGate", "XGate")
...
qr_23a5b5 = circuit.declare("qr_23a5b5", "BIT", 7)

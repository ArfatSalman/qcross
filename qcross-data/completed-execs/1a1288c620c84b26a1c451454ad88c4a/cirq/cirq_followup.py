...
p_028c2d = Symbol('p_028c2d')
p_77e236 = Symbol('p_77e236')
p_0f0077 = Symbol('p_0f0077')

circuit = cirq.Circuit()

circuit.append(Gates.RZGate(p_028c2d)( qr[1] ))
...
circuit.append(Gates.CRXGate(p_0f0077)( qr[2], qr[0] ))
circuit.append(Gates.SGate( qr[0] ))
circuit.append(Gates.CCXGate( qr[1], qr[2], qr[0] ))
circuit.append(Gates.CHGate( qr[0], qr[2] ))
circuit.append(Gates.CHGate( qr[1], qr[0] ))
circuit.append(Gates.RYYGate(p_77e236)( qr[1], qr[2] ))

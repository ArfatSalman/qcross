...
backend_50fa3d43639b4c31872131317a68e772 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_50fa3d43639b4c31872131317a68e772, shots=346).result().get_counts(qc)
RESULT = counts

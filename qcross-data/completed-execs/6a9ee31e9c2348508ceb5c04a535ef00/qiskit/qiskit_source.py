...
backend_6a3a18b559b14a9c91978d105e41bb42 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_6a3a18b559b14a9c91978d105e41bb42, shots=489).result().get_counts(qc)
RESULT = counts
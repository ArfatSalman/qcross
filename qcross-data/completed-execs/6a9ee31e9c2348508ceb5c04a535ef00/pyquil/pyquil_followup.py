...
defns = get_custom_get_definitions("TGate", "iSwapGate", "SXdgGate", "CHGate", "CCXGate", "RYYGate", "RCCXGate", "CRXGate", "XGate", "SdgGate", "ECRGate", "CSXGate", "RZGate", "ZGate", "SGate")
...
qr_3394ef = circuit.declare("qr_3394ef", "BIT", 6)

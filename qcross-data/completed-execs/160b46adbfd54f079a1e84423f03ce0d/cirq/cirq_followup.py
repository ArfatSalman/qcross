...
circuit.append(Gates.CSXGate( qr[2], qr[7] ))
circuit.append(Gates.CUGate(0.5112149185250571, 5.897054719225356, 2.3864521352475245, 5.987304452123941)( qr[4], qr[6] ))
circuit.append(Gates.SdgGate( qr[5] ))
circuit.append(Gates.C3SXGate( qr[4], qr[8], qr[0], qr[3] ))
circuit.append(Gates.ZGate( qr[2] ))
circuit.append(Gates.XGate( qr[3] ))
circuit.append(Gates.SGate( qr[4] ))
circuit.append(Gates.SGate( qr[8] ))
circuit.append(Gates.C3SXGate( qr[5], qr[1], qr[2], qr[4] ))

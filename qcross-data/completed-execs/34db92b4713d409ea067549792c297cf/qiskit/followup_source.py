...
backend_e53f02bc07434229a6b15dc58c07d554 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_e53f02bc07434229a6b15dc58c07d554, shots=5542).result().get_counts(qc)
RESULT = counts

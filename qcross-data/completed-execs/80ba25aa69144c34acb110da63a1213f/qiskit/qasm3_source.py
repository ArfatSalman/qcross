...
backend_989169a297404208b377c66180b15ce1 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_989169a297404208b377c66180b15ce1, shots=692).result().get_counts(qc)
RESULT = counts

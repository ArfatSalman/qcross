...
qc = transpile(qc, basis_gates=None, optimization_level=2, coupling_map=[[0,
    1], [0, 2], [1, 0], [1, 5], [2, 0], [3, 4], [3, 5], [4, 3], [5, 1], [5, 3]]
    )
# SECTION
# NAME: EXECUTION

from qiskit import Aer, transpile, execute
backend_2b01c72ca9f74c36bdb62ea685880004 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_2b01c72ca9f74c36bdb62ea685880004, shots=692).result().get_counts(qc)
RESULT = counts

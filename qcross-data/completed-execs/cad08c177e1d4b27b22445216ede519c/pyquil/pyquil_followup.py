...
qr_1 = qc_1.declare("ro", "BIT", 8)



defns = get_custom_get_definitions("CCXGate", "CRZGate", "XGate", "RCCXGate", "ZGate")

qc_1 += defns

qc_1.inst(Gates.CRZGate(4.2641612072511235, 2, 0 ))
qc_1.inst(Gates.CCXGate( 1, 5, 3 ))
qc_1.inst(Gates.ZGate( 0 ))
qc_1.inst(Gates.XGate( 3 ))
qc_1.inst(Gates.RCCXGate( 6, 2, 4 ))
qc_1.inst(Gates.CCXGate( 3, 6, 0 ))
...
defns = get_custom_get_definitions("RZGate", "ZGate")

qc_2 += defns

qc_2.inst(Gates.RZGate(6.163759533339787, 0 ))
qc_2.inst(Gates.ZGate( 1 ))
qc_2.inst(Gates.RZGate(4.229610589867865, 2 ))

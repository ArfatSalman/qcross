...
qr_1 = [cirq.NamedQubit('q' + str(i)) for i in range(8)]



qc_1 = cirq.Circuit()

qc_1.append(Gates.CRZGate(4.2641612072511235)( qr_1[2], qr_1[0] ))
qc_1.append(Gates.CCXGate( qr_1[1], qr_1[5], qr_1[3] ))
qc_1.append(Gates.ZGate( qr_1[0] ))
qc_1.append(Gates.XGate( qr_1[3] ))
qc_1.append(Gates.RCCXGate( qr_1[6], qr_1[2], qr_1[4] ))
qc_1.append(Gates.CCXGate( qr_1[3], qr_1[6], qr_1[0] ))
...
counts = get_qiskit_like_output(result_1, keys=['cr0', 'cr1', 'cr2', 'cr3', 'cr4', 'cr5', 'cr6', 'cr7'])
...
qc_2.append(Gates.RZGate(4.229610589867865)( qr_2[2] ))

...
backend_f64641d1849d4cfe86970302f09d3b15 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_f64641d1849d4cfe86970302f09d3b15, shots=1385).result().get_counts(qc)
RESULT = counts
...
qc.append(RYYGate(1.740253089260498), qargs=[qr[1], qr[2]], cargs=[])
qc.append(RCCXGate(), qargs=[qr[1], qr[3], qr[2]], cargs=[])
# SECTION
# NAME: MEASUREMENT
...
backend_6faf7b034a454651b336ea1e16c207e0 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_6faf7b034a454651b336ea1e16c207e0, shots=692).result().get_counts(qc)
RESULT = counts

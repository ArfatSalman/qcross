...
backend_33c031284bd74ee9b0431279c3be7f6e = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_33c031284bd74ee9b0431279c3be7f6e, shots=692).result().get_counts(qc)
RESULT = counts

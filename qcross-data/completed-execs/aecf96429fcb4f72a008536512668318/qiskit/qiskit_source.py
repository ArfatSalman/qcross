...
backend_16d75cdc4b1f4461919ee095b006a5d0 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_16d75cdc4b1f4461919ee095b006a5d0, shots=1385).result().get_counts(qc)
RESULT = counts
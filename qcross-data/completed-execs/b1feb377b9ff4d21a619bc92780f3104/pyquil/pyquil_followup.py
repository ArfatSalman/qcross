...
defns = get_custom_get_definitions("C3SXGate", "CRXGate", "RZGate", "XGate", "ZGate", "CHGate")
...
circuit.inst(Gates.CRXGate(2.0099472182748075, 1, 0 ))
circuit.inst(Gates.C3SXGate( 6, 2, 5, 1 ))

...
p_59406e = circuit.declare('p_59406e', 'REAL')
p_1c809b = circuit.declare('p_1c809b', 'REAL')

defns = get_custom_get_definitions("CPhaseGate", "CUGate", "RZZGate", "SXGate", "RZGate", "CU1Gate", "CSXGate", "CRZGate", "iSwapGate", "XGate", "ZGate", "CRXGate", "RYYGate", "C3SXGate")

circuit += defns

circuit.inst(Gates.RZGate(p_1c809b, 4 ))
...
subcircuit = Program()
subcircuit.inst(Gates.iSwapGate( 1, 7 ))
subcircuit.inst(Gates.CPhaseGate(3.326780904591333, 0, 6 ))
subcircuit.inst(Gates.CU1Gate(2.0685963035149753, 5, 4 ))
circuit.inst(subcircuit)
circuit.inst(subcircuit.dagger())

circuit.inst(Gates.CRXGate(p_59406e, 0, 3 ))
circuit.inst(Gates.CUGate(5.03147076606842, 5.0063780207098425, 3.1562533916051736, 4.940217775579305, 6, 2 ))

qr_9875d8 = circuit.declare("qr_9875d8", "BIT", 6)
...
params = {
    "p_59406e": 0.7279391018916035,
    "p_1c809b": 6.163759533339787
}

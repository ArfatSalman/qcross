...
p_59406e = Symbol('p_59406e')
p_1c809b = Symbol('p_1c809b')

circuit = cirq.Circuit()

circuit.append(Gates.RZGate(p_1c809b)( qr[4] ))
...
subcircuit.append(Gates.iSwapGate( qr[1], qr[7] ))
subcircuit.append(Gates.CPhaseGate(3.326780904591333)( qr[0], qr[6] ))
subcircuit.append(Gates.CU1Gate(2.0685963035149753)( qr[5], qr[4] ))
circuit.append(subcircuit)
circuit.append(cirq.inverse(cirq.expand_composite(subcircuit)))

circuit.append(Gates.CRXGate(p_59406e)( qr[0], qr[3] ))

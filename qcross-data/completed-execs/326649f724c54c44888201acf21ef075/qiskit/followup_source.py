...
p_59406e = Parameter('p_59406e')
p_1c809b = Parameter('p_1c809b')
# SECTION
# NAME: CIRCUIT
...
qc.append(RZGate(p_1c809b), qargs=[qr[4]], cargs=[])
...
subcircuit.append(iSwapGate(), qargs=[qr[1], qr[7]], cargs=[])
subcircuit.append(CPhaseGate(3.326780904591333), qargs=[qr[0], qr[6]], cargs=[])
subcircuit.append(CU1Gate(2.0685963035149753), qargs=[qr[5], qr[4]], cargs=[])

qc.append(subcircuit, qargs=qr, cargs=cr)
qc.append(subcircuit.inverse(), qargs=qr, cargs=cr)
qc.append(CRXGate(p_59406e), qargs=[qr[0], qr[3]], cargs=[])
qc.append(CUGate(5.03147076606842, 5.0063780207098425, 3.1562533916051736, 4.940217775579305), qargs=[qr[6], qr[2]], cargs=[])
# SECTION
# NAME: USELESS_ENTITIES

qr_9875d8 = QuantumRegister(6, name='qr_9875d8')
qc.add_register(qr_9875d8)
# SECTION
# NAME: MEASUREMENT
...
qc = qc.bind_parameters({p_59406e: 0.7279391018916035, p_1c809b: 6.163759533339787})
# SECTION
...
backend_6853161f5ace46a0a15cd3a4e24ecc42 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_6853161f5ace46a0a15cd3a4e24ecc42, shots=2771).result().get_counts(qc)
RESULT = counts

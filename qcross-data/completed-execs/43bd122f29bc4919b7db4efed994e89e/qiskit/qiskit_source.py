...
backend_4322cc79428a44f282a3ccc031df7b03 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_4322cc79428a44f282a3ccc031df7b03, shots=346).result().get_counts(qc)
RESULT = counts
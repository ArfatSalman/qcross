...
backend_5aa3cbf79db246f5bbc77dc8f81dd413 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_5aa3cbf79db246f5bbc77dc8f81dd413, shots=7838).result().get_counts(qc)
RESULT = counts
...
backend_65f6b5e39ea04cbba12fe5f7d1d4907a = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_65f6b5e39ea04cbba12fe5f7d1d4907a, shots=979).result().get_counts(qc)
RESULT = counts
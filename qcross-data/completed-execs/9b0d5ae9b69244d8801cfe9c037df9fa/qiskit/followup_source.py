...
backend_199b5115919042e2bb929c65ba900883 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_199b5115919042e2bb929c65ba900883, shots=5542).result().get_counts(qc)
RESULT = counts

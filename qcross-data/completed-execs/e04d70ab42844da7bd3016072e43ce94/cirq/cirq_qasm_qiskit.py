...
p_0e7163 = Symbol('p_0e7163')
p_44a409 = Symbol('p_44a409')
p_8270ff = Symbol('p_8270ff')
p_96c96a = Symbol('p_96c96a')
p_796fab = Symbol('p_796fab')
p_8d288b = Symbol('p_8d288b')
p_facb1d = Symbol('p_facb1d')
p_492eef = Symbol('p_492eef')

circuit = cirq.Circuit()

circuit.append(Gates.RZGate(p_44a409)( qr[4] ))
circuit.append(Gates.ZGate( qr[3] ))
circuit.append(Gates.CRZGate(p_8270ff)( qr[2], qr[4] ))
circuit.append(Gates.CUGate(0.5112149185250571, 5.897054719225356, p_8d288b, 5.987304452123941)( qr[2], qr[3] ))
...
circuit.append(Gates.CRZGate(p_facb1d)( qr[1], qr[5] ))
circuit.append(Gates.RZGate(4.229610589867865)( qr[1] ))
circuit.append(Gates.C3SXGate( qr[0], qr[2], qr[1], qr[3] ))
circuit.append(Gates.CU1Gate(p_0e7163)( qr[3], qr[0] ))
circuit.append(Gates.UGate(5.887184334931191, 0.07157463504881167, p_492eef)( qr[5] ))
...
circuit.append(Gates.CU1Gate(p_96c96a)( qr[1], qr[4] ))
circuit.append(Gates.C3SXGate( qr[3], qr[0], qr[4], qr[2] ))
circuit.append(Gates.CRZGate(p_796fab)( qr[2], qr[5] ))
circuit.append(Gates.CRXGate(2.6687018103754414)( qr[4], qr[5] ))
circuit.append(Gates.CRZGate(5.742126321682921)( qr[2], qr[0] ))

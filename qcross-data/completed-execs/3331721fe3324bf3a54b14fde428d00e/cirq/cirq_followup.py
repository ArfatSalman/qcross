...
p_6d9df8 = Symbol('p_6d9df8')
p_f1ed17 = Symbol('p_f1ed17')
...
circuit.append(Gates.CRZGate(p_f1ed17)( qr[1], qr[2] ))
circuit.append(Gates.U2Gate(p_6d9df8, 2.1276323672732023)( qr[2] ))

...
p_6d9df8 = circuit.declare('p_6d9df8', 'REAL')
p_f1ed17 = circuit.declare('p_f1ed17', 'REAL')

defns = get_custom_get_definitions("RZGate", "ZGate", "SXdgGate", "CSXGate", "C3SXGate", "CHGate", "CRZGate", "CRXGate", "SXGate", "U2Gate", "CCXGate", "XGate", "TGate")
...
circuit.inst(Gates.CRZGate(p_f1ed17, 1, 2 ))
circuit.inst(Gates.U2Gate(p_6d9df8, 2.1276323672732023)( 2 ))

...
circuit.append(Gates.CRZGate(4.2641612072511235)( qr[8], qr[5] ))
...
circuit.append(Gates.RCCXGate( qr[10], qr[8], qr[2] ))
circuit.append(Gates.RZGate(4.229610589867865)( qr[9] ))
circuit.append(Gates.CCXGate( qr[4], qr[10], qr[5] ))
...
circuit.append(Gates.CHGate( qr[9], qr[4] ))
circuit.append(Gates.CU1Gate(4.028174522740928)( qr[1], qr[9] ))
circuit.append(Gates.RZGate(5.0063780207098425)( qr[8] ))
circuit.append(Gates.U2Gate(2.5163050709890156, 2.1276323672732023)( qr[5] ))
circuit.append(Gates.TGate( qr[9] ))
circuit.append(Gates.RZZGate(3.950837470808744)( qr[0], qr[9] ))
circuit.append(Gates.TGate( qr[9] ))
circuit.append(Gates.TGate( qr[6] ))
circuit.append(Gates.SXdgGate( qr[3] ))
circuit.append(Gates.RZGate(4.722103101046168)( qr[5] ))
circuit.append(Gates.CRZGate(0.6393443962862078)( qr[3], qr[7] ))

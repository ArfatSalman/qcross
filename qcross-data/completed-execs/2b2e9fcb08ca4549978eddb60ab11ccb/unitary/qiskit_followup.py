...
qr_1aa900 = QuantumRegister(1, name='qr_1aa900')
qc.add_register(qr_1aa900)
# SECTION
...
from qiskit import Aer, transpile, execute
backend_6b1e3c40b11e407595f8964ea1267bac = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_6b1e3c40b11e407595f8964ea1267bac, shots=3919).result().get_counts(qc)
RESULT = counts

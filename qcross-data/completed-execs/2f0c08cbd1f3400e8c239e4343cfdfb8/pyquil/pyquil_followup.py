...
defns = get_custom_get_definitions("CSXGate", "CUGate", "ZGate", "XGate", "CPhaseGate", "SXGate", "CSwapGate", "iSwapGate", "RCCXGate", "CXGate", "CU1Gate", "SdgGate", "PhaseGate", "ECRGate", "SGate", "C3SXGate", "RZGate", "CRXGate", "CHGate", "CRZGate")
...
qr_941308 = circuit.declare("qr_941308", "BIT", 3)

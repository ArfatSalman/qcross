...
backend_526188c6f73044a7bf7058cc79945371 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_526188c6f73044a7bf7058cc79945371, shots=1959).result().get_counts(qc)
RESULT = counts

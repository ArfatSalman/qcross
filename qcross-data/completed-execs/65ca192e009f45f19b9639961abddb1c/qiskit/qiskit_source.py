...
backend_f0548678737d4cf994dc50885083c96e = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_f0548678737d4cf994dc50885083c96e, shots=1959).result().get_counts(qc)
RESULT = counts
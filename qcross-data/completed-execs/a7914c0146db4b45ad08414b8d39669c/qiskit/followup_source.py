...
# SECTION
# NAME: PARAMETERS
p_d78b4f = Parameter('p_d78b4f')
p_670928 = Parameter('p_670928')
p_3efaaf = Parameter('p_3efaaf')
p_779c94 = Parameter('p_779c94')
p_c2a67e = Parameter('p_c2a67e')
p_9e6f86 = Parameter('p_9e6f86')
p_637ac4 = Parameter('p_637ac4')
...
qc.append(CU1Gate(p_670928), qargs=[qr[9], qr[0]], cargs=[])
qc.append(RZGate(5.0063780207098425), qargs=[qr[6]], cargs=[])
qc.append(U2Gate(p_3efaaf, p_637ac4), qargs=[qr[2]], cargs=[])
qc.append(TGate(), qargs=[qr[0]], cargs=[])
qc.append(RZZGate(p_9e6f86), qargs=[qr[4], qr[0]], cargs=[])
qc.append(TGate(), qargs=[qr[0]], cargs=[])
qc.append(TGate(), qargs=[qr[1]], cargs=[])
qc.append(SXdgGate(), qargs=[qr[5]], cargs=[])
qc.append(RZGate(p_c2a67e), qargs=[qr[2]], cargs=[])
...
backend_7126fbf12881492097471d12df1fe3ec = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_7126fbf12881492097471d12df1fe3ec, shots=7838).result().get_counts(qc)
RESULT = counts

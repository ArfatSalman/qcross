...
defns = get_custom_get_definitions("U2Gate", "RCCXGate", "CSXGate", "CUGate", "RZGate", "SdgGate", "CU1Gate", "ZGate", "CCXGate", "XGate", "CHGate", "DCXGate", "CRZGate", "PhaseGate", "ECRGate", "CSwapGate")
...
subcircuit.inst(Gates.PhaseGate(0.4827903095199283, 0 ))
subcircuit.inst(Gates.CUGate(5.014941143947427, 4.437078557875917, 6.016631690603051, 3.1243053509071124, 3, 1 ))
subcircuit.inst(Gates.DCXGate( 3, 6 ))
subcircuit.inst(Gates.CHGate( 2, 5 ))
subcircuit.inst(Gates.CUGate(2.862865991712737, 6.0504088665633065, 1.7203758404994713, 2.8704483107274004, 1, 8 ))
subcircuit.inst(Gates.CHGate( 8, 5 ))

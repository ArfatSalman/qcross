...
subcircuit.append(Gates.PhaseGate(0.4827903095199283)( qr[0] ))
subcircuit.append(Gates.CUGate(5.014941143947427, 4.437078557875917, 6.016631690603051, 3.1243053509071124)( qr[3], qr[1] ))
subcircuit.append(Gates.DCXGate( qr[3], qr[6] ))
subcircuit.append(Gates.CHGate( qr[2], qr[5] ))
subcircuit.append(Gates.CUGate(2.862865991712737, 6.0504088665633065, 1.7203758404994713, 2.8704483107274004)( qr[1], qr[8] ))
subcircuit.append(Gates.CHGate( qr[8], qr[5] ))

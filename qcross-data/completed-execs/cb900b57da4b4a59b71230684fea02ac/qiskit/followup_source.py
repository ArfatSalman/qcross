...
backend_031b156f8fa7478b941ac8dd7c419479 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_031b156f8fa7478b941ac8dd7c419479, shots=5542).result().get_counts(qc)
RESULT = counts

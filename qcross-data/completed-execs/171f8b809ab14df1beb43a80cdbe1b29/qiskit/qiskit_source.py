...
backend_dca6b850b76644a3bf5515332c33a371 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_dca6b850b76644a3bf5515332c33a371, shots=346).result().get_counts(qc)
RESULT = counts
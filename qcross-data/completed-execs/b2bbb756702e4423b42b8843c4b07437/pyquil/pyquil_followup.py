...
defns = get_custom_get_definitions("ZGate", "CHGate", "CU1Gate", "RCCXGate", "SGate", "C3SXGate", "ECRGate", "XGate", "CRXGate", "RZGate", "CRZGate", "CSXGate", "SdgGate")
...
circuit.inst(Gates.CRXGate(5.94477504571567, 1, 4 ))
circuit.inst(Gates.CHGate( 1, 5 ))
circuit.inst(Gates.C3SXGate( 6, 5, 3, 1 ))
circuit.inst(Gates.CSXGate( 5, 6 ))
circuit.inst(Gates.ZGate( 2 ))
circuit.inst(Gates.CRZGate(4.833923139882297, 5, 4 ))

qr_dfac8e = circuit.declare("qr_dfac8e", "BIT", 7)

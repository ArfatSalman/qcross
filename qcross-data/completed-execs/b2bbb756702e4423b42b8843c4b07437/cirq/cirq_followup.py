...
circuit.append(Gates.C3SXGate( qr[4], qr[5], qr[0], qr[6] ))
circuit.append(Gates.CHGate( qr[1], qr[4] ))
circuit.append(Gates.C3SXGate( qr[5], qr[6], qr[0], qr[2] ))
circuit.append(Gates.ZGate( qr[6] ))
circuit.append(Gates.ECRGate( qr[4], qr[3] ))
circuit.append(Gates.SdgGate( qr[4] ))
circuit.append(Gates.RCCXGate( qr[6], qr[2], qr[5] ))
circuit.append(Gates.SGate( qr[0] ))
circuit.append(Gates.RZGate(4.229610589867865)( qr[0] ))
circuit.append(Gates.C3SXGate( qr[5], qr[6], qr[0], qr[3] ))
circuit.append(Gates.CU1Gate(3.2142159669963557)( qr[1], qr[5] ))
circuit.append(Gates.CRXGate(5.94477504571567)( qr[1], qr[4] ))
circuit.append(Gates.CHGate( qr[1], qr[5] ))
circuit.append(Gates.C3SXGate( qr[6], qr[5], qr[3], qr[1] ))
circuit.append(Gates.CSXGate( qr[5], qr[6] ))
circuit.append(Gates.ZGate( qr[2] ))
circuit.append(Gates.CRZGate(4.833923139882297)( qr[5], qr[4] ))

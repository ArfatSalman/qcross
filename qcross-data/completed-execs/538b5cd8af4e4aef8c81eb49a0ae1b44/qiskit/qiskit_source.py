...
backend_5db6aa48d8d3497da00c886e621dd826 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_5db6aa48d8d3497da00c886e621dd826, shots=1385).result().get_counts(qc)
RESULT = counts
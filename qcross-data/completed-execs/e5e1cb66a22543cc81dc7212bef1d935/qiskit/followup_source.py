...
qc = transpile(qc, basis_gates=None, optimization_level=2, coupling_map=[[0,
    1], [0, 5], [0, 6], [1, 0], [1, 2], [1, 3], [1, 4], [2, 1], [3, 1], [4,
    1], [5, 0], [6, 0]])
# SECTION
# NAME: EXECUTION

from qiskit import Aer, transpile, execute
backend_1e9964a6a3c349b49170828e324090a2 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_1e9964a6a3c349b49170828e324090a2, shots=979).result().get_counts(qc)
RESULT = counts

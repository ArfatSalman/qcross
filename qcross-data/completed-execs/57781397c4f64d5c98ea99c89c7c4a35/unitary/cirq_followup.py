...
circuit.append(Gates.CRXGate(2.0099472182748075)( qr[3], qr[6] ))
circuit.append(Gates.C3SXGate( qr[1], qr[5], qr[4], qr[3] ))
circuit.append(Gates.CHGate( qr[2], qr[1] ))
circuit.append(Gates.C3SXGate( qr[5], qr[3], qr[4], qr[6] ))
circuit.append(Gates.ZGate( qr[3] ))
circuit.append(Gates.ECRGate( qr[1], qr[0] ))
circuit.append(Gates.SdgGate( qr[1] ))
circuit.append(Gates.RCCXGate( qr[3], qr[6], qr[5] ))
circuit.append(Gates.SGate( qr[4] ))
circuit.append(Gates.RZGate(4.229610589867865)( qr[4] ))
circuit.append(Gates.C3SXGate( qr[5], qr[3], qr[4], qr[0] ))

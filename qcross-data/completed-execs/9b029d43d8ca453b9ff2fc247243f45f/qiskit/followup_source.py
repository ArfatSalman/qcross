...
backend_cafc96ce661e41dda394857c7c1cb0a5 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_cafc96ce661e41dda394857c7c1cb0a5, shots=346).result().get_counts(qc)
RESULT = counts

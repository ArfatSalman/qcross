...
backend_8e14a14158a545b0948957eb910b5c5c = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_8e14a14158a545b0948957eb910b5c5c, shots=5542).result().get_counts(qc)
RESULT = counts

...
p_8358ec = Symbol('p_8358ec')
p_9207da = Symbol('p_9207da')
p_87f09b = Symbol('p_87f09b')

circuit = cirq.Circuit()

circuit.append(Gates.RZGate(6.163759533339787)( qr[8] ))
circuit.append(Gates.CSXGate( qr[2], qr[4] ))
circuit.append(Gates.CUGate(p_8358ec, p_87f09b, 2.3864521352475245, 5.987304452123941)( qr[0], qr[6] ))
...
circuit.append(Gates.U2Gate(p_9207da, 2.1276323672732023)( qr[2] ))

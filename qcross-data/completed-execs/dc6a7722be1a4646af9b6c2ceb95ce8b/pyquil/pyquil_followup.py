...
p_8358ec = circuit.declare('p_8358ec', 'REAL')
p_9207da = circuit.declare('p_9207da', 'REAL')
p_87f09b = circuit.declare('p_87f09b', 'REAL')

defns = get_custom_get_definitions("SGate", "C3SXGate", "U2Gate", "RCCXGate", "CSXGate", "CUGate", "RZGate", "SdgGate", "CU1Gate", "ZGate", "CHGate", "XGate", "TGate", "CCXGate", "CRZGate", "SXGate")

circuit += defns

circuit.inst(Gates.RZGate(6.163759533339787, 8 ))
circuit.inst(Gates.CSXGate( 2, 4 ))
circuit.inst(Gates.CUGate(p_8358ec, p_87f09b, 2.3864521352475245, 5.987304452123941, 0, 6 ))

...
qc = transpile(qc, basis_gates=None, optimization_level=2, coupling_map=[[0,
    1], [0, 2], [0, 4], [0, 8], [1, 0], [1, 6], [2, 0], [2, 3], [2, 5], [3,
    2], [4, 0], [5, 2], [6, 1], [7, 8], [8, 0], [8, 7]])
# SECTION
# NAME: EXECUTION

from qiskit import Aer, transpile, execute
backend_a46126155b464f3ba74eebdb56067a75 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_a46126155b464f3ba74eebdb56067a75, shots=3919).result().get_counts(qc)
RESULT = counts

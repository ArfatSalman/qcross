...
backend_5d5829eca3e04a41bfeac681b506c164 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_5d5829eca3e04a41bfeac681b506c164, shots=1385).result().get_counts(qc)
RESULT = counts

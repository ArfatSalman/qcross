...
backend_547c72a4731547a2bbf099a8fe879488 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_547c72a4731547a2bbf099a8fe879488, shots=489).result().get_counts(qc)
RESULT = counts
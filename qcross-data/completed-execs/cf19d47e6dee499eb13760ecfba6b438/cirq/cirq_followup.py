...
p_bd9a33 = Symbol('p_bd9a33')
p_7a8190 = Symbol('p_7a8190')

circuit = cirq.Circuit()

circuit.append(Gates.RZGate(6.163759533339787)( qr[8] ))
circuit.append(Gates.CSXGate( qr[2], qr[4] ))
circuit.append(Gates.CUGate(p_bd9a33, 5.897054719225356, 2.3864521352475245, 5.987304452123941)( qr[0], qr[6] ))
...
circuit.append(Gates.U2Gate(p_7a8190, 2.1276323672732023)( qr[2] ))

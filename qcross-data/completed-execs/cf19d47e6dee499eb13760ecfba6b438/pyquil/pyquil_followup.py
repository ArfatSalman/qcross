...
p_bd9a33 = circuit.declare('p_bd9a33', 'REAL')
p_7a8190 = circuit.declare('p_7a8190', 'REAL')

defns = get_custom_get_definitions("CRZGate", "SXGate", "TGate", "U2Gate", "ZGate", "SdgGate", "CUGate", "RZGate", "XGate", "SGate", "CCXGate", "RCCXGate", "CU1Gate", "CHGate", "CSXGate", "C3SXGate")

circuit += defns

circuit.inst(Gates.RZGate(6.163759533339787, 8 ))
circuit.inst(Gates.CSXGate( 2, 4 ))
circuit.inst(Gates.CUGate(p_bd9a33, 5.897054719225356, 2.3864521352475245, 5.987304452123941, 0, 6 ))
...
circuit.inst(Gates.U2Gate(p_7a8190, 2.1276323672732023)( 2 ))
...
params = {
    "p_bd9a33": 0.5112149185250571,
    "p_7a8190": 2.5163050709890156
}

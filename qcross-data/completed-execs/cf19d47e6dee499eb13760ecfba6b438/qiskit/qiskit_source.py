...
backend_ff025e8c13714ceba6e436ca825c3e14 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_ff025e8c13714ceba6e436ca825c3e14, shots=3919).result().get_counts(qc)
RESULT = counts
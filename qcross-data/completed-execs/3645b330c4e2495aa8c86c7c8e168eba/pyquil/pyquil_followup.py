...
defns = get_custom_get_definitions("RCCXGate", "RYYGate", "C3SXGate", "CUGate", "CSXGate", "XGate", "CU1Gate", "SXdgGate", "RZGate", "CHGate", "TGate", "RZZGate", "iSwapGate")
...
qr_0d9c79 = circuit.declare("qr_0d9c79", "BIT", 10)

...
defns = get_custom_get_definitions("RYYGate", "C3SXGate", "XGate", "ZGate", "U2Gate", "TGate", "SXdgGate", "SGate", "RZGate", "CSXGate", "RCCXGate", "CRZGate", "CU1Gate", "CHGate", "iSwapGate", "RZZGate", "CRXGate", "CUGate")
...
qr_da2ad6 = circuit.declare("qr_da2ad6", "BIT", 6)

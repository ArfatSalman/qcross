...
backend_84f2f4e930504c1f8c4e843b89505719 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_84f2f4e930504c1f8c4e843b89505719, shots=346).result().get_counts(qc)
RESULT = counts

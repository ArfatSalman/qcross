...
backend_f0cd3140f6394def9a051960983b9e77 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_f0cd3140f6394def9a051960983b9e77, shots=1959).result().get_counts(qc)
RESULT = counts
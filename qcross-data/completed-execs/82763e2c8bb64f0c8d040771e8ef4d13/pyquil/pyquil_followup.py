...
p_780b72 = circuit.declare('p_780b72', 'REAL')
p_b653f2 = circuit.declare('p_b653f2', 'REAL')

defns = get_custom_get_definitions("CHGate", "ECRGate", "SGate", "C3SXGate", "CRXGate", "SdgGate", "CU1Gate", "ZGate", "XGate", "RCCXGate", "RZGate")
...
circuit.inst(Gates.CRXGate(p_780b72, 2, 5 ))
...
circuit.inst(Gates.CU1Gate(p_b653f2, 4, 0 ))
...
params = {
    "p_780b72": 2.0099472182748075,
    "p_b653f2": 3.2142159669963557
}

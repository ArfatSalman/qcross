...
backend_34eaaa7b59a94860a5912b83c831fb5f = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_34eaaa7b59a94860a5912b83c831fb5f, shots=489).result().get_counts(qc)
RESULT = counts

...
backend_ae942b66b2504f63b04412c870dbb1d4 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_ae942b66b2504f63b04412c870dbb1d4, shots=3919).result().get_counts(qc)
RESULT = counts
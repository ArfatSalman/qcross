...
p_2b8349 = Symbol('p_2b8349')
p_c2da95 = Symbol('p_c2da95')
p_a72c71 = Symbol('p_a72c71')
p_ec1844 = Symbol('p_ec1844')
p_14ed32 = Symbol('p_14ed32')
...
circuit.append(Gates.CRXGate(p_2b8349)( qr[2], qr[5] ))
...
circuit.append(Gates.CRZGate(p_14ed32)( qr[0], qr[6] ))
circuit.append(Gates.CU1Gate(p_ec1844)( qr[1], qr[4] ))
circuit.append(Gates.C3SXGate( qr[2], qr[0], qr[5], qr[4] ))
circuit.append(Gates.CRZGate(2.586208953975239)( qr[6], qr[2] ))
circuit.append(Gates.U2Gate(p_c2da95, p_a72c71)( qr[2] ))

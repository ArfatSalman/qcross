...
p_2b8349 = circuit.declare('p_2b8349', 'REAL')
p_c2da95 = circuit.declare('p_c2da95', 'REAL')
p_a72c71 = circuit.declare('p_a72c71', 'REAL')
p_ec1844 = circuit.declare('p_ec1844', 'REAL')
p_14ed32 = circuit.declare('p_14ed32', 'REAL')

defns = get_custom_get_definitions("TGate", "CSXGate", "CRZGate", "CHGate", "RCCXGate", "RZZGate", "U2Gate", "CRXGate", "XGate", "ECRGate", "C3SXGate", "SdgGate", "RZGate", "ZGate", "CU1Gate", "SGate")
...
circuit.inst(Gates.CRXGate(p_2b8349, 2, 5 ))
...
circuit.inst(Gates.CRZGate(p_14ed32, 0, 6 ))
circuit.inst(Gates.CU1Gate(p_ec1844, 1, 4 ))
circuit.inst(Gates.C3SXGate( 2, 0, 5, 4 ))
circuit.inst(Gates.CRZGate(2.586208953975239, 6, 2 ))
circuit.inst(Gates.U2Gate(p_c2da95, p_a72c71)( 2 ))
...
params = {
    "p_2b8349": 2.0099472182748075,
    "p_c2da95": 2.5163050709890156,
    "p_a72c71": 2.1276323672732023,
    "p_ec1844": 4.028174522740928,
    "p_14ed32": 4.833923139882297
}

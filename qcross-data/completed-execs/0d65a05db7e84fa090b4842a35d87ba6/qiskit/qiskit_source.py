...
backend_ed77e0d157a446f79013416cc6fc69ef = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_ed77e0d157a446f79013416cc6fc69ef, shots=346).result().get_counts(qc)
RESULT = counts
...
backend_70ac744a28dc426287047c599d051fcc = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_70ac744a28dc426287047c599d051fcc, shots=2771).result().get_counts(qc)
RESULT = counts

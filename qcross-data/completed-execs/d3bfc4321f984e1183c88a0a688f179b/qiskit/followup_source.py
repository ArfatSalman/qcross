...
backend_98d13eaa11944eb0856ca01dfc727963 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_98d13eaa11944eb0856ca01dfc727963, shots=346).result().get_counts(qc)
RESULT = counts

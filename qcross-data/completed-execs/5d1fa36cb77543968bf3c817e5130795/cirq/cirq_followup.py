...
p_bba60a = Symbol('p_bba60a')

circuit = cirq.Circuit()


subcircuit = cirq.Circuit()
subcircuit.append(Gates.RYYGate(0.9356897707598831)( qr[4], qr[1] ))
subcircuit.append(Gates.TdgGate( qr[6] ))
subcircuit.append(Gates.HGate( qr[0] ))
subcircuit.append(Gates.RZZGate(5.017245588344839)( qr[0], qr[5] ))
subcircuit.append(Gates.CRZGate(2.008796895454228)( qr[0], qr[5] ))
subcircuit.append(Gates.CSXGate( qr[4], qr[0] ))
circuit.append(subcircuit)
circuit.append(cirq.inverse(cirq.expand_composite(subcircuit)))

circuit.append(Gates.RZGate(p_bba60a)( qr[4] ))

...
p_bba60a = circuit.declare('p_bba60a', 'REAL')

defns = get_custom_get_definitions("CRZGate", "ECRGate", "C3SXGate", "RCCXGate", "CRXGate", "RZZGate", "RYYGate", "SGate", "RZGate", "TdgGate", "XGate", "CSXGate", "ZGate", "SdgGate", "HGate", "CHGate")

circuit += defns


subcircuit = Program()
subcircuit.inst(Gates.RYYGate(0.9356897707598831)( 4, 1 ))
subcircuit.inst(Gates.TdgGate( 6 ))
subcircuit.inst(Gates.HGate( 0 ))
subcircuit.inst(Gates.RZZGate(5.017245588344839)( 0, 5 ))
subcircuit.inst(Gates.CRZGate(2.008796895454228, 0, 5 ))
subcircuit.inst(Gates.CSXGate( 4, 0 ))
circuit.inst(subcircuit)
circuit.inst(subcircuit.dagger())

circuit.inst(Gates.RZGate(p_bba60a, 4 ))

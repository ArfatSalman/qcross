...
backend_08f22cdacb9b4efabdd8f695980de69a = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_08f22cdacb9b4efabdd8f695980de69a, shots=2771).result().get_counts(qc)
RESULT = counts
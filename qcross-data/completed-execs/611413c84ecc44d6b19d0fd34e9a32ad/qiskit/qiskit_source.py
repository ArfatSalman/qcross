...
backend_3925b31fa0a44e2588a9aecd104399dd = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_3925b31fa0a44e2588a9aecd104399dd, shots=7838).result().get_counts(qc)
RESULT = counts
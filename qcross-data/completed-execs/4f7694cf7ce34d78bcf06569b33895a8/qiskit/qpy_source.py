...
qc = transpile(qc, basis_gates=['rx', 'ry', 'rz', 'p', 'cx'], optimization_level=2, coupling_map=[[0, 1], [1, 0], [1, 2], [1, 3], [2, 1], [3, 1]])
# SECTION
...
backend_00a4676c5033448fb775c2d806629b6d = Aer.get_backend('aer_simulator_matrix_product_state')
counts = execute(qc, backend=backend_00a4676c5033448fb775c2d806629b6d, shots=489).result().get_counts(qc)
RESULT = counts

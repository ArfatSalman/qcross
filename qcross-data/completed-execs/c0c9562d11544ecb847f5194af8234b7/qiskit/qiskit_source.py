...
backend_3bbec91a477b4a56948bfcf5d4a0bdc7 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_3bbec91a477b4a56948bfcf5d4a0bdc7, shots=5542).result().get_counts(qc)
RESULT = counts
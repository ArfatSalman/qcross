...
qr_74253d = QuantumRegister(1, name='qr_74253d')
qc.add_register(qr_74253d)
# SECTION
# NAME: MEASUREMENT
...
backend_7581be0d01534292bcfa54b90cd8006c = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_7581be0d01534292bcfa54b90cd8006c, shots=3919).result().get_counts(qc)
RESULT = counts

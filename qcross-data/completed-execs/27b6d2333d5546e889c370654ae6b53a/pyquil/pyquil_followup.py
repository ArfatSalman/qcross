...
defns = get_custom_get_definitions("RCCXGate", "U2Gate", "ZGate", "CU1Gate", "C3SXGate", "XGate", "CSXGate", "RZGate", "SdgGate", "SGate", "CRZGate", "CHGate", "TGate", "CCXGate", "SXGate", "CUGate")
...
qr_74253d = circuit.declare("qr_74253d", "BIT", 1)

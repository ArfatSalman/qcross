...
qc = transpile(qc, basis_gates=None, optimization_level=2, coupling_map=[[0,
    1], [1, 0], [1, 2], [1, 4], [2, 1], [2, 3], [3, 2], [4, 1]])
# SECTION
# NAME: EXECUTION

from qiskit import Aer, transpile, execute
backend_5e7473faa49b4e1b99165f70dfad3835 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_5e7473faa49b4e1b99165f70dfad3835, shots=979).result().get_counts(qc)
RESULT = counts

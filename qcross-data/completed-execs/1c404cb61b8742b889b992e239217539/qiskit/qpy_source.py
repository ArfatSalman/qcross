...
backend_6a687869f426489fa933bdcaa63f412a = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_6a687869f426489fa933bdcaa63f412a, shots=3919).result().get_counts(qc)
RESULT = counts

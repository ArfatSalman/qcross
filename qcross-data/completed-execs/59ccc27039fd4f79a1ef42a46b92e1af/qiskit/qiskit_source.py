...
backend_2d7a69aba155495fac4c99b684fa60b9 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_2d7a69aba155495fac4c99b684fa60b9, shots=3919).result().get_counts(qc)
RESULT = counts
...
defns = get_custom_get_definitions("XGate", "RYYGate", "TGate", "CRXGate", "SXdgGate", "CHGate", "CSXGate", "ZGate", "CXGate", "ECRGate", "SXGate", "iSwapGate", "RZZGate")
...
subcircuit = Program()
subcircuit.inst(Gates.CRXGate(2.2498881927557752, 0, 1 ))
subcircuit.inst(Gates.ZGate( 1 ))
subcircuit.inst(Gates.CXGate( 0, 1 ))

...
backend_7d359a4d0b2941a697a95d58050a887b = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_7d359a4d0b2941a697a95d58050a887b, shots=1385).result().get_counts(qc)
RESULT = counts

...
defns = get_custom_get_definitions("TGate", "CRZGate", "SXGate", "CCXGate", "CPhaseGate", "RCCXGate", "U2Gate", "CRXGate", "CXGate", "XGate", "RXXGate", "RZGate", "ZGate")
...
subcircuit.inst(Gates.U2Gate(5.887184334931191, 0.07157463504881167)( 8 ))
...
qr_0d679b = circuit.declare("qr_0d679b", "BIT", 9)

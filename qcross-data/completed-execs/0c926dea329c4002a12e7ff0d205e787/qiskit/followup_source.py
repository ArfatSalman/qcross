...
backend_29b93ff28caa44b18ac66faaf8a0c303 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_29b93ff28caa44b18ac66faaf8a0c303, shots=692).result().get_counts(qc)
RESULT = counts

...
circuit.append(Gates.RZZGate(4.066449154047175)( qr[1], qr[3] ))
circuit.append(Gates.iSwapGate( qr[1], qr[3] ))
...
circuit.append(Gates.CU1Gate(5.154187354656876)( qr[3], qr[2] ))
...
circuit.append(Gates.C3SXGate( qr[3], qr[0], qr[2], qr[1] ))
...
circuit.append(Gates.RYYGate(1.740253089260498)( qr[1], qr[2] ))
circuit.append(Gates.RCCXGate( qr[1], qr[3], qr[2] ))

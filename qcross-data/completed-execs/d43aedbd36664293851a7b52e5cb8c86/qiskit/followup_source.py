...
backend_1ac1deb8ee8d45039959daf0a8568d2a = Aer.get_backend('aer_simulator_density_matrix')
counts = execute(qc, backend=backend_1ac1deb8ee8d45039959daf0a8568d2a, shots=3919).result().get_counts(qc)
RESULT = counts

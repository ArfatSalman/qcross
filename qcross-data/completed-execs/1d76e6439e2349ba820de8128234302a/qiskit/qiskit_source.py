...
backend_50acf0a74cce47c1b7cbb2f44ea249b5 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_50acf0a74cce47c1b7cbb2f44ea249b5, shots=979).result().get_counts(qc)
RESULT = counts
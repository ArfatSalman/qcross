...
defns = get_custom_get_definitions("CRZGate", "TGate", "SXGate", "ZGate", "UGate", "CUGate", "RZGate", "CCXGate", "RZZGate", "RCCXGate", "CU1Gate", "CRXGate", "SGate", "C3SXGate")
...
circuit.inst(Gates.CRXGate(2.6687018103754414, 2, 5 ))

...
qc.append(CRXGate(2.6687018103754414), qargs=[qr[2], qr[5]], cargs=[])
...
backend_4404b6c9bc054cf5b9d45226a277ebfa = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_4404b6c9bc054cf5b9d45226a277ebfa, shots=1385).result().get_counts(qc)
RESULT = counts

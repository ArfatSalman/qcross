...
qc = transpile(qc, basis_gates=None, optimization_level=0, coupling_map=[[0, 1], [0, 5], [0, 9], [0, 12], [1, 0], [1, 3], [1, 6], [1, 7], [1, 11], [2, 3], [3, 1], [3, 2], [4, 8], [5, 0], [5, 8], [6, 1], [7, 1], [7, 10], [8, 4], [8, 5], [9, 0], [10, 7], [11, 1], [12, 0]])
# SECTION
# NAME: EXECUTION
from qiskit import Aer, transpile, execute
backend_21fe07fb98b54cf2a30eb3ffaf5bb794 = Aer.get_backend(
    'aer_simulator_matrix_product_state')
counts = execute(qc, backend=backend_21fe07fb98b54cf2a30eb3ffaf5bb794,

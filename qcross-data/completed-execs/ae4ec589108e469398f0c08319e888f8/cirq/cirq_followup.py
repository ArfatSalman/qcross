...
p_1b933a = Symbol('p_1b933a')
p_292ddb = Symbol('p_292ddb')
p_32eb37 = Symbol('p_32eb37')
...
circuit.append(Gates.CUGate(0.5112149185250571, p_292ddb, 2.3864521352475245, p_1b933a)( qr[0], qr[2] ))
circuit.append(Gates.CU1Gate(p_32eb37)( qr[3], qr[0] ))

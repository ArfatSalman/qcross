...
from qiskit import Aer, transpile, execute
backend_d553c22ed10d4c2e89d88aed392c5943 = Aer.get_backend('qasm_simulator')
counts_1 = execute(qc_1, backend=backend_d553c22ed10d4c2e89d88aed392c5943, shots=7838).result().get_counts(qc_1)
counts_2 = execute(qc_2, backend=backend_d553c22ed10d4c2e89d88aed392c5943, shots=7838).result().get_counts(qc_2)

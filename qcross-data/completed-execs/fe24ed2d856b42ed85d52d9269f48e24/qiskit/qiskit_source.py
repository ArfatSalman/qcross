...
backend_1be2fcc625a5455495d14649d4aba76e = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_1be2fcc625a5455495d14649d4aba76e, shots=692).result().get_counts(qc)
RESULT = counts
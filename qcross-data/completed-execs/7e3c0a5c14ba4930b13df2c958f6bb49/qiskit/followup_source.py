...
backend_bed29dead4724e77b975d6b3473f68a3 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_bed29dead4724e77b975d6b3473f68a3, shots=489).result().get_counts(qc)
RESULT = counts

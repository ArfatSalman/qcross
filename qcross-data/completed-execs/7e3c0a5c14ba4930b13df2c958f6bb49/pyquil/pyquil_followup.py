...
defns = get_custom_get_definitions("CCXGate", "RCCXGate", "XGate", "RZGate", "SdgGate", "CRXGate", "RYYGate", "TGate", "SXdgGate", "CHGate", "CSXGate", "SGate", "ZGate", "ECRGate", "CRZGate", "iSwapGate")
...
circuit.inst(Gates.RYYGate(3.2287759437031154)( 2, 0 ))

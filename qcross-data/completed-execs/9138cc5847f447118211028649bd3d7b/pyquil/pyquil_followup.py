...
defns = get_custom_get_definitions("CU1Gate", "CRZGate", "RYYGate", "CSXGate", "CUGate", "CHGate", "ZGate", "XGate", "RZGate", "UGate", "SXdgGate", "SGate", "TGate", "CRXGate", "ECRGate")
...
qr_945035 = circuit.declare("qr_945035", "BIT", 8)

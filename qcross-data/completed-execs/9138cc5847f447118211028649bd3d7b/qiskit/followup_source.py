...
qr_945035 = QuantumRegister(8, name='qr_945035')
qc.add_register(qr_945035)
# SECTION
# NAME: MEASUREMENT
...
backend_6fc2d954e040467589a22986b0ac5328 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_6fc2d954e040467589a22986b0ac5328, shots=979).result().get_counts(qc)
RESULT = counts

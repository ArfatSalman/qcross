...
backend_5837de76dd3a4179be841dc48bddaf85 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_5837de76dd3a4179be841dc48bddaf85, shots=7838).result().get_counts(qc)
RESULT = counts

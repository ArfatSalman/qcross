...
backend_ac8afd9f21ee4a90ac4d89bac5e8dcad = Aer.get_backend('statevector_simulator')
counts = execute(qc, backend=backend_ac8afd9f21ee4a90ac4d89bac5e8dcad, shots=489).result().get_counts(qc)
RESULT = counts

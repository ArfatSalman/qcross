...
qc = transpile(qc, basis_gates=None, optimization_level=2, coupling_map=[[0, 1], [0, 4], [1, 0], [1, 2], [1, 5], [2, 1], [2, 6], [3, 6], [4, 0], [5, 1], [6, 2], [6, 3]])
# SECTION
...
backend_b93a620cf9a24faeaf0ed1d04441f80d = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_b93a620cf9a24faeaf0ed1d04441f80d, shots=1959).result().get_counts(qc)
RESULT = counts

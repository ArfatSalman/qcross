...
defns = get_custom_get_definitions("U2Gate", "ZGate", "CRZGate", "XGate", "RZGate", "TGate", "CSXGate", "C3SXGate", "CHGate", "CCXGate", "SXGate", "CRXGate")
...
qr_330f5b = circuit.declare("qr_330f5b", "BIT", 8)

...
qr_330f5b = QuantumRegister(8, name='qr_330f5b')
qc.add_register(qr_330f5b)
# SECTION
# NAME: MEASUREMENT
...
backend_9bf0d569cdcc4951ac0eff8e2f3776b4 = Aer.get_backend(
    'aer_simulator_matrix_product_state')
counts = execute(qc, backend=backend_9bf0d569cdcc4951ac0eff8e2f3776b4,

...
p_33458c = circuit.declare('p_33458c', 'REAL')

defns = get_custom_get_definitions("C3SXGate", "CUGate", "SGate", "RZGate", "XGate", "CSXGate", "RXGate", "ZGate", "SdgGate")

circuit += defns

circuit.inst(Gates.RZGate(p_33458c, 8 ))
circuit.inst(Gates.CSXGate( 2, 4 ))

subcircuit = Program()
subcircuit.inst(Gates.RXGate(3.855749700561927, 4 ))

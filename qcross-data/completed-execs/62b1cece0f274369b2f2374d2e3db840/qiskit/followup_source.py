...
qc = transpile(qc, basis_gates=None, optimization_level=2, coupling_map=[[0, 1], [0, 4], [0, 5], [1, 0], [1, 3], [2, 5], [3, 1], [4, 0], [5, 0], [5, 2]])
# SECTION
# NAME: EXECUTION

from qiskit import Aer, transpile, execute
backend_491d2d8713524f7a9f523cd1866ec225 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_491d2d8713524f7a9f523cd1866ec225, shots=692).result().get_counts(qc)
RESULT = counts

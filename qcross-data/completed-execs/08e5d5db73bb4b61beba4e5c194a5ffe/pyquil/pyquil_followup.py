...
defns = get_custom_get_definitions("CRZGate", "CU1Gate", "CYGate", "TGate", "XGate", "CSXGate", "ECRGate", "HGate", "RZZGate", "SGate", "RXGate", "SXdgGate", "RYYGate", "RZGate", "ZGate", "iSwapGate", "CRXGate", "SXGate", "CHGate")
...
circuit.inst(Gates.XGate( 1 ))
circuit.inst(Gates.RYYGate(5.167261531657622)( 1, 0 ))
circuit.inst(Gates.SGate( 0 ))

subcircuit = Program()
subcircuit.inst(Gates.CRXGate(4.167661441102218, 1, 0 ))
subcircuit.inst(Gates.HGate( 0 ))
subcircuit.inst(Gates.RXGate(6.221353754875494, 0 ))
...
qr_44b36c = circuit.declare("qr_44b36c", "BIT", 6)

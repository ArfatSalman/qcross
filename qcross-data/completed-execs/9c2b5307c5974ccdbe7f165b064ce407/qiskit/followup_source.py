...
qr_7f88f6 = QuantumRegister(1, name='qr_7f88f6')
qc.add_register(qr_7f88f6)
# SECTION
# NAME: MEASUREMENT
...
backend_ca4472a5effb429589598af2dccd93a7 = Aer.get_backend('statevector_simulator')
counts = execute(qc, backend=backend_ca4472a5effb429589598af2dccd93a7, shots=1959).result().get_counts(qc)
RESULT = counts

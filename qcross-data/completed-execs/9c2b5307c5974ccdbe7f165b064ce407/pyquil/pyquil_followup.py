...
defns = get_custom_get_definitions("ZGate", "CHGate", "CU1Gate", "RCCXGate", "SGate", "C3SXGate", "ECRGate", "TGate", "XGate", "U2Gate", "CRXGate", "RZGate", "RZZGate", "CRZGate", "CSXGate", "SdgGate")
...
qr_7f88f6 = circuit.declare("qr_7f88f6", "BIT", 1)

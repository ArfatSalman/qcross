...
p_c22ee3 = Symbol('p_c22ee3')
p_1477d5 = Symbol('p_1477d5')
p_dd3917 = Symbol('p_dd3917')
p_d41fd7 = Symbol('p_d41fd7')
p_ef9572 = Symbol('p_ef9572')
p_1fb36c = Symbol('p_1fb36c')
p_42a4f3 = Symbol('p_42a4f3')

circuit = cirq.Circuit()

circuit.append(Gates.RZGate(p_1477d5)( qr[4] ))
circuit.append(Gates.ZGate( qr[6] ))
circuit.append(Gates.XGate( qr[3] ))
circuit.append(Gates.CRXGate(p_42a4f3)( qr[2], qr[5] ))
...
circuit.append(Gates.RZGate(p_c22ee3)( qr[1] ))
circuit.append(Gates.C3SXGate( qr[0], qr[2], qr[1], qr[3] ))
circuit.append(Gates.CU1Gate(p_ef9572)( qr[4], qr[0] ))
circuit.append(Gates.CRXGate(p_d41fd7)( qr[4], qr[6] ))
...
circuit.append(Gates.CRZGate(p_dd3917)( qr[0], qr[6] ))
circuit.append(Gates.CU1Gate(p_1fb36c)( qr[1], qr[4] ))

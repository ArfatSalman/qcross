...
p_9d24ce = circuit.declare('p_9d24ce', 'REAL')

defns = get_custom_get_definitions("ECRGate", "C3SXGate", "RCCXGate", "CRXGate", "SGate", "RZGate", "XGate", "ZGate", "SdgGate", "CHGate")

circuit += defns

circuit.inst(Gates.RZGate(p_9d24ce, 4 ))

...
qr_381222 = QuantumRegister(5, name='qr_381222')
qc.add_register(qr_381222)
# SECTION
# NAME: MEASUREMENT
...
backend_42f3d3a6475c499d9213107308411830 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_42f3d3a6475c499d9213107308411830, shots=5542).result().get_counts(qc)
RESULT = counts

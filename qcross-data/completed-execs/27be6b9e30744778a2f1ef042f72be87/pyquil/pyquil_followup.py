...
defns = get_custom_get_definitions("ZGate", "RZXGate", "SXGate", "C3SXGate", "CU3Gate", "XGate", "CRXGate", "RZGate", "CRZGate", "DCXGate", "RYYGate")
...
subcircuit = Program()
subcircuit.inst(Gates.RZXGate(4.563562108824195)( 5, 4 ))
subcircuit.inst(Gates.DCXGate( 6, 4 ))

...
qc.append(RZGate(p_23c306), qargs=[qr[1]], cargs=[])
...
backend_2dec05a3004e438f841b9e816003a0e4 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_2dec05a3004e438f841b9e816003a0e4, shots=489).result().get_counts(qc)
RESULT = counts

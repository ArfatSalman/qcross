...
defns = get_custom_get_definitions("ZGate", "CHGate", "CU1Gate", "RCCXGate", "SGate", "C3SXGate", "ECRGate", "XGate", "CRXGate", "RZGate", "CSXGate", "SdgGate")
...
qr_da5ac6 = circuit.declare("qr_da5ac6", "BIT", 3)

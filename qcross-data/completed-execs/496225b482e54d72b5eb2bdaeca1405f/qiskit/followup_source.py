...
qr_da5ac6 = QuantumRegister(3, name='qr_da5ac6')
qc.add_register(qr_da5ac6)
# SECTION
# NAME: MEASUREMENT
...
backend_60683721dd0442e2a12a556e1bd87577 = Aer.get_backend(
    'statevector_simulator')
counts = execute(qc, backend=backend_60683721dd0442e2a12a556e1bd87577,

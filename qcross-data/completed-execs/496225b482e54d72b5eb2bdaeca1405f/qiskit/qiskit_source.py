...
backend_60683721dd0442e2a12a556e1bd87577 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_60683721dd0442e2a12a556e1bd87577, shots=1959).result().get_counts(qc)
RESULT = counts
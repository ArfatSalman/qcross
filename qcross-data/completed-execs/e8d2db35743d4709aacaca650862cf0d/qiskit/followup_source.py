...
backend_750e051b0327449587f0bc46e655529b = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_750e051b0327449587f0bc46e655529b, shots=692).result().get_counts(qc)
RESULT = counts

...
defns = get_custom_get_definitions("XGate", "RZGate", "ZGate", "CRXGate", "C3SXGate", "RYYGate", "RZZGate", "UGate", "CU1Gate", "SXGate", "CRZGate")
...
subcircuit = Program()
subcircuit.inst(Gates.UGate(4.8767543643948805, 4.182786512570673, 4.614324844707754)( 3 ))
subcircuit.inst(Gates.RZGate(6.253452668458444, 2 ))
...
qr_7f5736 = circuit.declare("qr_7f5736", "BIT", 5)

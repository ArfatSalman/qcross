...
qc.append(C3SXGate(), qargs=[qr[4], qr[2], qr[5], qr[1]], cargs=[])
qc.append(ZGate(), qargs=[qr[3]], cargs=[])
qc.append(XGate(), qargs=[qr[1]], cargs=[])
qc.append(SGate(), qargs=[qr[4]], cargs=[])
qc.append(SGate(), qargs=[qr[2]], cargs=[])
qc.append(C3SXGate(), qargs=[qr[0], qr[8], qr[3], qr[4]], cargs=[])
# SECTION
# NAME: MEASUREMENT
...
backend_8f34f9219c56466e884db87502d89860 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_8f34f9219c56466e884db87502d89860, shots=3919).result().get_counts(qc)
RESULT = counts

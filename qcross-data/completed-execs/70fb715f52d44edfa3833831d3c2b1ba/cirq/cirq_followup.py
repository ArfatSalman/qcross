...
circuit.append(Gates.CRXGate(5.987304452123941)( qr[7], qr[2] ))
circuit.append(Gates.CRZGate(1.0296448789776642)( qr[1], qr[2] ))
circuit.append(Gates.C3SXGate( qr[7], qr[0], qr[2], qr[6] ))
...
circuit.append(Gates.SXGate( qr[7] ))
circuit.append(Gates.CU1Gate(3.2142159669963557)( qr[4], qr[7] ))
circuit.append(Gates.CRXGate(5.94477504571567)( qr[2], qr[4] ))
circuit.append(Gates.RZZGate(5.1829934776392745)( qr[0], qr[7] ))
circuit.append(Gates.CSXGate( qr[7], qr[5] ))
circuit.append(Gates.ZGate( qr[2] ))
circuit.append(Gates.RZGate(3.775592041307464)( qr[4] ))
circuit.append(Gates.CRXGate(0.7279391018916035)( qr[7], qr[6] ))
circuit.append(Gates.CUGate(5.03147076606842, 5.0063780207098425, 3.1562533916051736, 4.940217775579305)( qr[2], qr[5] ))
...
circuit.append(Gates.RZZGate(3.950837470808744)( qr[6], qr[4] ))
circuit.append(Gates.TGate( qr[3] ))
circuit.append(Gates.RYYGate(1.9669252191306448)( qr[4], qr[5] ))
circuit.append(Gates.C3SXGate( qr[1], qr[6], qr[5], qr[3] ))
circuit.append(Gates.SXdgGate( qr[0] ))
circuit.append(Gates.UGate(5.080799300534071, 5.023617931957853, 2.271164628944128)( qr[5] ))

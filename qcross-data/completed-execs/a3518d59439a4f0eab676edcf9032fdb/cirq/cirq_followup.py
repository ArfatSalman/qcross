...
p_fdadbd = Symbol('p_fdadbd')
p_25c756 = Symbol('p_25c756')
...
circuit.append(Gates.CUGate(0.5112149185250571, p_25c756, 2.3864521352475245, 5.987304452123941)( qr[0], qr[2] ))
circuit.append(Gates.CU1Gate(p_fdadbd)( qr[3], qr[0] ))

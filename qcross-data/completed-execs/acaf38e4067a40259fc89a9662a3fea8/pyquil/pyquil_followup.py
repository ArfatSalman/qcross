...
defns = get_custom_get_definitions("ZGate", "UGate", "RCCXGate", "CCXGate", "XGate", "U2Gate", "RZGate", "CRZGate", "CSXGate", "SdgGate")
...
subcircuit = Program()
subcircuit.inst(Gates.UGate(4.8767543643948805, 4.182786512570673, 4.614324844707754)( 7 ))
subcircuit.inst(Gates.CSXGate( 6, 8 ))

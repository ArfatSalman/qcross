...
backend_1b4ab13282fd450da0cedd4d74c5df94 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_1b4ab13282fd450da0cedd4d74c5df94, shots=7838).result().get_counts(qc)
RESULT = counts
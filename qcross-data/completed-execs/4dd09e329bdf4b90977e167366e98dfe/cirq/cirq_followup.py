...
circuit.append(Gates.ECRGate( qr[4], qr[2] ))
circuit.append(Gates.CRXGate(2.0099472182748075)( qr[3], qr[4] ))
...
circuit.append(Gates.CUGate(5.708725119517347, 4.167661441102218, 4.623446645668956, 3.865496458458116)( qr[1], qr[3] ))
...
circuit.append(Gates.RCCXGate( qr[0], qr[4], qr[1] ))
circuit.append(Gates.CUGate(5.03147076606842, 5.0063780207098425, 3.1562533916051736, 4.940217775579305)( qr[3], qr[4] ))

...
qc.append(ECRGate(), qargs=[qr[4], qr[2]], cargs=[])
qc.append(CRXGate(2.0099472182748075), qargs=[qr[3], qr[4]], cargs=[])
...
qc.append(CUGate(5.708725119517347, 4.167661441102218, 4.623446645668956, 
    3.865496458458116), qargs=[qr[1], qr[3]], cargs=[])
...
qc.append(RCCXGate(), qargs=[qr[0], qr[4], qr[1]], cargs=[])
qc.append(CUGate(5.03147076606842, 5.0063780207098425, 3.1562533916051736, 
    4.940217775579305), qargs=[qr[3], qr[4]], cargs=[])
...
backend_4a2c60d3501940d88d77310472794c8b = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_4a2c60d3501940d88d77310472794c8b, shots=979).result().get_counts(qc)
RESULT = counts

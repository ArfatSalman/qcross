...
defns = get_custom_get_definitions("CRZGate", "ECRGate", "U2Gate", "C3SXGate", "RCCXGate", "CRXGate", "RZZGate", "SwapGate", "CU1Gate", "SGate", "RZGate", "TGate", "XGate", "CSXGate", "ZGate", "SdgGate", "CHGate")
...
subcircuit = Program()
subcircuit.inst(Gates.RZGate(4.38472991219647, 5 ))

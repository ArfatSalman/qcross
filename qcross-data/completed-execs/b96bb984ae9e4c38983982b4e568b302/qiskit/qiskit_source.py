...
backend_4e0d26a8292c4b27a6e5ee2f32ca5a42 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_4e0d26a8292c4b27a6e5ee2f32ca5a42, shots=1959).result().get_counts(qc)
RESULT = counts
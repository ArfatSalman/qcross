...
subcircuit.append(RZGate(4.38472991219647), qargs=[qr[5]], cargs=[])
...
backend_4e0d26a8292c4b27a6e5ee2f32ca5a42 = Aer.get_backend(
    'aer_simulator_density_matrix')
counts = execute(qc, backend=backend_4e0d26a8292c4b27a6e5ee2f32ca5a42,

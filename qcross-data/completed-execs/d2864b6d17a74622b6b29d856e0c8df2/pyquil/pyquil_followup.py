...
defns = get_custom_get_definitions("XGate", "CU1Gate", "RZZGate", "iSwapGate", "CUGate", "CHGate", "TGate", "CSXGate", "RZGate", "C3SXGate", "SXdgGate")
...
qr_b5122c = circuit.declare("qr_b5122c", "BIT", 3)

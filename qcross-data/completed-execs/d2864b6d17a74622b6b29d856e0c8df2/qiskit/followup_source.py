...
qr_b5122c = QuantumRegister(3, name='qr_b5122c')
qc.add_register(qr_b5122c)
# SECTION
# NAME: MEASUREMENT
...
backend_e27d566d5267402bb2d3c98d363b63bb = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_e27d566d5267402bb2d3c98d363b63bb, shots=692).result().get_counts(qc)
RESULT = counts

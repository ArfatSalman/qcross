...
backend_0b077507b79e4156a089e971d13a0a28 = Aer.get_backend('aer_simulator_density_matrix')
counts = execute(qc, backend=backend_0b077507b79e4156a089e971d13a0a28, shots=346).result().get_counts(qc)
RESULT = counts

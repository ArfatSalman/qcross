...
backend_10fa0c7c99ed4edc93c62da50d0118ce = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_10fa0c7c99ed4edc93c62da50d0118ce, shots=1959).result().get_counts(qc)
RESULT = counts
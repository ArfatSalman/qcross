...
backend_b0f9978fd54744f99a3eb1146904144b = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_b0f9978fd54744f99a3eb1146904144b, shots=1385).result().get_counts(qc)
RESULT = counts

...
qr_600e51 = QuantumRegister(8, name='qr_600e51')
qc.add_register(qr_600e51)
# SECTION
# NAME: MEASUREMENT
...
backend_aa848b74e892421294ce3e54aa4d3773 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_aa848b74e892421294ce3e54aa4d3773, shots=2771).result().get_counts(qc)
RESULT = counts

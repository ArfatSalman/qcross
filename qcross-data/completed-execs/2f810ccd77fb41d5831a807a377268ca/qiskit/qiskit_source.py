...
backend_1ef439be4cb143b3bf2aaec6e49a47a5 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_1ef439be4cb143b3bf2aaec6e49a47a5, shots=346).result().get_counts(qc)
RESULT = counts
...
backend_eded2e01b4944157b3f7e1124b518b21 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_eded2e01b4944157b3f7e1124b518b21, shots=489).result().get_counts(qc)
RESULT = counts
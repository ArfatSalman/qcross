...
p_e3c499 = Symbol('p_e3c499')
p_52f0db = Symbol('p_52f0db')

circuit = cirq.Circuit()

circuit.append(Gates.RZGate(p_e3c499)( qr[1] ))
...
circuit.append(Gates.RYYGate(p_52f0db)( qr[1], qr[0] ))
...
circuit = cirq.resolve_parameters(circuit, {
    "p_e3c499": 6.163759533339787,
    "p_52f0db": 1.6723037552953224
}, recursive=True)

...
backend_cf46a3b4d4cc4daa8c21f338ea2e57be = Aer.get_backend('aer_simulator_statevector')
counts = execute(qc, backend=backend_cf46a3b4d4cc4daa8c21f338ea2e57be, shots=1385).result().get_counts(qc)
RESULT = counts

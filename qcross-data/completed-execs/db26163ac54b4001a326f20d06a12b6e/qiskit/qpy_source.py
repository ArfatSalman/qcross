...
qr_437218 = QuantumRegister(1, name='qr_437218')
qc.add_register(qr_437218)
# SECTION
# NAME: MEASUREMENT
...
backend_e632f44204d54e04b5ad38caab58ba98 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_e632f44204d54e04b5ad38caab58ba98, shots=5542).result().get_counts(qc)
RESULT = counts

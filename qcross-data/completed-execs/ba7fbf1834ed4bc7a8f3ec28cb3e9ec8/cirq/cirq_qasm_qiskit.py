...
p_a2dee9 = Symbol('p_a2dee9')
p_2179b1 = Symbol('p_2179b1')
p_4fb874 = Symbol('p_4fb874')
...
circuit.append(Gates.CRXGate(p_a2dee9)( qr[2], qr[5] ))
...
circuit.append(Gates.RZGate(p_4fb874)( qr[1] ))
circuit.append(Gates.C3SXGate( qr[0], qr[2], qr[1], qr[3] ))
circuit.append(Gates.CU1Gate(p_2179b1)( qr[4], qr[0] ))

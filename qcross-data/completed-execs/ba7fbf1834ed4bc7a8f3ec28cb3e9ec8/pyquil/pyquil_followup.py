...
p_a2dee9 = circuit.declare('p_a2dee9', 'REAL')
p_2179b1 = circuit.declare('p_2179b1', 'REAL')
p_4fb874 = circuit.declare('p_4fb874', 'REAL')
...
circuit.inst(Gates.CRXGate(p_a2dee9, 2, 5 ))
...
circuit.inst(Gates.RZGate(p_4fb874, 1 ))
circuit.inst(Gates.C3SXGate( 0, 2, 1, 3 ))
circuit.inst(Gates.CU1Gate(p_2179b1, 4, 0 ))
...
params = {
    "p_a2dee9": 2.0099472182748075,
    "p_2179b1": 3.2142159669963557,
    "p_4fb874": 4.229610589867865
}

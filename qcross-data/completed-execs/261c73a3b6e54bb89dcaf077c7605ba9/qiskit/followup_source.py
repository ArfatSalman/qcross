...
qc = transpile(qc, basis_gates=None, optimization_level=2, coupling_map=[[0,
    1], [0, 3], [0, 8], [1, 0], [1, 2], [1, 4], [1, 6], [2, 1], [3, 0], [4,
    1], [5, 8], [6, 1], [6, 7], [7, 6], [8, 0], [8, 5]])
# SECTION
# NAME: EXECUTION

from qiskit import Aer, transpile, execute
backend_9fa49ff2fb604e238da562dbf7a7f37c = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_9fa49ff2fb604e238da562dbf7a7f37c, shots=1959).result().get_counts(qc)
RESULT = counts

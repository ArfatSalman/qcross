...
backend_a578d84f4a25452caa320fa347246a62 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_a578d84f4a25452caa320fa347246a62, shots=692).result().get_counts(qc)
RESULT = counts

...
qc = transpile(qc, basis_gates=None, optimization_level=2, coupling_map=[[0, 1], [0, 2], [0, 5], [1, 0], [1, 3], [1, 4], [2, 0], [3, 1], [4, 1], [5, 0]])
# SECTION
...
backend_407f603c0e2a42e9afda902ce08f86ec = Aer.get_backend('statevector_simulator')
counts = execute(qc, backend=backend_407f603c0e2a42e9afda902ce08f86ec, shots=692).result().get_counts(qc)
RESULT = counts

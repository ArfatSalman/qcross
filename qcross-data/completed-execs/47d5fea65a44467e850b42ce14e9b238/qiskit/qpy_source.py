...
qr_470c84 = QuantumRegister(9, name='qr_470c84')
qc.add_register(qr_470c84)
# SECTION
# NAME: MEASUREMENT
...
backend_7fdf445150754a9a8c24006a520b700b = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_7fdf445150754a9a8c24006a520b700b, shots=2771).result().get_counts(qc)
RESULT = counts

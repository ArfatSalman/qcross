...
defns = get_custom_get_definitions("CRZGate", "SXGate", "RZZGate", "ZGate", "CU1Gate", "CRXGate", "XGate", "CSXGate", "RYYGate", "RZGate", "C3SXGate")
...
qr_470c84 = circuit.declare("qr_470c84", "BIT", 9)

...
p_0b0c01 = circuit.declare('p_0b0c01', 'REAL')

defns = get_custom_get_definitions("CSXGate", "CU1Gate", "ECRGate", "SGate", "C3SXGate", "CRZGate", "RZGate", "SdgGate", "XGate", "RCCXGate", "ZGate", "CRXGate", "CHGate")
...
circuit.inst(Gates.CRZGate(p_0b0c01, 0, 6 ))

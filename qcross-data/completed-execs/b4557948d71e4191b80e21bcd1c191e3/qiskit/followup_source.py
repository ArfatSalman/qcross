...
qc.append(CRZGate(p_0b0c01), qargs=[qr[0], qr[6]], cargs=[])
# SECTION
# NAME: MEASUREMENT
...
qc = qc.bind_parameters({p_0b0c01: 4.833923139882297})
# SECTION
...
backend_5ebd566655ca4a7ab83fe6dd21167d05 = Aer.get_backend('statevector_simulator')
counts = execute(qc, backend=backend_5ebd566655ca4a7ab83fe6dd21167d05, shots=1959).result().get_counts(qc)
RESULT = counts

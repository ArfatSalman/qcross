...
defns = get_custom_get_definitions("SGate", "C3SXGate", "CSXGate", "CUGate", "SdgGate", "SXGate", "CU1Gate", "ZGate", "XGate", "CRZGate", "RZGate")

circuit += defns

circuit.inst(Gates.RZGate(6.163759533339787, 3 ))
circuit.inst(Gates.CSXGate( 5, 1 ))
circuit.inst(Gates.CUGate(0.5112149185250571, 5.897054719225356, 2.3864521352475245, 5.987304452123941, 2, 6 ))
circuit.inst(Gates.SdgGate( 0 ))
circuit.inst(Gates.C3SXGate( 2, 3, 7, 8 ))
circuit.inst(Gates.ZGate( 5 ))
circuit.inst(Gates.XGate( 8 ))
circuit.inst(Gates.SGate( 2 ))
circuit.inst(Gates.SGate( 3 ))
circuit.inst(Gates.C3SXGate( 0, 4, 5, 2 ))
circuit.inst(Gates.SXGate( 2 ))
circuit.inst(Gates.CU1Gate(3.2142159669963557, 3, 4 ))

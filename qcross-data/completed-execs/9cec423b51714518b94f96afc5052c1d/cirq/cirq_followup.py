...
circuit.append(Gates.CRZGate(4.2641612072511235)( qr[4], qr[7] ))
circuit.append(Gates.ZGate( qr[9] ))
circuit.append(Gates.CCXGate( qr[6], qr[8], qr[3] ))
circuit.append(Gates.ZGate( qr[7] ))
circuit.append(Gates.XGate( qr[3] ))
circuit.append(Gates.RCCXGate( qr[2], qr[4], qr[10] ))
circuit.append(Gates.RZGate(4.229610589867865)( qr[0] ))
circuit.append(Gates.CCXGate( qr[3], qr[2], qr[7] ))
circuit.append(Gates.SdgGate( qr[3] ))
circuit.append(Gates.U2Gate(4.214504315296764, 4.6235667602042065)( qr[2] ))
circuit.append(Gates.CSXGate( qr[5], qr[7] ))
circuit.append(Gates.CHGate( qr[0], qr[3] ))
circuit.append(Gates.CU1Gate(4.028174522740928)( qr[8], qr[0] ))
...
circuit.append(Gates.RZZGate(3.950837470808744)( qr[1], qr[0] ))
circuit.append(Gates.TGate( qr[0] ))
circuit.append(Gates.TGate( qr[9] ))
circuit.append(Gates.SXdgGate( qr[6] ))
circuit.append(Gates.RZGate(4.722103101046168)( qr[7] ))
circuit.append(Gates.CRZGate(0.6393443962862078)( qr[6], qr[5] ))
circuit.append(Gates.CU1Gate(2.5476776328466872)( qr[5], qr[10] ))
circuit.append(Gates.SXdgGate( qr[9] ))
circuit.append(Gates.RZGate(3.6614081973587154)( qr[4] ))
circuit.append(Gates.XGate( qr[10] ))
...
circuit.append(cirq.measure(qr[10], key='cr8'))

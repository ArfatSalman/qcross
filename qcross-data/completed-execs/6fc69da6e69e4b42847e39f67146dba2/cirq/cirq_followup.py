...
circuit.append(Gates.CSXGate( qr[6], qr[7] ))
...
circuit.append(Gates.C3SXGate( qr[0], qr[8], qr[3], qr[5] ))
...
circuit.append(Gates.C3SXGate( qr[1], qr[4], qr[6], qr[0] ))
circuit.append(Gates.SXGate( qr[0] ))
circuit.append(Gates.CU1Gate(3.2142159669963557)( qr[8], qr[4] ))

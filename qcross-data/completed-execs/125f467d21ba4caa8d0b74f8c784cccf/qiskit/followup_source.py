...
backend_98ab7a6d57314f388df14081012ffeec = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_98ab7a6d57314f388df14081012ffeec, shots=346).result().get_counts(qc)
RESULT = counts

...
backend_b29ef37c24614db48b091b0fa2e48b3f = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_b29ef37c24614db48b091b0fa2e48b3f, shots=1385).result().get_counts(qc)
RESULT = counts
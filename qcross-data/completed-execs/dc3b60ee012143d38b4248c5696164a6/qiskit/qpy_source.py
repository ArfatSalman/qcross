...
backend_99046d70f2384cb48b43b84f5bad3eed = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_99046d70f2384cb48b43b84f5bad3eed, shots=692).result().get_counts(qc)
RESULT = counts

...
backend_b127bdb517374e8b95d2b08ae11e065b = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_b127bdb517374e8b95d2b08ae11e065b, shots=1959).result().get_counts(qc)
RESULT = counts

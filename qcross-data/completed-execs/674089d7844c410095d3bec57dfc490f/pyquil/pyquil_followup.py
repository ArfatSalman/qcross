...
p_0761dd = circuit.declare('p_0761dd', 'REAL')
p_da435c = circuit.declare('p_da435c', 'REAL')
p_cf41eb = circuit.declare('p_cf41eb', 'REAL')

defns = get_custom_get_definitions("CU1Gate", "RZZGate", "CUGate", "RZGate", "TGate", "CSXGate", "RYYGate", "CRZGate", "SGate", "RCCXGate", "C3SXGate", "SXdgGate", "iSwapGate", "CHGate", "XGate")

circuit += defns

circuit.inst(Gates.RZGate(p_0761dd, 1 ))
circuit.inst(Gates.RZZGate(p_cf41eb)( 2, 3 ))
...
circuit.inst(Gates.CRZGate(p_da435c, 0, 1 ))
circuit.inst(Gates.C3SXGate( 1, 2, 0, 3 ))

qr_403364 = circuit.declare("qr_403364", "BIT", 10)

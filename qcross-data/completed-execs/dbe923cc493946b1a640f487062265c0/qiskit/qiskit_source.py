...
backend_5a28e680b0c045c9b09624487148977a = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_5a28e680b0c045c9b09624487148977a, shots=3919).result().get_counts(qc)
RESULT = counts
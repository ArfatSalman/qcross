...
backend_a1b016f5d20d4b14a28fbae086965971 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_a1b016f5d20d4b14a28fbae086965971, shots=692).result().get_counts(qc)
RESULT = counts

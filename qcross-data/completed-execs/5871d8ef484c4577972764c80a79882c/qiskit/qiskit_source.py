...
backend_1221c9a3c5b245daa5f33eb26360a7ba = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_1221c9a3c5b245daa5f33eb26360a7ba, shots=1959).result().get_counts(qc)
RESULT = counts
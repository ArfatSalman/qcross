...
defns = get_custom_get_definitions("CRZGate", "TGate", "ZGate", "CUGate", "RZGate", "CCXGate", "RCCXGate", "SGate", "C3SXGate")

circuit += defns

circuit.inst(Gates.RZGate(6.163759533339787, 0 ))
circuit.inst(Gates.ZGate( 2 ))
circuit.inst(Gates.CRZGate(4.2641612072511235, 3, 0 ))
circuit.inst(Gates.CUGate(0.5112149185250571, 5.897054719225356, 2.3864521352475245, 5.987304452123941, 3, 2 ))
circuit.inst(Gates.C3SXGate( 4, 0, 1, 3 ))
circuit.inst(Gates.CCXGate( 4, 5, 1 ))
circuit.inst(Gates.C3SXGate( 0, 2, 5, 1 ))

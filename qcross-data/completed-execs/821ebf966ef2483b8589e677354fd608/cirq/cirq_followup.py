...
circuit.append(Gates.CRZGate(4.2641612072511235)( qr[3], qr[0] ))
circuit.append(Gates.CUGate(0.5112149185250571, 5.897054719225356, 2.3864521352475245, 5.987304452123941)( qr[3], qr[2] ))
circuit.append(Gates.C3SXGate( qr[4], qr[0], qr[1], qr[3] ))
circuit.append(Gates.CCXGate( qr[4], qr[5], qr[1] ))
circuit.append(Gates.C3SXGate( qr[0], qr[2], qr[5], qr[1] ))

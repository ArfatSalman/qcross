...
qc.append(C3SXGate(), qargs=[qr[0], qr[7], qr[1], qr[2]], cargs=[])
...
qc.append(CU1Gate(3.2142159669963557), qargs=[qr[7], qr[3]], cargs=[])
# SECTION
# NAME: MEASUREMENT
...
backend_5bb841b7301e488fac294aaec8a82a1c = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_5bb841b7301e488fac294aaec8a82a1c, shots=3919).result().get_counts(qc)
RESULT = counts

...
backend_6ca5bf1200ce4582b719ee5c35a96a36 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_6ca5bf1200ce4582b719ee5c35a96a36, shots=5542).result().get_counts(qc)
RESULT = counts

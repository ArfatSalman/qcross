...
qr_a6b906 = QuantumRegister(7, name='qr_a6b906')
qc.add_register(qr_a6b906)
# SECTION
# NAME: MEASUREMENT
...
backend_aed5c764341342c095b428fa2bc5b86d = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_aed5c764341342c095b428fa2bc5b86d, shots=979).result().get_counts(qc)
RESULT = counts

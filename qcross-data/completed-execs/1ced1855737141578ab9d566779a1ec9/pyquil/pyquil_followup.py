...
defns = get_custom_get_definitions("RYYGate", "SGate", "ZGate", "CHGate", "SXdgGate", "CU1Gate", "UGate", "RZGate", "TGate", "CRZGate", "CSXGate", "XGate", "CUGate", "CRXGate", "ECRGate")
...
qr_a6b906 = circuit.declare("qr_a6b906", "BIT", 7)

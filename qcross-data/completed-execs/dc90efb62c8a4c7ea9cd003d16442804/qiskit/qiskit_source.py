...
backend_160f881c0edb47018d932cdc83988e2f = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_160f881c0edb47018d932cdc83988e2f, shots=5542).result().get_counts(qc)
RESULT = counts
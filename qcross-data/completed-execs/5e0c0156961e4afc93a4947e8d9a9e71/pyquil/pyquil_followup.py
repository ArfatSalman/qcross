...
defns = get_custom_get_definitions("ZGate", "C3SXGate", "XGate", "CSXGate", "RZGate", "SdgGate", "SGate", "SXGate", "CUGate", "CU3Gate")
...
subcircuit = Program()
subcircuit.inst(Gates.CU3Gate(2.8392254891488653, 0.9356897707598831, 3.855749700561927, 4, 5 ))

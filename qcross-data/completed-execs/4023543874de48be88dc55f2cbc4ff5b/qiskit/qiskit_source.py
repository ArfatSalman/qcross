...
backend_9f2a7cd0fa134890b199f5f4810dcadc = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_9f2a7cd0fa134890b199f5f4810dcadc, shots=979).result().get_counts(qc)
RESULT = counts
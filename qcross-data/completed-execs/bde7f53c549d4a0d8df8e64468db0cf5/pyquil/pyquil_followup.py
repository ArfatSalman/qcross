...
defns = get_custom_get_definitions("SdgGate", "RCCXGate", "C3SXGate", "CUGate", "UGate", "SXGate", "CRXGate", "CU1Gate", "PhaseGate", "CCXGate", "RZGate", "ZGate", "SGate", "TGate", "CRZGate", "RZZGate")
...
subcircuit = Program()
subcircuit.inst(Gates.CCXGate( 3, 4, 2 ))

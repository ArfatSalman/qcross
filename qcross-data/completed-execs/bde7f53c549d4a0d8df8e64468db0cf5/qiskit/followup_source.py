...
backend_20a6ada51b534fea9a69431ddb43699e = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_20a6ada51b534fea9a69431ddb43699e, shots=1385).result().get_counts(qc)
RESULT = counts

...
backend_f67c72805c6b4f84903fd73c5d430488 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_f67c72805c6b4f84903fd73c5d430488, shots=1385).result().get_counts(qc)
RESULT = counts
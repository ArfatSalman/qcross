...
circuit.append(Gates.CUGate(0.5112149185250571, 5.897054719225356, 2.3864521352475245, 5.987304452123941)( qr[7], qr[2] ))
circuit.append(Gates.SdgGate( qr[6] ))
circuit.append(Gates.C3SXGate( qr[7], qr[3], qr[5], qr[8] ))
...
circuit.append(Gates.C3SXGate( qr[6], qr[0], qr[4], qr[7] ))

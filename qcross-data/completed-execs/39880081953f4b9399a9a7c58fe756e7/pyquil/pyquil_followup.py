...
p_695128 = circuit.declare('p_695128', 'REAL')

defns = get_custom_get_definitions("TGate", "RZZGate", "SXGate", "ECRGate", "RYYGate", "iSwapGate", "CSXGate", "SXdgGate", "XGate")
...
circuit.inst(Gates.XGate( 1 ))
circuit.inst(Gates.RYYGate(p_695128)( 0, 1 ))

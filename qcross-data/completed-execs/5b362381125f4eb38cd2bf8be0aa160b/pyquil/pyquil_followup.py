...
defns = get_custom_get_definitions("SGate", "CSXGate", "SXdgGate", "RYYGate", "RZGate", "SdgGate", "CRXGate", "ZGate", "CHGate", "iSwapGate", "XGate", "CCXGate", "TGate", "ECRGate")
...
qr_c3d903 = circuit.declare("qr_c3d903", "BIT", 6)

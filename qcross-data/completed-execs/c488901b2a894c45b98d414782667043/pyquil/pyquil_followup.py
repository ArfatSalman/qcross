...
defns = get_custom_get_definitions("CHGate", "RZGate", "SGate", "iSwapGate", "SdgGate", "CRXGate", "RYYGate", "U3Gate", "CU3Gate", "XGate", "CSXGate", "SXdgGate")
...
subcircuit = Program()
subcircuit.inst(Gates.U3Gate(2.6397681660693015, 5.320621737498446, 3.427505621225153)( 2 ))
subcircuit.inst(Gates.RYYGate(6.033961191253911)( 0, 2 ))

...
qc_1 = transpile(qc_1, basis_gates=None, optimization_level=2, coupling_map=[[0, 1], [0, 5], [0, 9], [0, 10], [1, 0], [1, 3], [1, 4], [1, 7], [2, 3], [3, 1], [3, 2], [4, 1], [5, 0], [5, 8], [6, 8], [7, 1], [7, 11], [8, 5], [8, 6], [9, 0], [10, 0], [11, 7]])
qc_2 = transpile(qc_2, basis_gates=None, optimization_level=2, coupling_map=[[0, 1], [0, 5], [0, 9], [0, 10], [1, 0], [1, 3], [1, 4], [1, 7], [2, 3], [3, 1], [3, 2], [4, 1], [5, 0], [5, 8], [6, 8], [7, 1], [7, 11], [8, 5], [8, 6], [9, 0], [10, 0], [11, 7]])
# SECTION
# NAME: EXECUTION

from qiskit import Aer, transpile, execute
backend_01ed49e273d749eb96923f4a304923ee = Aer.get_backend('qasm_simulator')
counts_1 = execute(qc_1, backend=backend_01ed49e273d749eb96923f4a304923ee, shots=7838).result().get_counts(qc_1)
counts_2 = execute(qc_2, backend=backend_01ed49e273d749eb96923f4a304923ee, shots=7838).result().get_counts(qc_2)

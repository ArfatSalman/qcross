...
defns = get_custom_get_definitions("TGate", "SXdgGate", "ZGate")
...
defns = get_custom_get_definitions("CHGate", "SdgGate", "RZZGate", "CCXGate", "RZGate", "U2Gate", "CSXGate", "SXdgGate", "CRZGate", "ZGate", "CU1Gate", "TGate", "RCCXGate", "XGate")
...
qc_2.inst(Gates.RZGate(3.6614081973587154, 5 ))

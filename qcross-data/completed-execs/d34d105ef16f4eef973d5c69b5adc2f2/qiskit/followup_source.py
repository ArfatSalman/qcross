...
backend_3494c6b634dd4c8eab7dd063c5debd2b = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_3494c6b634dd4c8eab7dd063c5debd2b, shots=346).result().get_counts(qc)
RESULT = counts

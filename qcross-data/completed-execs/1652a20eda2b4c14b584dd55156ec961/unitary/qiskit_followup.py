...
from qiskit import Aer, transpile, execute
backend_2c8cbf7d18404228aaf5eba568d4de66 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_2c8cbf7d18404228aaf5eba568d4de66, shots=692).result().get_counts(qc)
RESULT = counts

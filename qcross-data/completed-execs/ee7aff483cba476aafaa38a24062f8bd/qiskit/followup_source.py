...
backend_a9efdaca97264cf0b08352ca2eedd4d8 = Aer.get_backend('statevector_simulator')
counts = execute(qc, backend=backend_a9efdaca97264cf0b08352ca2eedd4d8, shots=692).result().get_counts(qc)
RESULT = counts

...
backend_17fc1c5be61b45699311693a1e577faa = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_17fc1c5be61b45699311693a1e577faa, shots=1959).result().get_counts(qc)
RESULT = counts
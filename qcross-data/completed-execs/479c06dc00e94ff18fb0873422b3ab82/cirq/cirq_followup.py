...
p_921885 = Symbol('p_921885')
p_56f09a = Symbol('p_56f09a')
p_e307f6 = Symbol('p_e307f6')

circuit = cirq.Circuit()

circuit.append(Gates.RZGate(6.163759533339787)( qr[3] ))
circuit.append(Gates.CRZGate(p_921885)( qr[6], qr[3] ))
circuit.append(Gates.CRXGate(p_56f09a)( qr[1], qr[7] ))
circuit.append(Gates.CCXGate( qr[5], qr[9], qr[7] ))
circuit.append(Gates.ZGate( qr[2] ))
circuit.append(Gates.TGate( qr[9] ))
circuit.append(Gates.XGate( qr[8] ))
circuit.append(Gates.CRZGate(p_e307f6)( qr[1], qr[6] ))
...
subcircuit.append(Gates.ECRGate( qr[3], qr[4] ))
subcircuit.append(Gates.PhaseGate(0.4827903095199283)( qr[8] ))

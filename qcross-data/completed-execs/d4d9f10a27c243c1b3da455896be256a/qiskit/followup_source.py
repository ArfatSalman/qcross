...
backend_bff824496b4f48c8b9bbd129d9fd9b50 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_bff824496b4f48c8b9bbd129d9fd9b50, shots=346).result().get_counts(qc)
RESULT = counts

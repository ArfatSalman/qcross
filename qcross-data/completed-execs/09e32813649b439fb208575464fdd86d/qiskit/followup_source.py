...
qr_638909 = QuantumRegister(9, name='qr_638909')
qc.add_register(qr_638909)
# SECTION
# NAME: MEASUREMENT
...
backend_1ee71abfa8d1423d81868cdea0877ab0 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_1ee71abfa8d1423d81868cdea0877ab0, shots=1959).result().get_counts(qc)
RESULT = counts

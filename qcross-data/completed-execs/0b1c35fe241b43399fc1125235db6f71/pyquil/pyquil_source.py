...
defns = get_custom_get_definitions("TdgGate", "RYGate", "CUGate", "C3XGate", "RZGate", "CHGate", "UGate", "RXXGate", "CU1Gate", "CSwapGate", "CSXGate", "CCXGate")
...
circuit.inst(Gates.CCXGate( 6, 0, 1 ))

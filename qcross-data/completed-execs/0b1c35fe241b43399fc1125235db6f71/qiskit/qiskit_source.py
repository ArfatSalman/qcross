...
qc.append(C3XGate(), qargs=[qr[1], qr[2], qr[6], qr[5]], cargs=[])
qc.append(CCXGate(), qargs=[qr[6], qr[0], qr[1]], cargs=[])
...
qc.append(RZGate(5.89153421924888), qargs=[qr[6]], cargs=[])
qc.append(TdgGate(), qargs=[qr[4]], cargs=[])
qc.append(RXXGate(3.9517064865019407), qargs=[qr[1], qr[6]], cargs=[])
...
backend_ee11b1987c90406daa87491d8981ee21 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_ee11b1987c90406daa87491d8981ee21, shots=1959).result().get_counts(qc)
RESULT = counts
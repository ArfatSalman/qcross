...
backend_6758008d0e8c4664b56dd324de151dc3 = Aer.get_backend('qasm_simulator')
counts_1 = execute(qc_1, backend=backend_6758008d0e8c4664b56dd324de151dc3, shots=7838).result().get_counts(qc_1)
counts_2 = execute(qc_2, backend=backend_6758008d0e8c4664b56dd324de151dc3, shots=7838).result().get_counts(qc_2)

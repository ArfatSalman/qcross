...
qc.append(C3XGate(), qargs=[qr[1], qr[2], qr[0], qr[3]], cargs=[])
...
qc.append(C3XGate(), qargs=[qr[3], qr[1], qr[0], qr[2]], cargs=[])
qc.append(CUGate(2.945697832726557,3.322311684185455,2.468007457013939,1.7221796439586554), qargs=[qr[3], qr[0]], cargs=[])
qc.append(iSwapGate(), qargs=[qr[2], qr[3]], cargs=[])
qc.append(RC3XGate(), qargs=[qr[1], qr[3], qr[0], qr[2]], cargs=[])
qc.append(RYGate(0.8391711967546518), qargs=[qr[3]], cargs=[])
qc.append(CCXGate(), qargs=[qr[1], qr[2], qr[0]], cargs=[])
qc.append(CYGate(), qargs=[qr[1], qr[0]], cargs=[])
qc.append(C3XGate(), qargs=[qr[1], qr[0], qr[3], qr[2]], cargs=[])
qc.append(RXXGate(3.9517064865019407), qargs=[qr[3], qr[0]], cargs=[])
...
backend_acde00b68199425f9cc836165d5a9a57 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_acde00b68199425f9cc836165d5a9a57, shots=692).result().get_counts(qc)
RESULT = counts
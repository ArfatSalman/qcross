...
defns = get_custom_get_definitions("XGate", "RZGate", "ZGate", "RCCXGate", "SGate", "CSXGate", "PhaseGate", "CHGate", "CRXGate", "C3SXGate", "ECRGate", "SdgGate", "TGate", "CCXGate", "CU1Gate", "CRZGate", "U2Gate")
...
qr_962eb5 = circuit.declare("qr_962eb5", "BIT", 5)

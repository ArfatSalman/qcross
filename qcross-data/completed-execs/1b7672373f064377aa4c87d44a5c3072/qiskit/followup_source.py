...
subcircuit.append(CCXGate(), qargs=[qr[3], qr[4], qr[2]], cargs=[])
...
qr_962eb5 = QuantumRegister(5, name='qr_962eb5')
subcircuit.add_register(qr_962eb5)
# SECTION
# NAME: MEASUREMENT
...
backend_4797fe5eb9694eab9c0d55d5313e360d = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_4797fe5eb9694eab9c0d55d5313e360d, shots=1959).result().get_counts(qc)
RESULT = counts

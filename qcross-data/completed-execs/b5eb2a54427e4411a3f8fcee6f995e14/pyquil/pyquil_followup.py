...
defns = get_custom_get_definitions("CHGate", "SXdgGate", "ZGate", "TGate", "ECRGate", "iSwapGate", "RCCXGate", "SdgGate", "XGate", "SGate", "CCXGate", "RZGate", "CRXGate", "RYYGate", "CSXGate")
...
circuit.inst(Gates.RYYGate(1.6723037552953224)( 1, 2 ))

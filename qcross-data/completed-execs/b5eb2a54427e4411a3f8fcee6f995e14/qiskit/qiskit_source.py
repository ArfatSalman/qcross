...
backend_29b3fd470aa74a099c50e61de1faadff = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_29b3fd470aa74a099c50e61de1faadff, shots=489).result().get_counts(qc)
RESULT = counts
...
circuit.append(Gates.CCXGate( qr[4], qr[9], qr[2] ))
circuit.append(Gates.ZGate( qr[1] ))
circuit.append(Gates.XGate( qr[2] ))
circuit.append(Gates.RCCXGate( qr[3], qr[6], qr[10] ))
...
circuit.append(Gates.CHGate( qr[8], qr[2] ))
circuit.append(Gates.CU1Gate(4.028174522740928)( qr[9], qr[8] ))

...
subcircuit.append(CSwapGate(), qargs=[qr[0], qr[4], qr[3]], cargs=[])
...
backend_7d670a2e121a4b0b91fce3160ef99eb2 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_7d670a2e121a4b0b91fce3160ef99eb2, shots=1385).result().get_counts(qc)
RESULT = counts

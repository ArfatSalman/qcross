...
defns = get_custom_get_definitions("CRZGate", "CU1Gate", "CXGate", "TGate", "CSXGate", "C3SXGate", "RZZGate", "DCXGate", "SGate", "CSwapGate", "UGate", "SXdgGate", "RCCXGate", "RYYGate", "CRYGate", "CUGate", "RZGate", "ZGate", "CCXGate", "SXGate")
...
subcircuit = Program()
subcircuit.inst(Gates.CSwapGate( 0, 4, 3 ))

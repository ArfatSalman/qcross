...
backend_ddd679b5c7604dd8a805d92f03dc6e53 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_ddd679b5c7604dd8a805d92f03dc6e53, shots=489).result().get_counts(qc)
RESULT = counts
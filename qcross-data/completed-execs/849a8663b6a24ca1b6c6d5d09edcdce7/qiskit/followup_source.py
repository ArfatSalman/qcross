...
qc = transpile(qc, basis_gates=None, optimization_level=1, coupling_map=[[0,
    1], [0, 2], [1, 0], [1, 3], [2, 0], [3, 1], [3, 4], [4, 3]])
# SECTION
# NAME: EXECUTION

from qiskit import Aer, transpile, execute
backend_b0fa4bd493e84aeda8aa5663dcfae3ca = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_b0fa4bd493e84aeda8aa5663dcfae3ca, shots=979).result().get_counts(qc)
RESULT = counts

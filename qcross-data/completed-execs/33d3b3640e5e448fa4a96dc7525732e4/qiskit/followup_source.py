...
qc.append(CUGate(0.5112149185250571, 5.897054719225356, 2.3864521352475245,
    5.987304452123941), qargs=[qr[3], qr[0]], cargs=[])
...
backend_583123b387ed495e985eae7adaf45cf8 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_583123b387ed495e985eae7adaf45cf8, shots=692).result().get_counts(qc)
RESULT = counts

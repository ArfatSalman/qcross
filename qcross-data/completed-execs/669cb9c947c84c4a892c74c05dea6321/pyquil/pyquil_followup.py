...
defns = get_custom_get_definitions("CU1Gate", "CRZGate", "CSXGate", "CRXGate", "TGate", "RYYGate", "U2Gate", "SdgGate", "ZGate", "SXGate", "RZZGate", "RXGate", "XGate", "CUGate", "C3SXGate", "RZGate")
...
subcircuit = Program()
subcircuit.inst(Gates.RXGate(2.4205260581208594, 4 ))
subcircuit.inst(Gates.CUGate(4.722103101046168, 5.3924725338944945, 4.88987246261121, 1.2497571638956968, 2, 0 ))
subcircuit.inst(Gates.CUGate(2.862865991712737, 6.0504088665633065, 1.7203758404994713, 2.8704483107274004, 3, 6 ))
...
qr_305339 = circuit.declare("qr_305339", "BIT", 7)

...
defns = get_custom_get_definitions("RYYGate", "iSwapGate", "XGate", "CHGate", "ECRGate", "RZZGate", "TGate", "ZGate", "CSXGate", "CU1Gate", "CRZGate", "SXGate", "CRXGate", "SXdgGate", "SGate", "RZGate")
...
qr_d699c7 = circuit.declare("qr_d699c7", "BIT", 6)

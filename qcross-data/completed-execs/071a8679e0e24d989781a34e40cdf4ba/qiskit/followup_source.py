...
qr_d699c7 = QuantumRegister(6, name='qr_d699c7')
qc.add_register(qr_d699c7)
# SECTION
# NAME: MEASUREMENT
...
backend_f2feb89965b0402794b63508a4656cf1 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_f2feb89965b0402794b63508a4656cf1, shots=346).result().get_counts(qc)
RESULT = counts

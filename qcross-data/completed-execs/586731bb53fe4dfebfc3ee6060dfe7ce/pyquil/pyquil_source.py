...
defns = get_custom_get_definitions("SXdgGate", "iSwapGate", "RZGate", "CRZGate", "ZGate", "RCCXGate", "CHGate", "SdgGate", "RYYGate", "XGate", "TGate", "ECRGate", "SGate", "CCXGate", "CRXGate", "CSXGate")

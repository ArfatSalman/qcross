...
backend_1b366d9a5df348b7a73e9bc7c928e882 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_1b366d9a5df348b7a73e9bc7c928e882, shots=2771).result().get_counts(qc)
RESULT = counts

...
backend_f00928ac1e8341bba110a69a8702195c = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_f00928ac1e8341bba110a69a8702195c, shots=346).result().get_counts(qc)
RESULT = counts

...
p_8c9338 = circuit.declare('p_8c9338', 'REAL')

defns = get_custom_get_definitions("CCXGate", "XGate", "RZGate", "SdgGate", "CRXGate", "SXdgGate", "CHGate", "CSXGate", "SGate", "iSwapGate")
...
circuit.inst(Gates.CRXGate(p_8c9338, 0, 2 ))
circuit.inst(Gates.SGate( 2 ))

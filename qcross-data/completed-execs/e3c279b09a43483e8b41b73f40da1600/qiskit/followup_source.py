...
qr_d05763 = QuantumRegister(8, name='qr_d05763')
qc.add_register(qr_d05763)
# SECTION
# NAME: MEASUREMENT
...
backend_c34a4120a9c0410f93147760fe1fa8a8 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_c34a4120a9c0410f93147760fe1fa8a8, shots=692).result().get_counts(qc)
RESULT = counts

...
defns = get_custom_get_definitions("CHGate", "CU1Gate", "CRZGate", "RCCXGate", "SGate", "C3SXGate", "CUGate", "SXdgGate", "XGate", "iSwapGate", "RZZGate", "RZGate", "TGate", "CSXGate", "RYYGate")
...
qr_d05763 = circuit.declare("qr_d05763", "BIT", 8)

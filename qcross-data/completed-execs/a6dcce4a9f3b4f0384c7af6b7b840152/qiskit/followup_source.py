...
qr_9858c7 = QuantumRegister(7, name='qr_9858c7')
qc.add_register(qr_9858c7)
# SECTION
# NAME: MEASUREMENT
...
backend_4979dd7fa3d246f4bca9ee2693a1fff7 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_4979dd7fa3d246f4bca9ee2693a1fff7, shots=692).result().get_counts(qc)
RESULT = counts

...
defns = get_custom_get_definitions("CRZGate", "SXdgGate", "iSwapGate", "C3SXGate", "RCCXGate", "RZZGate", "CU1Gate", "RYYGate", "CUGate", "SGate", "RZGate", "TGate", "XGate", "CSXGate", "CHGate")
...
qr_9858c7 = circuit.declare("qr_9858c7", "BIT", 7)

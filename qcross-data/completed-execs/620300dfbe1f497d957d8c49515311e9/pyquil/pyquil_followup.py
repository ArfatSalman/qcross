...
defns = get_custom_get_definitions("XGate", "RYYGate", "CRZGate", "CU1Gate", "RZZGate", "CRXGate", "iSwapGate", "SXGate", "ECRGate", "CHGate", "TGate", "CSXGate", "RZGate", "SXdgGate")
...
qr_2ad6b1 = circuit.declare("qr_2ad6b1", "BIT", 6)

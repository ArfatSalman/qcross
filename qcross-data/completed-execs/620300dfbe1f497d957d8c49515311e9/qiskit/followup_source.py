...
qr_2ad6b1 = QuantumRegister(6, name='qr_2ad6b1')
qc.add_register(qr_2ad6b1)
# SECTION
# NAME: MEASUREMENT
...
backend_12b13dd1b9c64aa08fe875233e7df1a3 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_12b13dd1b9c64aa08fe875233e7df1a3, shots=346).result().get_counts(qc)
RESULT = counts

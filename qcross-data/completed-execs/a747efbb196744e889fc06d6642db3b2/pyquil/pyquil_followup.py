...
defns = get_custom_get_definitions("CRZGate", "CHGate", "SXdgGate", "iSwapGate", "TGate", "SXGate", "IGate", "RXGate", "XGate", "RZGate", "RZZGate", "CYGate", "RYGate", "ECRGate", "RYYGate", "CRXGate", "CSXGate")
...
subcircuit = Program()
subcircuit.inst(Gates.RYGate(1.6723037552953224, 0 ))
...
qr_9224f0 = circuit.declare("qr_9224f0", "BIT", 5)

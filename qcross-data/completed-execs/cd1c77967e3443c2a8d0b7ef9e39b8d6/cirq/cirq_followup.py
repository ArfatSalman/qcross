...
circuit.append(Gates.CRZGate(4.2641612072511235)( qr[0], qr[9] ))
circuit.append(Gates.CRXGate(5.987304452123941)( qr[4], qr[5] ))
circuit.append(Gates.CCXGate( qr[1], qr[3], qr[5] ))

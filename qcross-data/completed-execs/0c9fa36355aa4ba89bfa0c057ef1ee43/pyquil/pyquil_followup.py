...
defns = get_custom_get_definitions("iSwapGate", "SXGate", "RYYGate", "SdgGate", "RZGate", "UGate", "PhaseGate", "C3SXGate", "CSXGate", "SGate", "SXdgGate", "CRZGate", "ZGate", "CU1Gate", "CUGate", "CSwapGate", "XGate")
...
qr_fabff3 = circuit.declare("qr_fabff3", "BIT", 2)

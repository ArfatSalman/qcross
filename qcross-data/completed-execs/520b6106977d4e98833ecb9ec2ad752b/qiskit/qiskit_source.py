...
backend_e1faa7636f9c473f926d68d784aed35b = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_e1faa7636f9c473f926d68d784aed35b, shots=979).result().get_counts(qc)
RESULT = counts
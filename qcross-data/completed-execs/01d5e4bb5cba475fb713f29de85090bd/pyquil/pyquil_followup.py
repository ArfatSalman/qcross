...
p_faecf5 = circuit.declare('p_faecf5', 'REAL')
p_428d4a = circuit.declare('p_428d4a', 'REAL')
p_5976d3 = circuit.declare('p_5976d3', 'REAL')
p_91ad47 = circuit.declare('p_91ad47', 'REAL')
p_1fff0a = circuit.declare('p_1fff0a', 'REAL')

defns = get_custom_get_definitions("CRZGate", "TGate", "SXGate", "ZGate", "UGate", "CUGate", "RZGate", "CCXGate", "RZZGate", "RCCXGate", "CU1Gate", "SGate", "C3SXGate")
...
circuit.inst(Gates.CUGate(p_faecf5, 5.897054719225356, p_5976d3, p_91ad47, 2, 3 ))
...
circuit.inst(Gates.UGate(5.887184334931191, 0.07157463504881167, p_1fff0a)( 5 ))
circuit.inst(Gates.RZZGate(5.1829934776392745)( 0, 5 ))
circuit.inst(Gates.SGate( 4 ))
circuit.inst(Gates.SXGate( 0 ))
circuit.inst(Gates.ZGate( 4 ))
circuit.inst(Gates.CRZGate(p_428d4a, 0, 5 ))
...
params = {
    "p_faecf5": 0.5112149185250571,
    "p_428d4a": 4.833923139882297,
    "p_5976d3": 2.3864521352475245,
    "p_91ad47": 5.987304452123941,
    "p_1fff0a": 1.4112277317699358
}

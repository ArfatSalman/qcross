...
p_faecf5 = Symbol('p_faecf5')
p_428d4a = Symbol('p_428d4a')
p_5976d3 = Symbol('p_5976d3')
p_91ad47 = Symbol('p_91ad47')
p_1fff0a = Symbol('p_1fff0a')
...
circuit.append(Gates.CUGate(p_faecf5, 5.897054719225356, p_5976d3, p_91ad47)( qr[2], qr[3] ))
...
circuit.append(Gates.UGate(5.887184334931191, 0.07157463504881167, p_1fff0a)( qr[5] ))
...
circuit.append(Gates.CRZGate(p_428d4a)( qr[0], qr[5] ))

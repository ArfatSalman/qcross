...
backend_2bbaa6261f08482ea8aee5ce1b9e4e83 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_2bbaa6261f08482ea8aee5ce1b9e4e83, shots=979).result().get_counts(qc)
RESULT = counts
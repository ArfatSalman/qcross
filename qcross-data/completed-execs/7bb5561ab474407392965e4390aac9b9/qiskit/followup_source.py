...
qr_4f3a91 = QuantumRegister(4, name='qr_4f3a91')
qc.add_register(qr_4f3a91)
# SECTION
# NAME: MEASUREMENT
...
backend_2b82ab54aa544af6877b1f129267fae2 = Aer.get_backend('aer_simulator_statevector')
counts = execute(qc, backend=backend_2b82ab54aa544af6877b1f129267fae2, shots=1959).result().get_counts(qc)
RESULT = counts

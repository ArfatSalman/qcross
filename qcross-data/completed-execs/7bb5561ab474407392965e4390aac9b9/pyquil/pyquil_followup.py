...
defns = get_custom_get_definitions("CRZGate", "CSXGate", "ZGate", "XGate", "RZGate", "SdgGate", "RCCXGate", "CU1Gate", "ECRGate", "CHGate", "CRXGate", "SGate", "C3SXGate")
...
qr_4f3a91 = circuit.declare("qr_4f3a91", "BIT", 4)

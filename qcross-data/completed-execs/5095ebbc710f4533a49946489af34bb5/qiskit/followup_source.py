...
backend_94cad97b000640acade8a7da4eee8102 = Aer.get_backend('aer_simulator_statevector')
counts = execute(qc, backend=backend_94cad97b000640acade8a7da4eee8102, shots=489).result().get_counts(qc)
RESULT = counts

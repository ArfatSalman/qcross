...
p_51446f = Symbol('p_51446f')
p_40d80f = Symbol('p_40d80f')
p_2e845a = Symbol('p_2e845a')
p_75570c = Symbol('p_75570c')
p_94fb1b = Symbol('p_94fb1b')
p_002797 = Symbol('p_002797')
p_b6d4eb = Symbol('p_b6d4eb')

circuit = cirq.Circuit()

circuit.append(Gates.RZGate(p_40d80f)( qr[1] ))
circuit.append(Gates.RZZGate(p_75570c)( qr[2], qr[3] ))
circuit.append(Gates.iSwapGate( qr[2], qr[3] ))
circuit.append(Gates.CSXGate( qr[1], qr[0] ))
circuit.append(Gates.XGate( qr[2] ))
circuit.append(Gates.CUGate(p_94fb1b, p_002797, p_51446f, p_b6d4eb)( qr[0], qr[2] ))
circuit.append(Gates.CU1Gate(p_2e845a)( qr[3], qr[0] ))

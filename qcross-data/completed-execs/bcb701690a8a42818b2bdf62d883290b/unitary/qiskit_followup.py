...
from qiskit import Aer, transpile, execute
backend_153dd18724f94b68833b0931128e4d5b = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_153dd18724f94b68833b0931128e4d5b, shots=489).result().get_counts(qc)
RESULT = counts

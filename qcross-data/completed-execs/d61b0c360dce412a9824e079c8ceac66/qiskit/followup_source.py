...
qc.append(RCCXGate(), qargs=[qr[5], qr[1], qr[0]], cargs=[])
...
qr_1bc5c2 = QuantumRegister(6, name='qr_1bc5c2')
qc.add_register(qr_1bc5c2)
# SECTION
# NAME: MEASUREMENT
...
backend_54571894b690485fb9d4139939745691 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_54571894b690485fb9d4139939745691, shots=1385).result().get_counts(qc)
RESULT = counts

...
defns = get_custom_get_definitions("CRZGate", "TGate", "ZGate", "CUGate", "RZGate", "CCXGate", "RCCXGate", "CU1Gate", "SGate", "C3SXGate")
...
circuit.inst(Gates.RCCXGate( 5, 1, 0 ))
...
qr_1bc5c2 = circuit.declare("qr_1bc5c2", "BIT", 6)

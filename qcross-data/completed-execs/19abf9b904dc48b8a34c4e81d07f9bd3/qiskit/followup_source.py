...
backend_0a94c4dd814140c7a6e6ed1ba5f3cde5 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_0a94c4dd814140c7a6e6ed1ba5f3cde5, shots=346).result().get_counts(qc)
RESULT = counts

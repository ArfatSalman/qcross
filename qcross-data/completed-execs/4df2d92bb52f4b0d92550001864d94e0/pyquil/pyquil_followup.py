...
p_b699b9 = circuit.declare('p_b699b9', 'REAL')
p_edcf6a = circuit.declare('p_edcf6a', 'REAL')

defns = get_custom_get_definitions("CHGate", "ZGate", "RZGate", "ECRGate", "SdgGate", "C3SXGate", "CRXGate", "XGate")

circuit += defns

circuit.inst(Gates.RZGate(p_edcf6a, 4 ))
circuit.inst(Gates.ZGate( 6 ))
circuit.inst(Gates.XGate( 3 ))
circuit.inst(Gates.CRXGate(p_b699b9, 2, 5 ))
...
qr_1fe11f = circuit.declare("qr_1fe11f", "BIT", 9)

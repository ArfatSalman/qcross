...
circuit.append(Gates.CRZGate(4.2641612072511235)( qr[1], qr[2] ))
...
subcircuit.append(Gates.RYYGate(0.5501056885328758)( qr[1], qr[0] ))
subcircuit.append(Gates.SXdgGate( qr[2] ))
subcircuit.append(Gates.DCXGate( qr[3], qr[1] ))
subcircuit.append(Gates.RYYGate(0.6724371252296606)( qr[0], qr[5] ))
subcircuit.append(Gates.CXGate( qr[1], qr[0] ))
subcircuit.append(Gates.PhaseGate(5.5146057452272546)( qr[3] ))
...
circuit.append(Gates.CRZGate(4.167661441102218)( qr[3], qr[5] ))

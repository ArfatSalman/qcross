...
defns = get_custom_get_definitions("CHGate", "XGate", "IGate", "ECRGate", "RZZGate", "ZGate", "TGate", "CSXGate", "CU1Gate", "CRZGate", "C3SXGate", "RCCXGate", "CRXGate", "SGate", "U2Gate", "RZGate", "SdgGate")
...
qr_4cc6a8 = circuit.declare("qr_4cc6a8", "BIT", 9)

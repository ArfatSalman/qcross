...
qr_4cc6a8 = QuantumRegister(9, name='qr_4cc6a8')
subcircuit.add_register(qr_4cc6a8)
# SECTION
# NAME: MEASUREMENT
...
backend_428b41e88a5f42eba6b34d63df1cbefe = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_428b41e88a5f42eba6b34d63df1cbefe, shots=1959).result().get_counts(qc)
RESULT = counts

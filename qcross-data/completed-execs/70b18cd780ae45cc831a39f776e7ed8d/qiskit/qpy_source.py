...
qr_d14cf0 = QuantumRegister(7, name='qr_d14cf0')
qc.add_register(qr_d14cf0)
# SECTION
# NAME: MEASUREMENT
...
backend_22deab2ea69744e88299949fd64bfb5e = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_22deab2ea69744e88299949fd64bfb5e, shots=346).result().get_counts(qc)
RESULT = counts

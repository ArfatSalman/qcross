...
defns = get_custom_get_definitions("CRZGate", "SXdgGate", "iSwapGate", "RZZGate", "CRXGate", "RYYGate", "TGate", "RZGate", "XGate", "CSXGate", "ECRGate", "SXGate", "CHGate")
...
qr_d14cf0 = circuit.declare("qr_d14cf0", "BIT", 7)

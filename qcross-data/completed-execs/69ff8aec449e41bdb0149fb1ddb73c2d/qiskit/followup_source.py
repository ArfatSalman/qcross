...
qr_d659fb = QuantumRegister(6, name='qr_d659fb')
qc.add_register(qr_d659fb)
# SECTION
# NAME: MEASUREMENT
...
backend_1fe36b823173424a911efd733c112cea = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_1fe36b823173424a911efd733c112cea, shots=7838).result().get_counts(qc)
RESULT = counts

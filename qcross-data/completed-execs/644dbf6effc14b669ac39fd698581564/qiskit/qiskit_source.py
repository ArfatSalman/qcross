...
backend_f75c0c278733421a989415d18627c459 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_f75c0c278733421a989415d18627c459, shots=3919).result().get_counts(qc)
RESULT = counts
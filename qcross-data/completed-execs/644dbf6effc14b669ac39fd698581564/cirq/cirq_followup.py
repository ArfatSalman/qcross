...
subcircuit.append(Gates.CPhaseGate(4.63837786161633)( qr[7], qr[5] ))
subcircuit.append(Gates.UGate(3.5173414605326783, 2.3568871696687452, 6.011900464835247)( qr[4] ))
subcircuit.append(Gates.XGate( qr[0] ))
subcircuit.append(Gates.RZZGate(5.017245588344839)( qr[0], qr[8] ))
subcircuit.append(Gates.CRZGate(2.008796895454228)( qr[0], qr[6] ))

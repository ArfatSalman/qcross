...
defns = get_custom_get_definitions("UGate", "RZGate", "CRZGate", "ZGate", "C3SXGate", "CPhaseGate", "SXGate", "CUGate", "SdgGate", "XGate", "RZZGate", "CSXGate", "SGate")
...
subcircuit = Program()
subcircuit.inst(Gates.CPhaseGate(4.63837786161633, 7, 5 ))
subcircuit.inst(Gates.UGate(3.5173414605326783, 2.3568871696687452, 6.011900464835247)( 4 ))
subcircuit.inst(Gates.XGate( 0 ))
subcircuit.inst(Gates.RZZGate(5.017245588344839)( 0, 8 ))
subcircuit.inst(Gates.CRZGate(2.008796895454228, 0, 6 ))
...
qr_0ba758 = circuit.declare("qr_0ba758", "BIT", 1)

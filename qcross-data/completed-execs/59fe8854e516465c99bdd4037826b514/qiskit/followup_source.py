...
qr_c00dd1 = QuantumRegister(9, name='qr_c00dd1')
qc.add_register(qr_c00dd1)
# SECTION
# NAME: MEASUREMENT
...
backend_ee542056abed4685ba839dc09f8e4fe3 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_ee542056abed4685ba839dc09f8e4fe3, shots=7838).result().get_counts(qc)
RESULT = counts

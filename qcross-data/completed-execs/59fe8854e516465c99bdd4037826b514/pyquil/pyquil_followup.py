...
defns = get_custom_get_definitions("CRZGate", "U2Gate", "RCCXGate", "CU1Gate", "RZGate", "TGate", "XGate", "CSXGate", "PhaseGate", "ZGate", "SdgGate", "CHGate", "CCXGate")

circuit += defns


subcircuit = Program()
subcircuit.inst(Gates.CCXGate( 4, 0, 1 ))
subcircuit.inst(Gates.PhaseGate(5.336667571035288, 1 ))
...
qr_c00dd1 = circuit.declare("qr_c00dd1", "BIT", 9)

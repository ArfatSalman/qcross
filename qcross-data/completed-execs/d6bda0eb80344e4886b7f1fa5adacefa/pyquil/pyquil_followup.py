...
p_b56eb0 = circuit.declare('p_b56eb0', 'REAL')

defns = get_custom_get_definitions("XGate", "RYYGate", "TGate", "CRXGate", "SXdgGate", "CHGate", "CSXGate", "ECRGate", "CRZGate", "SXGate", "iSwapGate", "RZZGate")
...
circuit.inst(Gates.CRZGate(p_b56eb0, 0, 1 ))
circuit.inst(Gates.SXGate( 1 ))

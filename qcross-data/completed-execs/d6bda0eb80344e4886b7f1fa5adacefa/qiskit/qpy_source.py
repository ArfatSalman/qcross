...
qc.append(CRZGate(p_b56eb0), qargs=[qr[0], qr[1]], cargs=[])
qc.append(SXGate(), qargs=[qr[1]], cargs=[])
# SECTION
# NAME: MEASUREMENT
...
backend_ea33b23b782340309f5175f910f9fff8 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_ea33b23b782340309f5175f910f9fff8, shots=346).result().get_counts(qc)
RESULT = counts

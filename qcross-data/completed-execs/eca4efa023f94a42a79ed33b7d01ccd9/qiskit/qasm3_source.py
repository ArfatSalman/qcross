...
qc.append(RZZGate(6.037113923235684), qargs=[qr[2], qr[0]], cargs=[])
# SECTION
# NAME: USELESS_ENTITIES

qr_246dc7 = QuantumRegister(3, name='qr_246dc7')
qc.add_register(qr_246dc7)
# SECTION
# NAME: MEASUREMENT
...
backend_fb75495d4ec94d169594cf6409e736f8 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_fb75495d4ec94d169594cf6409e736f8, shots=692).result().get_counts(qc)
RESULT = counts

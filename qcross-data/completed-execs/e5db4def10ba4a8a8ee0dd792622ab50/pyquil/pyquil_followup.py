...
defns = get_custom_get_definitions("C3SXGate", "CCXGate", "ZGate", "RZGate", "CRZGate", "CUGate")

circuit += defns

circuit.inst(Gates.RZGate(6.163759533339787, 3 ))
circuit.inst(Gates.ZGate( 5 ))
circuit.inst(Gates.CRZGate(4.2641612072511235, 1, 3 ))
circuit.inst(Gates.CUGate(0.5112149185250571, 5.897054719225356, 2.3864521352475245, 5.987304452123941, 1, 5 ))
circuit.inst(Gates.C3SXGate( 2, 3, 0, 1 ))
circuit.inst(Gates.CCXGate( 2, 4, 0 ))

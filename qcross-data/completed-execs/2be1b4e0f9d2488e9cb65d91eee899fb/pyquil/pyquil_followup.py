...
defns = get_custom_get_definitions("XGate", "RZGate", "ZGate", "CRXGate", "C3SXGate", "CRZGate")

qc_1 += defns

qc_1.inst(Gates.RZGate(6.163759533339787, 0 ))
qc_1.inst(Gates.ZGate( 4 ))
qc_1.inst(Gates.XGate( 4 ))
qc_1.inst(Gates.CRXGate(5.987304452123941, 1, 4 ))
qc_1.inst(Gates.CRZGate(1.0296448789776642, 2, 4 ))
qc_1.inst(Gates.C3SXGate( 1, 5, 4, 3 ))
qc_1.inst(Gates.XGate( 2 ))

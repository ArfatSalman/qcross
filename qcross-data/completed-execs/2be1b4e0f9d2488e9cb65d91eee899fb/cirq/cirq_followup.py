...
qc_1.append(Gates.ZGate( qr_1[4] ))
qc_1.append(Gates.XGate( qr_1[4] ))
qc_1.append(Gates.CRXGate(5.987304452123941)( qr_1[1], qr_1[4] ))
qc_1.append(Gates.CRZGate(1.0296448789776642)( qr_1[2], qr_1[4] ))
qc_1.append(Gates.C3SXGate( qr_1[1], qr_1[5], qr_1[4], qr_1[3] ))
qc_1.append(Gates.XGate( qr_1[2] ))

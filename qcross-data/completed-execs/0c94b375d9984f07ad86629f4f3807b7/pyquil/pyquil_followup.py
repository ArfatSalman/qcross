...
defns = get_custom_get_definitions("UGate", "SXGate", "CRXGate", "CU3Gate", "C3SXGate", "CYGate", "CSXGate", "ZGate", "U2Gate", "CRZGate", "CXGate", "CCXGate", "SXdgGate", "RZGate", "ECRGate", "CHGate", "RCCXGate", "XGate", "TGate")
...
subcircuit = Program()
subcircuit.inst(Gates.U2Gate(2.9670729916188607, 2.039688749053328)( 4 ))
subcircuit.inst(Gates.RZGate(3.2374432046466546, 4 ))
subcircuit.inst(Gates.TGate( 4 ))
subcircuit.inst(Gates.CYGate( 8, 0 ))
subcircuit.inst(Gates.RCCXGate( 7, 8, 2 ))

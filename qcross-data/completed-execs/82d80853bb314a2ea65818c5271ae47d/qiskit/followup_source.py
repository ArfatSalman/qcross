...
qc.append(ZGate(), qargs=[qr[1]], cargs=[])
qc.append(RZGate(3.775592041307464), qargs=[qr[3]], cargs=[])
# SECTION
# NAME: USELESS_ENTITIES

qr_d8f917 = QuantumRegister(9, name='qr_d8f917')
qc.add_register(qr_d8f917)
# SECTION
# NAME: MEASUREMENT
...
backend_c5941a03cd2547c48a3c32929673cae6 = Aer.get_backend('aer_simulator')
counts = execute(qc, backend=backend_c5941a03cd2547c48a3c32929673cae6, shots=2771).result().get_counts(qc)
RESULT = counts

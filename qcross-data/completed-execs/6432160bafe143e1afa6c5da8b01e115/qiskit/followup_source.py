...
backend_f689c3aa69814546bb76c639cd7c4892 = Aer.get_backend('aer_simulator_density_matrix')
counts = execute(qc, backend=backend_f689c3aa69814546bb76c639cd7c4892, shots=2771).result().get_counts(qc)
RESULT = counts

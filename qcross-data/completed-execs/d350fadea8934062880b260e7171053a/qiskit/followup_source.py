...
qc = transpile(qc, basis_gates=None, optimization_level=2, coupling_map=[[0,
    1], [0, 8], [1, 0], [1, 2], [1, 3], [2, 1], [3, 1], [3, 4], [3, 6], [4,
    3], [4, 5], [4, 7], [5, 4], [6, 3], [7, 4], [8, 0]])
# SECTION
# NAME: EXECUTION

from qiskit import Aer, transpile, execute
backend_981654bb7bcc415b8e4f857203a1b1fc = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_981654bb7bcc415b8e4f857203a1b1fc, shots=1385).result().get_counts(qc)
RESULT = counts

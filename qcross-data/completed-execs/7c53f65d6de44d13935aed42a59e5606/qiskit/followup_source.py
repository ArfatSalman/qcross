...
backend_d9e4532a3629437fa6acbfb266c2d6df = Aer.get_backend('aer_simulator_matrix_product_state')
counts = execute(qc, backend=backend_d9e4532a3629437fa6acbfb266c2d6df, shots=346).result().get_counts(qc)
RESULT = counts

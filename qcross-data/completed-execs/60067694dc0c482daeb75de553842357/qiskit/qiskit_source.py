...
backend_952f6c0b836545e0934f044e3bf1c2b0 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_952f6c0b836545e0934f044e3bf1c2b0, shots=1385).result().get_counts(qc)
RESULT = counts
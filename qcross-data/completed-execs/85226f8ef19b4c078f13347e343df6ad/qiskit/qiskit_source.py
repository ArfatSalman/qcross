...
backend_694468fc9a534242bcaef989d6973474 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_694468fc9a534242bcaef989d6973474, shots=489).result().get_counts(qc)
RESULT = counts
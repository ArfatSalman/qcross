...
p_02c2c5 = circuit.declare('p_02c2c5', 'REAL')
p_fbcf76 = circuit.declare('p_fbcf76', 'REAL')
p_6f2fa9 = circuit.declare('p_6f2fa9', 'REAL')

defns = get_custom_get_definitions("CHGate", "ZGate", "RZGate", "CRZGate", "TGate", "SXGate", "C3SXGate", "CRXGate", "U2Gate", "XGate", "CSXGate", "CCXGate")

circuit += defns

circuit.inst(Gates.RZGate(6.163759533339787, 3 ))
circuit.inst(Gates.CRZGate(4.2641612072511235, 6, 3 ))
circuit.inst(Gates.CRXGate(p_6f2fa9, 1, 7 ))
...
circuit.inst(Gates.CRZGate(p_fbcf76, 1, 2 ))
circuit.inst(Gates.U2Gate(p_02c2c5, 2.1276323672732023)( 2 ))

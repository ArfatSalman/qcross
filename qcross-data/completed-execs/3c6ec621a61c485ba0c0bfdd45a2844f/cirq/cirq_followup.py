...
p_02c2c5 = Symbol('p_02c2c5')
p_fbcf76 = Symbol('p_fbcf76')
p_6f2fa9 = Symbol('p_6f2fa9')

circuit = cirq.Circuit()

circuit.append(Gates.RZGate(6.163759533339787)( qr[3] ))
circuit.append(Gates.CRZGate(4.2641612072511235)( qr[6], qr[3] ))
circuit.append(Gates.CRXGate(p_6f2fa9)( qr[1], qr[7] ))
...
circuit.append(Gates.CRZGate(p_fbcf76)( qr[1], qr[2] ))
circuit.append(Gates.U2Gate(p_02c2c5, 2.1276323672732023)( qr[2] ))

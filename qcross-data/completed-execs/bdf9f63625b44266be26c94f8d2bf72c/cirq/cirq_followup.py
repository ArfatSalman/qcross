...
p_d40aec = Symbol('p_d40aec')
p_10c631 = Symbol('p_10c631')
p_a7734b = Symbol('p_a7734b')
p_c8b7aa = Symbol('p_c8b7aa')
p_8f9e53 = Symbol('p_8f9e53')
p_da6dd8 = Symbol('p_da6dd8')
p_7f634a = Symbol('p_7f634a')

circuit = cirq.Circuit()

circuit.append(Gates.RZGate(p_da6dd8)( qr[4] ))
...
subcircuit.append(Gates.CRZGate(p_7f634a)( qr[0], qr[5] ))
subcircuit.append(Gates.CSXGate( qr[4], qr[0] ))
subcircuit.append(Gates.SwapGate( qr[1], qr[4] ))
subcircuit.append(Gates.RYYGate(p_a7734b)( qr[2], qr[0] ))
circuit.append(subcircuit)
circuit.append(cirq.inverse(cirq.expand_composite(subcircuit)))

circuit.append(Gates.CRXGate(p_c8b7aa)( qr[2], qr[5] ))
...
circuit.append(Gates.RZGate(p_10c631)( qr[1] ))
circuit.append(Gates.C3SXGate( qr[0], qr[2], qr[1], qr[3] ))
circuit.append(Gates.CU1Gate(p_d40aec)( qr[4], qr[0] ))
circuit.append(Gates.CRXGate(p_8f9e53)( qr[4], qr[6] ))

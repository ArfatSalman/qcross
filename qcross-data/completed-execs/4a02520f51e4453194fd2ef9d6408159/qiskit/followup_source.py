...
qc = transpile(qc, basis_gates=None, optimization_level=2, coupling_map=[[0,
    1], [1, 0], [1, 3], [1, 4], [1, 6], [2, 4], [3, 1], [4, 1], [4, 2], [4,
    5], [5, 4], [6, 1]])
# SECTION
# NAME: EXECUTION

from qiskit import Aer, transpile, execute
backend_01eabda031584c388785f294681da947 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_01eabda031584c388785f294681da947, shots=1959).result().get_counts(qc)
RESULT = counts

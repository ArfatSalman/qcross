...
defns = get_custom_get_definitions("CRZGate", "U2Gate", "C3SXGate", "CU1Gate", "CUGate", "SGate", "RZGate", "TGate", "XGate", "CSXGate", "ZGate", "SdgGate", "SXGate", "CHGate")

circuit += defns

circuit.inst(Gates.RZGate(6.163759533339787, 2 ))
circuit.inst(Gates.CSXGate( 7, 1 ))
circuit.inst(Gates.CUGate(0.5112149185250571, 5.897054719225356, 2.3864521352475245, 5.987304452123941, 3, 5 ))
circuit.inst(Gates.SdgGate( 4 ))
circuit.inst(Gates.C3SXGate( 3, 2, 8, 6 ))
circuit.inst(Gates.ZGate( 7 ))
circuit.inst(Gates.XGate( 6 ))
circuit.inst(Gates.SGate( 3 ))
circuit.inst(Gates.SGate( 2 ))
circuit.inst(Gates.C3SXGate( 4, 0, 7, 3 ))
circuit.inst(Gates.SXGate( 3 ))
circuit.inst(Gates.CU1Gate(3.2142159669963557, 2, 0 ))
circuit.inst(Gates.CRZGate(1.4112277317699358, 6, 2 ))
circuit.inst(Gates.ZGate( 7 ))
circuit.inst(Gates.CSXGate( 3, 7 ))
circuit.inst(Gates.ZGate( 8 ))
circuit.inst(Gates.CHGate( 5, 4 ))
circuit.inst(Gates.CSXGate( 0, 3 ))
circuit.inst(Gates.CRZGate(2.586208953975239, 4, 7 ))

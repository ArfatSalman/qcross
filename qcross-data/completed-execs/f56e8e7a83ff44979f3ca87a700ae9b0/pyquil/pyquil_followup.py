...
p_382017 = circuit.declare('p_382017', 'REAL')

defns = get_custom_get_definitions("SdgGate", "RCCXGate", "RZGate", "CRZGate", "ZGate", "CSXGate", "XGate", "CCXGate", "CHGate", "U2Gate")
...
circuit.inst(Gates.U2Gate(p_382017, 4.6235667602042065)( 10 ))
circuit.inst(Gates.CSXGate( 3, 2 ))
circuit.inst(Gates.CHGate( 0, 7 ))

qr_fa3172 = circuit.declare("qr_fa3172", "BIT", 1)

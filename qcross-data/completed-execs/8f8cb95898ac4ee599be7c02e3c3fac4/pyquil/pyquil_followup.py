...
defns = get_custom_get_definitions("CU1Gate", "U2Gate", "CUGate", "RZZGate", "TGate", "ZGate", "ECRGate", "XGate", "RZGate", "CCXGate", "CRZGate", "SXdgGate", "CRXGate", "CSXGate", "SXGate", "RCCXGate", "C3SXGate", "RYYGate", "SwapGate")
...
subcircuit = Program()
subcircuit.inst(Gates.ZGate( 7 ))
subcircuit.inst(Gates.ECRGate( 5, 2 ))
subcircuit.inst(Gates.SwapGate( 1, 3 ))
subcircuit.inst(Gates.TGate( 7 ))
subcircuit.inst(Gates.RZGate(5.116009661150895, 2 ))
subcircuit.inst(Gates.RCCXGate( 2, 5, 0 ))

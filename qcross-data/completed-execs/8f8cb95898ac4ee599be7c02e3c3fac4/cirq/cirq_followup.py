...
subcircuit.append(Gates.ZGate( qr[7] ))
subcircuit.append(Gates.ECRGate( qr[5], qr[2] ))
subcircuit.append(Gates.SwapGate( qr[1], qr[3] ))
subcircuit.append(Gates.TGate( qr[7] ))
subcircuit.append(Gates.RZGate(5.116009661150895)( qr[2] ))
subcircuit.append(Gates.RCCXGate( qr[2], qr[5], qr[0] ))
subcircuit.append(Gates.SXdgGate( qr[6] ))
subcircuit.append(Gates.CCXGate( qr[5], qr[3], qr[4] ))

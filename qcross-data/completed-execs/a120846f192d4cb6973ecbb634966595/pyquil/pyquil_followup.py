...
defns = get_custom_get_definitions("C3SXGate", "ZGate", "SGate", "CHGate", "SdgGate", "RCCXGate", "XGate", "ECRGate", "CSXGate", "CU1Gate", "RZGate", "CRXGate")
...
qr_067348 = circuit.declare("qr_067348", "BIT", 9)

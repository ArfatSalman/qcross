...
backend_4fd036c6b7ce43aabbc59a0f8a17b773 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_4fd036c6b7ce43aabbc59a0f8a17b773, shots=3919).result().get_counts(qc)
RESULT = counts

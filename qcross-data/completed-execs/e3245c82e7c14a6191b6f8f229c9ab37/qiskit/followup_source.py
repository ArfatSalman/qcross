...
qr_80ebae = QuantumRegister(10, name='qr_80ebae')
qc.add_register(qr_80ebae)
# SECTION
# NAME: MEASUREMENT
...
backend_4ca215bdd59e4dddbb3bc4b431fa2395 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_4ca215bdd59e4dddbb3bc4b431fa2395, shots=5542).result().get_counts(qc)
RESULT = counts

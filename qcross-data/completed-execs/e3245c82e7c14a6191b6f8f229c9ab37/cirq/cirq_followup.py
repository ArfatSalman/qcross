...
circuit.append(Gates.CRZGate(4.2641612072511235)( qr[8], qr[3] ))
circuit.append(Gates.CRXGate(5.987304452123941)( qr[9], qr[7] ))
circuit.append(Gates.CCXGate( qr[1], qr[2], qr[7] ))
circuit.append(Gates.ZGate( qr[4] ))
circuit.append(Gates.TGate( qr[2] ))
circuit.append(Gates.XGate( qr[6] ))
circuit.append(Gates.CRZGate(4.167661441102218)( qr[9], qr[8] ))
circuit.append(Gates.RZGate(4.229610589867865)( qr[9] ))
circuit.append(Gates.SXGate( qr[4] ))
circuit.append(Gates.CSXGate( qr[5], qr[6] ))
circuit.append(Gates.CCXGate( qr[5], qr[2], qr[1] ))

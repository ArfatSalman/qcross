...
p_a95533 = Symbol('p_a95533')
p_ec403b = Symbol('p_ec403b')
p_4c0f0f = Symbol('p_4c0f0f')
p_6100f8 = Symbol('p_6100f8')
p_07e86a = Symbol('p_07e86a')
p_55c5f0 = Symbol('p_55c5f0')

circuit = cirq.Circuit()

circuit.append(Gates.RZGate(p_4c0f0f)( qr[3] ))
circuit.append(Gates.CRZGate(p_6100f8)( qr[6], qr[3] ))
circuit.append(Gates.CRXGate(p_55c5f0)( qr[1], qr[7] ))
circuit.append(Gates.CCXGate( qr[5], qr[9], qr[7] ))
circuit.append(Gates.ZGate( qr[2] ))
circuit.append(Gates.TGate( qr[9] ))
circuit.append(Gates.XGate( qr[8] ))
circuit.append(Gates.CRZGate(p_07e86a)( qr[1], qr[6] ))
circuit.append(Gates.RZGate(p_ec403b)( qr[1] ))
...
circuit.append(Gates.CRZGate(p_a95533)( qr[1], qr[2] ))

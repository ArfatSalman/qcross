...
backend_1140a3d1239240078c39ee6ea2ea46e9 = Aer.get_backend('aer_simulator')
counts_1 = execute(qc_1, backend=backend_1140a3d1239240078c39ee6ea2ea46e9, shots=3919).result().get_counts(qc_1)
counts_2 = execute(qc_2, backend=backend_1140a3d1239240078c39ee6ea2ea46e9, shots=3919).result().get_counts(qc_2)

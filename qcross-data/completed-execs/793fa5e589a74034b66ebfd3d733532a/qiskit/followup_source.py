...
qr_f12346 = QuantumRegister(5, name='qr_f12346')
qc.add_register(qr_f12346)
# SECTION
# NAME: MEASUREMENT
...
backend_94d36a892e9c4e7684b4e96b15f76850 = Aer.get_backend(
    'aer_simulator_statevector')
counts = execute(qc, backend=backend_94d36a892e9c4e7684b4e96b15f76850,

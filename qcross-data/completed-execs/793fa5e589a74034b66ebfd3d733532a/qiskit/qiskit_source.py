...
backend_94d36a892e9c4e7684b4e96b15f76850 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_94d36a892e9c4e7684b4e96b15f76850, shots=979).result().get_counts(qc)
RESULT = counts
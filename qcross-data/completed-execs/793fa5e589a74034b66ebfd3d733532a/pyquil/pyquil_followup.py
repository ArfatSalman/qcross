...
defns = get_custom_get_definitions("SGate", "ZGate", "CU1Gate", "RZGate", "RYYGate", "CRZGate", "CRXGate", "CHGate", "TGate", "UGate", "XGate", "CUGate", "CSXGate", "ECRGate", "SXdgGate")
...
qr_f12346 = circuit.declare("qr_f12346", "BIT", 5)

...
qc.append(CRZGate(4.167661441102218), qargs=[qr[1], qr[3]], cargs=[])
qc.append(RZGate(4.229610589867865), qargs=[qr[1]], cargs=[])
qc.append(SXGate(), qargs=[qr[5]], cargs=[])
qc.append(CSXGate(), qargs=[qr[9], qr[8]], cargs=[])
qc.append(CCXGate(), qargs=[qr[9], qr[2], qr[4]], cargs=[])
qc.append(C3SXGate(), qargs=[qr[5], qr[9], qr[6], qr[2]], cargs=[])
qc.append(CSXGate(), qargs=[qr[6], qr[5]], cargs=[])
...
qc.append(CRXGate(5.970852306777193), qargs=[qr[0], qr[1]], cargs=[])
qc.append(UGate(5.080799300534071, 5.023617931957853, 2.271164628944128),
    qargs=[qr[5]], cargs=[])
qc.append(ECRGate(), qargs=[qr[9], qr[8]], cargs=[])
...
backend_5a0b8ad97c41446b9780a3627f50bcf5 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_5a0b8ad97c41446b9780a3627f50bcf5, shots=5542).result().get_counts(qc)
RESULT = counts

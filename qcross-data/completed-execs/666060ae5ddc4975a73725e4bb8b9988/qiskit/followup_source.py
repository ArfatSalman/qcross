...
qc = transpile(qc, basis_gates=None, optimization_level=2, coupling_map=[[0,
    1], [1, 0], [1, 2], [2, 1], [2, 3], [3, 2], [3, 4], [4, 3]])
# SECTION
# NAME: EXECUTION

from qiskit import Aer, transpile, execute
backend_be397763641647a6b155fbb90e6c8047 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_be397763641647a6b155fbb90e6c8047, shots=979).result().get_counts(qc)
RESULT = counts

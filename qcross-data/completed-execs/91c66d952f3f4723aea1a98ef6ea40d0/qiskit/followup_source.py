...
qr_edd40d = QuantumRegister(7, name='qr_edd40d')
qc.add_register(qr_edd40d)
# SECTION
# NAME: MEASUREMENT
...
backend_5d2f11b93f6a4c7f9a0b7e9a7654e303 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_5d2f11b93f6a4c7f9a0b7e9a7654e303, shots=7838).result().get_counts(qc)
RESULT = counts

...
qr_2e072e = QuantumRegister(5, name='qr_2e072e')
qc.add_register(qr_2e072e)
# SECTION
# NAME: MEASUREMENT
...
backend_fc020e6ec6384dd18316751c26b7c168 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_fc020e6ec6384dd18316751c26b7c168, shots=3919).result().get_counts(qc)
RESULT = counts

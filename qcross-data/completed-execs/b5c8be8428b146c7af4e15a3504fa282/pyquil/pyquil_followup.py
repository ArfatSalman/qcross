...
defns = get_custom_get_definitions("XGate", "RZGate", "CSXGate", "ZGate", "SGate", "C3SXGate", "SdgGate", "CU1Gate", "SXGate", "CUGate", "CRZGate")

circuit += defns

circuit.inst(Gates.RZGate(6.163759533339787, 3 ))
circuit.inst(Gates.CSXGate( 5, 4 ))
circuit.inst(Gates.CUGate(0.5112149185250571, 5.897054719225356, 2.3864521352475245, 5.987304452123941, 6, 7 ))
circuit.inst(Gates.SdgGate( 1 ))
circuit.inst(Gates.C3SXGate( 6, 3, 8, 2 ))
circuit.inst(Gates.ZGate( 5 ))
circuit.inst(Gates.XGate( 2 ))
circuit.inst(Gates.SGate( 6 ))
circuit.inst(Gates.SGate( 3 ))
circuit.inst(Gates.C3SXGate( 1, 0, 5, 6 ))
circuit.inst(Gates.SXGate( 6 ))
circuit.inst(Gates.CU1Gate(3.2142159669963557, 3, 0 ))
circuit.inst(Gates.CRZGate(1.4112277317699358, 2, 3 ))
circuit.inst(Gates.ZGate( 5 ))

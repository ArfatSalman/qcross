...
qr_d4743d = QuantumRegister(10, name='qr_d4743d')
qc.add_register(qr_d4743d)
# SECTION
# NAME: MEASUREMENT
...
backend_b9298741d497488fa555866927054e46 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_b9298741d497488fa555866927054e46, shots=2771).result().get_counts(qc)
RESULT = counts

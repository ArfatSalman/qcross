...
qr_a67738 = QuantumRegister(10, name='qr_a67738')
subcircuit.add_register(qr_a67738)
# SECTION
# NAME: MEASUREMENT
...
backend_4d8b449c4ac74546b7131f39ee225d1e = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_4d8b449c4ac74546b7131f39ee225d1e, shots=1385).result().get_counts(qc)
RESULT = counts

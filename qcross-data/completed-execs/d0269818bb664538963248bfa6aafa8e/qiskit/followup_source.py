...
qc = transpile(qc, basis_gates=['rx', 'ry', 'rz', 'p', 'cx'],
    optimization_level=2, coupling_map=[[0, 1], [0, 3], [0, 5], [1, 0], [2,
    3], [3, 0], [3, 2], [3, 4], [4, 3], [5, 0]])
# SECTION
# NAME: EXECUTION

from qiskit import Aer, transpile, execute
backend_969df70e648a48e48ee29db9db3c70a6 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_969df70e648a48e48ee29db9db3c70a6, shots=1385).result().get_counts(qc)
RESULT = counts

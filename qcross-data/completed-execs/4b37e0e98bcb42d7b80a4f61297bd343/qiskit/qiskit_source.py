...
backend_0e584b2f0b1840b998f72ed30a46c325 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_0e584b2f0b1840b998f72ed30a46c325, shots=692).result().get_counts(qc)
RESULT = counts
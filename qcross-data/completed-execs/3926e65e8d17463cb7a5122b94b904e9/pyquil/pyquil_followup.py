...
p_eb443b = circuit.declare('p_eb443b', 'REAL')
p_9b2473 = circuit.declare('p_9b2473', 'REAL')

defns = get_custom_get_definitions("SXdgGate", "XGate", "RZGate", "CSXGate", "SGate", "ZGate", "RCCXGate", "CHGate", "CRXGate", "RYYGate", "SdgGate", "ECRGate", "TGate", "CCXGate", "iSwapGate")

circuit += defns

circuit.inst(Gates.RZGate(p_eb443b, 1 ))
...
circuit.inst(Gates.RYYGate(p_9b2473)( 1, 0 ))

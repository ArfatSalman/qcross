...
backend_05463784d55e47008dd4dd0130a862df = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_05463784d55e47008dd4dd0130a862df, shots=5542).result().get_counts(qc)
RESULT = counts

...
qc.append(CUGate(0.5112149185250571, 5.897054719225356, 2.3864521352475245,
    5.987304452123941), qargs=[qr[5], qr[4]], cargs=[])
...
backend_6af50c280f534cc5a6983ebeb0779c90 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_6af50c280f534cc5a6983ebeb0779c90, shots=1385).result().get_counts(qc)
RESULT = counts

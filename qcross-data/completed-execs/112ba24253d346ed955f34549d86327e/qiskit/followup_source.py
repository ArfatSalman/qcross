...
qr_2fd1a3 = QuantumRegister(3, name='qr_2fd1a3')
qc.add_register(qr_2fd1a3)
# SECTION
# NAME: MEASUREMENT
...
backend_3c9ceaffa0964b2495a2ec98ea5ea0df = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_3c9ceaffa0964b2495a2ec98ea5ea0df, shots=1385).result().get_counts(qc)
RESULT = counts

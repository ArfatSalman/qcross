...
p_a7ecd0 = Symbol('p_a7ecd0')

circuit = cirq.Circuit()


subcircuit = cirq.Circuit()
subcircuit.append(Gates.CXGate( qr[10], qr[3] ))
subcircuit.append(Gates.RYGate(2.3864521352475245)( qr[1] ))
subcircuit.append(Gates.CPhaseGate(1.6161683469432118)( qr[5], qr[9] ))
circuit.append(subcircuit)
circuit.append(cirq.inverse(cirq.expand_composite(subcircuit)))

circuit.append(Gates.RZGate(p_a7ecd0)( qr[3] ))

...
backend_2dd3ea92cef547848e2665bbaa7be9b9 = Aer.get_backend('qasm_simulator')
counts_1 = execute(qc_1, backend=backend_2dd3ea92cef547848e2665bbaa7be9b9, shots=2771).result().get_counts(qc_1)
counts_2 = execute(qc_2, backend=backend_2dd3ea92cef547848e2665bbaa7be9b9, shots=2771).result().get_counts(qc_2)

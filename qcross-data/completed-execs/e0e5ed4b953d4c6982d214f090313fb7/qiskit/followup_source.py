...
backend_60147ec9c2cf49dda75a6f19d4160dfb = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_60147ec9c2cf49dda75a6f19d4160dfb, shots=3919).result().get_counts(qc)
RESULT = counts

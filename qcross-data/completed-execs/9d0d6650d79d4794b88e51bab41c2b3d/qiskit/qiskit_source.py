...
backend_823d06fb7e6e4fa1ae3b79300a4520c9 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_823d06fb7e6e4fa1ae3b79300a4520c9, shots=7838).result().get_counts(qc)
RESULT = counts
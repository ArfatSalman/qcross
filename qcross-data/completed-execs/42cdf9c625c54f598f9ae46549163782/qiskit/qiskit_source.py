...
backend_f40afdf73e0648dab729da4aeb0f4b76 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_f40afdf73e0648dab729da4aeb0f4b76, shots=3919).result().get_counts(qc)
RESULT = counts
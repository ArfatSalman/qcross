...
defns = get_custom_get_definitions("CRZGate", "RZGate", "CCXGate", "XGate", "RCCXGate", "ZGate")

circuit += defns

circuit.inst(Gates.RZGate(6.163759533339787, 1 ))
circuit.inst(Gates.CRZGate(4.2641612072511235, 3, 2 ))
circuit.inst(Gates.ZGate( 7 ))
circuit.inst(Gates.CCXGate( 5, 0, 10 ))
circuit.inst(Gates.ZGate( 2 ))
circuit.inst(Gates.XGate( 10 ))
circuit.inst(Gates.RCCXGate( 8, 3, 6 ))

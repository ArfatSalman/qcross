...
circuit.append(Gates.CRZGate(4.2641612072511235)( qr[3], qr[2] ))
circuit.append(Gates.ZGate( qr[7] ))
circuit.append(Gates.CCXGate( qr[5], qr[0], qr[10] ))
circuit.append(Gates.ZGate( qr[2] ))
circuit.append(Gates.XGate( qr[10] ))
circuit.append(Gates.RCCXGate( qr[8], qr[3], qr[6] ))
...
circuit.append(cirq.measure(qr[8], key='cr10'))

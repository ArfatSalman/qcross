...
qc = transpile(qc, basis_gates=None, optimization_level=2, coupling_map=[[0,
    1], [0, 4], [1, 0], [1, 2], [2, 1], [2, 3], [3, 2], [4, 0], [4, 5], [5, 4]]
    )
# SECTION
# NAME: EXECUTION

from qiskit import Aer, transpile, execute
backend_44981baea1594b0e9bfc1c0ff6d48838 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_44981baea1594b0e9bfc1c0ff6d48838, shots=979).result().get_counts(qc)
RESULT = counts

...
from qiskit import Aer, transpile, execute
backend_4a62240adc6a4e6e8dd49b370c2293d0 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_4a62240adc6a4e6e8dd49b370c2293d0, shots=979).result().get_counts(qc)
RESULT = counts

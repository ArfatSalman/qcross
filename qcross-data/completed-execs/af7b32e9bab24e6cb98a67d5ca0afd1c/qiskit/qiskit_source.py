...
backend_6c0271acc0c744a4b8590ab941ae48af = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_6c0271acc0c744a4b8590ab941ae48af, shots=979).result().get_counts(qc)
RESULT = counts
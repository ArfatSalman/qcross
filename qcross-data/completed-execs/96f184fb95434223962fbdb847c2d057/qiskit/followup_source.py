...
qc = transpile(qc, basis_gates=None, optimization_level=1, coupling_map=[[0,
    1], [0, 3], [1, 0], [1, 2], [1, 4], [2, 1], [2, 6], [3, 0], [3, 5], [4,
    1], [5, 3], [6, 2]])
# SECTION
# NAME: EXECUTION

from qiskit import Aer, transpile, execute
backend_601b13d6aedc4c109f9ba14eabc32dc3 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_601b13d6aedc4c109f9ba14eabc32dc3, shots=979).result().get_counts(qc)
RESULT = counts

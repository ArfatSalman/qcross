...
defns = get_custom_get_definitions("TGate", "SwapGate", "SXGate", "PhaseGate", "CSwapGate", "CUGate", "C3SXGate", "CSXGate", "CRXGate", "ZGate", "XGate", "CHGate", "CRZGate", "RCCXGate", "CCXGate", "RZGate", "ECRGate", "iSwapGate", "UGate")
...
qr_51b36a = circuit.declare("qr_51b36a", "BIT", 5)

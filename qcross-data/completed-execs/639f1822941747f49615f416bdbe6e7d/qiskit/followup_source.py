...
qr_90443c = QuantumRegister(4, name='qr_90443c')
qc.add_register(qr_90443c)
# SECTION
# NAME: MEASUREMENT
...
backend_307fc1bd38074930b1d9c39fc363f2c0 = Aer.get_backend('aer_simulator_matrix_product_state')
counts = execute(qc, backend=backend_307fc1bd38074930b1d9c39fc363f2c0, shots=692).result().get_counts(qc)
RESULT = counts

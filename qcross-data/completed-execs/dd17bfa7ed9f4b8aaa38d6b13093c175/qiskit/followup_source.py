...
qc = transpile(qc, basis_gates=None, optimization_level=2, coupling_map=[[0,
    1], [0, 8], [0, 9], [1, 0], [1, 6], [2, 7], [3, 7], [3, 8], [4, 9], [5,
    8], [5, 10], [6, 1], [7, 2], [7, 3], [8, 0], [8, 3], [8, 5], [9, 0], [9,
    4], [10, 5]])
# SECTION
# NAME: EXECUTION

from qiskit import Aer, transpile, execute
backend_51253134a8cf4d77ae63d1273285bea6 = Aer.get_backend('aer_simulator_statevector')
counts = execute(qc, backend=backend_51253134a8cf4d77ae63d1273285bea6, shots=5542).result().get_counts(qc)
RESULT = counts

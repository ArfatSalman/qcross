...
backend_b4456bd48f0f4ef3bd1709e0c58e01ed = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_b4456bd48f0f4ef3bd1709e0c58e01ed, shots=346).result().get_counts(qc)
RESULT = counts
...
backend_c4ee162661cd4849b795f37b10f7a4df = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_c4ee162661cd4849b795f37b10f7a4df, shots=3919).result().get_counts(qc)
RESULT = counts

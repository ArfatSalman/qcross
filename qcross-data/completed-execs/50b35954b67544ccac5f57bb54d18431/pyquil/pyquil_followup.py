...
p_6210b8 = circuit.declare('p_6210b8', 'REAL')

defns = get_custom_get_definitions("CCXGate", "RCCXGate", "XGate", "RZGate", "SdgGate", "U2Gate", "ZGate", "CRZGate")

circuit += defns

circuit.inst(Gates.RZGate(p_6210b8, 3 ))

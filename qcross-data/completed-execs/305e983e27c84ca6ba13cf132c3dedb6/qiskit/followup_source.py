...
backend_16f854b438fa40cd920d509d11aa2137 = Aer.get_backend('qasm_simulator')
counts_1 = execute(qc_1, backend=backend_16f854b438fa40cd920d509d11aa2137, shots=7838).result().get_counts(qc_1)
counts_2 = execute(qc_2, backend=backend_16f854b438fa40cd920d509d11aa2137, shots=7838).result().get_counts(qc_2)

...
defns = get_custom_get_definitions("CSXGate", "RC3XGate", "RCCXGate", "CXGate", "CUGate", "CZGate", "RZGate", "IGate")

circuit += defns


subcircuit = Program()
subcircuit.inst(Gates.RCCXGate( 1, 7, 8 ))
subcircuit.inst(Gates.IGate( 0 ))
subcircuit.inst(Gates.CXGate( 2, 7 ))
subcircuit.inst(Gates.CZGate( 5, 7 ))
subcircuit.inst(Gates.RC3XGate( 0, 2, 6, 8 ))
...
qr_2cfbba = circuit.declare("qr_2cfbba", "BIT", 10)

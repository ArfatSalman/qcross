...
backend_0198d885c0e54074a8e6967c362a5e22 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_0198d885c0e54074a8e6967c362a5e22, shots=2771).result().get_counts(qc)
RESULT = counts
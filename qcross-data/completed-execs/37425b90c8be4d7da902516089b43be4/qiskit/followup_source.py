...
backend_03ed570a6dbe4a42a438ff6f72e60f22 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_03ed570a6dbe4a42a438ff6f72e60f22, shots=979).result().get_counts(qc)
RESULT = counts

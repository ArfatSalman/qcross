...
qc.append(CRZGate(2.9790366726895714), qargs=[qr[2], qr[0]], cargs=[])
qc.append(C3SXGate(), qargs=[qr[0], qr[3], qr[2], qr[1]], cargs=[])
...
qc.append(CRXGate(5.94477504571567), qargs=[qr[3], qr[2]], cargs=[])
...
backend_b7270953b1214b07864f4485e393c547 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_b7270953b1214b07864f4485e393c547, shots=692).result().get_counts(qc)
RESULT = counts

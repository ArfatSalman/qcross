...
defns = get_custom_get_definitions("ECRGate", "CRXGate", "RZGate", "UGate", "CRZGate", "CU1Gate", "RYYGate", "CSXGate", "ZGate", "TGate", "SXdgGate", "XGate", "SGate", "CUGate", "CHGate")
...
qr_3c15dc = circuit.declare("qr_3c15dc", "BIT", 9)

...
qr_3c15dc = QuantumRegister(9, name='qr_3c15dc')
qc.add_register(qr_3c15dc)
# SECTION
# NAME: MEASUREMENT
...
backend_c7dab7a25b9547edbe563d31a537814f = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_c7dab7a25b9547edbe563d31a537814f, shots=979).result().get_counts(qc)
RESULT = counts

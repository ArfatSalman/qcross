...
backend_1b82b1b34c6d49b78967181f93fa1397 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_1b82b1b34c6d49b78967181f93fa1397, shots=7838).result().get_counts(qc)
RESULT = counts

...
backend_f9f0cccbf7ba4f1db5a9ad6dcc731894 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_f9f0cccbf7ba4f1db5a9ad6dcc731894, shots=346).result().get_counts(qc)
RESULT = counts

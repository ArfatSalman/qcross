...
defns = get_custom_get_definitions("CHGate", "RYYGate", "CSXGate", "SdgGate", "CCXGate", "U2Gate", "ZGate", "XGate", "RCCXGate", "SXdgGate", "CRZGate", "RZGate")
...
subcircuit = Program()
subcircuit.inst(Gates.RZGate(5.2273388406613, 2 ))
subcircuit.inst(Gates.SXdgGate( 10 ))
...
qr_ea7a51 = circuit.declare("qr_ea7a51", "BIT", 7)

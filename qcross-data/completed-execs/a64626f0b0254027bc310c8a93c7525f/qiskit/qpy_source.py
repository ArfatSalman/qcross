...
qr_2943bb = QuantumRegister(4, name='qr_2943bb')
qc.add_register(qr_2943bb)
# SECTION
# NAME: MEASUREMENT
...
backend_6fcaa26dd90e499ea4f3a91f46dae50b = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_6fcaa26dd90e499ea4f3a91f46dae50b, shots=5542).result().get_counts(qc)
RESULT = counts

...
p_0733ce = Symbol('p_0733ce')
p_74209b = Symbol('p_74209b')

circuit = cirq.Circuit()

circuit.append(Gates.RZGate(p_0733ce)( qr[4] ))
circuit.append(Gates.ZGate( qr[6] ))
circuit.append(Gates.XGate( qr[3] ))
circuit.append(Gates.CRXGate(p_74209b)( qr[2], qr[5] ))
...
circuit = cirq.resolve_parameters(circuit, {
    "p_0733ce": 6.163759533339787,
    "p_74209b": 2.0099472182748075
}, recursive=True)

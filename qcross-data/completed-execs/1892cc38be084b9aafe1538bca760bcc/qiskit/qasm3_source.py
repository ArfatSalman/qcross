...
qr_79bda8 = QuantumRegister(2, name='qr_79bda8')
qc.add_register(qr_79bda8)
# SECTION
# NAME: MEASUREMENT
...
backend_ae434a91aa5741efa3ac271ceca8fbf9 = Aer.get_backend(
    'aer_simulator_matrix_product_state')
counts = execute(qc, backend=backend_ae434a91aa5741efa3ac271ceca8fbf9,

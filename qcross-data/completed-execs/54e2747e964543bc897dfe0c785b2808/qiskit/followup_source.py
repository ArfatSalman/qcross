...
qr_e1b699 = QuantumRegister(4, name='qr_e1b699')
qc.add_register(qr_e1b699)
# SECTION
# NAME: MEASUREMENT
...
backend_d33328b831db428f8dadf08bd283bad8 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_d33328b831db428f8dadf08bd283bad8, shots=692).result().get_counts(qc)
RESULT = counts

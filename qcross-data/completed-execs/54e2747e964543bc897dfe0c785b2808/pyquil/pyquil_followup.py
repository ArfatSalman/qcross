...
defns = get_custom_get_definitions("SXdgGate", "iSwapGate", "C3SXGate", "RCCXGate", "RZZGate", "CU1Gate", "RYYGate", "CUGate", "RZGate", "TGate", "XGate", "CSXGate", "CHGate")
...
qr_e1b699 = circuit.declare("qr_e1b699", "BIT", 4)

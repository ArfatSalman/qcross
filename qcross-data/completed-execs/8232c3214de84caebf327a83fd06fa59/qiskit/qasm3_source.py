...
subcircuit.append(TGate(), qargs=[qr[3]], cargs=[])
...
backend_235f3db70b944c61a0282297e087e2bf = Aer.get_backend('aer_simulator')
counts = execute(qc, backend=backend_235f3db70b944c61a0282297e087e2bf, shots=692).result().get_counts(qc)
RESULT = counts

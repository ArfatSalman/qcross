...
p_63fe22 = Symbol('p_63fe22')
p_8b8a09 = Symbol('p_8b8a09')
p_45fbe7 = Symbol('p_45fbe7')
p_bd04cf = Symbol('p_bd04cf')

circuit = cirq.Circuit()

circuit.append(Gates.RZGate(p_63fe22)( qr[8] ))
circuit.append(Gates.CSXGate( qr[2], qr[4] ))
circuit.append(Gates.CUGate(p_45fbe7, p_8b8a09, p_bd04cf, 5.987304452123941)( qr[0], qr[6] ))

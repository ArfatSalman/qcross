...
p_63fe22 = circuit.declare('p_63fe22', 'REAL')
p_8b8a09 = circuit.declare('p_8b8a09', 'REAL')
p_45fbe7 = circuit.declare('p_45fbe7', 'REAL')
p_bd04cf = circuit.declare('p_bd04cf', 'REAL')

defns = get_custom_get_definitions("C3SXGate", "SGate", "ZGate", "CUGate", "RZGate", "CSXGate", "XGate", "SdgGate")

circuit += defns

circuit.inst(Gates.RZGate(p_63fe22, 8 ))
circuit.inst(Gates.CSXGate( 2, 4 ))
circuit.inst(Gates.CUGate(p_45fbe7, p_8b8a09, p_bd04cf, 5.987304452123941, 0, 6 ))

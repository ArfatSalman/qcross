...
qr_e266a6 = QuantumRegister(2, name='qr_e266a6')
qc.add_register(qr_e266a6)
# SECTION
# NAME: MEASUREMENT
...
backend_9afd34c1e7224dc7af23756be7c9b015 = Aer.get_backend('aer_simulator_statevector')
counts = execute(qc, backend=backend_9afd34c1e7224dc7af23756be7c9b015, shots=3919).result().get_counts(qc)
RESULT = counts

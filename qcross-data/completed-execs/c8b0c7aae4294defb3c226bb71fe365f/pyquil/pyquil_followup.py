...
defns = get_custom_get_definitions("CUGate", "SGate", "SXGate", "TGate", "C3SXGate", "ZGate", "CU1Gate", "CHGate", "U2Gate", "RZGate", "SdgGate", "CCXGate", "CSXGate", "CRZGate", "XGate")
...
qr_e266a6 = circuit.declare("qr_e266a6", "BIT", 2)

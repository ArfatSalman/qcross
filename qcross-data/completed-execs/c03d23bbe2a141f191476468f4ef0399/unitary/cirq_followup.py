...
circuit.append(Gates.CRXGate(5.987304452123941)( qr[6], qr[1] ))
circuit.append(Gates.CRZGate(1.0296448789776642)( qr[3], qr[1] ))
circuit.append(Gates.C3SXGate( qr[6], qr[7], qr[1], qr[4] ))

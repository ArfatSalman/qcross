...
backend_2cec2130aea0482b9ce0935e8d9761c5 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_2cec2130aea0482b9ce0935e8d9761c5, shots=346).result().get_counts(qc)
RESULT = counts

...
qr_e7a267 = QuantumRegister(8, name='qr_e7a267')
qc.add_register(qr_e7a267)
# SECTION
# NAME: MEASUREMENT
...
backend_51ea89efad3b4fecab96a9304dca44e5 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_51ea89efad3b4fecab96a9304dca44e5, shots=692).result().get_counts(qc)
RESULT = counts

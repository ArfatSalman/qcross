...
circuit.inst(Gates.CRXGate(2.0099472182748075, 1, 6 ))
circuit.inst(Gates.C3SXGate( 5, 0, 3, 1 ))
circuit.inst(Gates.CHGate( 2, 5 ))
circuit.inst(Gates.C3SXGate( 0, 1, 3, 6 ))
circuit.inst(Gates.ZGate( 1 ))
circuit.inst(Gates.ECRGate( 5, 4 ))
circuit.inst(Gates.SdgGate( 5 ))
circuit.inst(Gates.RCCXGate( 1, 6, 0 ))
...
circuit.inst(Gates.C3SXGate( 1, 0, 4, 2 ))
...
circuit.inst(Gates.C3SXGate( 1, 0, 6, 2 ))

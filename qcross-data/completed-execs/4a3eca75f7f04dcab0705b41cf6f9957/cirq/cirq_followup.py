...
p_35205c = Symbol('p_35205c')
p_5601c2 = Symbol('p_5601c2')
p_cd242e = Symbol('p_cd242e')
p_d80ef0 = Symbol('p_d80ef0')

circuit = cirq.Circuit()

circuit.append(Gates.RZGate(p_5601c2)( qr[4] ))
...
circuit.append(Gates.CU1Gate(p_35205c)( qr[4], qr[0] ))

subcircuit = cirq.Circuit()
subcircuit.append(Gates.CSwapGate( qr[0], qr[5], qr[4] ))
...
subcircuit.append(Gates.C3XGate(p_d80ef0)( qr[6], qr[5], qr[4], qr[7] ))
subcircuit.append(Gates.CXGate( qr[2], qr[3] ))
subcircuit.append(Gates.PhaseGate(p_cd242e)( qr[0] ))

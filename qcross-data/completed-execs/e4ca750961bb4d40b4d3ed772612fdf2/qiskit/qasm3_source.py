...
backend_84c101acac6542e2a94128275e27b2bc = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_84c101acac6542e2a94128275e27b2bc, shots=5542).result().get_counts(qc)
RESULT = counts

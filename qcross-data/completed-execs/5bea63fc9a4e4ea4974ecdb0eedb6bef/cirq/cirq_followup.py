...
circuit.append(Gates.CUGate(0.5112149185250571, 5.897054719225356, 2.3864521352475245, 5.987304452123941)( qr[4], qr[1] ))
circuit.append(Gates.C3SXGate( qr[5], qr[2], qr[0], qr[4] ))
circuit.append(Gates.CCXGate( qr[5], qr[3], qr[0] ))
circuit.append(Gates.C3SXGate( qr[2], qr[1], qr[3], qr[0] ))
...
circuit.append(Gates.C3SXGate( qr[0], qr[4], qr[5], qr[1] ))
circuit.append(Gates.CU1Gate(3.2142159669963557)( qr[1], qr[0] ))
circuit.append(Gates.UGate(5.887184334931191, 0.07157463504881167, 1.4112277317699358)( qr[3] ))
circuit.append(Gates.RZZGate(5.1829934776392745)( qr[0], qr[3] ))
...
circuit.append(Gates.C3SXGate( qr[1], qr[0], qr[2], qr[4] ))

...
backend_e67fceb959dd4cce8accc8cee4b0b2f1 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_e67fceb959dd4cce8accc8cee4b0b2f1, shots=7838).result().get_counts(qc)
RESULT = counts
...
defns = get_custom_get_definitions("SXdgGate", "XGate", "RZGate", "CSXGate", "RCCXGate", "SGate", "CHGate", "RZZGate", "C3SXGate", "RYYGate", "CRXGate", "TGate", "CU1Gate", "iSwapGate", "CUGate", "CRZGate")
...
qr_a35414 = circuit.declare("qr_a35414", "BIT", 6)

...
qr_a35414 = QuantumRegister(6, name='qr_a35414')
qc.add_register(qr_a35414)
# SECTION
# NAME: MEASUREMENT
...
backend_e819bc9fda7b4533915a29641fd888df = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_e819bc9fda7b4533915a29641fd888df, shots=692).result().get_counts(qc)
RESULT = counts

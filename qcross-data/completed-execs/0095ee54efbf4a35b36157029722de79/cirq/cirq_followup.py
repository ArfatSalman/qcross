...
subcircuit.append(Gates.CSwapGate( qr[0], qr[1], qr[6] ))
subcircuit.append(Gates.CXGate( qr[2], qr[0] ))
subcircuit.append(Gates.PhaseGate(1.7897858384938228)( qr[0] ))
subcircuit.append(Gates.CU3Gate(3.950837470808744, 0.31862897237472254, 0.35592835823340635)( qr[4], qr[0] ))
subcircuit.append(Gates.PhaseGate(5.336667571035288)( qr[0] ))
subcircuit.append(Gates.CRZGate(4.747288222618085)( qr[1], qr[5] ))
subcircuit.append(Gates.RXGate(2.4205260581208594)( qr[5] ))
subcircuit.append(Gates.CUGate(4.722103101046168, 5.3924725338944945, 4.88987246261121, 1.2497571638956968)( qr[2], qr[5] ))

...
defns = get_custom_get_definitions("ZGate", "CHGate", "CU1Gate", "RCCXGate", "SGate", "SXGate", "C3SXGate", "CUGate", "TGate", "CCXGate", "XGate", "U2Gate", "RZGate", "SwapGate", "CRZGate", "CSXGate", "SdgGate")
...
subcircuit = Program()
subcircuit.inst(Gates.RZGate(4.38472991219647, 1 ))

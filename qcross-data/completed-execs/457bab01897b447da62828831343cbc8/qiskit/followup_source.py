...
qr_acd2f4 = QuantumRegister(1, name='qr_acd2f4')
qc.add_register(qr_acd2f4)
# SECTION
# NAME: MEASUREMENT
...
backend_8eeeaa4da01e4936bc4ee6961e09f256 = Aer.get_backend(
    'aer_simulator_matrix_product_state')
counts = execute(qc, backend=backend_8eeeaa4da01e4936bc4ee6961e09f256,

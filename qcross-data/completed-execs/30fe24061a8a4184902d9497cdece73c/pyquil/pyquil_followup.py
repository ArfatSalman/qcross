...
defns = get_custom_get_definitions("SdgGate", "CRXGate", "CHGate", "SGate", "RZGate", "RCCXGate", "CU1Gate", "ZGate", "XGate", "C3SXGate", "ECRGate")
...
circuit.inst(Gates.CRXGate(2.0099472182748075, 3, 1 ))
circuit.inst(Gates.C3SXGate( 6, 2, 0, 3 ))
circuit.inst(Gates.CHGate( 5, 6 ))
circuit.inst(Gates.C3SXGate( 2, 3, 0, 1 ))
circuit.inst(Gates.ZGate( 3 ))
circuit.inst(Gates.ECRGate( 6, 4 ))
...
circuit.inst(Gates.CRXGate(5.94477504571567, 5, 6 ))

...
circuit.append(Gates.CRXGate(2.0099472182748075)( qr[3], qr[1] ))
...
circuit.append(Gates.ECRGate( qr[6], qr[4] ))
...
circuit.append(Gates.CRXGate(5.94477504571567)( qr[5], qr[6] ))

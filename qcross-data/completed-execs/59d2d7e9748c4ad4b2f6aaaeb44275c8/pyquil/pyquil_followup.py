...
defns = get_custom_get_definitions("CRZGate", "SXdgGate", "TGate", "SXGate", "RXXGate", "ZGate", "UGate", "RYYGate", "RZGate", "XGate", "SGate", "CUGate", "CU1Gate", "U3Gate", "ECRGate", "CHGate", "CRXGate", "CSXGate")
...
subcircuit = Program()
subcircuit.inst(Gates.U3Gate(5.555370888627314, 5.844449584475221, 3.8139021644696793)( 3 ))
subcircuit.inst(Gates.SXGate( 0 ))
subcircuit.inst(Gates.RXXGate(5.25962645863375)( 2, 0 ))

...
qc = transpile(qc, basis_gates=None, optimization_level=0, coupling_map=[[0, 1], [0, 2], [1, 0], [2, 0]])
# SECTION
# NAME: EXECUTION

from qiskit import Aer, transpile, execute
backend_590be53ac115412980dd201fa8f1b6a1 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_590be53ac115412980dd201fa8f1b6a1, shots=346).result().get_counts(qc)
RESULT = counts

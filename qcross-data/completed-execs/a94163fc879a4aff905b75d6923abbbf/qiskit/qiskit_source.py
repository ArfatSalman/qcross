...
backend_7a3d3fd31f5241a6a78f7c132d558faa = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_7a3d3fd31f5241a6a78f7c132d558faa, shots=979).result().get_counts(qc)
RESULT = counts
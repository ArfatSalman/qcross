...
defns = get_custom_get_definitions("SXdgGate", "XGate", "SGate", "CHGate", "RZZGate", "UGate", "ECRGate", "CPhaseGate", "RXXGate", "YGate")
...
subcircuit.inst(Gates.UGate(5.987304452123941, 1.847916451195972, 4.094867647151279)( 1 ))

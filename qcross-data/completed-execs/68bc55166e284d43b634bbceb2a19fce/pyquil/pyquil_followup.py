...
defns = get_custom_get_definitions("CSXGate", "CHGate", "ZGate", "RZGate", "ECRGate", "SGate", "DCXGate", "CXGate", "SdgGate", "C3SXGate", "CRXGate", "CSwapGate", "RYYGate", "CU1Gate", "SwapGate", "XGate", "RCCXGate", "SXdgGate")
...
subcircuit.inst(Gates.DCXGate( 2, 1 ))
subcircuit.inst(Gates.CSwapGate( 6, 5, 4 ))
...
qr_a2badd = circuit.declare("qr_a2badd", "BIT", 3)

...
qc = transpile(qc, basis_gates=['rx', 'ry', 'rz', 'p', 'cx'],
    optimization_level=2, coupling_map=[[0, 1], [0, 5], [0, 9], [0, 10], [1,
    0], [1, 3], [1, 4], [1, 7], [2, 3], [3, 1], [3, 2], [4, 1], [5, 0], [5,
    8], [6, 8], [7, 1], [7, 11], [8, 5], [8, 6], [9, 0], [10, 0], [11, 7]])
# SECTION
# NAME: EXECUTION

from qiskit import Aer, transpile, execute
backend_2324396cc62b485b86278facca52a36b = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_2324396cc62b485b86278facca52a36b, shots=5542).result().get_counts(qc)
RESULT = counts

...
p_879f8b = Symbol('p_879f8b')
p_6f6166 = Symbol('p_6f6166')
p_0b24f3 = Symbol('p_0b24f3')
p_4f0dc0 = Symbol('p_4f0dc0')
p_b4f3fe = Symbol('p_b4f3fe')
p_0ac045 = Symbol('p_0ac045')

circuit = cirq.Circuit()

circuit.append(Gates.RZGate(p_879f8b)( qr[8] ))
circuit.append(Gates.CSXGate( qr[2], qr[4] ))
circuit.append(Gates.CUGate(p_4f0dc0, 5.897054719225356, 2.3864521352475245, 5.987304452123941)( qr[0], qr[6] ))
...
circuit.append(Gates.CU1Gate(p_b4f3fe)( qr[8], qr[3] ))
...
circuit.append(Gates.CRZGate(p_0b24f3)( qr[1], qr[2] ))
circuit.append(Gates.U2Gate(p_0ac045, p_6f6166)( qr[2] ))

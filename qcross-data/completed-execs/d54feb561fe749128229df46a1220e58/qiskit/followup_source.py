...
qr_34cc35 = QuantumRegister(8, name='qr_34cc35')
qc.add_register(qr_34cc35)
# SECTION
# NAME: MEASUREMENT
...
backend_4e54a32238e24d35816fbbff067d2545 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_4e54a32238e24d35816fbbff067d2545, shots=692).result().get_counts(qc)
RESULT = counts

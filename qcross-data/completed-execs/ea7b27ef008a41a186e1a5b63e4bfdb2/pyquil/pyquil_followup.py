...
defns = get_custom_get_definitions("XGate", "ZGate", "ECRGate", "TGate", "CU3Gate", "RZGate", "CRZGate", "CCXGate", "CRXGate")

circuit += defns


subcircuit = Program()
subcircuit.inst(Gates.CU3Gate(2.696266694818697, 5.631160518436971, 2.9151388486514547, 0, 9 ))

...
qc = transpile(qc, basis_gates=['rx', 'ry', 'rz', 'p', 'cx'],
    optimization_level=2, coupling_map=[[0, 1], [0, 5], [0, 8], [0, 10], [1,
    0], [1, 6], [2, 4], [2, 10], [3, 10], [4, 2], [5, 0], [5, 7], [6, 1], [
    7, 5], [8, 0], [9, 10], [10, 0], [10, 2], [10, 3], [10, 9]])
# SECTION
...
backend_c53189bc7bad4f3b91ef9e69f18cd7ce = Aer.get_backend('statevector_simulator')
counts = execute(qc, backend=backend_c53189bc7bad4f3b91ef9e69f18cd7ce, shots=5542).result().get_counts(qc)
RESULT = counts

...
backend_a308f63f516048ceb40a0825e6c107f8 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_a308f63f516048ceb40a0825e6c107f8, shots=5542).result().get_counts(qc)
RESULT = counts
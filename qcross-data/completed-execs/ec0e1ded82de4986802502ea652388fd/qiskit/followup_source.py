...
backend_690758a250c04c47864264bedf126ee2 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_690758a250c04c47864264bedf126ee2, shots=346).result().get_counts(qc)
RESULT = counts

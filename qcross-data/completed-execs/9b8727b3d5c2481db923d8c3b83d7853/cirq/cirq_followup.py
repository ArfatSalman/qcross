...
circuit.append(Gates.CRXGate(5.987304452123941)( qr[1], qr[8] ))
circuit.append(Gates.CCXGate( qr[5], qr[3], qr[8] ))
...
circuit.append(Gates.CSXGate( qr[4], qr[9] ))
circuit.append(Gates.CCXGate( qr[4], qr[3], qr[5] ))
circuit.append(Gates.C3SXGate( qr[6], qr[4], qr[7], qr[3] ))

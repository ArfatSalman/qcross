...
circuit.append(Gates.C3SXGate( qr[2], qr[5], qr[1], qr[4] ))
circuit.append(Gates.CCXGate( qr[2], qr[3], qr[1] ))
circuit.append(Gates.C3SXGate( qr[5], qr[0], qr[3], qr[1] ))
circuit.append(Gates.ZGate( qr[1] ))
circuit.append(Gates.ZGate( qr[4] ))
circuit.append(Gates.TGate( qr[5] ))
circuit.append(Gates.RCCXGate( qr[3], qr[0], qr[5] ))
circuit.append(Gates.SGate( qr[3] ))
circuit.append(Gates.CRZGate(4.167661441102218)( qr[2], qr[3] ))
circuit.append(Gates.RZGate(4.229610589867865)( qr[2] ))
circuit.append(Gates.C3SXGate( qr[1], qr[4], qr[2], qr[0] ))
...
circuit.append(Gates.CU1Gate(4.028174522740928)( qr[2], qr[5] ))
circuit.append(Gates.C3SXGate( qr[0], qr[1], qr[5], qr[4] ))

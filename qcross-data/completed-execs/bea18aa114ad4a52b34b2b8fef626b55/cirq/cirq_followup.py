...
circuit.append(Gates.C3SXGate( qr[0], qr[3], qr[2], qr[7] ))
circuit.append(Gates.ZGate( qr[4] ))
circuit.append(Gates.XGate( qr[6] ))
circuit.append(Gates.RYYGate(1.740253089260498)( qr[2], qr[3] ))
circuit.append(Gates.CRZGate(4.167661441102218)( qr[6], qr[3] ))
circuit.append(Gates.RZGate(4.229610589867865)( qr[6] ))
circuit.append(Gates.SXGate( qr[0] ))
circuit.append(Gates.CU1Gate(3.2142159669963557)( qr[5], qr[0] ))

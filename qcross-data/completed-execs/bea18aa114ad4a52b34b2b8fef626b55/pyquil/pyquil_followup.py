...
defns = get_custom_get_definitions("RYYGate", "XGate", "ZGate", "CU1Gate", "CRZGate", "C3SXGate", "SXGate", "CRXGate", "RZGate")
...
circuit.inst(Gates.C3SXGate( 0, 3, 2, 7 ))
circuit.inst(Gates.ZGate( 4 ))
circuit.inst(Gates.XGate( 6 ))
circuit.inst(Gates.RYYGate(1.740253089260498)( 2, 3 ))
circuit.inst(Gates.CRZGate(4.167661441102218, 6, 3 ))
circuit.inst(Gates.RZGate(4.229610589867865, 6 ))
circuit.inst(Gates.SXGate( 0 ))
circuit.inst(Gates.CU1Gate(3.2142159669963557, 5, 0 ))
circuit.inst(Gates.CRXGate(5.94477504571567, 2, 5 ))

qr_c1ed4b = circuit.declare("qr_c1ed4b", "BIT", 5)

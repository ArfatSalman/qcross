...
qr_ee55b7 = QuantumRegister(4, name='qr_ee55b7')
qc.add_register(qr_ee55b7)
# SECTION
# NAME: MEASUREMENT
...
backend_6a1bae2b41ff456caf0f1f2e77d0f346 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_6a1bae2b41ff456caf0f1f2e77d0f346, shots=346).result().get_counts(qc)
RESULT = counts

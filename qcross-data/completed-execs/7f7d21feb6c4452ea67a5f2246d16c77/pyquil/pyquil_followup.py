...
defns = get_custom_get_definitions("CRZGate", "CHGate", "SXdgGate", "iSwapGate", "TGate", "SXGate", "XGate", "RZGate", "RZZGate", "CU1Gate", "ECRGate", "RYYGate", "CRXGate", "CSXGate")
...
qr_ee55b7 = circuit.declare("qr_ee55b7", "BIT", 4)

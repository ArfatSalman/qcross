...
backend_a6bedae3a40d45ab883c3a495dc6ed61 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_a6bedae3a40d45ab883c3a495dc6ed61, shots=489).result().get_counts(qc)
RESULT = counts
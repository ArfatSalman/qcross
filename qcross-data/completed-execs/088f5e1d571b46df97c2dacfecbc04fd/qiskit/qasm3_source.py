...
backend_61e0d2038bbf420d80206a82af403a13 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_61e0d2038bbf420d80206a82af403a13, shots=3919).result().get_counts(qc)
RESULT = counts

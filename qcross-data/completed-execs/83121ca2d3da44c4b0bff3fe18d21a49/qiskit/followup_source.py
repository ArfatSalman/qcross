...
backend_8c3eb950ad6547f48ba995f2193637ec = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_8c3eb950ad6547f48ba995f2193637ec, shots=7838).result().get_counts(qc)
RESULT = counts

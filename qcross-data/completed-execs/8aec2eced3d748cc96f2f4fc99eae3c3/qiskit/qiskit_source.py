...
qc.append(CU3Gate(1.3311670849927728,3.9319327441527228,5.390352297216399), qargs=[qr[0], qr[2]], cargs=[])
qc.append(TGate(), qargs=[qr[0]], cargs=[])
qc.append(RYGate(5.264688008730697), qargs=[qr[1]], cargs=[])
qc.append(CU1Gate(5.709276284014425), qargs=[qr[2], qr[1]], cargs=[])
...
backend_5648d931fde54263a1c449799cb766d8 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_5648d931fde54263a1c449799cb766d8, shots=489).result().get_counts(qc)
RESULT = counts
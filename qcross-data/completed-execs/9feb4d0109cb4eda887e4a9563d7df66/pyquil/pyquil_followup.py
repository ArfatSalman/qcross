...
p_7b7b65 = circuit.declare('p_7b7b65', 'REAL')
p_e65c05 = circuit.declare('p_e65c05', 'REAL')
p_e39fe0 = circuit.declare('p_e39fe0', 'REAL')

defns = get_custom_get_definitions("ZGate", "RZGate", "C3SXGate", "CRXGate", "RYYGate", "XGate", "CRZGate")

circuit += defns

circuit.inst(Gates.RZGate(p_7b7b65, 4 ))
...
circuit.inst(Gates.RYYGate(p_e65c05)( 6, 7 ))
circuit.inst(Gates.CRZGate(p_e39fe0, 1, 7 ))

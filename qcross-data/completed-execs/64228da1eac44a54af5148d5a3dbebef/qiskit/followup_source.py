...
backend_5991600131ef4b10aea767c2ea462333 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_5991600131ef4b10aea767c2ea462333, shots=692).result().get_counts(qc)
RESULT = counts

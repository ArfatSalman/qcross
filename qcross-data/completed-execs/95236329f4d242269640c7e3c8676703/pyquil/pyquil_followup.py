...
defns = get_custom_get_definitions("CUGate", "UGate", "SGate", "RZGate", "CU1Gate", "CSXGate", "ECRGate", "CHGate", "TGate", "CRZGate", "SXdgGate", "XGate", "ZGate", "CRXGate", "RYYGate")
...
circuit.inst(Gates.ECRGate( 3, 4 ))
circuit.inst(Gates.CRXGate(2.0099472182748075, 2, 3 ))
circuit.inst(Gates.SGate( 0 ))
circuit.inst(Gates.CRZGate(1.0296448789776642, 3, 2 ))
circuit.inst(Gates.CHGate( 1, 2 ))
circuit.inst(Gates.RYYGate(1.6723037552953224)( 0, 4 ))
...
circuit.inst(Gates.RYYGate(5.398622178940033)( 0, 4 ))

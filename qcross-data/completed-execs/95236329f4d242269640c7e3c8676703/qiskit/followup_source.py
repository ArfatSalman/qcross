...
qc.append(RYYGate(1.6723037552953224), qargs=[qr[0], qr[4]], cargs=[])
...
qc.append(RYYGate(5.398622178940033), qargs=[qr[0], qr[4]], cargs=[])
...
backend_a213e15ddb3f4b178be99fc4d047d334 = Aer.get_backend('aer_simulator')
counts = execute(qc, backend=backend_a213e15ddb3f4b178be99fc4d047d334, shots=979).result().get_counts(qc)
RESULT = counts

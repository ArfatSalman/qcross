...
defns = get_custom_get_definitions("RYYGate", "XGate", "CRYGate", "U3Gate", "RZZGate", "ZGate", "PhaseGate", "CSXGate", "CU1Gate", "CRZGate", "C3SXGate", "SXGate", "CXGate", "C3XGate", "CRXGate", "SXdgGate", "RZGate")
...
subcircuit = Program()
subcircuit.inst(Gates.U3Gate(5.555370888627314, 5.844449584475221, 3.8139021644696793)( 6 ))

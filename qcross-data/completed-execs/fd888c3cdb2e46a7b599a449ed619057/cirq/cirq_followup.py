...
subcircuit.append(Gates.U3Gate(5.555370888627314, 5.844449584475221, 3.8139021644696793)( qr[6] ))
subcircuit.append(Gates.CRYGate(3.1402006997068588)( qr[2], qr[0] ))
subcircuit.append(Gates.SXdgGate( qr[2] ))
subcircuit.append(Gates.C3XGate(2.6687018103754414)( qr[6], qr[5], qr[4], qr[7] ))

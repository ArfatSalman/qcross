...
qr_917057 = QuantumRegister(8, name='qr_917057')
qc.add_register(qr_917057)
# SECTION
# NAME: MEASUREMENT
...
backend_8814d37b49834d4c8da7a70cee04b6dd = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_8814d37b49834d4c8da7a70cee04b6dd, shots=1959).result().get_counts(qc)
RESULT = counts

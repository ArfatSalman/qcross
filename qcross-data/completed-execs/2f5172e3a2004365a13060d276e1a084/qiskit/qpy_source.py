...
backend_0e525d748ff44eaf8eb0db8568f37c3b = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_0e525d748ff44eaf8eb0db8568f37c3b, shots=346).result().get_counts(qc)
RESULT = counts

...
backend_bf675c772c964906848f529e55de6711 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_bf675c772c964906848f529e55de6711, shots=979).result().get_counts(qc)
RESULT = counts

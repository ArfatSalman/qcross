...
backend_d32fb533142141668b7d41373dd4207d = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_d32fb533142141668b7d41373dd4207d, shots=1959).result().get_counts(qc)
RESULT = counts
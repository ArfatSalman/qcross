...
backend_87b02ac10ccf472885d670c22802648c = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_87b02ac10ccf472885d670c22802648c, shots=692).result().get_counts(qc)
RESULT = counts

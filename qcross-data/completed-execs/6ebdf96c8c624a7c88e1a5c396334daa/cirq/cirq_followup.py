...
p_a7d066 = Symbol('p_a7d066')
p_3e420c = Symbol('p_3e420c')
p_4dde90 = Symbol('p_4dde90')
p_e123c8 = Symbol('p_e123c8')

circuit = cirq.Circuit()

circuit.append(Gates.RZGate(p_a7d066)( qr[3] ))
circuit.append(Gates.SXdgGate( qr[2] ))
circuit.append(Gates.CSXGate( qr[1], qr[0] ))
circuit.append(Gates.ECRGate( qr[3], qr[2] ))
circuit.append(Gates.CRXGate(p_e123c8)( qr[4], qr[3] ))
circuit.append(Gates.SGate( qr[0] ))
circuit.append(Gates.CRZGate(p_3e420c)( qr[3], qr[4] ))
circuit.append(Gates.CHGate( qr[1], qr[4] ))
circuit.append(Gates.RYYGate(p_4dde90)( qr[0], qr[2] ))

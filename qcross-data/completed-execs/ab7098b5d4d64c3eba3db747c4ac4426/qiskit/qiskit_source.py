...
backend_e876b646cf424233973df1d4e3d675c7 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_e876b646cf424233973df1d4e3d675c7, shots=346).result().get_counts(qc)
RESULT = counts
...
qr_7edcce = QuantumRegister(10, name='qr_7edcce')
qc.add_register(qr_7edcce)
# SECTION
# NAME: MEASUREMENT
...
backend_3b4129738900402ea6ce818b03f3541e = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_3b4129738900402ea6ce818b03f3541e, shots=1385).result().get_counts(qc)
RESULT = counts

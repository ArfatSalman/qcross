...
defns = get_custom_get_definitions("CRZGate", "CU1Gate", "RZZGate", "ZGate", "CRXGate", "UGate", "SXGate", "CUGate", "TGate", "RCCXGate", "CCXGate", "RZGate", "C3SXGate", "SGate", "SdgGate")
...
qr_7edcce = circuit.declare("qr_7edcce", "BIT", 10)

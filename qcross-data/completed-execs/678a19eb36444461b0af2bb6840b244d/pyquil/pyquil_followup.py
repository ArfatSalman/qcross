...
qr_1 = qc_1.declare("ro", "BIT", 9)



defns = get_custom_get_definitions("RZGate", "CCXGate", "ZGate")

qc_1 += defns

qc_1.inst(Gates.RZGate(6.163759533339787, 0 ))
qc_1.inst(Gates.ZGate( 1 ))
qc_1.inst(Gates.CCXGate( 3, 2, 4 ))
...
defns = get_custom_get_definitions("CRZGate", "ZGate")

qc_2 += defns

qc_2.inst(Gates.CRZGate(4.2641612072511235, 1, 0 ))

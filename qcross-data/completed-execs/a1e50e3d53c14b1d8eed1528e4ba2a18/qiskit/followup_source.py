...
qc_2.append(CRZGate(4.2641612072511235), qargs=[qr_2[6], qr_2[4]], cargs=[])
qc_2.append(CCXGate(), qargs=[qr_2[1], qr_2[0], qr_2[2]], cargs=[])
qc_2.append(ZGate(), qargs=[qr_2[4]], cargs=[])
qc_2.append(XGate(), qargs=[qr_2[2]], cargs=[])
qc_2.append(RCCXGate(), qargs=[qr_2[5], qr_2[6], qr_2[3]], cargs=[])
qc_2.append(RZGate(4.229610589867865), qargs=[qr_2[7]], cargs=[])
# SECTION
# NAME: MEASUREMENT
...
backend_1e7b32515a0148d8ba3298bb14c96218 = Aer.get_backend('qasm_simulator')
counts_1 = execute(qc_1, backend=backend_1e7b32515a0148d8ba3298bb14c96218, shots=7838).result().get_counts(qc_1)
counts_2 = execute(qc_2, backend=backend_1e7b32515a0148d8ba3298bb14c96218, shots=7838).result().get_counts(qc_2)

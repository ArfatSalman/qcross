...
qr_2 = qc_2.declare("ro", "BIT", 8)



defns = get_custom_get_definitions("RZGate", "RCCXGate", "CCXGate", "ZGate", "CRZGate", "XGate")

qc_2 += defns

qc_2.inst(Gates.CRZGate(4.2641612072511235, 6, 4 ))
qc_2.inst(Gates.CCXGate( 1, 0, 2 ))
qc_2.inst(Gates.ZGate( 4 ))
qc_2.inst(Gates.XGate( 2 ))
qc_2.inst(Gates.RCCXGate( 5, 6, 3 ))
qc_2.inst(Gates.RZGate(4.229610589867865, 7 ))

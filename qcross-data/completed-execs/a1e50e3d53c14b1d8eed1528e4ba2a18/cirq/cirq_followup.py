...
qc_2.append(Gates.CRZGate(4.2641612072511235)( qr_2[6], qr_2[4] ))
qc_2.append(Gates.CCXGate( qr_2[1], qr_2[0], qr_2[2] ))
qc_2.append(Gates.ZGate( qr_2[4] ))
qc_2.append(Gates.XGate( qr_2[2] ))
qc_2.append(Gates.RCCXGate( qr_2[5], qr_2[6], qr_2[3] ))
qc_2.append(Gates.RZGate(4.229610589867865)( qr_2[7] ))

...
defns = get_custom_get_definitions("CHGate", "ZGate", "UGate", "CRZGate", "RCCXGate", "SGate", "CCXGate", "ECRGate", "SXdgGate", "XGate", "iSwapGate", "RZGate", "CRXGate", "TGate", "CSXGate", "RYYGate", "SdgGate")
...
subcircuit.inst(Gates.RYYGate(0.2906326206587185)( 1, 2 ))

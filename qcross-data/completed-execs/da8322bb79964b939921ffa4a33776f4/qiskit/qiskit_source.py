...
backend_abcda5ac7e9a470ea822a8db7862defd = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_abcda5ac7e9a470ea822a8db7862defd, shots=1385).result().get_counts(qc)
RESULT = counts
...
backend_4f51a11797a448f3b9c546e54f8e36c5 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_4f51a11797a448f3b9c546e54f8e36c5, shots=489).result().get_counts(qc)
RESULT = counts
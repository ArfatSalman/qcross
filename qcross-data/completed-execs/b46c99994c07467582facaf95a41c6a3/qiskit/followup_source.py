...
backend_d5dd5643bbf442ed8e952d32ed4a8374 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_d5dd5643bbf442ed8e952d32ed4a8374, shots=1385).result().get_counts(qc)
RESULT = counts

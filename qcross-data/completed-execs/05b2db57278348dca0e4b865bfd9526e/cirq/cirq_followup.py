...
circuit.append(Gates.CRXGate(5.987304452123941)( qr[0], qr[8] ))
circuit.append(Gates.CCXGate( qr[4], qr[5], qr[8] ))
circuit.append(Gates.ZGate( qr[6] ))
circuit.append(Gates.TGate( qr[5] ))
circuit.append(Gates.XGate( qr[1] ))
circuit.append(Gates.CRZGate(4.167661441102218)( qr[0], qr[7] ))
...
circuit.append(Gates.C3SXGate( qr[6], qr[3], qr[2], qr[5] ))
circuit.append(Gates.CSXGate( qr[2], qr[6] ))
circuit.append(Gates.ZGate( qr[2] ))
circuit.append(Gates.CHGate( qr[8], qr[0] ))
circuit.append(Gates.CSXGate( qr[6], qr[2] ))
circuit.append(Gates.CRZGate(2.586208953975239)( qr[0], qr[6] ))
...
circuit.append(cirq.measure(qr[5], key='cr9'))

...
backend_6cde30722b0c4f4fbbdaa5290be9570a = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_6cde30722b0c4f4fbbdaa5290be9570a, shots=346).result().get_counts(qc)
RESULT = counts
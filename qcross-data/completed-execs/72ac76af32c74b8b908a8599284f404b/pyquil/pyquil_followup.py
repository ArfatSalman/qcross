...
defns = get_custom_get_definitions("CRXGate", "CCXGate", "RZGate", "CRZGate")

circuit += defns

circuit.inst(Gates.RZGate(6.163759533339787, 9 ))
circuit.inst(Gates.CRZGate(4.2641612072511235, 0, 9 ))
circuit.inst(Gates.CRXGate(5.987304452123941, 4, 6 ))
circuit.inst(Gates.CCXGate( 2, 3, 6 ))

qr_26cb71 = circuit.declare("qr_26cb71", "BIT", 9)

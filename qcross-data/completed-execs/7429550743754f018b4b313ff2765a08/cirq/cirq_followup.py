...
circuit.append(Gates.CRXGate(2.0099472182748075)( qr[2], qr[4] ))
circuit.append(Gates.SGate( qr[0] ))
circuit.append(Gates.CRZGate(1.0296448789776642)( qr[4], qr[2] ))
circuit.append(Gates.CHGate( qr[1], qr[2] ))
circuit.append(Gates.RYYGate(1.6723037552953224)( qr[0], qr[3] ))
...
circuit.append(Gates.CUGate(5.708725119517347, 4.167661441102218, 4.623446645668956, 3.865496458458116)( qr[1], qr[2] ))
circuit.append(Gates.RZGate(4.229610589867865)( qr[1] ))
circuit.append(Gates.RYYGate(5.398622178940033)( qr[0], qr[3] ))

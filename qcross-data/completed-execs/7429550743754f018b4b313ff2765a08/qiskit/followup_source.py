...
qc.append(CRXGate(2.0099472182748075), qargs=[qr[2], qr[4]], cargs=[])
qc.append(SGate(), qargs=[qr[0]], cargs=[])
qc.append(CRZGate(1.0296448789776642), qargs=[qr[4], qr[2]], cargs=[])
...
qc.append(CUGate(5.708725119517347, 4.167661441102218, 4.623446645668956, 
    3.865496458458116), qargs=[qr[1], qr[2]], cargs=[])
qc.append(RZGate(4.229610589867865), qargs=[qr[1]], cargs=[])
qc.append(RYYGate(5.398622178940033), qargs=[qr[0], qr[3]], cargs=[])
...
qr_b78677 = QuantumRegister(6, name='qr_b78677')
qc.add_register(qr_b78677)
# SECTION
# NAME: MEASUREMENT
...
backend_1ad62fea18cd45b6ac316df23f6c2386 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_1ad62fea18cd45b6ac316df23f6c2386, shots=979).result().get_counts(qc)
RESULT = counts

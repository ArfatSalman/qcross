...
qr_bbcfa3 = QuantumRegister(9, name='qr_bbcfa3')
qc.add_register(qr_bbcfa3)
# SECTION
# NAME: MEASUREMENT
...
backend_e2120990163e4cb3954e8f7273f2b3c8 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_e2120990163e4cb3954e8f7273f2b3c8, shots=692).result().get_counts(qc)
RESULT = counts

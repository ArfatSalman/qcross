...
qr_55e3fe = QuantumRegister(7, name='qr_55e3fe')
qc.add_register(qr_55e3fe)
# SECTION
# NAME: MEASUREMENT
...
backend_c4df74bf258e4d9883dc45c52c728ca4 = Aer.get_backend('aer_simulator_density_matrix')
counts = execute(qc, backend=backend_c4df74bf258e4d9883dc45c52c728ca4, shots=489).result().get_counts(qc)
RESULT = counts

...
defns = get_custom_get_definitions("SXdgGate", "ZGate", "ECRGate", "CPhaseGate", "TGate", "CCXGate", "CSXGate", "XGate", "SGate", "CRXGate", "SdgGate", "iSwapGate", "IGate", "RZGate", "RCCXGate", "CHGate", "RYYGate", "UGate", "RYGate")
...
qr_55e3fe = circuit.declare("qr_55e3fe", "BIT", 7)

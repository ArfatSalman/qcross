...
backend_6b9b03866920461a9a09de259ae4f75e = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_6b9b03866920461a9a09de259ae4f75e, shots=692).result().get_counts(qc)
RESULT = counts

...
backend_4542516053524f519c4e36ce0c454475 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_4542516053524f519c4e36ce0c454475, shots=692).result().get_counts(qc)
RESULT = counts

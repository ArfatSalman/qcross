...
subcircuit.append(CRXGate(2.2498881927557752), qargs=[qr[1], qr[0]], cargs=[])
...
backend_e92c26b596d547de8cd6643516ecf1ca = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_e92c26b596d547de8cd6643516ecf1ca, shots=346).result().get_counts(qc)
RESULT = counts

...
qr_833ec4 = QuantumRegister(1, name='qr_833ec4')
qc_2.add_register(qr_833ec4)
# SECTION
# NAME: MEASUREMENT
...
backend_b7bf3def52c148418af1e22fa96350e9 = Aer.get_backend('qasm_simulator')
counts_1 = execute(qc_1, backend=backend_b7bf3def52c148418af1e22fa96350e9, shots=7838).result().get_counts(qc_1)
counts_2 = execute(qc_2, backend=backend_b7bf3def52c148418af1e22fa96350e9, shots=7838).result().get_counts(qc_2)

...
backend_62e3ff2dfd1440c3a9f393b6f55e0e99 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_62e3ff2dfd1440c3a9f393b6f55e0e99, shots=1959).result().get_counts(qc)
RESULT = counts
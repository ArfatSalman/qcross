...
backend_9b0f313309064234aa955433a671dae5 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_9b0f313309064234aa955433a671dae5, shots=979).result().get_counts(qc)
RESULT = counts
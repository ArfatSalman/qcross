...
subcircuit.append(RZGate(3.8580685613059242), qargs=[qr[2]], cargs=[])
...
backend_c32d3d33e53c4848b1a537038d52a429 = Aer.get_backend('statevector_simulator')
counts = execute(qc, backend=backend_c32d3d33e53c4848b1a537038d52a429, shots=692).result().get_counts(qc)
RESULT = counts

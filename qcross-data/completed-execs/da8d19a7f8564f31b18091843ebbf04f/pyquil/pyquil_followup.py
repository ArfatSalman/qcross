...
defns = get_custom_get_definitions("XGate", "CUGate", "CHGate", "iSwapGate", "SXdgGate", "HGate", "C3SXGate", "CYGate", "CU1Gate", "RZGate", "TdgGate", "CSXGate", "RZZGate", "CXGate", "TGate")
...
subcircuit.inst(Gates.RZGate(3.8580685613059242, 2 ))

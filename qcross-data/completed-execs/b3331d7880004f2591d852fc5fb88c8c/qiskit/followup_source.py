...
backend_7b0d12737b1c48118627f8620a9eedbe = Aer.get_backend('aer_simulator_matrix_product_state')
counts = execute(qc, backend=backend_7b0d12737b1c48118627f8620a9eedbe, shots=3919).result().get_counts(qc)
RESULT = counts

...
qc = transpile(qc, basis_gates=None, optimization_level=2, coupling_map=[[0,
    1], [0, 4], [1, 0], [1, 3], [2, 4], [3, 1], [4, 0], [4, 2]])
# SECTION
# NAME: EXECUTION

from qiskit import Aer, transpile, execute
backend_ebd7888f90de4962a759e1234408d994 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_ebd7888f90de4962a759e1234408d994, shots=692).result().get_counts(qc)
RESULT = counts

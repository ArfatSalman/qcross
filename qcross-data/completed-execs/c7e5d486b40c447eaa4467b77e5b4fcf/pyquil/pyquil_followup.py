...
defns = get_custom_get_definitions("CHGate", "iSwapGate", "XGate", "CCXGate", "CSXGate", "CRXGate", "SXdgGate", "SGate", "RZGate", "SdgGate")
...
qr_de0284 = circuit.declare("qr_de0284", "BIT", 2)

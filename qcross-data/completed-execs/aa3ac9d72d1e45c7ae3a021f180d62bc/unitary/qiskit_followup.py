...
qc = transpile(qc, basis_gates=None, optimization_level=0, coupling_map=[[0, 1], [0, 5], [0, 11], [1, 0], [1, 2], [1, 3], [2, 1], [3, 1], [4, 8], [5, 0], [6, 7], [7, 6], [7, 9], [7, 11], [8, 4], [8, 11], [9, 7], [9, 10], [10, 9], [11, 0], [11, 7], [11, 8]])
# SECTION
# NAME: EXECUTION

from qiskit import Aer, transpile, execute
backend_fcf498f41058438b86c99f991ba400c9 = Aer.get_backend('aer_simulator_density_matrix')
counts = execute(qc, backend=backend_fcf498f41058438b86c99f991ba400c9, shots=2771).result().get_counts(qc)
RESULT = counts

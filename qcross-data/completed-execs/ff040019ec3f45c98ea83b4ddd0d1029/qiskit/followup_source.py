...
backend_4b831831db5f4ec5bcd15d87196e6a64 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_4b831831db5f4ec5bcd15d87196e6a64, shots=692).result().get_counts(qc)
RESULT = counts

...
defns = get_custom_get_definitions("ZGate", "CU1Gate", "RYGate", "CCXGate", "C3SXGate", "CUGate", "CRXGate", "RZGate", "CZGate", "CRZGate", "IGate")
...
subcircuit = Program()
subcircuit.inst(Gates.IGate( 5 ))
subcircuit.inst(Gates.ZGate( 2 ))
subcircuit.inst(Gates.RYGate(4.658325508156331, 2 ))
...
qr_88aa42 = circuit.declare("qr_88aa42", "BIT", 2)

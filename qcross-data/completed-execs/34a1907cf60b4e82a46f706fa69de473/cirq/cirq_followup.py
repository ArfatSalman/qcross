...
subcircuit.append(Gates.IGate( qr[5] ))
subcircuit.append(Gates.ZGate( qr[2] ))
subcircuit.append(Gates.RYGate(4.658325508156331)( qr[2] ))
subcircuit.append(Gates.CZGate( qr[1], qr[4] ))
subcircuit.append(Gates.CRXGate(4.736752714049485)( qr[0], qr[4] ))
subcircuit.append(Gates.CU1Gate(4.501598818751339)( qr[2], qr[5] ))

...
qc.append(CU1Gate(1.6723037552953224), qargs=[qr[1], qr[0]], cargs=[])
qc.append(XGate(), qargs=[qr[0]], cargs=[])
...
backend_c7f7bbc4dc0d47d9aaf946ef5283af0f = Aer.get_backend('aer_simulator_density_matrix')
counts = execute(qc, backend=backend_c7f7bbc4dc0d47d9aaf946ef5283af0f, shots=346).result().get_counts(qc)
RESULT = counts

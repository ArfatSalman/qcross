...
backend_da06767e96f74abfbd28f598b975c893 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_da06767e96f74abfbd28f598b975c893, shots=979).result().get_counts(qc)
RESULT = counts

...
backend_516348b8657d4c6ca615b0be23ec4405 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_516348b8657d4c6ca615b0be23ec4405, shots=346).result().get_counts(qc)
RESULT = counts

...
backend_8c998ec4e6104fd68e1db639b7018fda = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_8c998ec4e6104fd68e1db639b7018fda, shots=2771).result().get_counts(qc)
RESULT = counts

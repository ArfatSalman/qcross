...
backend_e8f34cb8a5b44639bfa8cef701b8d731 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_e8f34cb8a5b44639bfa8cef701b8d731, shots=2771).result().get_counts(qc)
RESULT = counts
...
defns = get_custom_get_definitions("ZGate", "CU1Gate", "UGate", "RCCXGate", "SGate", "CCXGate", "C3SXGate", "CUGate", "TGate", "SXGate", "RZGate", "RZZGate", "CRZGate")
...
circuit.inst(Gates.C3SXGate( 2, 5, 1, 4 ))
circuit.inst(Gates.CCXGate( 2, 3, 1 ))
circuit.inst(Gates.C3SXGate( 5, 0, 3, 1 ))
circuit.inst(Gates.ZGate( 1 ))
circuit.inst(Gates.ZGate( 4 ))
circuit.inst(Gates.TGate( 5 ))
circuit.inst(Gates.RCCXGate( 3, 0, 5 ))
...
circuit.inst(Gates.CU1Gate(4.028174522740928, 2, 5 ))
circuit.inst(Gates.C3SXGate( 0, 1, 5, 4 ))

...
qr_208106 = QuantumRegister(4, name='qr_208106')
qc.add_register(qr_208106)
# SECTION
# NAME: MEASUREMENT
...
backend_374344bf4c814145a422168055bf421d = Aer.get_backend('aer_simulator')
counts = execute(qc, backend=backend_374344bf4c814145a422168055bf421d,

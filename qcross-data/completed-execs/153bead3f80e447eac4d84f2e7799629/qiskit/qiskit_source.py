...
backend_7cf354cb78dc4a0aac71ce1d791cbcb7 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_7cf354cb78dc4a0aac71ce1d791cbcb7, shots=346).result().get_counts(qc)
RESULT = counts
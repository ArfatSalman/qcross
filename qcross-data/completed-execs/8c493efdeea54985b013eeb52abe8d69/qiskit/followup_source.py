...
qr_b6bf79 = QuantumRegister(7, name='qr_b6bf79')
qc.add_register(qr_b6bf79)
# SECTION
# NAME: MEASUREMENT
...
backend_45f33ddc9b124bc48696565dce11ba2d = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_45f33ddc9b124bc48696565dce11ba2d, shots=346).result().get_counts(qc)
RESULT = counts

...
defns = get_custom_get_definitions("CCXGate", "SdgGate", "CRZGate", "CUGate", "CSwapGate", "PhaseGate", "SXGate", "XGate", "RZGate", "CYGate", "RCCXGate", "ZGate", "ECRGate")
...
subcircuit = Program()
subcircuit.inst(Gates.CYGate( 9, 0 ))

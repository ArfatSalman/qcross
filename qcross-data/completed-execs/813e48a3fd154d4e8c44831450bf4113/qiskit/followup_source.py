...
qc.append(CUGate(0.5112149185250571, 5.897054719225356, 2.3864521352475245,
    5.987304452123941), qargs=[qr[2], qr[8]], cargs=[])
qc.append(SdgGate(), qargs=[qr[0]], cargs=[])
qc.append(C3SXGate(), qargs=[qr[2], qr[4], qr[7], qr[6]], cargs=[])
...
qc.append(CRZGate(1.4112277317699358), qargs=[qr[6], qr[4]], cargs=[])
qc.append(ZGate(), qargs=[qr[1]], cargs=[])
...
qc.append(CCXGate(), qargs=[qr[2], qr[8], qr[0]], cargs=[])
qc.append(RCCXGate(), qargs=[qr[5], qr[2], qr[0]], cargs=[])
...
backend_d785ebe80bb843fbb90ba12815285a55 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_d785ebe80bb843fbb90ba12815285a55, shots=3919).result().get_counts(qc)
RESULT = counts

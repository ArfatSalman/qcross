...
def apply_transformations(circuit, context=None):
    ...
    cirq.eject_phased_paulis(optimized_circuit, eject_parameterized=True)
...
result_dict = dict(
    result.multi_measurement_histogram(keys=["cr0", "cr1", "cr2", "cr3"])
)
keys = list(
...

{
    ...
    "qubit_type": "generate_named_qubit_registers",
